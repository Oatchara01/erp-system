...
(ref_id,type_doc,bill_name,bill_address,bill_tel,full_bill,date_so,suggest,payment,sale_comment,po_no,delivery_contract,book_clear,book_no,brn_clear,brn_no,brnp_clear,brnp_no,sn_ckk,sn_no,install_place,with_pr,type_type,type_detail,delivery_type,delivery_date,delivery_time,delivery_address,delivery_contact,delivery_tel,sale_date,sale,sale_code,pr_no,add_date,add_by,status_doc,approve,approve_code,approve_date,payment_des,slip1,slip2,slip3,slip4,slip5,date_send_key,have_order,send_sup,iv_no,tax_id,approve_time,bill_id,cm_no,pre_name,que_ckk,mode_cus,plan_ckk,ic_ckk)
values
('".$ref_id."','".$type_doc."','".$bill_name."','".$bill_address."','".$bill_tel."','".$full_bill."','".$date_so."','".$suggest."','".$payment."','".$sale_comment."','".$po_no."','".$delivery_contract."','".$book_clear."','".$book_no."','".$brn_clear."','".$brn_no."','".$brnp_clear."','".$brnp_no."','".$sn_ckk."','".$sn_no."','".$install_place."','".$with_pr."','".$type_type."','".$type_detail."','".$delivery_type."','".$delivery_date."','".$delivery_time."','".$delivery_address."','".$delivery_contact."','".$delivery_tel."','".$sale_date."','".$sale."','".$sale_code."','".$pr_no."','".$add_date."','".$add_by."','Request','".$approve."','".$sup_code."','".$sale_date."','".$payment_des."','".$_FILES['slip1']['name']."','".$_FILES['slip2']['name']."','".$_FILES['slip3']['name']."','".$_FILES['slip4']['name']."','".$_FILES['slip5']['name']."','".$date_send_key."','".$have_order."','1','".$iv_no."','".$tax_id."','".$approve_time."','".$bill_id."','".$cm_no."','".$pre_name."','".$que_ckk."','".$mode_cus."','".$plan_ckk."','".$ic_ckk."')";
