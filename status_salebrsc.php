...
<div class="w3-container w3-padding-large">
	<div class="w3-panel w3-light-grey"><h3>Status ใบฝากขาย (ทั้งหมด)</h3></div>
...
$strSQL = "SELECT *  FROM hos__consig  where sale_code LIKE '%EN%' ";
}else{
$strSQL = "SELECT *  FROM hos__consig  where sale_code = '".$sale_code."' ";	
}
...
<td><a href=javascript:if(confirm('!!!ต้องการเพิ่มเอกสารใหม่โดยCopyเอกสารเดิมใช่หรือไม่')==true){window.location='register_brcshos_create.php?ref_id=<?php echo $objResult["ref_id"];?>';}><img src="img/sticker.png" width="23" height="23" border="0" /></a>	
