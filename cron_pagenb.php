<?php
$secret_key = "010554107248319112541nb";
...
if (!isset($_GET['key']) || $_GET['key'] !== $secret_key) {
    ...
    $message = "Someone tried to access cron_page.php with an incorrect key on " . date("Y-m-d H:i:s");
...
$message = "Cron Job Report NBM ran successfully on " . date("Y-m-d H:i:s");
$headers = "From: no-reply@yourwebsite.com\r\n" . 
           "MIME-Version: 1.0\r\n" . 
           "Content-Type: text/plain; charset=UTF-8\r\n";
...
$file_to_include = "report_sumallevery_rpanb.php";
