...
$sql21 = "SELECT ref_id FROM so__main where order_id='".$order_id."' and ckk_h ='0'  and ckk_item='0'";
...
$sql2 = "SELECT * FROM tb_product_tiktok where code_jd='".$objArr[6]."'";
//echo $sql2."<br>";
...
$unit1 = $fetch2["unit1"]*$objArr[9];
$unit2 = $fetch2["unit2"]*$objArr[9];
$unit3 = $fetch2["unit3"]*$objArr[9];
$unit4 = $fetch2["unit4"]*$objArr[9];
$unit5 = $fetch2["unit5"]*$objArr[9];
$unit6 = $fetch2["unit6"]*$objArr[9];
$unit7 = $fetch2["unit7"]*$objArr[9];
$unit8 = $fetch2["unit8"]*$objArr[9];
$unit7 = $fetch2["unit7"]*$objArr[9];
$unit8 = $fetch2["unit8"]*$objArr[9];
$unit9 = $fetch2["unit9"]*$objArr[9];
$unit10 = $fetch2["unit10"]*$objArr[9];
...
$sum_amount = $objArr[12]-$objArr[14];
$price_per_unit = ($objArr[12]-$objArr[14])/$unit1;	
...
values ('".$fetch21["ref_id"]."','".$unit1."','".$unit1."','".$price_per_unit."','".$sum_amount."','".$sum_amount."','0.00','".$id_product1."','".$id_product1."','".$waranty1."','Approve','".$objArr[6]."')";

$objQuery1 = mysqli_query($conn,$strSQL1);
	
	
/*if($objArr[14]!='' or $objArr[14]!='0' or $objArr[14]!='0.00'){	
$sum_dis = "-$objArr[14]";
$strSQL1 = "insert into so__submain
...
values ('".$fetch21["ref_id"]."','".$unit1."','".$unit1."','0.00','0.00','".$sum_dis."','".$objArr[14]."','3196','3196','','Approve')";
...
$strSQL19 = "insert into so__submain
(ref_idd,sale_count,sale_countref,price_per_unit,price_per_unitref,sum_amount,discount_unit,product_id,product_code,warranty,status_sol,sale_remark)
values ('".$fetch21["ref_id"]."','".$unit1."','".$unit1."','0.00','0.00','0.00','0.00','5016','5016','','Approve','แถมผ้าเปียก ALLWELL')";
$objQuery19 = mysqli_query($conn,$strSQL19);
...
$sql31 = "SELECT ref_id FROM so__main where order_id='".$order_id."'";
...
$customer_name = $objArr[39];
$delivery_name = $objArr[39];
$tax_id = "";	
	
	
$create = substr($objArr[24],0,10);	
$create_time = substr($objArr[24],-9);	
$date_arr = explode('/' ,$create);
$xdate = $date_arr[2].'-'.$date_arr[1].'-'.$date_arr[0];
$create_order = "$xdate $create_time";	

$tel = $objArr[40];
$order_name = $objArr[39];
$delivery_contact = "$objArr[39]/$objArr[40]";
$address1 = "$objArr[46] $objArr[47]";
$address2 = $objArr[44];
$province = $objArr[43];
$delivery_place = "$objArr[46] $objArr[47] $objArr[44] $objArr[43]";
$ampher = $objArr[44];

$postcode =	$objArr[41];
	
$billing_address = "$objArr[46] $objArr[47] $objArr[44] $objArr[43]";
$billing_name =	$objArr[39];
$billing_tel =	$objArr[40];
$billing_postcode =	$objArr[41];
$billing_add = "$objArr[46] $objArr[47]";
$billing_aum = $objArr[44];
$billing_pro = $objArr[43];	

	
		
$sql9 = "SELECT customer_name FROM tb_customer where cus_tel LIKE '%".$tel."%'";
...
values
('".$customer_name."','7','".$address1."','".$ampher."','".$province."','".$postcode."','".$tel."','".$billing_name."','".$billing_address."','".$ampher."','".$province."','".$billing_postcode."','".$billing_tel."','".$tax_id."','".$delivery_name."','".$delivery_place."','".$ampher."','".$province."','".$postcode."','".$tel."','".$delivery_contact."','".$employee_name."','".$objArr[3]."','".$email."','".$h_ckk."','".$brun_no."')";
...
$sql10 = "SELECT customer_id FROM tb_customer where cus_tel LIKE '%".$tel."%'";
...
// $sum_amount = $objArr[12];
// $price_per_unit = $objArr[12]/$unit1;	
$sum_amount = $objArr[12]-$objArr[14];
$price_per_unit = ($objArr[12]-$objArr[14])/$unit1;	
// echo $price_per_unit;
...
$strSQL = "INSERT INTO so__main (ref_id,register_date,register_time,delivery_name,address1,address2,province,postcode,billing_address,billing_name,billing_tel,tel,order_id,customer_name,order_name,delivery_contact,delivery_place,add_date,add_by,order_refer_code,sale_channel,select_type_doc,doc_release_date,status_doc,delivery_date,approve_complete,employee_name,job_id,delivery,payment,sale_remark,send_stock,bill_id,doc_no,prefer_name,po_no,ex_add,ex_aumper,ex_provin,ex_post,pre_name,tax_id,bill_vat,send_supadm,status_vat,create_order,cs_remark) VALUES ('".$main_id."','".$register_date."','".$register_time."','".$delivery_name."','".$address1."','".$address2."','".$province."','".$postcode."','".$billing_address."','".$billing_name."','".$billing_tel."','".$tel."','".$order_id."','".$customer_name."','".$order_name."','".$delivery_contact."','".$delivery_place."','".$add_date."','".$add_by."','".$order_refer_code."','".$sale_channel."','".$select_type_doc."','".$doc_release_date."','".$select_type_doc."','".$delivery_date."','".$approve_complete."','".$employee_name."','".$job_id."','".$delivery."','".$payment."','Tiktok Shop','1','".$bill_id."','".$doc_no."','Tiktok Shop','".$order_id."','".$billing_add."','".$billing_aum."','".$billing_pro."','".$billing_postcode."','".$pre_name."','".$tax_id."','".$bill_vat."','".$send_supadm."','".$status_vat."','".$create_order."','".$cs_remark."')";
//echo $strSQL;
...
if($id_product1 !=''){
	...
	$strSQL1 = "insert into so__submain
(ref_idd,sale_count,sale_countref,price_per_unit,price_per_unitref,sum_amount,discount_unit,product_id,product_code,warranty,status_sol,sku_code)
values ('".$main_id."','".$unit1."','".$unit1."','".$price_per_unit."','".$sum_amount."','".$sum_amount."','0.00','".$id_product1."','".$id_product1."','".$waranty1."','Approve','".$objArr[6]."')";
...
$strSQL1 = "insert into so__submain
(ref_idd,sale_count,sale_countref,price_per_unit,price_per_unitref,sum_amount,discount_unit,product_id,product_code,warranty,status_sol)
values ('".$main_id."','".$unit1."','".$unit1."','0.00','0.00','".$sum_dis."','".$objArr[14]."','3196','3196','','Approve')";
...
$strSQL19 = "insert into so__submain
(ref_idd,sale_count,sale_countref,price_per_unit,price_per_unitref,sum_amount,discount_unit,product_id,product_code,warranty,status_sol,sale_remark)
values ('".$main_id."','".$unit1."','".$unit1."','0.00','0.00','0.00','0.00','5016','5016','','Approve','แถมผ้าเปียก ALLWELL')";
$objQuery19 = mysqli_query($conn,$strSQL19);
...
$sql2 = "SELECT ref_id FROM so__main WHERE sale_channel = '34' and register_date = '" . $register_date . "' and ckk_item='0'";
$result2 = mysqli_query($conn, $sql2);
$Num_Rows21 = mysqli_num_rows($result2);
	 
$sql2 = "SELECT ref_id FROM so__main WHERE sale_channel = '34' and register_date = '" . $register_date . "' and ckk_item='0' and order_refer_code LIKE '%THT%'";
$result2 = mysqli_query($conn, $sql2);
$Num_Rows22 = mysqli_num_rows($result2);	 

$sql2 = "SELECT ref_id FROM so__main WHERE sale_channel = '34' and register_date = '" . $register_date . "' and ckk_item='0'  and order_refer_code NOT LIKE '%THT%'  and order_refer_code NOT LIKE '%JA%'";
$result2 = mysqli_query($conn, $sql2);
$Num_Rows23 = mysqli_num_rows($result2);	 
	 
$sql2 = "SELECT ref_id FROM so__main WHERE sale_channel = '34' and register_date = '" . $register_date . "' and ckk_item='0' and order_refer_code LIKE '%JA%'";
$result2 = mysqli_query($conn, $sql2);
$Num_Rows24 = mysqli_num_rows($result2);	 
...
$sMessage = "
Tiktok นำเข้าเรียบร้อยค่ะ

J.T Express จำนวน $Num_Rows23 ออเดอร์
Flash Express จำนวน $Num_Rows22 ออเดอร์
ขนส่งปณ.ไทย จำนวน $Num_Rows24 ออเดอร์
...
$strSQL = "Update  so__main set ckk_item='1' Where sale_channel= '34' and register_date = '".$register_date."'";
