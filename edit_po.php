...
$rs = mysqli_fetch_array($qry);
	...
	<form action='edit_po1.php' method="post" name="frmMain" enctype="multipart/form-data" onSubmit="JavaScript:return fncSubmit();" >
...
<font color ='red'>การดำเนินการ</font>
<textarea name="description" id="description" class="w3-input" rows="3" style="width:50%" ><?php echo $rs["description"]; ?></textarea>
