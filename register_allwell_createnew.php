...
?>
<form action='register_allwell_createnew1.php' method="post" name="frmMain" enctype="multipart/form-data" >
	<div class="w3-white">
...
?>
	...
	เลขที่เอกสาร <input name="doc_no" class="w3-input"   type="text" style="width:90%;" readonly>
	
	วันที่ออกเอกสาร <input name="doc_release_date" class="w3-input"  type="date" style="width:90%;" readonly>
...
ชื่อที่ออกบิล
<input name="billing_name" id = "billing_name" type='text' value="<?php echo $objResult['billing_name']; ?>" class="w3-input" readonly>
ทีอยู่ที่ออกบิล
<textarea name="billing_address" id = "billing_address" class="w3-input" rows="1" readonly><?php echo $objResult['billing_address']; ?></textarea>
<div class="w3-half">
Tel.
<input type="text" name="billing_tel" id ="billing_tel" value="<?php echo $objResult['billing_tel']; ?>" class="w3-input" readonly>
</div>
...
?>
<input type="text" name="tax_id" id = "tax_id" value="<?php echo $objResult['tax_id']; ?>" class="w3-input" readonly>
</div>
<div class="w3-bar">
</div>
...
<td style="width:15%;"><teaxarea name = "product_name[]<?php echo $objResult1["id"];?>" id = "product_name[]<?php echo $objResult1["id"];?>"  class="w3-input" readonly><?php echo $objResult1["sol_name"];?></teaxarea></td>	
...
<td style="width:5%;"><input type='text' name = "clear_br[]<?php echo $objResult1["id"];?>" value="<?php echo $objResult1["clear_br"];?>" id = "clear_br[]<?php echo $objResult1["id"];?>"  class="w3-input"  />

	<input type='text' name = "sn[]<?php echo $objResult1["id"];?>" value="<?php echo $objResult1["sn_number"];?>" id = "sn[]<?php echo $objResult1["id"];?>"  class="w3-input"  />
</td>
