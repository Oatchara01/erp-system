...
<div class="w3-container w3-bar w3-light-gray w3-margin-bottom"><h4>Status ค้างรหัสลูกค้า Express AWL</h4></div>
<div class="w3-bar w3-quarter">
วันที่ : <input name="start_date" class="w3-input" value="<?php echo $start_date = isset($_GET['start_date']) ? $_GET['start_date'] : ''; ?>" style="width:90%;" type="date" id="start_date" ></div>
<div class="w3-bar w3-quarter">
ถึง :<input name="end_date" class="w3-input"  value="<?php echo $end_date = isset($_GET['end_date']) ? $_GET['end_date'] : ''; ?>"  style="width:90%;" type="date" id="end_date" ></div>
...
$strSQL = "SELECT *  FROM (hos__so LEFT JOIN tb_customer ON hos__so.bill_id=tb_customer.customer_id)  where  send_admin ='1' and status_doc ='Approve' and customer_code ='' and type_doc='3' and iv_date!='0000-00-00'";
...
if($Keyword !=""){ 
	/*$strSQL .= ' AND hos__so.bill_name  LIKE "%'.$Keyword.'%"'; 
