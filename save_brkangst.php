...
(ref_id,product_code,have_ckk,des_sale,sale_code,customer_name,count,sn_number,iv_no,stock_date,iv_date,add_by,add_date,create_date,status_doc,employee_code)
values ('".$nextId."','".$product_id_new."','".$have_ckk_new."','".$des_sale_new."','".$sale_code_new."','".$customer_name_new."','".$count_new."','".$sn_number_new."','".$iv_no_new."','".$stock_date_new."','".$iv_date_new."','".$add_by."','".$add_date."','".$today_save."','".$status_doc."','".$employee_code."')";
