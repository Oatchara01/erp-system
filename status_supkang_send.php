...
<div class="w3-panel w3-light-gray"><h4>Status Sale Order (ค้างส่ง)</h4></div>
...
$zone=$objResult1["sale_code"];*/
	...
	$strSQL = "SELECT *  FROM hos__so  where status_doc ='Approve' and send_erpst ='0' and stock !='' $sddd";
...
?>
 ...
 echo DateThai($objResult["date_so"]);
				...
				<td><div align="left">
					<?php
						$strSQL2 = "SELECT access_name FROM (hos__subso LEFT JOIN tb_product ON hos__subso.product_ID=tb_product.product_id) WHERE ref_idd = '".$objResult["ref_id"]."' and ckk_st='0' and product_type !='อื่นๆ'";
						//echo $strSQL1;
						//exit();
						...
						while($objResult2 = mysqli_fetch_array($objQuery2)) { ?>
							<?php	echo $objResult2["access_name"]; ?>
