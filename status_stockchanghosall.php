...
$strSQL = "SELECT *  FROM hos__change  where  status_doc !='Rejected'   and iv_no !=''  and stock !='' ";
...
?>
 ...
 echo DateThai($objResult["date_change"]);
	...
	?><br />
				...
				$strSQL2 = "SELECT sn FROM hos__subchange  WHERE ref_idd = '".$objResult["ref_id"]."' ";
						//echo $strSQL1;
						//exit();
	...
	<td  >
				...
				<a href="register_stockchangehos.php?ref_id=<?php echo $objResult["ref_id"];?>&start_date=<?php echo $_GET["start_date"];  ?>&end_date=<?php echo $_GET["end_date"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
				<?php } ?>
