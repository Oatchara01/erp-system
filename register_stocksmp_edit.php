...
<div class="w3-container">
	...
	<form action="register_stocksmp_edit1.php" method="post" name="frmMain" enctype="multipart/form-data">
	<div class="w3-bar">
...
<div class="w3-bar w3-margin-bottom">
			...
			<div class="w3-bar w3-margin-bottom">
			รหัสอ้างอิงการส่ง 
			<input type="text" name="ref_no" id="ref_no" value = "<?php echo $ffirst['ref_no']; ?>" class="w3-input" style="width:90%;"  >
</div>
...
<div class="w3-bar w3-margin-bottom">
	...
	<div class="w3-bar w3-margin-bottom">
		<?php if($ffirst['date_disburse']=='0000-00-00'){ ?>
...
<td style="width:5%;">
<input type='text' name = "sale_count[<?php echo $i?>]; ?>" id = "sale_count[<?php echo $i?>]; ?>" value = "<?php echo $objResult1["sale_count"]; ?>" class="w3-input" style="color:black;text-align:center"  />
</td>
<td style="width:8%;">
<input type='text' name = "product_price[<?php echo $i?>]; ?>"  id = "product_price[<?php echo $i?>]; ?>" value="<?php  $price=$objResult1["unit_price"]; echo number_format( $price,2)."";?>" class="w3-input" size="7" style="color:black;text-align:right" />
	
	<input type='hidden' name = "unit_price[<?php echo $i?>]; ?>"  id = "unit_price[<?php echo $i?>]; ?>" value="<?php  echo $objResult1["unit_price"]; ?>"  />
	
		<input type='hidden' name = "sum_amount1[<?php echo $i?>]; ?>"  id = "sum_amount1[<?php echo $i?>]; ?>" value="<?php  echo $objResult1["sum_amount"]; ?>"  />
</td >



<td style="width:8%;"><input type='text' name = "sum_amount[<?php echo $i?>]; ?>"  id = "sum_amount[<?php echo $i?>]; ?>" value="<?php  $sum_amount=$objResult1["sum_amount"]; echo number_format( $sum_amount,2)."";?>"  class="w3-input" size="7" style="color:black;text-align:right" readonly/>
</td>
...
<td style="width:5%;"><a href="delete_productsmp.php?ref_idsmp=<?php echo $ffirst['ref_idsmp'];?>&subsmp_id=<?php echo $objResult1["subsmp_id"];?>"><img src="img/false.png" width="16" height="16" border="0" /></a></td>
...
<?php include ('detail_allwellsmp1.php')?>
...
ชื่อพนักงาน :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input name="employee_name" value="<?php echo $fetch1["employee_name"]; ?>" class="button4" type='text'  id="employee_name" >
...
<input name="add_code" value="<?php echo $fetch1["add_code"]; ?>"  class="button4" type='hidden' id="add_code" >
</p>
