...
if (remain < 0 && creditThb !== 0) {
        ...
        Swal.fire({
            ...
            window.location.href = "status_suphos.php";
        });
    }
})();
</script>
	...
	<form action='register_suphos_createnew1.php' method="post" name="frmMain" enctype="multipart/form-data"  onSubmit="JavaScript:return fncSubmit();" >
...
วันที่ : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="date" name = "date_so" id="date_so" value="<?php echo $today; ?>" class = "button4">
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<input type='text' name = "bill_id"  id = "bill_id" class="button4" placeholder="Search ชื่อลูกค้า..." value="<?php echo $rs["bill_id"];?>" style="width:30%;" OnChange="JavaScript:doCallAjax1('bill_id','bill_name','bill_address','bill_tel','tax_id');"/> 
...
<input type="hidden" value="<?php echo $rs["mode_cus"];?>" name="mode_cus" id="mode_cus" class="button4" style="width:30%;"  > </p>
...
กำหนดส่งตามสัญญา :
<input name="delivery_contract" id="delivery_contract" type='date'   class="button4" style="width:30%"> </p>
...
สถานที่ส่งสินค้า :</p>
<textarea  class="button4" name="address_1" value="<?php echo $fetch1["address_1"]; ?>"  style="width:50%" > </textarea></p>
