...
?>
<form action='register_cuseng_edit1.php' method="post" name="frmMain" enctype="multipart/form-data">
		<div class="w3-white w3-container w3-padding-large"><!-- main div -->
			<div class="w3-panel w3-light-gray">
				<div class="w3-half">
				<h4>รายการรับเรื่องจากลูกค้า</h4>
					</div> <div class="w3-half">
				<?php if($fetch["send_eng"]=='0'){ ?>
				<a href="send_cuseng.php?ref_id=<?php echo $fetch["ref_id"];?>&id=<?php echo $fetch["id"];?>&customer_name=<?php echo $fetch["customer_name"]; ?>" target="_blank" class="w3-button w3-grey w3-right"><font color="red">ส่งเรื่องให้ช่าง</font></a>
				<?php } ?>
			</div>	
			</div>

		วันที่ : &nbsp;&nbsp;&nbsp;<?php echo $fetch["date_story"]; ?>
		&nbsp;&nbsp;เวลา&nbsp;&nbsp;<?php echo $fetch["time_story"]; ?>
			<br><br>
...
โรงพยาบาล : &nbsp;<input type="text" name="customer_name"  id="customer_name" value="<?php echo $fetch["customer_name"]; ?>"  class="button4" style="width:20%;" > &nbsp;&nbsp;&nbsp;

แผนก  : &nbsp;

<input type='text' name = "address_name"  id = "address_name" class="button4"  value="<?php echo $fetch["address_name"]; ?>" style="width:20%;" /> 
...
<input type='text' name = "contact_name"  id = "contact_name" class="button4"  value="<?php echo $fetch["contact_name"]; ?>" style="width:20%;" /></p>
...
วันที่นัดหมาย : &nbsp;<input type="date" name="date_plan"  id="date_plan" value="<?php echo $fetch["date_plan"]; ?>"  class="button4" style="width:20%;" > &nbsp;&nbsp;&nbsp;

เวลาที่นัดหมาย  : &nbsp;

<input type='text' name = "time_plan"  id = "time_plan" class="button4"  value="<?php echo $fetch["time_plan"]; ?>" style="width:20%;" /> 
 </p>
รายละเอียด  : </p> 

<textarea type='text' name = "description"  id = "description" class="button4"   style="width:25%;" ><?php echo $fetch["description"]; ?></textarea>
</p>

เบอร์โทรศัพท์ : &nbsp;<input type="text" name="tel_number"  id="tel_number" value="<?php echo $fetch["tel_number"]; ?>"  class="button4" style="width:20%;" > &nbsp;&nbsp;&nbsp;

				</p>

<input type="hidden" name="sale_code"  id="sale_code" value="<?php echo $fetch["sale_code"]; ?>" class="button4" style="width:20%;" required>

ผู้รับเรื่อง  : &nbsp;

<input type='text' name = "receive_name"  id = "receive_name" class="button4"  value="<?php echo $fetch["receive_name"]; ?>"  style="width:18%;" />
</p>

<input type='hidden' name='img_11' id='img_11' value ="<?php echo $fetch['img_1']; ?>"  />
<input type='hidden' name='img_22' id='img_22' value ="<?php echo $fetch['img_2']; ?>"  />
<input type='hidden' name='img_33' id='img_33' value ="<?php echo $fetch['img_3']; ?>"  />
<input type='hidden' name='img_44' id='img_44' value ="<?php echo $fetch['img_4']; ?>"  />
<input type='hidden' name='img_55' id='img_55' value ="<?php echo $fetch['img_5']; ?>"  />
