...
$rs = mysqli_fetch_array($qry);
	...
	<form action='register_poclose1.php' method="post" name="frmMain" enctype="multipart/form-data" onSubmit="JavaScript:return fncSubmit();" >
...
<fieldset><legend ><b><font color="red">ส่วนของ Admin</font></b></legend><br>
<div class="w3-container 1"> 
<?php if($rs["cancel_ckk"]=='1'){ ?>	
<input type='checkbox' name = "cancel_ckk" value="1" checked='checked' id = "cancel_ckk">	 <font color='red'>ยกเลิก</font>
<?php }else{ ?>
<input type='checkbox' name = "cancel_ckk" value="1" id = "cancel_ckk">	 <font color='red'>ยกเลิก</font>	
<?php } ?><br>	
	
หมายเหตุยกเลิก
<textarea name="remark_cancel" id="remark_cancel" class="w3-input" rows="2" style="width:90%" ><?php echo $rs["remark_cancel"]; ?></textarea>
	
	
</div>	
<div class="w3-half 1">
		เลขที่อ้างอิงใบสั่งขาย  : <input type='text' name = "ref_so" value="<?php echo $rs["ref_so"]; ?>" id = "ref_so" style="width:90%;" class="w3-input" required >
	
	</div>
<div class="w3-half 1">
		ผู้เปิดใบสั่งขาย  : <input type='text' name = "name_open" value="<?php echo $rs["name_open"]; ?>" id = "name_open" style="width:90%;" class="w3-input" required >
