...
$code_shopee = $_GET["code_shopee"];
$name_shopee  = $_GET["name_shopee"];
$price_shopee = $_GET["price_shopee"];
...
$save="insert into tb_product_shopee
(code_shopee,name_shopee,price_shopee,id_product1,id_product2,id_product3,id_product4,unit1,unit2,unit3,unit4,waranty1,waranty2,waranty3,waranty4)
values
('".$code_shopee."','".$name_shopee."','".$price_shopee."','".$id_product1."','".$id_product2."','".$id_product3."','".$id_product4."','".$unit1."','".$unit2."','".$unit3."','".$unit4."','".$waranty1."','".$waranty2."','".$waranty3."','".$waranty4."')";
