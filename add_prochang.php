...
<div class="w3-panel w3-light-gray"><h4>ADD : สินค้าแลกเครื่องวัดน้ำตาล</h4></div>


<div class="w3-container w3-third">
สินค้าแลกเครื่องวัดน้ำตาล
<input name="prochange" id="prochange" class="w3-input" >

</div>

<br>
<center>
		  <input type="button" name ="Submit" value="บันทึก" class = "button button4" onClick="this.form.action='add_prochang1.php'; submit()">
</center>
...
<div class="w3-container">
	<table border="1" width="100%" class="w3-table">
		<thead class="w3-gray">
			<th width="5%">ID สินค้าแลกเครื่องวัดน้ำตาล</th>
			<th width="15%">สินค้าแลกเครื่องวัดน้ำตาล</th>
			<th width="5%">แก้ไข</th>
	</thead>
<?php
$i = 1;
...
?>
		<tbody>
			<tr>
				...
				<td><?php echo $objResult["prochange"];?></td>
				<td><a href="edit_prochang.php?id=<?php echo $objResult["id"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a></td>
