...
<body>
	<form action='register_storysum1.php' method="post" name="frmMain" enctype="multipart/form-data">
		<div class="w3-white">
...
<input type="checkbox" checked='checked' name="summary_sale" value = "1">&nbsp;Sale ปิดงาน
<?php }else{ ?>

<input type="checkbox" name="summary_sale"  value="1" >&nbsp;Sale ปิดงาน

			<?php } ?>
&nbsp;&nbsp;&nbsp;
			<?php if($objResult["summary_adm"]=='1'){ ?>
<input type="checkbox" checked='checked' name="summary_adm" value = "1">&nbsp;Admin ปิดงาน
<?php }else{ ?>

<input type="checkbox" name="summary_adm"  value="1" >&nbsp;Admin ปิดงาน
