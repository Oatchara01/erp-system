...
<div class="w3-panel w3-light-grey"><h3>Status หมายเหตุแจ้ง Admin</h3></div>
...
$strSQL = "SELECT * FROM tb_comment_so WHERE comment_ad != '' and complete_adckk='0'";
...
?>
 ...
 <div class="w3-panel">    <strong>พบทั้งหมด</strong>
      <?= $i;?>
      <strong>รายการ<span class="style14">
      </p>
</div></div>
