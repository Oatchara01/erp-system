...
$sMessage = "หมายเลขอ้างอิง $ref_id คุณ $billing_name มีสินค้าครับ ";
$chOne = curl_init();
...
$save1="Update  so__main set have_product = '2'  where ref_id='".$ref_id."'";
...
echo "alert('บันทึกข้อมูลของท่านเรียบร้อยแล้ว');window.location='status_stock_fak.php';";
echo "</script>";
  } else {
   echo "Cannot";
  }
