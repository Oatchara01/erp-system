...
(ref_credit,date_credit,customer_name,customer_tel,address_name,return_des,send_return_name,date_send_return,receive_name,date_receive,sale_name,sale_date,credit_ckk,credit_no,type_return_ckk,type_return_no,dis_credit,add_by,add_date,company_type,ttype_doc,iv_no_ref,sale_code,ref_order_id,send_sup,send_admin,status_doc,type_return,bank_name,account_name,account_no,bill_id,sale_chan,mode_cus)
values
('".$ref_credit."','".$date_credit."','".$customer_name."','".$customer_tel."','".$address_name."','".$return_des."','".$send_return_name."','".$date_send_return."','".$receive_name."','".$date_receive."','".$sale_name."','".$sale_date."','".$credit_ckk."','".$credit_no."','".$type_return_ckk."','".$type_return_no."','".$dis_credit."','".$add_by."','".$add_date."','".$company_type."','".$ttype_doc."','".$iv_no_ref."','".$sale_code."','".$ref_order_id."','".$send_sup."','".$send_admin."','".$status_doc."','".$type_return."','".$bank_name."','".$account_name."','".$account_no."','".$bill_id."','".$sale_chan."','".$mode_cus."')";
