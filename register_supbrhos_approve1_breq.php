...
$strSQL21 = "SELECT * FROM in__subbr WHERE ref_idd_br = '".$ref_id_br."' ";
...
$strSQL = "Update   in__subbr set count='$sale_count_new',countref='$sale_count_new',price='$product_price_new',amount='$sum_amount_new',sale_remark='$sale_remarkk_new',product_id='$product_id_new',product_code ='$product_id_new',br_periodd='".$br_period_new."',warranty='".$warranty_new."'   Where id= '$id_new' ";
...
if($id_product1 !=''){
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit1."','".$unit1."','".$product_price6."','".$sum_amount6."','".$sale_remarkk6."','".$id_product1."','".$id_product1."','".$br_period6."','".$warranty6."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit2."','".$unit2."','0.00','0.00','".$sale_remarkk6."','".$id_product2."','".$id_product2."','".$br_period6."','".$warranty6."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit3."','".$unit3."','0.00','0.00','".$sale_remarkk6."','".$id_product3."','".$id_product3."','".$br_period6."','".$warranty6."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit4."','".$unit4."','0.00','0.00','".$sale_remarkk6."','".$id_product4."','".$id_product4."','".$br_period6."','".$warranty6."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit5."','".$unit5."','0.00','0.00','".$sale_remarkk6."','".$id_product5."','".$id_product5."','".$br_period6."','".$warranty6."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit6."','".$unit6."','0.00','0.00','".$sale_remarkk6."','".$id_product6."','".$id_product6."','".$br_period6."','".$warranty6."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit7."','".$unit7."','0.00','0.00','".$sale_remarkk6."','".$id_product7."','".$id_product7."','".$br_period6."','".$warranty6."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit8."','".$unit8."','0.00','0.00','".$sale_remarkk6."','".$id_product8."','".$id_product8."','".$br_period6."','".$warranty6."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit9."','".$unit9."','0.00','0.00','".$sale_remarkk6."','".$id_product9."','".$id_product9."','".$br_period6."','".$warranty6."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit10."','".$unit10."','0.00','0.00','".$sale_remarkk6."','".$id_product10."','".$id_product10."','".$br_period6."','".$warranty6."')";
...
$strSQL6 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$sale_count6."','".$sale_count6."','".$product_price6."','".$sum_amount6."','".$sale_remarkk6."','".$product_id6."','".$product_id6."','".$br_period6."','".$warranty6."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit1."','".$unit1."','".$product_price7."','".$sum_amount7."','".$sale_remarkk7."','".$id_product1."','".$id_product1."','".$br_period7."','".$warranty7."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit2."','".$unit2."','0.00','0.00','".$sale_remarkk7."','".$id_product2."','".$id_product2."','".$br_period7."','".$warranty7."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit3."','".$unit3."','0.00','0.00','".$sale_remarkk7."','".$id_product3."','".$id_product3."','".$br_period7."','".$warranty7."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit4."','".$unit4."','0.00','0.00','".$sale_remarkk7."','".$id_product4."','".$id_product4."','".$br_period7."','".$warranty7."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit5."','".$unit5."','0.00','0.00','".$sale_remarkk7."','".$id_product5."','".$id_product5."','".$br_period7."','".$warranty7."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit6."','".$unit6."','0.00','0.00','".$sale_remarkk7."','".$id_product6."','".$id_product6."','".$br_period7."','".$warranty7."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit7."','".$unit7."','0.00','0.00','".$sale_remarkk7."','".$id_product7."','".$id_product7."','".$br_period7."','".$warranty7."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit8."','".$unit8."','0.00','0.00','".$sale_remarkk7."','".$id_product8."','".$id_product8."','".$br_period7."','".$warranty7."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit9."','".$unit9."','0.00','0.00','".$sale_remarkk7."','".$id_product9."','".$id_product9."','".$br_period7."','".$warranty7."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit10."','".$unit10."','0.00','0.00','".$sale_remarkk7."','".$id_product10."','".$id_product10."','".$br_period7."','".$warranty7."')";
...
$strSQL7 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$sale_count7."','".$sale_count7."','".$product_price7."','".$sum_amount7."','".$sale_remarkk7."','".$product_id7."','".$product_id7."','".$br_period7."','".$warranty7."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit1."','".$unit1."','".$product_price8."','".$sum_amount8."','".$sale_remarkk8."','".$id_product1."','".$id_product1."','".$br_period8."','".$warranty8."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit2."','".$unit2."','0.00','0.00','".$sale_remarkk8."','".$id_product2."','".$id_product2."','".$br_period8."','".$warranty8."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit3."','".$unit3."','0.00','0.00','".$sale_remarkk8."','".$id_product3."','".$id_product3."','".$br_period8."','".$warranty8."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit4."','".$unit4."','0.00','0.00','".$sale_remarkk8."','".$id_product4."','".$id_product4."','".$br_period8."','".$warranty8."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit5."','".$unit5."','0.00','0.00','".$sale_remarkk8."','".$id_product5."','".$id_product5."','".$br_period8."','".$warranty8."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit6."','".$unit6."','0.00','0.00','".$sale_remarkk8."','".$id_product6."','".$id_product6."','".$br_period8."','".$warranty8."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit7."','".$unit7."','0.00','0.00','".$sale_remarkk8."','".$id_product7."','".$id_product7."','".$br_period8."','".$warranty8."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit8."','".$unit8."','0.00','0.00','".$sale_remarkk8."','".$id_product8."','".$id_product8."','".$br_period8."','".$warranty8."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit9."','".$unit9."','0.00','0.00','".$sale_remarkk8."','".$id_product9."','".$id_product9."','".$br_period8."','".$warranty8."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit10."','".$unit10."','0.00','0.00','".$sale_remarkk8."','".$id_product10."','".$id_product10."','".$br_period8."','".$warranty8."')";
...
$strSQL8 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$sale_count8."','".$sale_count8."','".$product_price8."','".$sum_amount8."','".$sale_remarkk8."','".$product_id8."','".$product_id8."','".$br_period8."','".$warranty8."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit1."','".$unit1."','".$product_price9."','".$sum_amount9."','".$sale_remarkk9."','".$id_product1."','".$id_product1."','".$br_period9."','".$warranty9."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit2."','".$unit2."','0.00','0.00','".$sale_remarkk9."','".$id_product2."','".$id_product2."','".$br_period9."','".$warranty9."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit3."','".$unit3."','0.00','0.00','".$sale_remarkk9."','".$id_product3."','".$id_product3."','".$br_period9."','".$warranty9."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit4."','".$unit4."','0.00','0.00','".$sale_remarkk9."','".$id_product4."','".$id_product4."','".$br_period9."','".$warranty9."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit5."','".$unit5."','0.00','0.00','".$sale_remarkk9."','".$id_product5."','".$id_product5."','".$br_period9."','".$warranty9."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit6."','".$unit6."','0.00','0.00','".$sale_remarkk9."','".$id_product6."','".$id_product6."','".$br_period9."','".$warranty9."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit7."','".$unit7."','0.00','0.00','".$sale_remarkk9."','".$id_product7."','".$id_product7."','".$br_period9."','".$warranty9."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit8."','".$unit8."','0.00','0.00','".$sale_remarkk9."','".$id_product8."','".$id_product8."','".$br_period9."','".$warranty9."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit9."','".$unit9."','0.00','0.00','".$sale_remarkk9."','".$id_product9."','".$id_product9."','".$br_period9."','".$warranty9."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit10."','".$unit10."','0.00','0.00','".$sale_remarkk9."','".$id_product10."','".$id_product10."','".$br_period9."','".$warranty9."')";
...
$strSQL9 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$sale_count9."','".$sale_count9."','".$product_price9."','".$sum_amount9."','".$sale_remarkk9."','".$product_id9."','".$product_id9."','".$br_period9."','".$warranty9."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit1."','".$unit1."','".$product_price10."','".$sum_amount10."','".$sale_remarkk10."','".$id_product1."','".$id_product1."','".$br_period10."','".$warranty10."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit2."','".$unit2."','0.00','0.00','".$sale_remarkk10."','".$id_product2."','".$id_product2."','".$br_period10."','".$warranty10."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit3."','".$unit3."','0.00','0.00','".$sale_remarkk10."','".$id_product3."','".$id_product3."','".$br_period10."','".$warranty10."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit4."','".$unit4."','0.00','0.00','".$sale_remarkk10."','".$id_product4."','".$id_product4."','".$br_period10."','".$warranty10."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit5."','".$unit5."','0.00','0.00','".$sale_remarkk10."','".$id_product5."','".$id_product5."','".$br_period10."','".$warranty10."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit6."','".$unit6."','0.00','0.00','".$sale_remarkk10."','".$id_product6."','".$id_product6."','".$br_period10."','".$warranty10."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit7."','".$unit7."','0.00','0.00','".$sale_remarkk10."','".$id_product7."','".$id_product7."','".$br_period10."','".$warranty10."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit8."','".$unit8."','0.00','0.00','".$sale_remarkk10."','".$id_product8."','".$id_product8."','".$br_period10."','".$warranty10."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit9."','".$unit9."','0.00','0.00','".$sale_remarkk10."','".$id_product9."','".$id_product9."','".$br_period10."','".$warranty10."')";
...
$strSQL1 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$unit10."','".$unit10."','0.00','0.00','".$sale_remarkk10."','".$id_product10."','".$id_product10."','".$br_period10."','".$warranty10."')";
...
$strSQL10 = "insert into in__subbr
(ref_idd_br,po_no,count,countref,price,amount,sale_remark,product_id,product_code,br_periodd,warranty)
values ('".$ref_id_br."','".$po_no."','".$sale_count10."','".$sale_count10."','".$product_price10."','".$sum_amount10."','".$sale_remarkk10."','".$product_id10."','".$product_id10."','".$br_period10."','".$warranty10."')";
...
echo "alert('บันทึกข้อมูลของท่านเรียบร้อยแล้ว');window.location='register_supbrin_approve_breq.php?ref_id_br=$ref_id_br';";
echo "</script>";
  } else {
   echo "Cannot";
  }
