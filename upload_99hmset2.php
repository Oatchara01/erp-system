...
<br><br>
<center> 
    <h2><span class="style15">Upload รายการน้ำท่วม ลูกค้าไม่รับสินค้า </span></h2>
...
<br>
  ...
  <form enctype="multipart/form-data" action="upload_99hmset2.php" method="POST">
  <center>
  <br>
  <br>
...

  {
    ...
    if(move_uploaded_file($_FILES['uploaded_file']['tmp_name'], $path)) {
     ...
     echo '	 	 <center>
           ...
           <form action = "import_99hmset2.php" method ="post">
