...
<a href="approve_rental.php?ref_id=<?php echo $objResult["ref_id"];?>&rental_name=<?php echo $objResult["rental_name"]; ?>&iv_no=<?php echo $objResult["iv_no"]; ?>&type_doc=<?php echo $objResult["type_doc"]; ?>&start_promis=<?php echo $objResult["start_promis"]; ?>" class="w3-button w3-green w3-center"><font color="black">Approve</font></a>
<a href="reject_rental.php?ref_id=<?php echo $objResult["ref_id"];?>" class="w3-button w3-red w3-center"><font color="black">Rejected</font></a>
<?php } ?>
