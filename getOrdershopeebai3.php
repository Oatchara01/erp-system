...
$strSQL = "SELECT order_id,cs_remark FROM so__main WHERE sale_channel ='12'  AND ckk_item = '0'  and  cs_remark NOT LIKE '%Instant%' and pre_ckk='0' and doc_no !=''";
$objQuery = mysqli_query($conn, $strSQL) or die ("Error Query [".$strSQL."]");
...
$strSQL = "SELECT order_id,cs_remark FROM so__main WHERE sale_channel ='12' AND register_date ='".$register_date."' AND order_refer_code = ''  and  cs_remark NOT LIKE '%Instant%'  and pre_ckk='0' and doc_no !=''";
$objQuery = mysqli_query($conn, $strSQL) or die ("Error Query [".$strSQL."]");
...
$strSQL = "SELECT order_id,cs_remark FROM so__main WHERE sale_channel ='12' AND register_date > '2026-01-01' AND order_refer_code = ''  and  cs_remark NOT LIKE '%Instant%'  and pre_ckk='1' and doc_no !=''";
$objQuery = mysqli_query($conn, $strSQL) or die ("Error Query [".$strSQL."]");
...
/*
--ปิดอยุ่แล้ว
$strSQL = "SELECT order_id,cs_remark FROM so__main WHERE sale_channel ='12'  AND ckk_item = '0'  and cs_remark LIKE '%ด่วน%'";
$objQuery = mysqli_query($conn, $strSQL) or die ("Error Query [".$strSQL."]");
...
$strSQL = "SELECT order_id,cs_remark FROM so__main WHERE sale_channel ='12'  AND register_date='".$register_date."' and order_refer_code=''  and  cs_remark NOT LIKE '%Instant%' ";
$objQuery = mysqli_query($conn, $strSQL) or die("Error Query [$strSQL]");
