...
g[v]!==g[v+12]){l=!1;break}return l?g[0]<<16|g[1]<<8|g[2]:0}function la(g,l,v){return g in l?l[g]:v[g]}function La(g,l,v){if(w&&Za){var s=g.getContext("2d");Ma=s.webkitBackingStorePixelRatio||s.mozBackingStorePixelRatio||s.msBackingStorePixelRatio||s.oBackingStorePixelRatio||s.backingStorePixelRatio||1;ka=Qa/Ma;g.width=l*ka;g.height=v*ka;Qa!==Ma&&(g.style.width=l+"px",g.style.height=v+"px",s.scale(ka,ka))}else g.width=l,g.height=v}function hb(g){}function ta(g,l){Ga&&(this.canvasCount|=0,window.console.log(++this.canvasCount));
