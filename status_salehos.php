...
<div class="w3-panel w3-light-gray"><h4>Status ใบสั่งขาย</h4></div>
...
<div class="w3-bar w3-quarter">
ค้นหาเลขที่ IV ,เลขที่อ้างอิง,ใบยืม : <input name="Keyword" class="w3-input" style="width:90%;" type="text" id="Keyword" value="<?php echo $Keyword = isset($_GET['Keyword']) ? $_GET['Keyword'] : '';?>"></div>
<div class="w3-bar w3-quarter">
...
$strSQL = "SELECT *  FROM hos__so  where sale_code LIKE '%EN%' and ic_ckk='0'";
}else{
$strSQL = "SELECT *  FROM hos__so  where sale_code = '".$sale_code."' and ic_ckk='0'";	
}
