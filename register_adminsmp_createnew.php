...
<div class="w3-white w3-container">
	...
	<h5>(Sample Request)</h5>
		...
		<form action="register_adminsmp_createnew1.php" method="post" name="frmMain" enctype="multipart/form-data">
<div class="w3-bar">
...
<textarea   class="button4" name="address_send"  style="width:50%" rows="2"><?php echo $fetch1["address_send"]; ?></textarea></p>
