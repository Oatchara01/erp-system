...
<div class="w3-panel w3-light-gray"><h4>EDIT : PRODUCT LAZADA HEALTHMART</h4></div>

<?php
		$strSQL = "SELECT *  FROM tb_product_lzd WHERE lzd_id = '".$_GET["lzd_id"]."' ";
...
รหัสสินค้า
<input name="code_lazada" value="<?php echo $objResult["code_lazada"]; ?>" class="w3-input" >


</div><div class="w3-container w3-third">
ชื่อสินค้า
<input name="name_lazada" value="<?php echo $objResult["name_lazada"]; ?>" class="w3-input" >
</div><div class="w3-container w3-third">
ราคาขาย
<input name="price_lazada" value="<?php echo $objResult["price_lazada"]; ?>" class="w3-input" >
</div>
...
<input type = 'hidden' name="lzd_id" value="<?php echo $objResult["lzd_id"]; ?>" class="w3-input" >
</div>
	<div class="w3-container w3-third">
จำนวนปีรับประกัน 3
...
<?php
	...
	?>
ID สินค้า 4
<input name="id_product4" class="w3-input" value="<?php echo $objResult["id_product4"]; ?>" placeholder="Search ชื่อสินค้า...">
...
<br>
<center>
		  <input type="button" name ="Submit" value="บันทึก" class = "button button4" onClick="this.form.action='edit_bom_lzdhm1.php'; submit()">
</center>
