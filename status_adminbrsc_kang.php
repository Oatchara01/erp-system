...
<div class="w3-container w3-padding-large">
	<div class="w3-panel w3-light-grey"><h3>Status ใบยืมฝากขาย (ค้างเลขที่เอกสาร)</h3></div>
<div class="w3-half">
...
$strSQL = "SELECT *  FROM hos__consig  where send_admin='1' and status_doc ='Approve' and iv_no=''";	
...
?>
 ...
 echo DateThai($objResult["date_save"]);
	...
	<td><a href="register_adminbrcshos_edit.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a></td>
