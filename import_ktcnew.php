...
$customer_name = $objArr[10];
$delivery_name = $objArr[10];
$tax_id = $objArr[28];


$order_name = $objArr[1];
$delivery_contact = "$objArr[10] / $objArr[17]";
$address1 = "$objArr[11] $objArr[12]";
$province = trim($objArr[13]);
$delivery_place = "$objArr[11] $objArr[12] $objArr[13] $objArr[14]";
...
$billing_name =	$objArr[29];	
$billing_address = "$objArr[30] $objArr[31] $objArr[32] $objArr[33]";
$billing_postcode =	$objArr[33];	
$billing_add = $objArr[30];
$billing_aum = $objArr[31];
$billing_pro = trim($objArr[32]);	
	
}else{
	
$billing_address = "$objArr[11] $objArr[12] $objArr[13] $objArr[14]";
$billing_name =	$objArr[1];
$billing_postcode =	$objArr[14];	
$billing_add = $objArr[11];
$billing_aum = $objArr[12];
$billing_pro = trim($objArr[13]);
}	
	
$billing_tel =	$objArr[17];	
$email =	$objArr[34];	
$sale_remark = $objArr[2]; 
...
$unit1 = $fetch2["unit1"]*$objArr[8];
$unit2 = $fetch2["unit2"]*$objArr[8];
$unit3 = $fetch2["unit3"]*$objArr[8];
$unit4 = $fetch2["unit4"]*$objArr[8];
$unit5 = $fetch2["unit5"]*$objArr[8];
$unit6 = $fetch2["unit6"]*$objArr[8];
$unit7 = $fetch2["unit7"]*$objArr[8];
$unit8 = $fetch2["unit8"]*$objArr[8];
$unit7 = $fetch2["unit7"]*$objArr[8];
$unit8 = $fetch2["unit8"]*$objArr[8];
$unit9 = $fetch2["unit9"]*$objArr[8];
$unit10 = $fetch2["unit10"]*$objArr[8];
...
values
('".$customer_name."','7','".$address1."','".$address2."','".$province."','".$postcode."','".$tel."','".$billing_name."','".$billing_add."','".$billing_aum."','".$billing_pro."','".$billing_postcode."','".$billing_tel."','".$tax_id."','".$delivery_name."','".$address1."','".$address2."','".$province."','".$postcode."','".$tel."','".$delivery_contact."','".$employee_name."','".$email_cus."')";
...
values ('".$main_id."','".$unit1."','".$unit1."','".$price_per_unit."','".$price_per_unit."','".$objArr[9]."','0.00','".$id_product1."','".$id_product1."','".$waranty1."','Approve')";
...
/*if($sku=='ALLWELL อุปกรณ์ซัพพอร์ตพยุงเข่า Vantelin Support Cool Fit Knee Blue Size L ฟรี หน้ากากอนามัย 1 ซอง (คละแบบ)' or $sku =='ALLWELL อุปกรณ์ซัพพอร์ตพยุงเข่า Vantelin Support Cool Fit Knee Blue Size M ฟรี หน้ากากอนามัย 1 ซอง (คละแบบ)' or $sku =='ALLWELL อุปกรณ์ซัพพอร์ตพยุงเข่า Vantelin Support Cool Fit Knee Blue Size S ฟรี หน้ากากอนามัย 1 ซอง (คละแบบ)'){
	
$strSQL45 = "insert into so__submain
(ref_idd,sale_count,sale_countref,price_per_unit,price_per_unitref,sum_amount,discount_unit,product_id,product_code,warranty,status_sol,sale_remark)
values ('".$main_id."','".$unit1."','".$unit1."','0.00','0.00','0.00','0.00','5357','5357','','Approve','แถมฟรีแมส 1 แพ็ค')";
