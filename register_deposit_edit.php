...
<script language="JavaScript">
	...
	function fncSum() {
		...
		var TotSum = parseFloat(unit_price1)+parseFloat(unit_price2)+parseFloat(unit_price3)+parseFloat(unit_price4)+parseFloat(unit_price5);
...
<form action="register_deposit_edit1.php" name="frmAdd" method="post" onSubmit="JavaScript:return fncSubmit();">
<div class="w3-white">
	<div class="w3-container w3-padding-large"><!-- main div -->
		...
		<!-- -->
		<input name="deposit_code" type='hidden' id="deposit_code" value="<?php echo $fetch1['deposit_code']; ?>" />
 		<div class="w3-half">
			<div class="w3-half">
				<div class="w3-bar w3-margin-bottom">
					<span>วันที่ออกบิล</span>
					<input name="bill_date" type='date' id="bill_date" class="w3-input" style="width:90%;" value="<?php echo $fetch1['bill_date']; ?>" />
				<span>เลขที่</span>
					<input name="iv_no" type='text' id="iv_no" class="w3-input" style="width:90%;" value="<?php echo $fetch1['iv_no']; ?>" iv_no />
			...
			<div class="w3-half">
				<div class="w3-bar w3-margin-bottom">
					...
					<input name="bill_name" class="w3-input" type='text' id="bill_name" value="<?php echo $fetch1['bill_name']; ?>" style="width:100%;" />
					<input name="add_by" type='hidden' id="add_by" value="<?php echo $fetch1['add_by']; ?>" />
				</div>
			</div>
			<div class="w3-bar w3-margin-bottom">
				<span>ที่อยู่</span>
				<textarea class="w3-input" name="bill_address" rows="1" id="bill_address" style="width:100%;"/><?php echo $fetch1['bill_address']; ?></textarea>
			</div>
			<div class="w3-third 1">
				<div class="w3-bar w3-margin-bottom">
					<span>เบอร์โทร</span>
					<input name="bill_tel" type='text' class="w3-input" id="bill_tel" value="<?php echo $fetch1['bill_tel']; ?>" style="width:90%;">
				</div>
			</div>
			<div class="w3-third 2">
				<div class="w3-bar w3-margin-bottom">
					<span>ชื่อผู้ติดต่อ</span>
					<input name="customer_contact" type="text" id="customer_contact" style="width:90%;" value="<?php echo $fetch1['customer_contact']; ?>" class="w3-input" />
				</div>
			</div>
			<div class="w3-third 3">
				<div class="w3-bar w3-margin-bottom">
					<span>เลขประจำตัวผู้เสียภาษี</span>
					<input name="tax_id" class="w3-input" id="tax_id" value="<?php echo $fetch1['tax_id']; ?>"  style="width:100%;" />
				</div>
			</div>
			<div class="w3-third 2">
				<div class="w3-bar w3-margin-bottom">
					<span>วันที่ส่งสินค้า</span>
					<input name="delivery_date" type='date' id="delivery_date" value="<?php echo $fetch1['delivery_date']; ?>" style="width:90%;" class="w3-input" />
				</div>
					</div>
				<div class="w3-third 2">
				<div class="w3-bar w3-margin-bottom">
					<span>เวลา</span>
					<input name="delivery_time" type='text' class="w3-input" value="<?php echo $fetch1['delivery_time']; ?>" id="delivery_time" style="width:90%;">
				</div>
			</div>
				<div class="w3-third 2">
				<div class="w3-bar w3-margin-bottom">
				<span>ชื่อผู้ติดต่อ</span>
				<input name="delivery_name" class="w3-input" type='text' value="<?php echo $fetch1['delivery_name']; ?>" id="delivery_name" style="width:90%;" />
			</div>
			</div>
			<div class="w3-third 2">
				<div class="w3-bar w3-margin-bottom">
				<span>แผนก</span>
				<input name="department" type="text" id="department" style="width:90%;" value="<?php echo $fetch1['department']; ?>" class="w3-input" />
			</div>
			</div>
				<div class="w3-third 2">
				<div class="w3-bar w3-margin-bottom">
				<span>เบอร์โทร</span>
				<input name="delivery_tel" class="w3-input" type='text' value="<?php echo $fetch1['delivery_tel']; ?>" id="delivery_tel" style="width:100%;" />
			</div>
			</div>
			<div class="w3-bar w3-margin-bottom">
				<span>ที่อยู่</span>
				<textarea class="w3-input" name="delivery_address" rows="1" id="delivery_address" style="width:100%;" /><?php echo $fetch1['delivery_address']; ?></textarea>
			</div>
	
	<div class="w3-bar w3-margin-bottom">
	<?php if ($fetch1['bill_send']=='1'){ ?>
	...
	<input type="checkbox" name="bill_send" value="1">&nbsp; เปิดบิลแล้วรอส่งของ
		...
		<div class="w3-half w3-container">
			<div class="w3-bar w3-twothird 0">
				...
				<input name="product_name1" type="text" id="product_name1" value="<?php echo $fetch1['product_name1']; ?>" style="width:90%;" class="w3-input" placeholder="1." />
								<input type='hidden' name = "h_product_name1"  id = "h_product_name1"  class="w3-input" >

				<input name="product_name2" type="text" id="product_name2" value="<?php echo $fetch1['product_name2']; ?>" style="width:90%;" class="w3-input" placeholder="2." />
								<input type='hidden' name = "h_product_name2"  id = "h_product_name2"  class="w3-input" >

				<input name="product_name3" type="text" id="product_name3" value="<?php echo $fetch1['product_name3']; ?>" style="width:90%;" class="w3-input" placeholder="3." />
								<input type='hidden' name = "h_product_name3"  id = "h_product_name3"  class="w3-input" >

				<input name="product_name4" type="text" id="product_name4" value="<?php echo $fetch1['product_name4']; ?>" style="width:90%;" class="w3-input" placeholder="4." />
								<input type='hidden' name = "h_product_name4"  id = "h_product_name4"  class="w3-input" >

				<input name="product_name5" type="text" id="product_name5" value="<?php echo $fetch1['product_name5']; ?>" style="width:90%;" class="w3-input" placeholder="5." />
...
<div id="frm_txt" style="display:none;">
				...
				<input name="product_name6" type="text" id="product_name6" style="width:90%;" value="<?php echo $fetch1['product_name6']; ?>" class="w3-input" placeholder="6." />
								<input type='hidden' name = "h_product_name6"  id = "h_product_name6"  class="w3-input" >

				<input name="product_name7" type="text" id="product_name7" style="width:90%;" value="<?php echo $fetch1['product_name7']; ?>" class="w3-input" placeholder="7." />
								<input type='hidden' name = "h_product_name7"  id = "h_product_name7"  class="w3-input" >

				<input name="product_name8" type="text" id="product_name8" style="width:90%;" value="<?php echo $fetch1['product_name8']; ?>" class="w3-input" placeholder="8." />
								<input type='hidden' name = "h_product_name8"  id = "h_product_name8"  class="w3-input" >

				<input name="product_name9" type="text" id="product_name9" style="width:90%;" value="<?php echo $fetch1['product_name9']; ?>" class="w3-input" placeholder="9." />
								<input type='hidden' name = "h_product_name9"  id = "h_product_name9"  class="w3-input" >

				<input name="product_name10" type="text" id="product_name10" style="width:90%;" value="<?php echo $fetch1['product_name10']; ?>" class="w3-input" placeholder="10." />
...
<div id="frm_txt1" style="display:none;">
				<input name="product_name11" type="text" id="product_name11" style="width:90%;" value="<?php echo $fetch1['product_name11']; ?>" class="w3-input" placeholder="11." />
								<input type='hidden' name = "h_product_name11"  id = "h_product_name11"  class="w3-input" >

				<input name="product_name12" type="text" id="product_name12" style="width:90%;" value="<?php echo $fetch1['product_name12']; ?>" class="w3-input" placeholder="12." />
								<input type='hidden' name = "h_product_name12"  id = "h_product_name12"  class="w3-input" >

				<input name="product_name13" type="text" id="product_name13" style="width:90%;" value="<?php echo $fetch1['product_name13']; ?>" class="w3-input" placeholder="13." />
								<input type='hidden' name = "h_product_name13"  id = "h_product_name13"  class="w3-input" >

				<input name="product_name14" type="text" id="product_name14" style="width:90%;" value="<?php echo $fetch1['product_name14']; ?>" class="w3-input" placeholder="14." />
								<input type='hidden' name = "h_product_name14"  id = "h_product_name14"  class="w3-input" >

				<input name="product_name15" type="text" id="product_name15" style="width:90%;" value="<?php echo $fetch1['product_name15']; ?>" class="w3-input" placeholder="15." />
			...
			<div class="w3-bar w3-third 0">
				...
				<input name="unit_price1" type="text" id="unit_price1" style="text-align:right;padding-right:2px; width:100%;" value="<?php $unit_price1=$fetch1["unit_price1"]; echo number_format( $unit_price1,2)."";?>" class="w3-input" OnChange="fncSum();"/>

				<input name="unit_price2" type="text" id="unit_price2" style="text-align:right;padding-right:2px; width:100%;" value="<?php $unit_price2=$fetch1["unit_price2"]; echo number_format( $unit_price2,2)."";?>" class="w3-input" OnChange="fncSum();"/>

				<input name="unit_price3" type="text" id="unit_price3" style="text-align:right;padding-right:2px; width:100%;" value="<?php $unit_price3=$fetch1["unit_price3"]; echo number_format( $unit_price3,2)."";?>" class="w3-input" OnChange="fncSum();"/>

				<input name="unit_price4" type="text" id="unit_price4" style="text-align:right;padding-right:2px; width:100%;" value="<?php $unit_price4=$fetch1["unit_price4"]; echo number_format( $unit_price4,2)."";?>" class="w3-input" OnChange="fncSum();"/>

				<input name="unit_price5" type="text" id="unit_price5" style="text-align:right;padding-right:2px; width:100%;" value="<?php $unit_price5=$fetch1["unit_price5"]; echo number_format( $unit_price5,2)."";?>" class="w3-input" OnChange="fncSum();"/>


         <div id="frm_tx" style="display:none;">
          .
				<input name="unit_price6" type="text" id="unit_price6" style="text-align:right;padding-right:2px; width:100%;" value="<?php $unit_price6=$fetch1["unit_price6"]; echo number_format( $unit_price6,2)."";?>" class="w3-input" OnChange="fncSum();"/>
				<input name="unit_price7" type="text" id="unit_price7" style="text-align:right;padding-right:2px; width:100%;" value="<?php $unit_price7=$fetch1["unit_price7"]; echo number_format( $unit_price7,2)."";?>" class="w3-input" OnChange="fncSum();"/>
				<input name="unit_price8" type="text" id="unit_price8" style="text-align:right;padding-right:2px; width:100%;" value="<?php $unit_price8=$fetch1["unit_price8"]; echo number_format( $unit_price8,2)."";?>" class="w3-input" OnChange="fncSum();"/>
				<input name="unit_price9" type="text" id="unit_price9" style="text-align:right;padding-right:2px; width:100%;" value="<?php $unit_price9=$fetch1["unit_price9"]; echo number_format( $unit_price9,2)."";?>" class="w3-input" OnChange="fncSum();"/>
				<input name="unit_price10" type="text" id="unit_price10" style="text-align:right;padding-right:2px; width:100%;" value="<?php $unit_price10=$fetch1["unit_price10"]; echo number_format( $unit_price10,2)."";?>" class="w3-input" OnChange="fncSum();"/>

           </div>
           <div id="frm_tx1" style="display:none;">
            .
				<input name="unit_price11" type="text" id="unit_price11" style="text-align:right;padding-right:2px; width:100%;" value="<?php $unit_price11=$fetch1["unit_price11"]; echo number_format( $unit_price11,2)."";?>" class="w3-input" OnChange="fncSum();"/>
				<input name="unit_price12" type="text" id="unit_price12" style="text-align:right;padding-right:2px; width:100%;" value="<?php $unit_price12=$fetch1["unit_price12"]; echo number_format( $unit_price12,2)."";?>" class="w3-input" OnChange="fncSum();"/>
				<input name="unit_price13" type="text" id="unit_price13" style="text-align:right;padding-right:2px; width:100%;" value="<?php $unit_price13=$fetch1["unit_price13"]; echo number_format( $unit_price13,2)."";?>" class="w3-input" OnChange="fncSum();"/>
				<input name="unit_price14" type="text" id="unit_price14" style="text-align:right;padding-right:2px; width:100%;" value="<?php $unit_price14=$fetch1["unit_price14"]; echo number_format( $unit_price14,2)."";?>" class="w3-input" OnChange="fncSum();"/>
				<input name="unit_price15" type="text" id="unit_price15" style="text-align:right;padding-right:2px; width:100%;" value="<?php $unit_price15=$fetch1["unit_price15"]; echo number_format( $unit_price15,2)."";?>" class="w3-input" OnChange="fncSum();"/>
			...
			<div class="w3-bar w3-third total">
				<input name="sum_unit_price" type="text" id="sum_unit_price" style="text-align:right;padding-right:2px; width:100%;" value="<?php $sum_unit_price=$fetch1["sum_unit_price"]; echo number_format( $sum_unit_price,2)."";?>" class="w3-input" />
			</div>
			<div class="w3-bar w3-third w3-margin-bottom w3-margin-top">
				...
				<select name="payment" class="w3-select" style="width:90%; height:90%;"
					...
					<option value="">**เลือกช่องทางการชำระ**</option>
						<?php
							...
							while ($objResuut5 = mysqli_fetch_array($objQuery5,MYSQLI_ASSOC)) 
								...
								{
                           if($fetch1['payment'] == $objResuut5['payment_ID'])
                                 {
                               $sel = "selected";
                                  }
                                  else
					...
					<option class="w3-bar-item w3-button" value="<?php echo $objResuut5['payment_ID']; ?>"<?php echo $sel;?>><?php echo $objResuut5['payment_name']; ?></option>
						<?php } ?>
			...
			<div class="w3-bar w3-third w3-margin-bottom w3-margin-top">
				<span>ธนาคาร</span>
				<input name="bank_name" type='text' class="w3-input" id="bank_name" value="<?php echo $fetch1['bank_name']; ?>" style="width:100%;">
			</div>
<div class="w3-bar w3-third w3-margin-bottom w3-margin-top">
				<span>บัตรของธนาคาร</span>
				<input name="bank_card" type='text' class="w3-input" value="<?php echo $fetch1['bank_card']; ?>" id="bank_card" style="width:100%;">
			</div>

			<div class="w3-bar">
				<div class="w3-third 1">
					<span>เลขที่ / chq#</span>
					<input name="check_no" type="text" id="check_no" style="width:90%;" value="<?php echo $fetch1['check_no']; ?>" class="w3-input" />
				</div>
				<div class="w3-third 2">
					<span>สาขา</span>
					<input name="branch_name" type='text' class="w3-input" id="branch_name" value="<?php echo $fetch1['branch_name']; ?>" style="width:90%;" />
				</div>
				<div class="w3-third 3">
					<span>ลงวันที่ / Date</span>
					<input name="payment_date" type="date" id="payment_date" style="width:90%;" value="<?php echo $fetch1['payment_date']; ?>" class="w3-input" />
				</div>
			</div>
		</div>
		<div class="w3-panel w3-padding-large"></div>
		<div align="center" class="w3-panel"><legend>แผนที่</legend></div>
		
		<div class="w3-bar w3-border w3-margin-bottom w3-light-grey">

<?php
if($fetch1["employee_name"]!==''){
?>
	<center>
<img src="data:<?php echo $fetch1["employee_name"];?>"  align="center" width="700" height="350" />
					<input name="employee_signature_name" type="hidden" id="employee_signature_name" style="width:90%;" value="<?php echo $fetch1['employee_name']; ?>" class="w3-input" />
...
?>
	...
	<fieldset><legend><input type="checkbox" name="more" id="more"> <b>รายละเอียดการจัดส่ง</b></legend>
...
<?php
	...
	<?php
		...
		?>
			...
			<div class="w3-bar 15">
				ประตูบ้านกว้าง
				<input name="door_bigger" class="w3-input" type='text' id="door_bigger" value="<?php echo $fetch2["door_big"]; ?>" style="width:90%;" placeholder="(เมตร)" />
			</div>
			<div class="w3-bar 16">
				ประตูสูง 
