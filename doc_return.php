...
$doc_return=$objResult10["doc_return"];
$strSQL1 = "SELECT * FROM tb_user where em_id='".$doc_return."'";
//echo $strSQL1;
//exit();
    ...
    <td align="center"><label for="textfield"></label>
      <table width="100%" border="0" id="tablee">
        <tr>
          ...
          <td width="51%" align="letf"><input type="text" name="id_em" id="id_em" style="font-size:48px; width:500px;" value="<?=$objResult10["doc_return"];?>" align="letf" />
        </tr>
<center>
  <button align="center" type="submit" name="button" id="button" value="save" onClick="this.form.action='doc_return1.php'; submit()" style="width: 52px; height: 38px"><img src="save.png" width="35" height="30" /><br />
      บันทึก      </button>
