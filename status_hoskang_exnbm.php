...
<div class="w3-container w3-bar w3-light-gray w3-margin-bottom"><h4>Status ค้างรหัสลูกค้า Express NBM</h4></div>
...
$strSQL = "SELECT *  FROM (hos__so LEFT JOIN tb_customer ON hos__so.bill_id=tb_customer.customer_id)  where  send_admin ='1' and status_doc ='Approve' and customer_coden ='' and type_doc='4'";
