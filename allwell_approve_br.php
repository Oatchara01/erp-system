...
<div class="w3-white w3-container">
	<div class="w3-container w3-bar w3-light-gray w3-margin-bottom">
				...
				<div class="w3-half">
					<a href="allwell_rejected.php?ref_id=<?php echo $objResult["ref_id"];?>" class="w3-button w3-red w3-right"><font color="330066">Rejected</font></a>
					<a href="allwell_approve.php?ref_id=<?php echo $objResult["ref_id"];?>&que_ckk=<?php echo $objResult['que_ckk']; ?>&customer_name=<?php echo $objResult["customer_name"]; ?>&employee_name=<?php echo $objResult["employee_name"]; ?>" class="w3-button w3-green w3-right"><font color="330066">Approve</font></a>
