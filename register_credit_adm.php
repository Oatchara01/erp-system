...
$Num_Rows1 = mysqli_num_rows($objQuery1);
 ...
 ?>
	...
	<form action='register_credit_adm1.php' method="post" name="frmMain" enctype="multipart/form-data">
	<div class="w3-white">
...
&nbsp;&nbsp; วันที่โอนเงิน :&nbsp;&nbsp;
<input type="date" name="date_tran" id="date_tran" value ="<?php echo $rs["date_tran"];?>" class="button4" style="width:12%;"  >

<br>
แนบไฟล์รูป Book Bank
<input type='hidden' name='book_bank' id='book_bank' value ="<?php echo $rs['book_bank']; ?>"  />
<input name="book_bank"  type="file"><?php if($rs['book_bank']!=''){ ?><a href="credit_no/<?php echo $rs['book_bank']; ?>" target="_blank">ดูรายละเอียด</a> <?php } ?>
...
<center>
	<?php if($_SESSION['name']=='ขนิษฐา' or $_SESSION['name']=='บรรจบพร' or $_SESSION['name']=='นงลักษณ์' or $_SESSION['name']=='อัจฉรา'){ ?>
	<?php if($rs['status_doc']=='Approve'){ ?>
