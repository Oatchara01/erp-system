...
//
$strSQL1 = "SELECT ref_id_br,iv_no,iv_date,product_id,count,sale_remark,hos__subbr.id FROM (hos__br  LEFT JOIN hos__subbr ON hos__br.ref_id_br=hos__subbr.ref_idd_br) WHERE clear_ckk = '0' and close_br ='0' and status_doc ='Approve' and sale_code ='".$sale_code."' and customer_id ='".$objResult["customer_id"]."' and iv_date !='0000-00-00' ORDER BY product_id ASC";
$objQuery1 = mysqli_query($conn,$strSQL1) or die ("Error Query [".$strSQL1."]");
$Num_Rows1 = mysqli_num_rows($objQuery1);
