...
<div id="pd" class="w3-container city1">
	...
	<?php include "product_changstock.php"; ?>
...
รายละเอียดเพิ่มเติม :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	...
	<div class="w3-bar w3-center">
		...
		<input type="button" name ="Submit" value="บันทึก" class = "button button4" onClick="this.form.action='register_stockchangehos1.php'; submit()" >
<?php } ?>
