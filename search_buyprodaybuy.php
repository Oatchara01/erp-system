...
$strSQL71 = "UPDATE tb__buycustomer SET ckk_close='1' ";
$objQuery71 = mysqli_query($conn,$strSQL71);	

?>
<div class="w3-white">
<form name="frmSearch" method="GET" action="report_buyprodaybuy.php">
<div class="w3-panel w3-light-gray"><h4>รายงานยอดขายตามร้านค้าลูกค้าทั่วไป</h4></div>
