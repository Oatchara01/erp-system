...
<div class="w3-panel w3-light-gray"><h4>Status SMP(ทั้งหมด)</h4></div>
...
$strSQL = "SELECT *  FROM hos__smp  where send_stock = '1' and status_sup = 'Approve' ";
...
?>
 ...
 echo $objResult["smp_no"];
	...
	?><br />
				...
				<td><div align="left">
					<?php
						$strSQL2 = "SELECT sn FROM hos__subsmp  WHERE reff_idsmp = '".$objResult["ref_idsmp"]."' ";
						//echo $strSQL1;
						//exit();
