...
$strSQL1 = "SELECT * FROM tb_et_awl WHERE year_no='".$year_no."' and mount_no='".$month_code."' LIMIT 100";
$objQuery1 = mysqli_query($conn,$strSQL1) or die ("Error Query [".$strSQL1."]");
$Num_Rows1 = mysqli_num_rows($objQuery1);	
	
$strSQL2 = "SELECT * FROM tb_et_awl WHERE year_no='".$year_no."' and mount_no='".$month_code."' LIMIT 100 OFFSET 100";
$objQuery2 = mysqli_query($conn,$strSQL2) or die ("Error Query [".$strSQL2."]");
$Num_Rows2 = mysqli_num_rows($objQuery2);	
	
	
$strSQL3 = "SELECT * FROM tb_et_awl WHERE year_no='".$year_no."' and mount_no='".$month_code."' LIMIT 100  OFFSET 200";
$objQuery3 = mysqli_query($conn,$strSQL3) or die ("Error Query [".$strSQL3."]");
$Num_Rows3 = mysqli_num_rows($objQuery3);	
	
	
$strSQL4 = "SELECT * FROM tb_et_awl WHERE year_no='".$year_no."' and mount_no='".$month_code."' LIMIT 100 OFFSET 300";
$objQuery4 = mysqli_query($conn,$strSQL4) or die ("Error Query [".$strSQL4."]");
$Num_Rows4 = mysqli_num_rows($objQuery4);		
	
$strSQL5 = "SELECT * FROM tb_et_awl WHERE year_no='".$year_no."' and mount_no='".$month_code."' LIMIT 100 OFFSET 400";
$objQuery5= mysqli_query($conn,$strSQL5) or die ("Error Query [".$strSQL5."]");
$Num_Rows5 = mysqli_num_rows($objQuery5);	
	
$strSQL6 = "SELECT * FROM tb_et_awl WHERE year_no='".$year_no."' and mount_no='".$month_code."' LIMIT 100 OFFSET 500";
$objQuery6 = mysqli_query($conn,$strSQL6) or die ("Error Query [".$strSQL6."]");
$Num_Rows6 = mysqli_num_rows($objQuery6);		

/*$strSQL7 = "SELECT * FROM tb_et_awl WHERE year_no='".$year_no."' and mount_no='".$month_code."' LIMIT 100 OFFSET 600";
$objQuery7 = mysqli_query($conn,$strSQL7) or die ("Error Query [".$strSQL7."]");
$Num_Rows7 = mysqli_num_rows($objQuery7);		

$strSQL8 = "SELECT * FROM tb_et_awl WHERE year_no='".$year_no."' and mount_no='".$month_code."' LIMIT 100 OFFSET 700";
$objQuery8 = mysqli_query($conn,$strSQL8) or die ("Error Query [".$strSQL8."]");
$Num_Rows8 = mysqli_num_rows($objQuery8);	
	
$strSQL9 = "SELECT * FROM tb_et_awl WHERE year_no='".$year_no."' and mount_no='".$month_code."' LIMIT 100 OFFSET 800";
