...
$strSQL71 = "UPDATE tb__buypro SET ckk_close='1' ";
$objQuery71 = mysqli_query($conn,$strSQL71);	


$strSQL72 = "UPDATE tb__discash SET close_ckk='1' ";
$objQuery72 = mysqli_query($conn,$strSQL72);	

?>
<div class="w3-white">
<form name="frmSearch" method="GET" action="report_traninter.php">
<div class="w3-panel w3-light-gray"><h4>รายงานรายการสรุปขนส่ง Inter</h4></div>
