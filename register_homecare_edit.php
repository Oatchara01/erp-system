...
<div class="w3-white w3-container">
	...
	<a href="send_jonghc_approve.php?ref_id=<?php echo $_GET["ref_id"];?>" target="_blank" class="w3-button w3-gley w3-right"><font color="black">ส่งใบจองให้ Sup</font></a>&nbsp;&nbsp;
<?php } ?>
<a href="report_jongpro.php?ref_id=<?php echo $_GET["ref_id"];?>" target="_blank" class="w3-button w3-yellow w3-right"><font color="black">Print Preview</font></a>&nbsp;&nbsp;
	...
	<form action="register_homecare_edit1.php" method="post" name="frmMain" enctype="multipart/form-data">
	<div class="w3-bar">
