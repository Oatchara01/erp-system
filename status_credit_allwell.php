...
$strSQL = "SELECT *  FROM tb_credit_note  where sale_code = 'SOL1' or sale_code = 'SOL2' or sale_code = 'SOL99' or sale_code = 'SOL3'  or sale_code = 'E01' or sale_code = 'SOL4'  or sale_code = 'SOL5' or sale_code = 'SOL6'";
...
if($Keyword !=""){ 
	...
	$strSQL .= ' or ref_iv_no  LIKE "%'.$Keyword.'%"'; 
}
...
?>
 ...
 echo DateThai($objResult["date_credit"]);
	...
	?><br />
				...
				<?php }else if ($objResult["send_sup"]=='1' and $objResult["send_dm"]=='1'){ ?>
				<td >รอผู้บริหารอนุมัติ</td>
				<?php }else if ($objResult["send_sup"]=='1'){ ?>
				<td >รอหัวหน้าอนุมัติ</td>
				...
				<a href="register_credit_saleedit.php?ref_credit=<?php echo $objResult["ref_credit"];?>&start_date=<?php echo $_GET["start_date"];  ?>&end_date=<?php echo $_GET["end_date"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
			...
			<a href="register_credit_salecreatenew.php?ref_credit=<?php echo $objResult["ref_credit"];?>&start_date=<?php echo $_GET["start_date"];  ?>&end_date=<?php echo $_GET["end_date"];?>"><img src="img/sticker.png" width="23" height="23" border="0" /></a>
