...
<div class="w3-container w3-padding-large">
	<div class="w3-panel w3-light-grey"><h3>รายการใบตรวจทาน (ขากลับ)</h3></div>
...
$strSQL = "SELECT DISTINCT ref_pcc FROM (tb_product_checklis LEFT JOIN tb_product_checklist ON tb_product_checklis.ref_pcc=tb_product_checklist.ref_pc) where  tb_product_checklis.add_by = '' and type_emp ='EN' and go_back='2'";
if($keyword !=""){ 
...
<a href="register_chken2.php?ref_pc=<?php echo $objResult["ref_pcc"];?>"><img src="img/create.png" width="23" height="23" border="0" /></a>
				
				</td>
				
<td>
	
<a href=javascript:if(confirm('!!!ต้องการปิดใบตรวจทานสินค้าใช่หรือไม่')==true){window.location='register_chkencls2.php?ref_pc=<?php echo $objResult["ref_pcc"];?>';}><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
