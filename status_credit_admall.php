...
<div class="w3-container w3-bar w3-light-gray w3-margin-bottom"><h4>รายการใบสั่งลดหนี้ (ทั้งหมด)</h4></div>
...
ค้นหาเลขที่อ้างอิง SR : <input name="Keyword2" class="w3-input" style="width:90%;" type="text" id="Keyword2" value="<?php echo $Keyword2 = isset($_GET['Keyword2']) ? $_GET['Keyword2'] : '';?>"></div>
	...
	<div class="w3-bar w3-quarter">
ค้นหาเลขที่ IV : <input name="Keyword3" class="w3-input" style="width:90%;" type="text" id="Keyword3" value="<?php echo $Keyword3 = isset($_GET['Keyword3']) ? $_GET['Keyword3'] : '';?>"></div>
	</div>
...
?>
 ...
 echo DateThai($objResult["date_credit"]);
				...
				<td ><?php echo $objResult["iv_no_ref"];?></td>
	...
	?><br />
				...
				<td><div align="right">
					<?php
$strSQL1 = "SELECT count,unit_name FROM (tb_subcredit LEFT JOIN tb_product ON tb_subcredit.product_ID=tb_product.product_id) WHERE ref_creditt = '".$objResult["ref_credit"]."' ";
$objQuery1 = mysqli_query($conn,$strSQL1) or die ("Error Query [".$strSQL1."]");
$Num_Rows1 = mysqli_num_rows($objQuery1);
while($objResult1 = mysqli_fetch_array($objQuery1)) { 
...
$objResult3 = mysqli_fetch_array($objQuery3); 
  echo number_format($objResult3["sum_amount"],0);	?>
				</div></td>	
				...
				<?php }else if($objResult["send_dm"]=='1' and $objResult["status_doc"]=='Request'){ ?>
...
?>
 ...
 <div class="w3-panel">    <strong>พบทั้งหมด</strong>
	...
	if($Prev_Page)
	{
		echo " <a href='$_SERVER[SCRIPT_NAME]?Page=$Prev_Page&Keyword=$Keyword&Keyword1=$Keyword1&Keyword2=$Keyword2&Keyword3=$Keyword3&start_date=$start_date&end_date=$end_date'><font color='black'><< Back</font></a> ";
	}

	for($i=1; $i<=$Num_Pages; $i++){
		if($i != $Page)
		{
			echo "[ <a href='$_SERVER[SCRIPT_NAME]?Page=$i&Keyword=$Keyword&Keyword1=$Keyword1&Keyword2=$Keyword2&Keyword3=$Keyword3&start_date=$start_date&end_date=$end_date'><font color='black'>$i</font></a> ]";
	...
	if($Page!=$Num_Pages)
	{
		echo " <a href ='$_SERVER[SCRIPT_NAME]?Page=$Next_Page&Keyword=$Keyword&Keyword1=$Keyword1&Keyword3=$Keyword3&Keyword2=$Keyword2&start_date=$start_date&end_date=$end_date'><font color='black'>Next>></font></a> ";
	}
