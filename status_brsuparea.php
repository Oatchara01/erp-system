...
$strSQL = "SELECT DISTINCT ref_id  FROM st__checkbr  where 1 ";	
}
...
$sql1 = "SELECT add_date,add_by,sale_code,send_stock FROM st__checkbr where ref_id ='".$objResult["ref_id"]."'";
...
?>
		<tbody>
			<tr>
				...
				<a href="report_brkangbysupshow.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
