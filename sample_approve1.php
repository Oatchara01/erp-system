...
$strSQL2 = "SELECT * FROM  (hos__subsmp LEFT JOIN tb_product ON hos__subsmp.product_ID=tb_product.product_id) WHERE reff_idsmp = '".$ref_idsmp."'";
...
$strSQL2 = "SELECT SUM(sum_amount) AS sum_amount FROM  hos__subsmp WHERE reff_idsmp = '".$ref_idsmp."'";
$objQuery2 = mysqli_query($conn,$strSQL2) or die ("Error Query [".$strSQL2."]");
$Num_Rows2 = mysqli_num_rows($objQuery2);
$rs102 = mysqli_fetch_array($objQuery2);    
 if($rs102["sum_amount"]>='501'){
...
$strSQL26="Update  hos__smp set send_cs ='2',cs_no='".$nextId."'  where ref_idsmp='".$ref_idsmp."'";
