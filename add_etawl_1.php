...
$strSQL1 = "SELECT * FROM tb_et_awl WHERE year_no='".$year_no."' and mount_no='".$month_code."' LIMIT 100 OFFSET 600";
$objQuery1 = mysqli_query($conn,$strSQL1) or die ("Error Query [".$strSQL1."]");
$Num_Rows1 = mysqli_num_rows($objQuery1);	
	
$strSQL2 = "SELECT * FROM tb_et_awl WHERE year_no='".$year_no."' and mount_no='".$month_code."' LIMIT 100 OFFSET 700";
$objQuery2 = mysqli_query($conn,$strSQL2) or die ("Error Query [".$strSQL2."]");
$Num_Rows2 = mysqli_num_rows($objQuery2);	
	
	
$strSQL3 = "SELECT * FROM tb_et_awl WHERE year_no='".$year_no."' and mount_no='".$month_code."' LIMIT 100  OFFSET 800";
$objQuery3 = mysqli_query($conn,$strSQL3) or die ("Error Query [".$strSQL3."]");
$Num_Rows3 = mysqli_num_rows($objQuery3);	
	
	
$strSQL4 = "SELECT * FROM tb_et_awl WHERE year_no='".$year_no."' and mount_no='".$month_code."' LIMIT 100 OFFSET 900";
$objQuery4 = mysqli_query($conn,$strSQL4) or die ("Error Query [".$strSQL4."]");
$Num_Rows4 = mysqli_num_rows($objQuery4);		
	
$strSQL5 = "SELECT * FROM tb_et_awl WHERE year_no='".$year_no."' and mount_no='".$month_code."' LIMIT 100 OFFSET 1000";
$objQuery5= mysqli_query($conn,$strSQL5) or die ("Error Query [".$strSQL5."]");
$Num_Rows5 = mysqli_num_rows($objQuery5);	
	
$strSQL6 = "SELECT * FROM tb_et_awl WHERE year_no='".$year_no."' and mount_no='".$month_code."' LIMIT 100 OFFSET 1100";
$objQuery6 = mysqli_query($conn,$strSQL6) or die ("Error Query [".$strSQL6."]");
$Num_Rows6 = mysqli_num_rows($objQuery6);		

$strSQL7 = "SELECT * FROM tb_et_awl WHERE year_no='".$year_no."' and mount_no='".$month_code."' LIMIT 100 OFFSET 1200";
