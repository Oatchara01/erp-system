...
<body>
	<form action='edit_hosbrdel1.php' method="post" name="frmMain" enctype="multipart/form-data">
...
$strSQL1 = "SELECT order_refer_code1,order_refer_code,ker_bath,date_ker,iv_no,ref_id_br FROM hos__br WHERE ref_id_br = '".$_GET["ref_id_br"]."'";
$objQuery1 = mysqli_query($conn,$strSQL1);
$objResult1 = mysqli_fetch_array($objQuery1);

$strSQL2 = "SELECT address_1 FROM tb_register_data WHERE ref_id = '".$_GET["ref_id_br"]."'";
//echo $strSQL2;			
...
เลขที่เอกสาร : &nbsp;
		...
		<input type="hidden" name="ref_id_br"  id="ref_id_br" value="<?php echo $objResult1["ref_id_br"];?>" class="button4" style="width:20%;" >
