...
$(document).ready(function(){
	...
	$("#createRows").click(function(){
						...
						tr = tr + "<td><input type='text' name='sol_price"+rows+"' id='sol_price"+rows+"' class='w3-input' OnChange='JavaScript:chkNum(this,"+rows+")' onKeyUp='IsNumerid(this.value,this)' style='text-align:right'></td>";
