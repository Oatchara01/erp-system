...
$ref_id  = $_POST["ref_id_br"];
$end_date  = $_POST["end_date"];
$start_date  = $_POST["start_date"];
$address_1 = $_POST["address_1"];


$save="Update  hos__br set
date_ker='".$date_ker."',order_refer_code='".$order_refer_code."',order_refer_code1='".$order_refer_code1."',ker_bath='".$ker_bath."' where ref_id_br='".$ref_id."'";
