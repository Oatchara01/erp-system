...
<div class="w3-container w3-bar w3-light-gray w3-margin-bottom"><h4>รายการใบสั่งลดหนี้</h4></div>
...
<?php } ?>
	...
	?><br />
				...
				<?php if($objResult["stock_complete"] !='0'){	 ?>
				<td bgcolor="#00FF00">
					<?php }else{ ?>
					<td>
					<?php } ?>
<?php if($objResult["send_admin"] =='1' and $objResult["close_mount"]=='0'){	 ?>
				<a href="register_credinot_edit.php?ref_credit=<?php echo $objResult["ref_credit"];?>&start_date=<?php echo $_GET["start_date"];  ?>&end_date=<?php echo $_GET["end_date"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
					<?php } ?>			
				</td>
					<td>
