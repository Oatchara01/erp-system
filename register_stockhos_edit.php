...
$Num_Rows1 = mysqli_num_rows($objQuery1);
	...
	<form action='register_stockhos_edit1.php' method="post" name="frmMain" enctype="multipart/form-data">
...
<td style="width:5%;"><a href="delete_productstso.php?ref_id=<?php echo $rs["ref_id"];?>&id=<?php echo $objResult1["id"];?>"><img src="img/false.png" width="16" height="16" border="0" /></a></td>
...
<?php include ('product_stock_edit.php'); ?>	
