...
<div class="w3-white w3-container">
	...
	<form action="register_breng1.php" method="post" name="frmMain" enctype="multipart/form-data" onSubmit="JavaScript:return fncSubmit();" >
...
<?php include ('detail_brhosnb.php');	?>
