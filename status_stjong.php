...
$strSQL = "SELECT *  FROM hos__jongproduct  where send_stock = '1' and stock_name = '' ";
...
?>
 ...
 echo $objResult["date_jong"];
	...
	?><br />
				...
				<?php } ?>
				<td>
				<?php if($objResult["send_stock"] =="0"  ){	}else{ ?> 

				<a href="register_stbook_edit.php?ref_id=<?php echo $objResult["ref_id"];?>&start_date=<?php echo $_GET["start_date"];  ?>&end_date=<?php echo $_GET["end_date"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
				<?php } ?>
					...
					<?php /*<td>
						...
						<?php if($objResult["print_st"] =='1'){	 ?>
				<td bgcolor="#00FF00">
					<?php }else{ ?>
					<td>
					<?php } ?>

<a href="report_jongpro_st.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a>
