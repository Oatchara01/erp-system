...
$objResult2 = mysqli_fetch_array($objQuery2);	
	...
	<form action='register_salejong_create1.php' method="post" name="frmMain" enctype="multipart/form-data" onSubmit="JavaScript:return fncSubmit();" >
...
<td style="width:5%;"><input type='text' name = "warranty[]<?php echo $objResult1["id"];?>" value="<?php if($objResult1["war_hos"]!='0'){ echo $objResult1["war_hos"]; } ?><?php echo $objResult1["unit_hos"];?>" id = "warranty[]<?php echo $objResult1["id"];?>"  class="w3-input" ></td>
...
<?php /*<td style="width:2%;"><a href="producthos_delete.php?ref_id=<?php echo $rs["ref_id"];?>&id=<?php echo $objResult1["id"];?>&code=<?php echo $_SESSION["type_login"]; ?>"><img src="img/false.png" width="16" height="16" border="0" /></a></td>*/ ?>
