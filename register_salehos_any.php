...
$nextId = $yearMonth.$maxId1;
	...
	<form action='register_salehos_any1.php' method="post" name="frmMain" enctype="multipart/form-data" onSubmit="JavaScript:return fncSubmit();" >
...
if($rs12["credit_ckk"] == $objResuut5["id"])
{
$sel = "selected";
}
else
...
กำหนดส่งตามสัญญา :
<input name="delivery_contract" class="button4" type='date' style="width:30%" placeholder="กรุณาระบุเป็นวันที่เท่านั้น !!!"  > </p>
