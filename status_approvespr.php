...
<div class="w3-panel w3-light-grey"><h3>อนุมัติใบเบิกเครื่องและอะไหล่</h3>
...
$strSQL = "SELECT *  FROM hos__spr  where send_sup = '1' and sup_name='' and status_doc='Request' ";
...
<td><a href="register_engspr_app.php?ref_id=<?php echo $objResult["ref_id"];?>&start_date=<?php echo $_GET["start_date"];  ?>&end_date=<?php echo $_GET["end_date"];?>"><img src="img/create.png" width="23" height="23" border="0" /></a></td>
					
<!--td><a href="report_spr.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a></td-->
