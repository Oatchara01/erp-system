...
$strSQL = "SELECT order_id, cs_remark, stock_remark FROM so__main WHERE sale_channel = '12' AND order_refer_code='' and register_date = '" . $register_date . "' and cs_remark NOT LIKE '%ส่งด่วน%' and cs_remark NOT LIKE '%Instant%'";
