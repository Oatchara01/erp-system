...
if ($_SESSION['code']=='SS1' or $_SESSION['code']=='SS2'){
$type_sale = '1';
}else if($_SESSION['code']=='SS3'){
$type_sale = '2';
}
...
<h3 align="center"><?php echo $sale_code; ?></h3>
...
$strSQL ="SELECT distinct product_no FROM tb__buypro WHERE company ='".$company."'";
...
$strSQL .= ' AND type_arae = "'.$type_sale.'"';   
}
...
$strSQL1 ="SELECT SUM(amount) as amount  FROM tb__buypro  WHERE company = '".$company."' and product_no = '".$objResult["product_no"]."'";
...
$strSQL1 .= ' AND type_arae = "'.$type_sale.'"';   
}
...
$strSQL2 ="SELECT SUM(count) as count  FROM tb__buypro  WHERE company = '".$company."' and product_no = '".$objResult["product_no"]."'";
...
$strSQL2 .= ' AND type_arae = "'.$type_sale.'"';   
}
...
$strSQL11 ="SELECT SUM(amount) as amount  FROM tb__discash  WHERE company = '".$company."' and product_no = '".$objResult["product_no"]."'";
...
$strSQL11 .= ' AND type_arae = "'.$type_sale.'"';   
}
...
$strSQL1 ="SELECT SUM(amount) as amount,SUM(count) as count  FROM tb__buypro  WHERE company = '".$company."'";
...
$strSQL11 ="SELECT SUM(amount) as amount  FROM tb__discash  WHERE company = '".$company."'";
