...
<a href="change_approve.php?ref_id=<?php echo $rs["ref_id"];?>&approve_name=<?php echo $_SESSION['name']; ?>&sale_code=<?php echo $_SESSION['code']; ?>&adm_ckk=<?php echo $rs["adm_ckk"];?>" class="w3-button w3-green "><font color="330066">Approve</font></a>

<a href="change_rejected.php?ref_id=<?php echo $rs["ref_id"];?>" class="w3-button w3-red "><font color="330066">Rejected</font></a>
...
?>
	...
	<form  method="post" action='register_supchang_approve1.php' name="frmMain" enctype="multipart/form-data">
	<div class="w3-bar">
...
<div class="w3-bar w3-center">
			<input type="submit" name="submit" class="w3-button w3-teal be-border" value="บันทึก"><br>
	</div><br>	
	</div></div>
	</form>
