...
<div class="w3-panel w3-light-gray"><h4>Status ค้างรหัสลูกค้า Express AWL</h4></div>
...
$strSQL = "SELECT ref_id,select_type_doc,register_date,doc_no,doc_release_date,delivery_contact,approve_complete,ckk_h,bill_vat,select_type_doc,status_vat,print_vat,print_doc,close_mount,cancel_ckk,order_id,billing_name,pre_name,bill_id   FROM (so__main LEFT JOIN tb_customer ON so__main.bill_id=tb_customer.customer_id)  where approve_complete ='Approve' and cancel_ckk='0'  and customer_code ='' and select_type_doc='3'";
