...
$strSQL = "SELECT *  FROM hos__so  where  close_reseach ='1' and reseach_kk='1' and status_doc ='Approve' $sddd";
...
?> </br>
				...
				<?php } ?>
					...
					<td>
<?php $strSQL5 = "SELECT date_research FROM tb_research WHERE running_id = '".$objResult["job_no"]."' ";
$objQuery5 = mysqli_query($com1,$strSQL5) or die(mysqli_error());
$objResult5 = mysqli_fetch_array($objQuery5);
						
if ($objResult5["date_research"] >= '2025-03-01') { ?>
    <a href="https://cs.allwellcenter.com/report_research1369.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a>						
<?php }else if ($objResult5["date_research"] <= '2022-03-31') { ?>
    <a href="report_research.php?running_id=<?php echo $objResult["job_no"];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a>
<?php } elseif ($objResult5["date_research"] >= '2025-10-01') { ?>
<a href="report_researchnws.php?running_id=<?php echo $objResult["job_no"];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a>		
<?php } else { ?>
<a href="report_researchnew.php?running_id=<?php echo $objResult["job_no"];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a>		
<?php } ?>						
...
?>
 ...
 <div class="w3-panel">    <strong>พบทั้งหมด</strong>
	...
	if($Prev_Page)
	{
		echo " <a href='$_SERVER[SCRIPT_NAME]?Page=$Prev_Page&Keyword=$Keyword&sale_code=$sale_code&start_date=$start_date&end_date=$end_date'>
<font color='black'><< Back</font></a> ";
	...
	for($i=1; $i<=$Num_Pages; $i++){
		if($i != $Page)
		{
			echo "[ <a href='$_SERVER[SCRIPT_NAME]?Page=$i&Keyword=$Keyword&sale_code=$sale_code&start_date=$start_date&end_date=$end_date'>
<font color='black'>$i</font></a> ]";
	...
	if($Page!=$Num_Pages)
	{
		echo " <a href ='$_SERVER[SCRIPT_NAME]?Page=$Next_Page&Keyword=$Keyword&sale_code=$sale_code&start_date=$start_date&end_date=$end_date'>
