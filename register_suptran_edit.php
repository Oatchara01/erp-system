...
<?php if($rs["adm_ckk"]!='1'){ ?>		
<a href="sendadmin_change.php?ref_id=<?php echo $rs["ref_id"];?>&sale_code=<?php echo $_SESSION["code"]; ?>" target="_blank" class="w3-button w3-grey w3-right"><font color="red">ส่งใบแลกเปลี่ยนสินค้าให้  Admin</font></a>&nbsp;&nbsp;
<?php } ?>
...
?>
	...
	<form action="register_suptran_edit1.php" method="post" name="frmMain" enctype="multipart/form-data">
	<div class="w3-bar">
