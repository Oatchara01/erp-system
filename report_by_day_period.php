...
<?php
	...
	if(isset($_POST["register_date2"]))
	{
		$register2 = $_POST["register_date2"];
	}
	if(isset($_GET["register_date2"]))
	{
		$register2 = $_GET["register_date2"];
	}
?>
<div class="w3-container">
<div class="w3-padding-large"></div>
<div class="w3-bar w3-light-gray">
<div class="w3-half"><h4>รายงานสรุปตามวันที่ (ช่วงเวลา)</h4></div>
...
<table>
  ...
  <td>ถึงวันที่</td>
  <td> <input name="register_date2" type="date" id="register_date2" class="w3-input w3-light-gray" value="<?php echo $register2;?>"></td>
...
<?php
	$sql = "select so__main.*,tb_delivery.* from (so__main left join tb_delivery on so__main.delivery=tb_delivery.delivery_id) where (register_date between'".$register."' and '".$register2."')";
...
?>
  <tr>
	...
	<td align="right"><div align="left"><?php echo $result["delivery_name"];?></div></td>
  </tr>
<?php
}
?>
...
$total="select ref_id from so__main where register_date between '".$register."' and '".$register2."'";
