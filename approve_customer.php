...
<body>
<form   method="post" action="approve_customer1.php" name="frmMain" enctype="multipart/form-data"  onSubmit="JavaScript:return fncSubmit();" >
...
<div class="w3-half"><h4>APPROVE : CUSTOMER</h4></div>
<div class="w3-half">
</div>
</div>
...
<input name="customer_name" value = "<?php echo $objResult["customer_name"]; ?>" class="w3-input" >
	...
	<input name="eng_ckk" type='hidden' value = "<?php echo $objResult["eng_ckk"]; ?>" class="w3-input" >
...
<input type="submit" name ="Submit" value="Approve" class = "w3-button w3-green button4" >

<a href="reject_customer1.php?id=<?php echo $objResult["id"];?>" class="w3-button w3-red button4">Rejected</a>
