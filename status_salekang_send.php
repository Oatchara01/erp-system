...
<div class="w3-container w3-padding-large">
	<div class="w3-panel w3-light-grey"><h3>ใบสั่งขาย Hospital ค้างส่งของ</h3></div>
...
$strSQL = "SELECT *  FROM hos__so  where  status_doc ='Approve' and send_erpst ='0' and stock !='' and sale_code LIKE '%EN%'";
}else{
$strSQL = "SELECT *  FROM hos__so  where  status_doc ='Approve' and send_erpst ='0' and stock !='' and sale_code = '".$sale_code."'";	
}
...
?>
 ...
 echo DateThai($objResult["date_so"]);
				...
				<td><div align="left">
					<?php
						$strSQL1 = "SELECT sol_name FROM (hos__subso LEFT JOIN tb_product ON hos__subso.product_ID=tb_product.product_id) WHERE ref_idd = '".$objResult["ref_id"]."' and ckk_st='0' and product_type !='อื่นๆ'";
						//echo $strSQL1;
						//exit();
