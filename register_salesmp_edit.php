...
<div class="w3-white w3-container">
	...
	<?php if($ffirst["send_sup"]=="0"){ ?>
		<a href="send_sample_approve.php?ref_idsmp=<?php echo $_GET["ref_idsmp"];?>&sale_code=<?php echo $_SESSION["code"]; ?>" target="_blank" class="w3-button w3-grey w3-right"><font color="red">ส่งใบเบิกให้ Sup อนุมัติ</font></a>
	<?php } ?>
	&nbsp;&nbsp; 
<a href="report_sample.php?ref_idsmp=<?php echo $_GET["ref_idsmp"];?>" target="_blank" class="w3-button w3-yellow w3-right"><font color="black">Print Preview</font></a>&nbsp;&nbsp;
	...
	<form action="register_salesmp_edit1.php" method="post" name="frmMain" enctype="multipart/form-data">
	<div class="w3-bar">
...
<textarea name = "sale_remarkk[<?php echo $objResult1["subsmp_id"]; ?>]"  id = "sale_remarkk[<?php echo $objResult1["subsmp_id"]; ?>]" class="w3-input" ><?php echo $objResult1["sale_remark"];?></textarea>
...
<input type='checkbox' name = "clear_br[<?php echo $objResult1["subsmp_id"]; ?>]" checked='checked' id = "clear_br[<?php echo $objResult1["subsmp_id"]; ?>]" value = "1" class="w3-input" >
	<?php }else{ ?>
<input type='checkbox' name = "clear_br[<?php echo $objResult1["subsmp_id"]; ?>]" id = "clear_br[<?php echo $objResult1["subsmp_id"]; ?>]" value = "1" class="w3-input" >	
	<?php } ?>
