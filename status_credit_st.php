...
<div class="w3-white">
		<div class="w3-container w3-padding-large"><!-- main div -->
			<div class="w3-panel w3-light-gray"><h4>Status ลดหนี้ Stock</h4></div>
...
$strSQL = "SELECT *  FROM tb_credit_note  where send_return_name !=''  and sale_name !='' and ttype_doc = '1'  and stock_complete = '0' ";
...
?>
 ...
 echo DateThai($objResult["date_credit"]);
	...
	?><br />
				...
				<a href="register_credinot_stedit.php?ref_credit=<?php echo $objResult["ref_credit"];?>&start_date=<?php echo $_GET["start_date"];  ?>&end_date=<?php echo $_GET["end_date"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
