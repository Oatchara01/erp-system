...
<input type="button" name ="button" value="Approve" class = "button button4" onClick="this.form.action='salehos_approve.php'; submit()">
...
&nbsp;&nbsp;&nbsp;&nbsp;
<?php if($rs["et_ckk"]=='1'){ ?>	
<input type="checkbox" name="et_ckk" id="et_ckk" checked='checked' value="1" > <font color='blue'>ขอบิล E-Tax</font>
<?php }else{ ?>		
...
<br>
 <center><input type="button" name ="button" value="บันทึก" class = "button button4" onClick="this.form.action='register_suphos_approve1.php'; submit()"></center>
 </div>
