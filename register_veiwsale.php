...
$Num_Rows1 = mysqli_num_rows($objQuery1);
	...
	<form action='register_salehos_edit1.php' method="post" name="frmMain" enctype="multipart/form-data">
	<div class="w3-white">
...
<a href="sendmail_approveso.php?ref_id=<?php echo $rs["ref_id"];?>&sale_code=<?php echo $_SESSION["code"]; ?>" target="_blank" class="w3-button w3-grey w3-right"><font color="red">ส่งใบสั่งขายให้ Sup อนุมัติ</font></button></a>&nbsp;&nbsp;
...
<a href="report_salehosptl2.php?ref_id=<?php echo $rs["ref_id"];?>" target="_blank" class="w3-button w3-grey w3-right"><font color="Blue">ใบสั่งขาย AWL</font></button></a><br />
...
<a href="report_salehosnbm2.php?ref_id=<?php echo $rs["ref_id"];?>" target="_blank" class="w3-button w3-grey w3-right"><font color="DeepPink">ใบสั่งขาย NBM</font></a>
<?php
