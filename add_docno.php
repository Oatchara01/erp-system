...
<div class="w3-panel w3-light-gray"><h4>ADD : เลขที่เอกสาร</h4></div>
...
<br>
<center>
		  <input type="button" name ="Submit" value="บันทึก" class = "button button4" onClick="this.form.action='add_docno1.php'; submit()">
</center>
...
$strSQL1 = "SELECT * FROM tb_doc_nbm WHERE year_no='".$year_no."' and mount_no='".$month_code."' LIMIT 100";
$objQuery1 = mysqli_query($conn,$strSQL1) or die ("Error Query [".$strSQL1."]");
$Num_Rows1 = mysqli_num_rows($objQuery1);	
	
$strSQL2 = "SELECT * FROM tb_doc_nbm WHERE year_no='".$year_no."' and mount_no='".$month_code."' LIMIT 100 OFFSET 100";
$objQuery2 = mysqli_query($conn,$strSQL2) or die ("Error Query [".$strSQL2."]");
$Num_Rows2 = mysqli_num_rows($objQuery2);	
	
	
$strSQL3 = "SELECT * FROM tb_doc_nbm WHERE year_no='".$year_no."' and mount_no='".$month_code."' LIMIT 100  OFFSET 200";
$objQuery3 = mysqli_query($conn,$strSQL3) or die ("Error Query [".$strSQL3."]");
$Num_Rows3 = mysqli_num_rows($objQuery3);	
	
	
$strSQL4 = "SELECT * FROM tb_doc_nbm WHERE year_no='".$year_no."' and mount_no='".$month_code."' LIMIT 100 OFFSET 300";
$objQuery4 = mysqli_query($conn,$strSQL4) or die ("Error Query [".$strSQL4."]");
$Num_Rows4 = mysqli_num_rows($objQuery4);		
	
$strSQL5 = "SELECT * FROM tb_doc_nbm WHERE year_no='".$year_no."' and mount_no='".$month_code."' LIMIT 100 OFFSET 400";
$objQuery5= mysqli_query($conn,$strSQL5) or die ("Error Query [".$strSQL5."]");
$Num_Rows5 = mysqli_num_rows($objQuery5);	
	
$strSQL6 = "SELECT * FROM tb_doc_nbm WHERE year_no='".$year_no."' and mount_no='".$month_code."' LIMIT 100 OFFSET 500";
...
$strSQL11 = "SELECT ref_id,doc_release_date FROM so__main WHERE doc_no = '".$objResult1["doc_no"]."' and cancel_ckk='0' and select_type_doc='4' ";
...
$strSQL13 = "SELECT ref_id,iv_date FROM hos__so WHERE iv_no = '".$objResult1["doc_no"]."' and status_doc='Approve' and type_doc='4' ";
...
$strSQL22 =  "Update tb_doc_ptl Set ref_so='".$objResult11["ref_id"]."',iv_date='".$objResult11["doc_release_date"]."'  where  doc_no ='".$objResult1["doc_no"]."'";
 $objQuery22 = mysqli_query($conn,$strSQL22) or die(mysqli_error());	
	
}else if($Num_Rows13 > 0){	
	
$strSQL23 =  "Update tb_doc_ptl Set ref_so='".$objResult13["ref_id"]."',iv_date='".$objResult13["iv_date"]."'  where  doc_no ='".$objResult1["doc_no"]."'";
 $objQuery23 = mysqli_query($conn,$strSQL23) or die(mysqli_error());	
}else{
	
$strSQL23 =  "Update tb_doc_ptl Set ref_so='',iv_date=''  where  doc_no ='".$objResult1["doc_no"]."'";
 $objQuery23 = mysqli_query($conn,$strSQL23) or die(mysqli_error());	
}
...
$strSQL11 = "SELECT ref_id,doc_release_date FROM so__main WHERE doc_no = '".$objResult2["doc_no"]."' and cancel_ckk='0' and select_type_doc='4' ";
$objQuery11= mysqli_query($conn,$strSQL11) or die(mysqli_error());
$Num_Rows11 = mysqli_num_rows($objQuery11);		
$objResult11 = mysqli_fetch_array($objQuery11);
	
$strSQL13 = "SELECT ref_id,iv_date FROM hos__so WHERE iv_no = '".$objResult2["doc_no"]."' and status_doc='Approve' and type_doc='4' ";
$objQuery13= mysqli_query($conn,$strSQL13) or die(mysqli_error());
$Num_Rows13 = mysqli_num_rows($objQuery13);			
$objResult13 = mysqli_fetch_array($objQuery13);	
...
$strSQL22 =  "Update tb_doc_ptl Set ref_so='".$objResult11["ref_id"]."',iv_date='".$objResult11["doc_release_date"]."'  where  doc_no ='".$objResult2["doc_no"]."'";
 $objQuery22 = mysqli_query($conn,$strSQL22) or die(mysqli_error());	
	
}else if($Num_Rows13 > 0){	
	
$strSQL23 =  "Update tb_doc_ptl Set ref_so='".$objResult13["ref_id"]."',iv_date='".$objResult13["iv_date"]."'  where  doc_no ='".$objResult2["doc_no"]."'";
 $objQuery23 = mysqli_query($conn,$strSQL23) or die(mysqli_error());	
}else{
	
$strSQL23 =  "Update tb_doc_ptl Set ref_so='',iv_date=''  where  doc_no ='".$objResult2["doc_no"]."'";
 $objQuery23 = mysqli_query($conn,$strSQL23) or die(mysqli_error());	
}	
?>	
<tr>
...
{
$strSQL11 = "SELECT ref_id,doc_release_date FROM so__main WHERE doc_no = '".$objResult3["doc_no"]."' and cancel_ckk='0' and select_type_doc='4' ";
$objQuery11= mysqli_query($conn,$strSQL11) or die(mysqli_error());
$Num_Rows11 = mysqli_num_rows($objQuery11);		
$objResult11 = mysqli_fetch_array($objQuery11);
	
$strSQL13 = "SELECT ref_id,iv_date FROM hos__so WHERE iv_no = '".$objResult3["doc_no"]."' and status_doc='Approve' and type_doc='4' ";
$objQuery13= mysqli_query($conn,$strSQL13) or die(mysqli_error());
$Num_Rows13 = mysqli_num_rows($objQuery13);			
$objResult13 = mysqli_fetch_array($objQuery13);	
...
$strSQL22 =  "Update tb_doc_ptl Set ref_so='".$objResult11["ref_id"]."',iv_date='".$objResult11["doc_release_date"]."'  where  doc_no ='".$objResult3["doc_no"]."'";
 $objQuery22 = mysqli_query($conn,$strSQL22) or die(mysqli_error());	
	
}else if($Num_Rows13 > 0){	
	
$strSQL23 =  "Update tb_doc_ptl Set ref_so='".$objResult13["ref_id"]."',iv_date='".$objResult13["iv_date"]."'  where  doc_no ='".$objResult3["doc_no"]."'";
 $objQuery23 = mysqli_query($conn,$strSQL23) or die(mysqli_error());	
}else{
	
$strSQL23 =  "Update tb_doc_ptl Set ref_so='',iv_date=''  where  doc_no ='".$objResult3["doc_no"]."'";
 $objQuery23 = mysqli_query($conn,$strSQL23) or die(mysqli_error());	
}	
...
{
$strSQL11 = "SELECT ref_id,doc_release_date FROM so__main WHERE doc_no = '".$objResult4["doc_no"]."' and cancel_ckk='0' and select_type_doc='4' ";
$objQuery11= mysqli_query($conn,$strSQL11) or die(mysqli_error());
$Num_Rows11 = mysqli_num_rows($objQuery11);		
$objResult11 = mysqli_fetch_array($objQuery11);
	
$strSQL13 = "SELECT ref_id,iv_date FROM hos__so WHERE iv_no = '".$objResult4["doc_no"]."' and status_doc='Approve' and type_doc='4' ";
$objQuery13= mysqli_query($conn,$strSQL13) or die(mysqli_error());
$Num_Rows13 = mysqli_num_rows($objQuery13);			
$objResult13 = mysqli_fetch_array($objQuery13);	
...
$strSQL22 =  "Update tb_doc_ptl Set ref_so='".$objResult11["ref_id"]."',iv_date='".$objResult11["doc_release_date"]."'  where  doc_no ='".$objResult4["doc_no"]."'";
 $objQuery22 = mysqli_query($conn,$strSQL22) or die(mysqli_error());	
	
}else if($Num_Rows13 > 0){	
	
$strSQL23 =  "Update tb_doc_ptl Set ref_so='".$objResult13["ref_id"]."',iv_date='".$objResult13["iv_date"]."'  where  doc_no ='".$objResult4["doc_no"]."'";
 $objQuery23 = mysqli_query($conn,$strSQL23) or die(mysqli_error());	
}else{
	
$strSQL23 =  "Update tb_doc_ptl Set ref_so='',iv_date=''  where  doc_no ='".$objResult4["doc_no"]."'";
 $objQuery23 = mysqli_query($conn,$strSQL23) or die(mysqli_error());	
}			
?>				
		<tr>
...
{
$strSQL11 = "SELECT ref_id,doc_release_date FROM so__main WHERE doc_no = '".$objResult5["doc_no"]."' and cancel_ckk='0' and select_type_doc='4' ";
$objQuery11= mysqli_query($conn,$strSQL11) or die(mysqli_error());
$Num_Rows11 = mysqli_num_rows($objQuery11);		
$objResult11 = mysqli_fetch_array($objQuery11);
	
$strSQL13 = "SELECT ref_id,iv_date FROM hos__so WHERE iv_no = '".$objResult5["doc_no"]."' and status_doc='Approve' and type_doc='4' ";
$objQuery13= mysqli_query($conn,$strSQL13) or die(mysqli_error());
$Num_Rows13 = mysqli_num_rows($objQuery13);			
$objResult13 = mysqli_fetch_array($objQuery13);	
...
$strSQL22 =  "Update tb_doc_ptl Set ref_so='".$objResult11["ref_id"]."',iv_date='".$objResult11["doc_release_date"]."'  where  doc_no ='".$objResult5["doc_no"]."'";
 $objQuery22 = mysqli_query($conn,$strSQL22) or die(mysqli_error());	
	
}else if($Num_Rows13 > 0){	
	
$strSQL23 =  "Update tb_doc_ptl Set ref_so='".$objResult13["ref_id"]."',iv_date='".$objResult13["iv_date"]."'  where  doc_no ='".$objResult5["doc_no"]."'";
 $objQuery23 = mysqli_query($conn,$strSQL23) or die(mysqli_error());	
}else{
	
$strSQL23 =  "Update tb_doc_ptl Set ref_so='',iv_date=''  where  doc_no ='".$objResult5["doc_no"]."'";
 $objQuery23 = mysqli_query($conn,$strSQL23) or die(mysqli_error());	
}			
?>				<tr>
...
{
$strSQL11 = "SELECT ref_id,doc_release_date FROM so__main WHERE doc_no = '".$objResult6["doc_no"]."' and cancel_ckk='0' and select_type_doc='4' ";
$objQuery11= mysqli_query($conn,$strSQL11) or die(mysqli_error());
$Num_Rows11 = mysqli_num_rows($objQuery11);		
$objResult11 = mysqli_fetch_array($objQuery11);
	
$strSQL13 = "SELECT ref_id,iv_date FROM hos__so WHERE iv_no = '".$objResult6["doc_no"]."' and status_doc='Approve' and type_doc='4' ";
$objQuery13= mysqli_query($conn,$strSQL13) or die(mysqli_error());
$Num_Rows13 = mysqli_num_rows($objQuery13);			
$objResult13 = mysqli_fetch_array($objQuery13);	
...
$strSQL22 =  "Update tb_doc_ptl Set ref_so='".$objResult11["ref_id"]."',iv_date='".$objResult11["doc_release_date"]."'  where  doc_no ='".$objResult6["doc_no"]."'";
 $objQuery22 = mysqli_query($conn,$strSQL22) or die(mysqli_error());	
	
}else if($Num_Rows13 > 0){	
	
$strSQL23 =  "Update tb_doc_ptl Set ref_so='".$objResult13["ref_id"]."',iv_date='".$objResult13["iv_date"]."'  where  doc_no ='".$objResult6["doc_no"]."'";
 $objQuery23 = mysqli_query($conn,$strSQL23) or die(mysqli_error());	
}else{
	
$strSQL23 =  "Update tb_doc_ptl Set ref_so='',iv_date=''  where  doc_no ='".$objResult6["doc_no"]."'";
 $objQuery23 = mysqli_query($conn,$strSQL23) or die(mysqli_error());	
}			
?>				
		<tr>
