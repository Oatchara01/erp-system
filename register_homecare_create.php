...
$strSQL = "SELECT * FROM hos__jongproduct WHERE ref_id = '".$_GET['ref_id']."' ";
...
?>
<form action='register_homecare_create1.php' method="post" name="frmMain" enctype="multipart/form-data" onkeypress="return event.keyCode!=13">
<div class="w3-white">
...
<div class="w3-button">
	...
	<input type="radio" checked='checked' name="select_type_doc"  value="3" id="select_type_doc">&nbsp;ใบสั่งขาย AWL
	<input type="radio"  name="select_type_doc"  value="4" id="select_type_doc">&nbsp;ใบสั่งขาย NBM
	<?php }else{ ?>
	<input type="radio"  name="select_type_doc"  value="3" id="select_type_doc">&nbsp;ใบสั่งขาย AWL
	<input type="radio" checked='checked' name="select_type_doc"  value="4" id="select_type_doc">&nbsp;ใบสั่งขาย NBM
	<?php } ?>
...
<option value="">**Please Select Item**</option>
<?php
$strSQL5 = "select * from tb_payment where close_ckk='0' order by payment_ID";
...
<?php
$emp = "select * from tb_employee where department_id='1' and status ='1' order by employee_name";
$sqlemp = mysqli_query($conn,$emp);
while ($fetchemp = mysqli_fetch_array($sqlemp,MYSQLI_ASSOC)) { ?>
<option class="w3-bar-item w3-button" value="<?php echo $fetchemp['employee_name']; ?>"><?php echo $fetchemp['employee_name']; ?> - <?php echo $fetchemp['emp_ref']; ?></option>
<?php } ?>
</select>
	</p>		
...
<div class="w3-padding-small"></div>
<input type="checkbox" checked='checked' name="clear_book_ckk" value="1">&nbsp; เคลียร์ใบจอง:
<input name="clear_book_no" id="clear_book_no" value="<?php echo $objResult["iv_no"]; ?>" class="w3-input" placeholder="เลขที่" >
<div class="w3-padding-small"></div>
...
<?php include ('proclear_jongallwell.php') ?>
...
<select name="company_name" class="w3-input" >
<option value="">**Please Select Item**</option>
<?php
