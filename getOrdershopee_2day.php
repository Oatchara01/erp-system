...
/*$strSQL = "SELECT order_id,cs_remark FROM so__main WHERE sale_channel ='12'  AND ckk_item = '0'  and (sale_remark NOT LIKE '%ด่วน%' or cs_remark NOT LIKE '%Instant%') ";
$objQuery = mysqli_query($conn, $strSQL) or die ("Error Query [".$strSQL."]");
...
$strSQL = "SELECT order_id,cs_remark FROM so__main WHERE sale_channel ='12'  AND ckk_item = '0'  and (sale_remark NOT LIKE '%ด่วน%' or cs_remark NOT LIKE '%Instant%') and doc_no !='' and pre_ckk='0'";
$objQuery = mysqli_query($conn, $strSQL) or die ("Error Query [".$strSQL."]");

while ($objResult = mysqli_fetch_array($objQuery)) {
$orderSn = $objResult["order_id"];

processShopeeOrderPickupIn2Days($orderSn, $conn, $partnerId, $partnerKey, $shopId, $accessToken);
...
$strSQL = "SELECT order_id,cs_remark FROM so__main WHERE sale_channel ='12' register_date > '2026-01-01'    and (sale_remark NOT LIKE '%ด่วน%' or cs_remark NOT LIKE '%Instant%') and doc_no !='' and pre_ckk='1'";
$objQuery = mysqli_query($conn, $strSQL) or die ("Error Query [".$strSQL."]");
