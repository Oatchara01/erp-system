...
$Num_Rows1 = mysqli_num_rows($objQuery1);
	...
	<form action='register_posup_create1.php' method="post" name="frmMain" enctype="multipart/form-data"
...
แนบไฟล์ </p>
<input type='hidden' name='slip1' id='slip1' value ="<?php echo $rs['img_po1']; ?>"  />
<input type='hidden' name='slip2' id='slip2' value ="<?php echo $rs['img_po2']; ?>"  />
<input type='hidden' name='slip3' id='slip3' value ="<?php echo $rs['img_po3']; ?>"  />
<input type='hidden' name='slip4' id='slip4' value ="<?php echo $rs['img_po4']; ?>"  />
<input type='hidden' name='slip5' id='slip5' value ="<?php echo $rs['img_po5']; ?>"  />
...
<td style="width:8%;">
	...
	<input type='text' name = "jong_no[<?php echo $objResult1["id"];?>]"  id = "jong_no[<?php echo $objResult1["id"];?>]" placeholder="เลขที่ใบจอง"  class="w3-input"  />
	</td>		
