...
$strSQL = "SELECT *  FROM hos__change  where   status_doc !='Rejected'   and send_erpst = '0'  ";
...
?>
			...
			<tr>
					...
					<td  bgcolor="#00FF00"><?php echo $objResult["ref_id"];?></td>
...
<td  >
				<?php if($objResult["status_doc"]=='Approve' and $objResult["close_mount"] =='0' and $objResult["iv_date"] !='0000-00-00'){	?> 
				<a href="register_stockchangehos.php?ref_id=<?php echo $objResult["ref_id"];?>&start_date=<?php echo $_GET["start_date"];  ?>&end_date=<?php echo $_GET["end_date"];?>"><img src="img/create.png" width="23" height="23" border="0" /></a>
					<?php } ?>							
				</td>
	<td  >
				<?php if($objResult["status_doc"]=='Approve' and $objResult["close_mount"] =='0' and $objResult["iv_date"] !='0000-00-00'){	?> 

				<a href=javascript:if(confirm('!!!ต้องการแกไขข้อมูลรายการสินค้าใช่หรือไม่')==true){window.location='register_stockchangehos_edit.php?ref_id=<?php echo $objResult["ref_id"];?>&start_date=<?php echo $_GET["start_date"];  ?>&end_date=<?php echo $_GET["end_date"];?>';}><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
				<?php } ?>
				...
				<td bgcolor="#00FF00">
					...
					<td>
					<?php } ?>
<?php if($objResult["send_admin"] =='1' and $objResult["status_doc"]=='Approve' and $objResult["iv_date"] !='0000-00-00'){	if($objResult["company"] =='1' ){				
					?> 
					
				<a href="report_changehosptl_st.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a>
					<?php }else{ ?>
				<a href="report_changehosnbm_st.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a>	
				<?php } } ?>
				</td>
