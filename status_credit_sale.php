...
<div class="w3-container w3-padding-large">
	<div class="w3-panel w3-light-grey"><h3>รายการใบลดหนี้</h3></div>
...
$strSQL = "SELECT *  FROM tb_credit_note  where sale_code LIKE '%EN%'";
}else{
$strSQL = "SELECT *  FROM tb_credit_note  where sale_code = '".$sale_code."'";
}
if($start_date !=""){ 
