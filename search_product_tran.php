...
<form name="frmSearch" method="GET" action="report_product_tran.php">
	<div class="w3-white">
<div class="w3-panel w3-light-gray"><h4>รายงานการเคลื่อนไหวสินค้า</h4></div>
...
function make_autocom(autoObj,showObj){
	...
	new Autocomplete(mkAutoObj, function() {
		...
		if ( this.value.length < 1 && this.isNotClick ) 
			return ;	
		return "data_prostock.php?product_code_search=" +encodeURIComponent(this.value);
    });	
}	
