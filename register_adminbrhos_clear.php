...
<a href="register_adminbrhos_clear1.php?ref_id_br=<?php echo $rs["ref_id_br"];?>" target="_blank" class="w3-button w3-grey w3-right"><font color="Blue">ปิดใบยืม</font></button></a>
	...
	<form action="register_adminbrhos_edit1.php" method="post" name="frmMain" enctype="multipart/form-data">
	<div class="w3-bar">

	<?php if ($rs["company"]=='1'){ ?>
		<input type="radio" name="company" value="1" checked='checked' required>ใบยืม ALL
		<input type="radio" name="company" value="2" required> ใบยืม NBM
		<?php  }else if($rs["company"]=='2'){ ?>

		<input type="radio" name="company" value="1"  required>ใบยืม ALL
...
$Num_Rows2 = mysqli_num_rows($objQuery2);	
	...
	<a href="report_checklist.php?product_code=<?php echo $objR1["product_id"];?>&ref_id_br=<?php echo $rs["ref_id_br"];?>&doc_no=<?php echo $objR1["doc_no"];?>&year_no=<?php echo $objR1["year_no"];?>" target="_blank" class="w3-button w3-grey" style="width:20%;"><font color="DeepPink"><?php echo $objR2["product_name"];?></font></a>	
	</p>
	<?php
						  }
	}
