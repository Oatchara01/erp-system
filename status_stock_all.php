...
<div class="w3-panel w3-light-gray"><h4>Status Online(ทั้งหมด)</h4></div>
...
$strSQL = "SELECT ref_id,select_type_doc,register_date,doc_no,doc_release_date,delivery_contact,approve_complete,ckk_h,printst_ckk,close_mount,cancel_ckk   FROM so__main   where ckk_h ='1' and approve_complete = 'Approve' ";
...
<td><div align="left">
<?php
$strSQL1 = "SELECT sol_name,access_name FROM (so__submain LEFT JOIN tb_product ON so__submain.product_ID=tb_product.product_id) WHERE ref_idd = '".$objResult["ref_id"]."' ";
///echo $strSQL;
//exit();
...
<td><div align="left">
<?php
$strSQL2 = "SELECT sn_number FROM so__submain  WHERE ref_idd = '".$objResult["ref_id"]."' ";
///echo $strSQL;
//exit();
...
?>
 ...
 <span class="w3-red" ><?php echo $objResult2["sn_number"];?></span>
...
<?php
				...
				<?php }else if($objResult["approve_complete"]=='Rejected'){	?>
...
<a href="report_loanptl_st.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a>
				<?php }else if ($objResult["select_type_doc"]=='2'){?>
<a href="report_loannbm_st.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a>

<?php }else if ($objResult["select_type_doc"]=='3'){?>
<a href="report_saleptl1_st.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a>

<?php }else if ($objResult["select_type_doc"]=='4'){?>
<a href="report_salenbm1_st.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a>
