...
$strSQL11 = "SELECT * FROM tb_user_team WHERE em_id = '".$emid."' ";
$objQuery11 = mysqli_query($com,$strSQL11) or die(mysqli_error());
$i=1;
while($objResult11 = mysqli_fetch_array($objQuery11))
{

$sale_code=$objResult11["sale_code"];
...
if($Num_Rows >0){
	?>
<center><font size="5">รายการใบยืมคงค้าง เขตการขาย <?php echo $sale_code; ?> </font></center>	
...
$strSQL2 = "SELECT id,product_id,count,sale_remark FROM hos__subbr  WHERE ref_idd_br ='".$objResult1["ref_id_br"]."' and clear_ckk = '0'";
