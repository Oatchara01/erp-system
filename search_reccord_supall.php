...
<form name="frmSearch" method="GET" action="report_supallwell_record.php">
<div class="w3-white">
...
$strSQL5 = "SELECT * FROM tb_team_all where ckk='0' and sale_code NOT IN ('S31','S32','S33','MM1','MM2','HC_EXTRA','SM1','S51') ORDER BY sale_code ASC";
