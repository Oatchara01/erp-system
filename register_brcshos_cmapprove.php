...
<a href="rejected_brcshos_cm.php?ref_id=<?php echo $rs["ref_id"];?>&sale_code=<?php echo $_SESSION["code"]; ?>" target="_blank" class="w3-button w3-red w3-center"><font color="black">Rejected</font></a>&nbsp;&nbsp;
...
<form action="register_brcshos_cmapprove1.php" method="post" name="frmMain" enctype="multipart/form-data" onSubmit="JavaScript:return fncSubmit();" >
