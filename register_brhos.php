...
<form action="register_brhos1.php" method="post" name="frmMain" enctype="multipart/form-data" onSubmit="JavaScript:return fncSubmit();" >
...
<input type="checkbox" name="ref_11"  id="ref_11" value="1"> &nbsp;ใบประเมินสินค้า&nbsp;จำนวน&nbsp;&nbsp;
<input name="ref_11des" id="ref_11des"   class="button4" style="width:30%">
...
<?php
	...
	include ('detail_breng.php');
	}else{
		include ('detail_brhos.php');
	}
	?>
