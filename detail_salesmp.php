...
function doCallAjax(product_code,product_id,product_name,unit_name,waranty,product_price) {
HttPRequest = false;
...
<input type='text' name = "product_codet1"  id = "product_codet1" class="w3-input" placeholder="Search รหัส"  size="7" OnChange="JavaScript:doCallAjax('product_codet1','product_id1','product_name1','unit_name1','waranty1','product_price1');"/> 
<input type='hidden' name = "h_product_codet1"  id = "h_product_codet1"  class="button4" readonly>


<input type='text' name = "product_code1"  id = "product_code1" class="w3-input" placeholder="Search ชื่ออังกฤษ"  size="7" OnChange="JavaScript:doCallAjax('product_code1','product_id1','product_name1','unit_name1','waranty1','product_price1');"/> 
<input type='hidden' name = "h_product_code1"  id = "h_product_code1"  class="button4" readonly>
	
<input type='text' name = "product_c1"  id = "product_c1" class="w3-input" placeholder="Search ชื่อไทย"  size="7" OnChange="JavaScript:doCallAjax('product_c1','product_id1','product_name1','unit_name1','waranty1','product_price1');"/> 
...
<td style="width:8%;">
<input type='text' name = "product_price1"  id = "product_price1"  class="w3-input" size="7" style="color:black;text-align:right" readonly>
</td >
...
<input type='text' name = "product_codet2"  id = "product_codet2" class="w3-input" placeholder="Search รหัส" size="7"  OnChange="JavaScript:doCallAjax('product_codet2','product_id2','product_name2','unit_name2','waranty2','product_price2');"/> 
<input type='hidden' name = "h_product_codet2"  id = "h_product_codet2"  class="w3-input" readonly>

<input type='text' name = "product_code2"  id = "product_code2" class="w3-input" placeholder="Search ชื่ออังกฤษ..." size="7" OnChange="JavaScript:doCallAjax('product_code2','product_id2','product_name2','unit_name2','waranty2','product_price2');"/> 
<input type='hidden' name = "h_product_code2"  id = "h_product_code2"  class="w3-input" readonly>
	
<input type='text' name = "product_c2"  id = "product_c2" class="w3-input" placeholder="Search ชื่อไทย..." size="7" OnChange="JavaScript:doCallAjax('product_c2','product_id2','product_name2','unit_name2','waranty2','product_price2');"/> 
...
<td style="width:8%;">
<input type='text' name = "product_price2"  id = "product_price2" size="7" class="w3-input"  style="color:black;text-align:right" readonly>
...
<td style="width:5%;">
<input type='text' name = "waranty2" id = "waranty2"  class="w3-input" style="color:black;text-align:center"  />
</td>
<td style="width:10%;">
<textarea name = "sale_remark2" id = "sale_remark2"  class="w3-input"   ></textarea>
</td>
<td style="width:8%;">
	<input type='checkbox' name = "clear_br2" value="1" id = "clear_br2"  class="w3-input" >
	<input type='text' name = "br_no2" id = "br_no2"  class="w3-input"  >
</td>
...
<input type='text' name = "product_codet3"  id = "product_codet3" class="w3-input" placeholder="Search รหัส" size="7"  OnChange="JavaScript:doCallAjax('product_codet3','product_id3','product_name3','unit_name3','waranty3','product_price3');"/> 
<input type='hidden' name = "h_product_codet3"  id = "h_product_codet3"  class="w3-input" readonly>

<input type='text' name = "product_code3"  id = "product_code3" class="w3-input" placeholder="Search ชื่ออังกฤษ..."  size="7" OnChange="JavaScript:doCallAjax('product_code3','product_id3','product_name3','unit_name3','waranty3','product_price3');"/> 
<input type='hidden' name = "h_product_code3"  id = "h_product_code3"  class="w3-input" readonly>
	
<input type='text' name = "product_c3"  id = "product_c3" class="w3-input" placeholder="Search ชื่อไทย..."  size="7" OnChange="JavaScript:doCallAjax('product_c3','product_id3','product_name3','unit_name3','waranty3','product_price3');"/> 
...
<td>
<input type='text' name = "product_price3"  id = "product_price3" size="7" class="w3-input"  style="color:black;text-align:right" readonly>
</td>
...
<td style="width:5%;">
<input type='text' name = "waranty3" id = "waranty3"  class="w3-input" style="color:black;text-align:center"  />
</td>	
	
<td style="width:10%;">
<textarea name = "sale_remark3" id = "sale_remark3"  class="w3-input"   ></textarea>
</td>
<td style="width:8%;">
	<input type='checkbox' name = "clear_br3" value="1" id = "clear_br3"  class="w3-input" >
	<input type='text' name = "br_no3" id = "br_no3"  class="w3-input"  >
</td>
...
<input type='text' name = "product_codet4"  id = "product_codet4" class="w3-input" placeholder="Search รหัส" size="7"  OnChange="JavaScript:doCallAjax('product_codet4','product_id4','product_name4','unit_name4','waranty4','product_price4');"/> 
<input type='hidden' name = "h_product_codet4"  id = "h_product_codet4"  class="w3-input" readonly>

<input type='text' name = "product_code4"  id = "product_code4" class="w3-input" placeholder="Search ชื่ออังกฤษ..."  size="7" OnChange="JavaScript:doCallAjax('product_code4','product_id4','product_name4','unit_name4','waranty4','product_price4');"/> 
<input type='hidden' name = "h_product_code4"  id = "h_product_code4"  class="w3-input" readonly>
	
<input type='text' name = "product_c4"  id = "product_c4" class="w3-input" placeholder="Search ชื่อไทย..."  size="7" OnChange="JavaScript:doCallAjax('product_c4','product_id4','product_name4','unit_name4','waranty4','product_price4');"/> 
...
<td>
<input type='text' name = "product_price4"  id = "product_price4" size="7" class="w3-input"  style="color:black;text-align:right" readonly>
</td>
...
<td style="width:5%;">
<input type='text' name = "waranty4" id = "waranty4"  class="w3-input" style="color:black;text-align:center"  />
</td>
<td style="width:10%;">
<textarea name = "sale_remark4" id = "sale_remark4"  class="w3-input"   ></textarea>
</td>
<td style="width:8%;">
	<input type='checkbox' name = "clear_br4" value="1" id = "clear_br4"  class="w3-input" >
	<input type='text' name = "br_no4" id = "br_no4"  class="w3-input"  >
</td>
...
<input type='text' name = "product_codet5"  id = "product_codet5" class="w3-input" placeholder="Search รหัส" size="7"  OnChange="JavaScript:doCallAjax('product_codet5','product_id5','product_name5','unit_name5','waranty5','product_price5');"/> 
<input type='hidden' name = "h_product_codet5"  id = "h_product_codet5"  class="w3-input" readonly>

<input type='text' name = "product_code5"  id = "product_code5" class="w3-input" placeholder="Search ชื่ออังกฤษ..."  size="7" OnChange="JavaScript:doCallAjax('product_code5','product_id5','product_name5','unit_name5','waranty5','product_price5');"/> 
<input type='hidden' name = "h_product_code5"  id = "h_product_code5"  class="w3-input" readonly>
	
<input type='text' name = "product_c5"  id = "product_c5" class="w3-input" placeholder="Search ชื่อไทย..."  size="7" OnChange="JavaScript:doCallAjax('product_c5','product_id5','product_name5','unit_name5','waranty5','product_price5');"/> 
...
<td>
<input type='text' name = "product_price5"  id = "product_price5"  class="w3-input" size="7" style="color:black;text-align:right" readonly>
</td>
...
<td style="width:5%;">
<input type='text' name = "waranty5" id = "waranty5"  class="w3-input" style="color:black;text-align:center"  />
</td>
<td style="width:10%;">
<textarea name = "sale_remark5" id = "sale_remark5"  class="w3-input"   ></textarea>
</td>
<td style="width:8%;">
	<input type='checkbox' name = "clear_br5" value="1" id = "clear_br5"  class="w3-input" >
	<input type='text' name = "br_no5" id = "br_no5"  class="w3-input"  >
</td>
...
<tr>
<td  style="width:10%;">
<input type='text' name = "product_codet6"  id = "product_codet6" class="w3-input" placeholder="Search รหัส" size="7"  OnChange="JavaScript:doCallAjax('product_codet6','product_id6','product_name6','unit_name6','waranty6','product_price6');"/> 
<input type='hidden' name = "h_product_codet6"  id = "h_product_codet6"  class="w3-input" readonly>

<input type='text' name = "product_code6"  id = "product_code6" size="7" class="w3-input" placeholder="Search ชื่ออังกฤษ..." OnChange="JavaScript:doCallAjax('product_code6','product_id6','product_name6','unit_name6','waranty6','product_price6');"/> 
<input type='hidden' name = "h_product_code6"  id = "h_product_code6"  class="w3-input" readonly>
	
<input type='text' name = "product_c6"  id = "product_c6" size="7" class="w3-input" placeholder="Search ชื่อไทย..." OnChange="JavaScript:doCallAjax('product_c6','product_id6','product_name6','unit_name6','waranty6','product_price6');"/> 
...
<td style="width:8%;">
<input type='text' name = "product_price6"  id = "product_price6" size="7" class="w3-input"  style="color:black;text-align:right" readonly>
</td>
...
<td style="width:5%;">
<input type='text' name = "waranty6" id = "waranty6"  class="w3-input" style="color:black;text-align:center"  />
</td>	
<td style="width:10%;">
<textarea name = "sale_remark6" id = "sale_remark6"  class="w3-input"   ></textarea>
</td>
<td style="width:8%;">
	<input type='checkbox' name = "clear_br6" value="1" id = "clear_br6"  class="w3-input" >
	<input type='text' name = "br_no6" id = "br_no6"  class="w3-input"  >
</td>
...
<input type='text' name = "product_codet7"  id = "product_codet7" class="w3-input" placeholder="Search รหัส" size="7"  OnChange="JavaScript:doCallAjax('product_codet7','product_id7','product_name7','unit_name7','waranty7','product_price7');"/> 
<input type='hidden' name = "h_product_codet7"  id = "h_product_codet7"  class="w3-input" readonly>

<input type='text' name = "product_code7"  id = "product_code7" class="w3-input" placeholder="Search ชื่ออังกฤษ..." size="7" OnChange="JavaScript:doCallAjax('product_code7','product_id7','product_name7','unit_name7','waranty7','product_price7');"/> 
<input type='hidden' name = "h_product_code7"  id = "h_product_code7"  class="w3-input" readonly>
	
<input type='text' name = "product_c7"  id = "product_c7" class="w3-input" placeholder="Search ชื่อไทย..." size="7" OnChange="JavaScript:doCallAjax('product_c7','product_id7','product_name7','unit_name7','waranty7','product_price7');"/> 
...
<td style="width:8%;">
<input type='text' name = "product_price7"  id = "product_price7"  class="w3-input" size="7" style="color:black;text-align:right" readonly>
</td>
...
<td style="width:5%;">
<input type='text' name = "waranty7" id = "waranty7"  class="w3-input" style="color:black;text-align:center"  />
</td>
<td style="width:10%;">
<textarea name = "sale_remark7" id = "sale_remark7"  class="w3-input"   ></textarea>
</td>
<td style="width:8%;">
	<input type='checkbox' name = "clear_br7" value="1" id = "clear_br7"  class="w3-input" >
	<input type='text' name = "br_no7" id = "br_no7"  class="w3-input"  >
</td>
...
<input type='text' name = "product_codet8"  id = "product_codet8" class="w3-input" placeholder="Search รหัส" size="7"  OnChange="JavaScript:doCallAjax('product_codet8','product_id8','product_name8','unit_name8','waranty8','product_price8');"/> 
<input type='hidden' name = "h_product_codet8"  id = "h_product_codet8"  class="w3-input" readonly>

<input type='text' name = "product_code8"  id = "product_code8" class="w3-input" placeholder="Search ชื่ออังกฤษ..."  size="7" OnChange="JavaScript:doCallAjax('product_code8','product_id8','product_name8','unit_name8','waranty8','product_price8');"/> 
<input type='hidden' name = "h_product_code8"  id = "h_product_code8"  class="w3-input" readonly>
	
<input type='text' name = "product_c8"  id = "product_c8" class="w3-input" placeholder="Search ชื่อไทย..."  size="7" OnChange="JavaScript:doCallAjax('product_c8','product_id8','product_name8','unit_name8','waranty8','product_price8');"/> 
...
<td>
<input type='text' name = "product_price8"  id = "product_price8"  class="w3-input" size="7" style="color:black;text-align:right" readonly>
</td>
...
<input type='text' name = "waranty8" id = "waranty8"  class="w3-input" style="color:black;text-align:center"  />
</td>
<td style="width:10%;">
<textarea name = "sale_remark8" id = "sale_remark8"  class="w3-input"   ></textarea>
</td>
<td style="width:8%;">
	<input type='checkbox' name = "clear_br8" value="1" id = "clear_br8"  class="w3-input" >
	<input type='text' name = "br_no8" id = "br_no8"  class="w3-input"  >
</td>
...
<input type='text' name = "product_codet9"  id = "product_codet9" class="w3-input" placeholder="Search รหัส" size="7"  OnChange="JavaScript:doCallAjax('product_codet9','product_id9','product_name9','unit_name9','waranty9','product_price9');"/> 
<input type='hidden' name = "h_product_codet9"  id = "h_product_codet9"  class="w3-input" readonly>

<input type='text' name = "product_code9"  id = "product_code9" class="w3-input" placeholder="Search ชื่ออังกฤษ..."  size="7" OnChange="JavaScript:doCallAjax('product_code9','product_id9','product_name9','unit_name9','waranty9','product_price9');"/> 
<input type='hidden' name = "h_product_code9"  id = "h_product_code9"  class="w3-input" readonly>
	
<input type='text' name = "product_c9"  id = "product_c9" class="w3-input" placeholder="Search ชื่อไทย..."  size="7" OnChange="JavaScript:doCallAjax('product_c9','product_id9','product_name9','unit_name9','waranty9','product_price9');"/> 
...
<td>
<input type='text' name = "product_price9"  id = "product_price9" size="7" class="w3-input"  style="color:black;text-align:right" readonly>
</td>
...
<td style="width:5%;">
<input type='text' name = "waranty9" id = "waranty9"  class="w3-input" style="color:black;text-align:center"  />
</td>
<td style="width:10%;">
<textarea name = "sale_remark9" id = "sale_remark9"  class="w3-input"   ></textarea>
</td>
<td style="width:8%;">
	<input type='checkbox' name = "clear_br9" value="1" id = "clear_br9"  class="w3-input" >
	<input type='text' name = "br_no9" id = "br_no9"  class="w3-input"  >
</td>
...
<input type='text' name = "product_codet10"  id = "product_codet10" class="w3-input" placeholder="Search รหัส" size="7"  OnChange="JavaScript:doCallAjax('product_codet10','product_id10','product_name10','unit_name10','waranty10','product_price10');"/> 
<input type='hidden' name = "h_product_codet10"  id = "h_product_codet10"  class="w3-input" readonly>

<input type='text' name = "product_code10"  id = "product_code10" class="w3-input" placeholder="Search ชื่ออังกฤษ..."  size="7" OnChange="JavaScript:doCallAjax('product_code10','product_id10','product_name10','unit_name10','waranty10','product_price10');"/> 
<input type='hidden' name = "h_product_code10"  id = "h_product_code10"  class="w3-input" readonly>
	
<input type='text' name = "product_c10"  id = "product_c10" class="w3-input" placeholder="Search ชื่อไทย..."  size="7" OnChange="JavaScript:doCallAjax('product_c10','product_id10','product_name10','unit_name10','waranty10','product_price10');"/> 
...
<td>
<input type='text' name = "product_price10"  id = "product_price10"  class="w3-input" size="7" style="color:black;text-align:right" readonly>
</td>
...
<td style="width:5%;">
<input type='text' name = "waranty10" id = "waranty10"  class="w3-input" style="color:black;text-align:center"  />
</td>
<td style="width:10%;">
<textarea name = "sale_remark10" id = "sale_remark10"  class="w3-input"   ></textarea>
</td>
<td style="width:8%;">
	<input type='checkbox' name = "clear_br10" value="1" id = "clear_br10"  class="w3-input" >
	<input type='text' name = "br_no10" id = "br_no10"  class="w3-input"  >
</td>
