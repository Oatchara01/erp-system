...
$save56="Update tb__glu426 SET chang_ckk='1',smp_ref='".$ref_idsmp."' where  id ='".$id."'";
...
(reff_idsmp,product_id,product_code,sale_count,sale_countref,unit_price,sum_amount,sale_remark,sn_old,sn,clear_br,br_no)
values ('".$ref_idsmp."','".$product_id1."','".$product_id1."','".$sale_count1."','".$sale_count1."','".$product_price1."','".$sum_amount1."','".$sale_remark1."','".$sn_old1."','".$sn1."','".$clear_br1."','".$br_no1."')";
