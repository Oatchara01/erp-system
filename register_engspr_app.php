...
date_default_timezone_set("Asia/Bangkok");
		...
		?>
	<form action="approve_sprsup.php" method="post" name="frmMain" enctype="multipart/form-data"  onSubmit="JavaScript:return fncSubmit();" >
...
<div class="w3-half 1">
	...
	<a href="rejected_sprsup.php?ref_id=<?php echo $_GET["ref_id"];?>&sale_code=<?php echo $_SESSION["code"]; ?>" target="_blank" class="w3-button w3-red w3-right"><font color="black">Rejected</font></a>&nbsp;&nbsp;
	
<!--a href="approve_sprsup.php?ref_id=<?php echo $_GET["ref_id"];?>&sale_code=<?php echo $_SESSION["code"]; ?>&engineer=<?php echo $ffirst["engineer"]; ?>" target="_blank" class="w3-button w3-green w3-right"><font color="black">Approve</font></a-->

<input type="submit" name="submit" id="submit" class="w3-button w3-green w3-right" value="Approve"  onclick="window.location='approve_sprsup.php'"  />
...
<a href="report_spr.php?ref_id=<?php echo $_GET["ref_id"];?>" target="_blank" class="w3-button w3-yellow w3-right"><font color="black">Print Preview</font></a>
	...
	<div class="w3-bar">
		...
		<input type="hidden" name="engineer" class="w3-input" value="<?php echo $ffirst["engineer"]; ?>">
	</div>
