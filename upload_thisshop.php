...
<br><br>
<center> 
    <h2><span class="style15">Upload รายการจาก Thisshop </span></h2>
...
<br>
  ...
  <form enctype="multipart/form-data" action="upload_thisshop.php" method="POST">
  <center>
  <br>
  <br>
...

  {
    ...
    if(move_uploaded_file($_FILES['uploaded_file']['tmp_name'], $path)) {
     ...
     echo '	 	 <center>
           ...
           <form action = "import_thisshop.php" method ="post">
