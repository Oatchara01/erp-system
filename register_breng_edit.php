...
<a href="report_loanhosptl1.php?ref_id_br=<?php echo $rs["ref_id_br"];?>" target="_blank" class="w3-button w3-grey w3-right"><font color="Purple">แบบฟอร์มใบยืมใบยืม</font></a><br />
	...
	<form action="register_breng_edit1.php" method="post" name="frmMain" enctype="multipart/form-data">
	<div class="w3-bar">
...
<input type="radio" name="type_breng" value="0" checked='checked' required> ใบยืมลูกค้า (BRNP)
...
<input type="radio" name="type_breng" value="1" checked='checked' required> ใบยืมช่าง (BRES)
		
<?php  }else if($rs["type_breng"]=='2'){ ?>
		
<input type="radio" name="type_breng" value="0"  required> ใบยืมลูกค้า (BRNP)
<input type="radio" name="type_breng" value="1" required> ใบยืมช่าง (BRES)
<input type="radio" name="type_breng" value="2"  checked='checked' required> ใบยืมสินค้าตรวจเช็ค (BREQ)
