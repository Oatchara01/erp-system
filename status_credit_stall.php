...
<div class="w3-container w3-padding-large">
	<div class="w3-panel w3-light-gray"><h4>Status ใบลดหนี้ Stock (ทั้งหมด)</h4></div>
...
$strSQL = "SELECT *  FROM tb_credit_note  where stock_complete != '0' ";
...
if($Keyword !=""){ 
	...
	$strSQL .= ' or credit_no  LIKE "%'.$Keyword.'%"'; 
...
?>
 ...
 echo DateThai($objResult["date_credit"]);
	...
	?><br />
				...
				<td><div align="left">
					<?php
						$strSQL1 ="SELECT access_name FROM (tb_subcredit LEFT JOIN tb_product ON tb_subcredit.product_ID=tb_product.product_id) WHERE ref_creditt = '".$objResult["ref_credit"]."'";
						//echo $strSQL1;
						//exit();
	...
	?><br />
				...
				<a href="register_credinot_seest.php?ref_credit=<?php echo $objResult["ref_credit"];?>&start_date=<?php echo $_GET["start_date"];  ?>&end_date=<?php echo $_GET["end_date"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
...
<?php if($objResult["credit_no"]!=''){ ?>
				...
				<a href="report_credit_st.php?ref_credit=<?php echo $objResult["ref_credit"];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a>
