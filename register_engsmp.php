...
<div class="w3-white w3-container">
	...
	<form action="register_salesmp1.php" method="post" name="frmMain" enctype="multipart/form-data"  onSubmit="JavaScript:return fncSubmit();" >
...
$sql1 = "SELECT product_sn,service_order_no FROM tb_service_orderim where service_order_no = '".$_GET["wo_no"]."'";
...
<?php }else  if($_GET["company"]=='2'){ ?>
		...
		<div class="w3-bar w3-margin-bottom">
			...
			<div class="w3-bar w3-margin-bottom">
ที่อยุ่ :<textarea name="address_name" id="address_name" class="w3-input" style="width:90%;"  required><?php echo $bill_address; ?></textarea>
				<input type="hidden" name="cm_no" id="cm_no" value = "<?php echo $rs1["service_order_no"]; ?>" style="width:30%;" class="w3-input"  required>
</div>
...
<div class="w3-bar w3-margin-bottom">
			ชื่อลูกค้า 
			<input type="text" name="customer_name" id="customer_name"  value="<?php echo $bill_name; ?>" class="w3-input" style="width:90%;"  required>
</div>
...
<?php
 if($_GET["company"]=='1'){ 
		include ('detail_engsmp.php');
	}else{	
	include ('detail_engsmpnb.php');
		}
		?>
