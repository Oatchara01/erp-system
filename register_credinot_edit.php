...
$Num_Rows1 = mysqli_num_rows($objQuery1);
	...
	<form action='register_credinot_edit1.php' method="post" name="frmMain" enctype="multipart/form-data">
	<div class="w3-white">
		...
		<div class="w3-half">
				...
				<div class="w3-half">
					<?php if($rs["send_sup"]=='0' and $rs["send_admin"]=='0'){ ?>
<a href="send_credit_approve1.php?ref_credit=<?php echo $rs["ref_credit"];?>&sale_code=<?php echo $_SESSION["code"]; ?>" target="_blank" class="w3-button w3-grey w3-right"><font color="red">ส่งใบสั่งลดหนี้ให้ SUP อนุมัติ</font></a>&nbsp;&nbsp;
					<?php } ?>
				</div>
			</div>
...
<input type="checkbox" name="status_doc" id="status_doc" value = 'ยกเลิก' checked='checked' class="button4"  >&nbsp;&nbsp; ยกเลิก&nbsp;&nbsp;

<?php }else{ ?>
<input type="checkbox" name="status_doc" id="status_doc" value = 'ยกเลิก'  class="button4"  >&nbsp;&nbsp; ยกเลิก&nbsp;&nbsp;

<?php } ?></p>
หมายเหตุ : </p>
<textarea name="des_doc" id="des_doc"  class="button4" style="width:35%;"  ><?php echo $rs["des_doc"];?> </textarea>
</p>
เขตการขาย : &nbsp;&nbsp;
<input type="text" name="sale_code" id="sale_code" value ="<?php echo $rs["sale_code"];?>" class="button4" style="width:10%;"  >
&nbsp;&nbsp;
ชื่อผู้ขาย : &nbsp;&nbsp;
...
<input type='hidden' name='book_bank' id='book_bank' value ="<?php echo $rs['book_bank']; ?>"  />
<input name="book_bank"  type="file"><a href="credit_no/<?php echo $rs['book_bank']; ?>" target="_blank"><?php echo $rs['book_bank']; ?></a>
...
<?php include ('product_credit1.php')?>
