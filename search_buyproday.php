...
$strSQL = "DELETE FROM tb__buypro_ser ";
$objQuery = mysqli_query($conn,$strSQL);


?>

<form name="frmSearch" method="GET" action="report_buyproday.php">
	<div class="w3-white">
<div class="w3-panel w3-light-gray"><h4>รายงานยอดขายตามกลุ่มสินค้า แยกตามเขตการขาย</h4></div>
