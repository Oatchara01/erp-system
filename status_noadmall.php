...
$strSQL = "SELECT *  FROM no__complete  where  status_doc ='' and send_doc ='1' and send_sup ='0' and type_doc ='4'";
...
<td><div align="left">
<?php 	if($objResult["type_doc"]=='1'){ ?> <font color="blue"> <?php echo "คลังสินค้า";  ?> </font> <br> <?php } ?>
<?php 	if($objResult["type_st1"]=='1'){ echo "สินค้าไม่ครบตาม Order";  ?> <br> <?php } ?>
<?php 	if($objResult["type_st2"]=='1'){ echo "อุปกรณ์ประกอบไม่ครบตาม Order";  ?> <br> <?php } ?>
<?php 	if($objResult["type_doc"]=='2'){ ?> <font color="blue"> <?php echo "วิศวกรรม";  ?>  </font><br> <?php } ?>
<?php 	if($objResult["type_en2"]=='1'){ echo "สินค้าชำรุดไม่สามารถใช้งานได้";  ?> <b><u>เนื่องจาก</u></b> <?php echo $objResult["des_en2"]; ?><br> <?php } ?>
<?php 	if($objResult["type_doc"]=='3'){ ?> <font color="blue"> <?php echo "จัดส่ง";  ?> </font> <br> <?php } ?>
<?php 	if($objResult["cs_nockk"]=='1'){ echo "การจัดส่งไม่สมบูรณ์";  ?> <br> <?php } ?>
<?php 	if($objResult["type_doc"]=='4'){ ?> <font color="blue"> <?php echo "สำนักงาน";  ?>  </font><br> <?php } ?>
<?php 	if($objResult["adm_docckk"]=='1'){ echo "เอกสารไม่ครบ ต้องส่งตามหลัง";  ?> <br> <?php } ?>
<?php 	if($objResult["adm_noprockk"]=='1'){ echo "ลูกค้าเปลี่ยนใจ ไม่รับสินค้า";  ?>  <b><u>เนื่องจาก</u></b> <?php echo $objResult["adm_noprodes"]; ?><br> <?php } ?>
				...
				<?php }else{ ?>
			<td ><?php echo "รอกดส่งผู้ดำเนินการ";?></td>		
				<?php } ?>
				
				<td><a href="register_priveiw.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/preview.jpg" width="23" height="23" border="0" /></a></td>
				<td><a href="form_notcomplete.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a></td>	
