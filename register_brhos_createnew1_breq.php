...
echo "alert('บันทึกข้อมูลของท่านเรียบร้อยแล้ว');window.location='register_brhos_edit_breq.php?ref_id_br=$ref_id_br';";
echo "</script>";
  } else {
   echo "Cannot";
  }
