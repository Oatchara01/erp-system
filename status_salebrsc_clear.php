...
<div class="w3-container w3-padding-large">
	<div class="w3-panel w3-light-grey"><h3>Status ใบฝากขาย (ค้างเคลียร์)</h3></div>
...
$strSQL = "SELECT *  FROM hos__consig  where sale_code LIKE '%EN%' and close_br='0' and status_doc ='Approve'";
}else{
$strSQL = "SELECT *  FROM hos__consig  where sale_code = '".$sale_code."' and close_br='0' and status_doc ='Approve'";	
}
...
?>
 ...
 echo DateThai($objResult["date_save"]);
				...
				<td><div align="left">
					<?php
						$strSQL1 = "SELECT * FROM (hos__subconsig LEFT JOIN tb_product ON hos__subconsig.product_ID=tb_product.product_id) WHERE clear_ckk = '0' and ref_idd = '".$objResult["ref_id"]."' ";
						//echo $strSQL1;
						//exit();
	...
	<td>
	<a href=javascript:if(confirm('!!!ต้องการเคลียร์ใบยืมนี้ใช่หรือไม่')==true){window.location='rister_clearbrsc.php?ref_id=<?php echo $objResult["ref_id"];?>';}><img src="img/sticker.png" width="23" height="23" border="0" /></a>	
	</td>
<?php if($_SESSION['user_type']=='Engineer'){?><td>
	<a href=javascript:if(confirm('!!!ต้องการคืนสินค้าใช่หรือไม่')==true){window.location='rister_clearbrsc_st.php?ref_id=<?php echo $objResult["ref_id"];?>';}><img src="img/sticker.png" width="23" height="23" border="0" /></a>	
	</td> <?php } ?>
