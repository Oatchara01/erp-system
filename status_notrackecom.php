...
<div class="w3-panel w3-light-gray"><h4>Status Order Shopee ไม่มีเลขขนส่ง</h4></div>
...
$strSQL = "SELECT ref_id,select_type_doc,register_date,doc_no,doc_release_date,delivery_contact,approve_complete,ckk_h,bill_vat,select_type_doc,status_vat,print_vat,print_doc,sale_channel,close_mount,billing_name,order_id,cs_remark,order_refer_code   FROM so__main  where order_refer_code ='' and  sale_channel ='12' and cancel_ckk ='0' and approve_complete ='Approve' and employee_name ='SOL92' and doc_no NOT LIKE '%BRN%' and order_id !='' and sr_no =''";
/*and doc_no LIKE '%IV%'*/
