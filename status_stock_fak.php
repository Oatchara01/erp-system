...
$strSQL = "SELECT ref_id,select_type_doc,register_date,doc_no,doc_release_date,delivery_contact,approve_complete,ckk_h,close_mount,printst_ckk   FROM so__main   where ckk_h ='0' and approve_complete = 'Approve' and allwell_ckk ='1' and have_order = '1' and have_product ='0'";
...
<td>
	...
	<a href="register_stock_fak.php?ref_id=<?php echo $objResult["ref_id"];?>&start_date=<?php echo $start_date;  ?>&end_date=<?php echo $end_date;?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
	<?php } ?>
	</td>
