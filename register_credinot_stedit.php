...
คลังสินค้า :&nbsp;
<input type="text" name="stock_name" id="stock_name" value ="<?php echo $rs["stock_name"];?>" class="button4" style="width:12%;"  required> &nbsp;&nbsp;


วันที่ :&nbsp;
<input type="date" name="stock_date" id="stock_date" value ="<?php echo $rs["stock_date"];?>" class="button4" style="width:12%;"  required>
</p>
