...
<div class="w3-container w3-padding-large">
	<div class="w3-panel w3-light-grey"><h3>รายการตรวจเช็คใบยืม (ทั้งหมด)</h3></div>
...
$strSQL = "SELECT DISTINCT ref_id  FROM st__checkbr  where sale_code LIKE '%EN%' ";
}else{
$strSQL = "SELECT DISTINCT ref_id  FROM st__checkbr  where sale_code = '".$sale_code."' ";	
}
...
?>
		<tbody>
			<tr>
				...
				<a href="report_brkangbyareashow.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
