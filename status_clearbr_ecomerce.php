...
<div class="w3-panel w3-light-gray"><h4>Status ใบยืมค้างเคลียร์ E-Commerce</h4></div>
...
$strSQL = "SELECT *  FROM so__main  where doc_no LIKE '%SOL%' and iv_no ='' and cancel_ckk ='0'";
...
<td>
<a href=javascript:if(confirm('!!!ต้องการคืนสินค้าใช่หรือไม่')==true){window.location='register_clear_ecom.php?ref_id=<?php echo $objResult["ref_id"];?>';}><img src="img/sticker.png" width="23" height="23" border="0" /></a>		</td>
