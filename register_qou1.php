...
(ref_id,register_date,type_doc,cus_name,description,payment_dead,set_price,delivery_dead,waranty,cusmail_name,email,remark1,remark2,remark3,remark4,remark5,iv_date,iv_no,add_by,add_date,speck,catalog,picture,remark_ckk,waranty_ckk,type_head,delivery_date,payment_dead_other_wrap)
values
('".$ref_id."','".$register_date."','".$type_doc."','".$cus_name."','".$description."','".$payment_dead."','".$set_price."','".$delivery_dead."','".$waranty."','".$cusmail_name."','".$email."','".$remark1."','".$remark2."','".$remark3."','".$remark4."','".$remark5."','".$iv_date."','".$iv_no."','".$add_by."','".$add_date."','".$_FILES['speck']['name']."','".$_FILES['catalog']['name']."','".$_FILES['picture']['name']."','".$remark_ckk."','".$waranty_ckk."','".$type_head."','".$delivery_date."','".$payment_dead_other_wrap."')";
