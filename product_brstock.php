...
$sql = "SELECT * FROM (hos__subbr LEFT JOIN tb_product ON hos__subbr.product_ID=tb_product.product_id) WHERE ref_idd_br = '".$_GET["ref_id_br"]."' ";
...
<td style="width:15%;"><textarea name = "product_name[]<?php echo $fetch["id"];?>"   id = "product_name[]<?php echo $fetch["id"];?>"  class="w3-input" readonly><?php echo $fetch["sol_name"];?> <?php echo $fetch["sale_remark"];?></textarea></td>	
	
<td style="width:5%;"><input type='text' name = "unit_name[]<?php echo $fetch["id"];?>" value="<?php echo $fetch["unit_name"];?>" id = "unit_name[]<?php echo $fetch["id"];?>"  class="w3-input"    readonly/></td>
