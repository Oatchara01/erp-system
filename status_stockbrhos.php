...
$strSQL = "SELECT *  FROM hos__br  where   status_doc ='Approve'   and stock = ''  ";
...
?>
			...
			<tr>
					...
					<td  bgcolor="#00FF00"><?php echo $objResult["ref_id_br"];?></td>
...
<td  >
				...
				<a href="register_stockbrhos.php?ref_id_br=<?php echo $objResult["ref_id_br"];?>&start_date=<?php echo $_GET["start_date"];  ?>&end_date=<?php echo $_GET["end_date"];?>"><img src="img/create.png" width="23" height="23" border="0" /></a>
												
				</td>
	<td  >
				<?php if($objResult["status_doc"]=='Approve' and $objResult["close_mount"] =='0'){	?> 

				<a href=javascript:if(confirm('!!!ต้องการแกไขข้อมูลรายการสินค้าใช่หรือไม่')==true){window.location='register_stockbrhos_edit.php?ref_id_br=<?php echo $objResult["ref_id_br"];?>&start_date=<?php echo $_GET["start_date"];  ?>&end_date=<?php echo $_GET["end_date"];?>';}><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
				<?php } ?>
				...
				<td bgcolor="#00FF00">
					...
					<td>
					<?php } ?>
<?php if($objResult["send_admin"] =='1' and $objResult["status_doc"]=='Approve'){	if($objResult["company"] =='1' ){				
					?> 
					
				<a href="report_loanhosptl_st.php?ref_id_br=<?php echo $objResult["ref_id_br"];?>&stock=<?php echo $_SESSION['name'];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a>
					<?php }else{ ?>
				<a href="report_loanhosnbm_st.php?ref_id_br=<?php echo $objResult["ref_id_br"];?>&stock=<?php echo $_SESSION['name'];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a>	
				<?php } } ?>
				</td>
