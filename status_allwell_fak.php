...
$strSQL = "SELECT ref_id,select_type_doc,register_date,doc_no,doc_release_date,delivery_contact,approve_complete,sale_remark  FROM so__main  where allwell_ckk = '1' and have_order = '1' and have_product = '0' and cancel_ckk='0'";
...
?>
 ...
 echo DateThai($objResult["register_date"]);
	...
	?><br />
				...
				<td><div align="left"><?php echo $objResult["sale_remark"];?></div></td>
