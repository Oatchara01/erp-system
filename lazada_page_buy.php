...
if (!isset($_GET['key']) || $_GET['key'] !== $secret_key) {
    ...
    $message = "Someone tried to access cron_page.php GET ORDER LAZADA with an incorrect key on " . date("Y-m-d H:i:s");
...
$message = "Cron Job  GET ORDER LAZADA ran successfully on " . date("Y-m-d H:i:s");
$headers = "From: no-reply@yourwebsite.com\r\n" . 
           "MIME-Version: 1.0\r\n" . 
           "Content-Type: text/plain; charset=UTF-8\r\n";
...
$file_to_include = "getorderlzaauto_buy.php";
