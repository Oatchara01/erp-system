...
$save="insert into tb_doc_ptl (doc_no,year_no,mount_no,run_no,description) values ('".$doc_no."','".$year1."','".$mont."','".$nextId."','".$description."')";
...
echo "alert('บันทึกข้อมูลของท่านเรียบร้อยแล้ว');window.location='add_docnoptl.php'";
echo "</script>";
  } else {
   echo "Cannot";
  }
