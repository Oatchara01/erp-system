...
$ingredient29 = $_POST["ingredient29"];
 ...
 //move_uploaded_file($_FILES['img1']['tmp_name'],"review/".iconv("UTF-8", "TIS-620",$_FILES['img1']['name']));
...
(product_id,product_code,product_name,product_sn,product_photo,ingredient1,ingredient2,ingredient3,ingredient4,ingredient5,ingredient6,ingredient7,ingredient8,ingredient9,ingredient10,ingredient11,ingredient12,ingredient13,ingredient14,ingredient15,ingredient16,ingredient17,ingredient18,ingredient19,ingredient20,ingredient21,ingredient22,ingredient23,ingredient24,ingredient25,ingredient26,ingredient27,ingredient28,ingredient29,img1,img2,img3,img4,img5,img6,img7,img8,img9,img10,img11,img12,img13,img14,img15,img16,img17,img18,img19,img20,img21,img22,img23,img24,img25,img26,img27,img28,img29)
values
('".$product_id."','".$product_code."','".$product_name."','".$product_sn."','".$product_photo."','".$ingredient1."','".$ingredient2."','".$ingredient3."','".$ingredient4."','".$ingredient5."','".$ingredient6."','".$ingredient7."','".$ingredient8."','".$ingredient9."','".$ingredient10."','".$ingredient11."','".$ingredient12."','".$ingredient13."','".$ingredient14."','".$ingredient15."','".$ingredient16."','".$ingredient17."','".$ingredient18."','".$ingredient19."','".$ingredient20."','".$ingredient21."','".$ingredient22."','".$ingredient23."','".$ingredient24."','".$ingredient25."','".$ingredient26."','".$ingredient27."','".$ingredient28."','".$ingredient29."','".$img1."','".$img2."','".$img3."','".$img4."','".$img5."','".$img6."','".$img7."','".$img8."','".$img9."','".$img10."','".$img11."','".$img12."','".$img13."','".$img14."','".$img15."','".$img16."','".$img17."','".$img18."','".$img19."','".$img20."','".$img21."','".$img22."','".$img23."','".$img24."','".$img25."','".$img26."','".$img27."','".$img28."','".$img29."')";
...
echo "alert('บันทึกข้อมูลของท่านเรียบร้อยแล้ว');window.location='add_leaflet.php'";
echo "</script>";
  } else {
   echo "Cannot";
  }
