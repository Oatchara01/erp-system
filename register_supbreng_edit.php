...
<a href="send_bradmin.php?ref_id_br=<?php echo $rs["ref_id_br"];?>&sale_code=<?php echo $_SESSION["code"]; ?>" target="_blank" class="w3-button w3-grey w3-right"><font color="red">ส่งใบยืมให้ Admin</font></a>&nbsp;&nbsp;
	
<?php }else if ($rs["type_breng"]=='1' or $rs["type_breng"]=='2'){ ?>	
	
<a href="send_brstock.php?ref_id_br=<?php echo $rs["ref_id_br"];?>&sale_code=<?php echo $_SESSION["code"]; ?>&company=<?php echo $rs["company"];?>&type_breng=<?php echo $rs["type_breng"];?>&iv_no=<?php echo $rs["iv_no"];?>" target="_blank" class="w3-button w3-grey w3-right"><font color="red">ส่งใบยืมให้ Stock</font></a>&nbsp;&nbsp;
<?php }
									 } ?>
...
<a href="report_loanhosptl1.php?ref_id_br=<?php echo $rs["ref_id_br"];?>" target="_blank" class="w3-button w3-grey w3-right"><font color="Purple">แบบฟอร์มใบยืม</font></a><br />
	...
	<form action="register_supbreng_edit1.php" method="post" name="frmMain" enctype="multipart/form-data">
	<div class="w3-bar">
...
<td  style="width:10%;">
<textarea  name = "sn"  id = "sn"   rows="2" class="w3-input" readonly><?php echo $objResult1["sn"]; ?></textarea>
