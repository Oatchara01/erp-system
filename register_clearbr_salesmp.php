...
<div class="w3-container">
	...
	<form action="register_clearbr_salesmp1.php" method="post" name="frmMain" enctype="multipart/form-data"  onSubmit="JavaScript:return fncSubmit();" >
...
$objResult = mysqli_fetch_assoc($objQuery);
	...
	<div class="w3-bar w3-padding-small"></div><!-- bar -->
		...
		?>
<input type="radio" checked='checked' name="type_doc" value = "1">&nbsp; PTL
<input type="radio" name="type_doc"  value="2" >&nbsp; NBM
<?php }else{ ?>

	<input type="radio"  name="type_doc" value = "1">&nbsp; PTL
<input type="radio" name="type_doc" checked='checked' value="2" >&nbsp; NBM
		<?php } ?>
				</div>
		<div class="w3-bar w3-margin-bottom">
			...
			<div class="w3-bar w3-margin-bottom">
ที่อยุ่ :<textarea name="address_name" id="address_name" class="w3-input" style="width:90%;"  required><?php echo $objResult['address'];  ?></textarea>
</div>
</div>
<div class="w3-half 1">
...
<div class="w3-bar w3-margin-bottom">
			ชื่อลูกค้า 
			<input type="text" name="customer_name" id="customer_name" value='<?php echo $objResult['customer'];  ?>' class="w3-input" style="width:90%;"  required>
</div>
...
<div class="w3-bar w3-margin-bottom">
	...
	<div class="w3-bar w3-margin-bottom">
			<input type="checkbox" checked='checked' name="brnp_ckk" value = "1">&nbsp; เคลียร์ยืมเลขที่
			<input type="text" name="brnp_no" id="brnp_no" value='<?php echo $objResult['iv_no'];  ?>' class="w3-input" style="width:90%;"  required>
</div>		
