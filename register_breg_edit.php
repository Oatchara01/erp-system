...
$rs = mysqli_fetch_assoc($qry);
	...
	<form action='register_breg_edit1.php' method="post" name="frmMain" enctype="multipart/form-data" onSubmit="JavaScript:return fncSubmit();" >
...
<div class="w3-white">
		<div class="w3-container w3-padding-large"><!-- main div -->
			...
			<div class="w3-panel w3-light-gray"><div class="w3-half"><h4>ใบขอเบิกอะไหล่จากสินค้าขาย (BREG)</h4></div>
				<div class="w3-half">
		<?php if($_SESSION["type_login"]=='Sale'){ 
					if($rs["send_sup"]=='0'){?>			
<a href="send_supbreg.php?ref_id=<?php echo $rs["ref_id"];?>"  class="w3-button w3-yellow w3-right"><font color="red">ส่งใบยืมให้ Sup อนุมัติ</font></a>&nbsp;&nbsp;
					...
					if($rs["send_dm"]=='0'){?>
					<a href="send_dmbreg.php?ref_id=<?php echo $rs["ref_id"];?>&add_by=<?php echo $rs["add_by"]; ?>&customer_name=<?php echo $rs["customer_name"]; ?>" class="w3-button w3-yellow w3-right"><font color="red">ส่งใบยืมให้ผู้บริหารอนุมัติ</font></a>&nbsp;&nbsp;
					<?php 
										   } } ?>
...
<td style="width:8%;">
<input type='text' name = "sale_count[]<?php echo $objResult1["id_sub1"];?>" id = "sale_count[]<?php echo $objResult1["id_sub1"];?>" value="<?php echo $objResult1["count1"]; ?>" class="w3-input" style="color:black;text-align:center"  />
</td>
...
<td style="width:2%;"><a href="productbreg_delete.php?ref_id=<?php echo $rs["ref_id"];?>&id_sub=<?php echo $objResult1["id_sub1"];?>&code=<?php echo $_SESSION["type_login"]; ?>"><img src="img/false.png" width="16" height="16" border="0" /></a></td>
<?php } ?>
</tr>
	<?php
$i++;
...
<?php
	if($rs["send_dm"]=='0'){
	if($rs["type_doc"]=='1'){
	include ('detail_bregengedit.php');
	}else if($rs["type_doc"]=='2'){
	include ('detail_bregengnb_edit.php');	
	}
	}
	?>
</div>
...
<?php 	if ($rs["send_sup"] =='0'){ ?>	
<td style="width:2%;"><a href="productbreg1_delete.php?ref_id=<?php echo $rs["ref_id"];?>&id_sub=<?php echo $objResult2["id_sub2"];?>&code=<?php echo $_SESSION["type_login"]; ?>"><img src="img/false.png" width="16" height="16" border="0" /></a></td>
<?php } ?>
...
$j++;
	...
	if($rs["send_dm"]=='0'){
	if($rs["type_doc"]=='1'){
	include ('detail_bregeng_edit1.php');
	}else if($rs["type_doc"]=='2'){
	include ('detail_bregengnb_edit1.php');	
	}
	}
	?>
</div>
