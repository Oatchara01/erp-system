...
<div class="w3-panel w3-light-gray"><h4>Status Order Shopee ET ยกเลิก</h4></div>
...
$strSQL = "SELECT ref_id,select_type_doc,register_date,doc_no,doc_release_date,delivery_contact,approve_complete,ckk_h,bill_vat,select_type_doc,status_vat,print_vat,print_doc,sale_channel,close_mount,billing_name,order_id,cs_remark   FROM so__main  where  cancel_ckk ='1' and doc_no LIKE '%ET%' and approve_complete ='Approve' ";
/*and doc_no LIKE '%IV%'*/
