...
<div class="w3-panel w3-light-gray"><h4>Status รวมค้าง IV</h4></div>
...
$strSQL = "SELECT ref_id,select_type_doc,register_date,doc_no,doc_release_date,delivery_contact,approve_complete,ckk_h,bill_vat,select_type_doc,status_vat,print_vat,print_doc,sale_channel,close_mount,billing_name  FROM so__main  where doc_release_date = '0000-00-00' and approve_complete !='Rejected' and have_order = '0' and cancel_ckk='0' and register_date >='2024-01-01'";
/*and doc_no LIKE '%IV%'*/
