...
echo "alert('PO เลขที่ $po_no มีการบันทึกข้อมูลไปแล้วค่ะ');window.location='register_salehos_edit.php?ref_id=$ref_id';";
echo "</script>";
exit();
...
$count2 = ($rs2['sale_count']+$rs22['sale_count']+$rse2["sale_count"]+$rssc2["sale_count"]) - ($count3+$count4+$count5+$count13);
