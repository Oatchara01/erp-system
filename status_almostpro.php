...
<div class="w3-container w3-panel w3-light-gray"><h4>รายการสินค้ายอดนิยมออนไลน์สินค้าคงเหลือต่ำกว่ากำหนด</h4></div>
...
<div class="w3-container">
	<table border="1" width="100%" class="w3-table">
		<thead class="w3-gray">
			...
			<td width="10%">ยอดพร้อมขาย</td>
			<td width="5%">ปิดในแพลตฟอร์มแล้ว</td>
	</thead>
...
<td><?php echo number_format($count_pro7,0)."";?></td>
<td>
<a href=javascript:if(confirm('!!!ปิดสินค้าในส่วนของแพลตฟอร์มเรียบร้อยแล้วใช่หรือไม่')==true){window.location='almostpro_close.php?product_ID=<?php echo $objResult["product_ID"];?>';}><img src="img/create.png" width="23" height="23" border="0" /></a>
</td>				
...
<div class="w3-container w3-panel w3-light-gray"><h4>รายการสินค้ายอดนิยมออนไลน์สินค้าคงเหลือต่ำกว่ากำหนด (ปิดรายการแล้ว)</h4></div>
...
<div class="w3-container">
	<table border="1" width="100%" class="w3-table">
		<thead class="w3-gray">
			...
			<td width="10%">หน่วย</td >
			<td width="10%">ยอดพร้อมขาย</td >
			<td width="5%">ปิดในแพลตฟอร์ม</td>
			<td width="5%">เปิดในแพลตฟอร์ม</td>
	</thead>
...
$strSQL = "SELECT access_code,sol_name,unit_name,product_ID,close_out,close_in  FROM tb_product  WHERE  close_pro ='0' and ecom_ckk='1' and close_out='1'";
...
<td><?php echo $objResult["unit_name"];?></td>
<td><?php echo number_format($count_pro7,0)."";?></td>
<td><?php if($objResult["close_out"]=='1'){ ?><img src="img/success.gif" width="23" height="23" border="0" ><?php } ?></td>	
<td>
<?php if($objResult["close_in"]=='1'){ ?>	
