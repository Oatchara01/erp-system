...
<div class="w3-panel w3-light-gray"><h4>Status ลูกค้ารับเอง</h4></div>
...
$strSQL = "SELECT ref_id,select_type_doc,register_date,doc_no,doc_release_date,delivery_contact,approve_complete,clear_brnp_no  FROM so__main  where allwell_ckk = '1' and doc_no NOT LIKE '%BRNP%' and delivery_type ='3'";
