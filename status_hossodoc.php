...
<div class="w3-container w3-padding-large">
	<div class="w3-panel w3-light-grey"><h3>Status SO (เตรียมเอกสาร)</h3></div>	

<div class="w3-bar w3-quarter">
วันที่ : <input name="start_date" class="w3-input" value="<?php echo isset($_GET['start_date']) ? $_GET['start_date'] : ''; ?>" style="width:90%;" type="date" id="start_date" ></div>
<div class="w3-bar w3-quarter">
ถึง :<input name="end_date" class="w3-input"  value="<?php echo isset($_GET['end_date']) ? $_GET['end_date'] : ''; ?>"  style="width:90%;" type="date" id="end_date" ></div>
...
$strSQL = "SELECT *  FROM hos__so  where status_doc ='Approve' and  head_2 = '1' and iv_no !=''";
