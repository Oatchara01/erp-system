...
$save55="Update  tb_customer set  vip_ckk = '".$vip_ckk."'    where  customer_id = '".$bill_id."'";
...
//echo $rs2['sale_count'] + $rssc2['sale_count'] . "<br>";	
...
$save6="Update  hos__subconsig set  clear_ckk = '1'    where ref_idd = '".$rssc1['ref_id']."' and product_id = '".$product_id_new."'";
$qsave6=mysqli_query($conn,$save6);
...
$objQuery15 = mysqli_query($conn,$strSQL15) or die(mysqli_error());
 ...
 if($qsave){
   echo "<script language=\"JavaScript\">";
echo "alert('บันทึกข้อมูลของท่านเรียบร้อยแล้ว');window.location='register_suphos_approve.php?ref_id=$ref_id';";
echo "</script>";
  } else {
   echo "Cannot";
  }
