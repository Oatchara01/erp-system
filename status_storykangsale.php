...
<div class="w3-panel w3-light-gray"><h4>รายการรับเรื่องจากลูกค้า (ค้าง)</h4></div>
...
$strSQL = "SELECT *  FROM tb_register_story  where summary_sale = '0' and sale_code LIKE '%EN%'";
}else{
$strSQL = "SELECT *  FROM tb_register_story  where summary_sale = '0' and sale_code = '".$sale_code."'";
}
if($start_date !=""){ 
