...
if($sale_code=="S11" or $sale_code=="S12" or $sale_code=="S13" or $sale_code=="S23" or $sale_code=="S24"){
$area ="SS2";
 }else if($sale_code=="S15" or $sale_code=="S16" or $sale_code=="S21" or $sale_code=="S22" or $sale_code=="S14"){
$area ="SS1";
 }else if($sale_code=="SM1" or $sale_code=="MM2"){
$area ="SS3";
  }else if($sale_code=="S31" or $sale_code=="S32" or $sale_code=="MM1" or $sale_code=="(SOL1)" or $sale_code=="(SOL2)" or $sale_code=="(SOL99)" or $sale_code=="SOL3" or $sale_code=="SOL4" or $sale_code=="SOL5" or $sale_code=="SOL6" or $sale_code=="SOL0"){
	
$area ="SS3";	
}else if($sale_code=="EN1" or $sale_code=="EN2" or $sale_code=="EN3" or $sale_code=="EN4" or $sale_code=="EN5" or $sale_code=="EN6" or $sale_code=="EN7" or $sale_code=="EN8" or $sale_code=="EN9" or $sale_code=="EN10" or $sale_code=="EN11" or $sale_code=="EN12" or $sale_code=="EN13" or $sale_code=="EN14"){
$area ="SUP_EN";	
}
...
(ref_id,type_doc,register_date,rental_name,connect_name,start_promis,install_date,rental_address,rental_id,rental_tel,connect_tel,end_promis,des_sale,sale_code,add_date,add_by,install_address,bill_name,bill_tel,bill_address,tax_no,payment,patient_name,emergency_name,emergency_tel,count_m,unit_m,bill_vat,area,delivery_type,delivery_date,delivery_key,bank_name,accbank_name,bank_no,bank_img)
values
('".$ref_id."','".$type_doc."','".$register_date."','".$rental_name."','".$connect_name."','".$start_promis."','".$install_date."','".$rental_address."','".$rental_id."','".$rental_tel."','".$connect_tel."','".$end_promis."','".$des_sale."','".$sale_code."','".$add_date."','".$add_by."','".$install_address."','".$bill_name."','".$bill_tel."','".$bill_address."','".$tax_no."','".$payment."','".$patient_name."','".$emergency_name."','".$emergency_tel."','".$count_m."','".$unit."','".$bill_vat."','".$area."','".$delivery_type."','".$delivery_date."','".$delivery_key."','".$bank_name."','".$accbank_name."','".$bank_no."','".$bank_img."')";

$qsave=mysqli_query($conn,$save);

$save1 = "insert into hos__rental_runiv (ref_idren,date_runiv,sale_area,area) values ('".$ref_id."','".$start_promis."','".$sale_code."','".$area."')";
...
echo "alert('บันทึกข้อมูลของท่านเรียบร้อยแล้ว');window.location='register_salerental_edit.php?ref_id=$ref_id';";
echo "</script>";
  } else {
   echo "Cannot";
  }
