...
$sql = "select * from $table_db  where  ( product_type='สินค้าเช่า' OR product_type='อื่นๆ' )  and type_company = 'NBM' and close_pro ='0' and locate('$product_code_search', $find_field) > 0 order by locate('$product_code_search', $find_field), $find_field limit $pagesize";
