...
$objResult = mysqli_fetch_assoc($objQuery);
	...
	<form action='register_receive_smp1.php' method="post" name="frmMain" enctype="multipart/form-data">
	<div class="w3-white">
...
<div class="w3-bar">
	...
	<?php if ($objResult['type_company']=='1'){
		?>
...
เลขที่ใบยืม :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="iv_no" value = '<?php echo $objResult['smp_no'];?>' class="button4" style="width:30%;" 	></p>
</p>
...
ชื่อลูกค้า  : &nbsp;<input type="text" name="customer_name" class="button4" value = '<?php echo $objResult['customer_name'];?>' style="width:30%;" required> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					ที่อยู่ : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <textarea rows="2" name="customer_address" class="button4" style="width:30%"  ><?php echo $objResult["address_name"]; ?></textarea>
