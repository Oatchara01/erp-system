...
<div class="w3-container w3-bar w3-light-gray w3-margin-bottom"><h4>Status (BR) ด่วน</h4></div>
...
$strSQL = "SELECT *  FROM hos__br  where status_doc !='Rejected' and que_ckk ='1'";
