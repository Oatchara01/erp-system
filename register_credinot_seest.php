...
$Num_Rows1 = mysqli_num_rows($objQuery1);
	...
	<form action='register_credinot_stedit1.php' method="post" name="frmMain" enctype="multipart/form-data">
		<div class="w3-white">
...
<input type="radio" name="company_type" id="company_type" value = '3' checked='checked' class="button4"  >&nbsp;&nbsp; PTL&nbsp;&nbsp;
<input type="radio" name="company_type" id="company_type" value = '4'  class="button4"  >&nbsp;&nbsp; NBM</p>
<?php }else{ ?>
<input type="radio" name="company_type" id="company_type" value = '3'  class="button4"  >&nbsp;&nbsp; PTL&nbsp;&nbsp;
...
<input type="radio" name="ttype_doc" id="ttype_doc" value = '1'  class="button4"  >&nbsp;&nbsp; คืนสืนค้า&nbsp;&nbsp;
<input type="radio" name="ttype_doc" id="ttype_doc" value = '2' checked='checked' class="button4"  >&nbsp;&nbsp; ส่วนลด&nbsp;&nbsp;
...
ผู้รับคืนสินค้า :&nbsp;
<input type="text" name="receive_name" id="receive_name" value ="<?php echo $rs["receive_name"];?>" class="button4" style="width:12%;"  > &nbsp;&nbsp;


วันที่ :&nbsp;
<input type="date" name="date_receive" id="date_receive" value ="<?php echo $rs["date_receive"];?>" class="button4" style="width:12%;"  >
</p>
...
<?php if($rs["type_return_ckk"]=='1'){ ?>

<input type="checkbox" name="type_return_ckk" id="type_return_ckk" checked = 'checked' value ='1'  class="button4"  >&nbsp;&nbsp; ชำระคืนค่าสินโดย :&nbsp;&nbsp;
<?php }else{ ?>
<input type="checkbox" name="type_return_ckk" id="type_return_ckk"  value ='1'  class="button4"  >&nbsp;&nbsp; ชำระคืนค่าสินโดย :&nbsp;&nbsp;

	<?php } ?>


<input type="text" name="type_return_no" id="type_return_no" value ="<?php echo $rs["type_return_no"];?>" class="button4" style="width:12%;"  >
</p>

<?php if($rs["dis_credit"]=='1'){ ?>

<input type="checkbox" name="dis_credit" id="dis_credit"  value ='1' checked = 'checked'  class="button4"  >&nbsp;&nbsp; ลดหนี้&nbsp;&nbsp;
<?php }else{ ?>
...
&nbsp;&nbsp; ได้รับสินค้าข้างต้นคืนคลังสินค้าแล้วโดยสภาพสินค้า</p>

&nbsp;&nbsp;&nbsp;&nbsp;
<?php 

if($rs["stock_complete"]=='1'){ ?>
...
<input type="radio" name="wait_product" id="wait_product" value = '1' class="button4"  >&nbsp;&nbsp; รอสินค้า&nbsp;&nbsp;

<?php }else if($rs["stock_complete"]=='2'){ ?>
...
<input type="radio" name="wait_product" id="wait_product" value = '1' class="button4"  >&nbsp;&nbsp; รอสินค้า&nbsp;&nbsp;
	...
	<?php }else  if($rs["wait_product"]=='1'){ ?>
<input type="radio" name="stock_complete" id="stock_complete" value = '1' class="button4"  >&nbsp;&nbsp; สมบูรณ์&nbsp;&nbsp;
<input type="radio" name="stock_complete" id="stock_complete" value = '2' class="button4"  >&nbsp;&nbsp; ไม่สมบูรณ์&nbsp;&nbsp;
<input type="radio" name="wait_product" id="wait_product" value = '1' checked='checked' class="button4"  >&nbsp;&nbsp; รอสินค้า&nbsp;&nbsp;
...
&nbsp;&nbsp;หมายเหตุ :&nbsp;
<input type="text" name="stock_des" id="stock_des" value ="<?php echo $rs["stock_des"];?>" class="button4" style="width:20%;"  > &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;



คลังสินค้า :&nbsp;
<input type="text" name="stock_name" id="stock_name" value ="<?php echo $rs["stock_name"];?>" class="button4" style="width:12%;"  > &nbsp;&nbsp;


วันที่ :&nbsp;
<input type="date" name="stock_date" id="stock_date" value ="<?php echo $rs["stock_date"];?>" class="button4" style="width:12%;"  >
</p>
<?php if($rs["warraty_ckk"]=='1'){ ?>
