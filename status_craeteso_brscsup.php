...
<div class="w3-panel w3-light-grey"><h3>Status ใบยืมฝากขายค้างเคลียร์ (AWL)</h3></div>
...
<div class="w3-bar w3-quarter">
รหัสสินค้า :
<input type='text' name = "product_codet" style="width:90%;" value="<?php echo $product_codet = isset($_POST['product_codet']) ? $_POST['product_codet'] : ''; ?>" id = "product_codet" class="button4" placeholder="Search รหัสสินค้า" style="width:90%;" > 


</div>
<div class="w3-bar w3-quarter">
ชื่อสินค้า :
<input type='text' name = "product_c" style="width:90%;" value="<?php echo $product_c = isset($_POST['product_c']) ? $_POST['product_c'] : ''; ?>" id = "product_c" class="button4" placeholder="Search ชื่อสินค้า" style="width:90%;"> 
...
$strSQL = "SELECT ref_id,iv_no,iv_date,customer,sale_code,status_doc,sale,date_save  FROM hos__consig where  close_br ='0' and status_doc ='Approve' and company='1' $sddd";	
