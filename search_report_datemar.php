...
<form name="frmSearch" method="GET" action="report_datemar.php">
<div class="w3-white">
<div class="w3-container w3-padding-large">
<div class="w3-panel w3-light-gray"><h4>รายงานสรุปรายการสินค้า</h4></div>
...
<select name="sale_channel" id="sale_channel" class="w3-select" onchange="showUser(this.value)">
				...
				<?php
					$sqlchannel = "select * from tb_salechannel where ckk ='1' order by salechannel_ID ";
