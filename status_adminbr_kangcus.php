...
<div class="w3-container w3-bar w3-light-gray w3-margin-bottom"><h4>Status (BR) ค้าง ID ลูกค้า</h4></div>
...
$strSQL = "SELECT *  FROM hos__br  where status_doc ='Approve' and customer_id ='0' ";
