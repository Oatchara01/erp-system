...
function doCallAjax1(bill_id,customer_name,customer_tel,address_name) {
HttPRequest = false;
...
<div class="w3-container w3-padding-large">
	...
	<form action="register_allwellsmp_createnew1.php" method="post" name="frmMain" enctype="multipart/form-data">
	<div class="w3-bar">
