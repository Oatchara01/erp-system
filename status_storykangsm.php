...
<div class="w3-panel w3-light-gray"><h4>รายการรับเรื่องจากลูกค้า (รอใส่เขตการขาย)</h4></div>
...
$strSQL = "SELECT *  FROM tb_register_story  where send_admin = '1' and sale_code = ''";
...
<td><a href="register_story_edit.php?id_story=<?php echo $objResult["id_story"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a></td>
