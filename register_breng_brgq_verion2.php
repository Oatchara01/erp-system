...
<?php
$strSQL_po = "SELECT DISTINCT po_no FROM in__main  ORDER BY po_no DESC ";
...
if($num_cpny == 1){
?>
	<option value="register_breng_brgq_verion2.php?po_no=<?=$objResult_po['po_no'];?>"><?=$objResult_po['po_no'];?></option>
<?php 
} // num_cpny
} // while
 ?>
...
$num0 = 1;
	$strSQL_item01 = "SELECT * FROM  in__sbmain  WHERE ref_idd = '".$objResult_po01['ref_id']."' ";
