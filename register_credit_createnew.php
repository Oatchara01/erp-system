...
$nextId = $yearMonth.$maxId1;
	...
	<form action='register_credit_createnew1.php' method="post" name="frmMain" enctype="multipart/form-data">
	<div class="w3-white">
...
<input type="radio" name="ttype_doc" id="stock_complete" value = '1' checked='checked' class="button4"  >&nbsp;&nbsp; สมบูรณ์&nbsp;&nbsp;
<input type="radio" name="ttype_doc" id="stock_complete" value = '2' class="button4"  >&nbsp;&nbsp; ไม่สมบูรณ์&nbsp;&nbsp;

<?php }else if($rs["ttype_doc"]=='2'){ ?>
<input type="radio" name="ttype_doc" id="stock_complete" value = '1'  class="button4"  >&nbsp;&nbsp; สมบูรณ์&nbsp;&nbsp;
<input type="radio" name="ttype_doc" id="stock_complete" value = '2' checked='checked' class="button4"  >&nbsp;&nbsp; ไม่สมบูรณ์&nbsp;&nbsp;
