...
?>	
	...
	<form action='register_story_edit1.php' method="post" name="frmMain" enctype="multipart/form-data">
		<div class="w3-white">
		<div class="w3-container w3-padding-large"><!-- main div -->
			<div class="w3-panel w3-light-gray">
				...
				<?php if($objResult["send_sale"]=='0'){ ?>
				<a href="send_storysale.php?id_story=<?php echo $objResult["id_story"];?>&sale_code=<?php echo $objResult["sale_code"]; ?>&customer_name=<?php echo $objResult["customer_name"]; ?>" target="_blank" class="w3-button w3-grey w3-right"><font color="red">ส่งเรื่องให้ Sale</font></a>
				<?php } ?>
				<?php if($objResult["send_admin"]=='0' and $objResult["sale_code"]==''){ ?>
				<a href="send_storyadmin.php?id_story=<?php echo $objResult["id_story"];?>&customer_name=<?php echo $objResult["customer_name"]; ?>" target="_blank" class="w3-button w3-grey w3-right"><font color="black">ส่งเรื่องให้ Admin</font></a>
				<?php } ?>
...
<textarea type='text' name = "remark_sale"  id = "remark_sale" class="button4"  style="width:25%;" readonly><?php echo $objResult["remark_sale"]; ?></textarea>
