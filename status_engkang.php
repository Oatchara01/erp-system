...
<div class="w3-container w3-padding-large"><!-- main div -->
			<div class="w3-panel w3-light-gray"><h4>รายการรับเรื่องจากลูกค้าของช่าง (ค้าง)</h4>
			</div>
<div class="w3-half">	
...
<div class="w3-bar w3-quarter w3-third">
โรงพยาบาล : <input name="Keyword" class="w3-input" style="width:90%;" type="text" id="Keyword" value="<?php echo $Keyword = isset($_GET['Keyword']) ? $_GET['Keyword'] : '';?>"></div>
...
$strSQL = "SELECT *  FROM tb_register_eng  where send_eng='1' and summary_adm='0'";
...
?>
		<tbody>
			...
			<td><?php echo $objResult["ref_id"];?></td>	
				...
				<td><?php
 echo DateThai($objResult["datesend_eng"]);
					?></td>
				<td><?php echo substr($objResult["datesend_eng"], 10, 10);?></td>
...
<td>
				<a href="register_engkang.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
