...
<div class="w3-panel w3-light-grey"><h3>รายการใบยืมค้างเคลียร์ BREQ</h3></div>
...
if($emid=='SS1'){
$sddd = " and sale_code !='S11'  and sale_code !='S12' and sale_code !='S13'  and sale_code !='S17'  and sale_code !='S23'  and sale_code !='S24'  and sale_code !='S31' and sale_code !='SM1' and sale_code !='MM1' and sale_code !='MM2' and sale_code !='S32' and sale_code NOT LIKE '%EN%' and sale_code NOT LIKE '%M%' and sale_code NOT LIKE '%H%' and sale_code NOT LIKE '%I%'";
	
}else if($emid=='SS2'){
$sddd = " and sale_code !='S14'  and sale_code !='S15' and sale_code !='S16'  and sale_code !='S21'  and sale_code !='S22' and sale_code !='S31' and sale_code !='SM1' and sale_code !='MM1'  and sale_code !='MM2' and sale_code !='S32' and sale_code NOT LIKE '%EN%' and sale_code NOT LIKE '%M%' and sale_code NOT LIKE '%H%' and sale_code NOT LIKE '%I%'";	
}else if($emid=='SS3'){
$sddd = " and sale_code !='S11'  and sale_code !='S12' and sale_code !='S13'  and sale_code !='S17'  and sale_code !='S23'  and sale_code !='S24' and sale_code !='S14'  and sale_code !='S15' and sale_code !='S16'  and sale_code !='S21' and sale_code !='S22' and  sale_code NOT LIKE '%EN%'  and sale_code NOT LIKE '%H%' and sale_code NOT LIKE '%I%'";	
}else if($emid=='SUP_EN'){
...
//and send_sup = '1' 
// $strSQL = "SELECT *  FROM in__br  where  status_doc ='Approve' and close_br = '1' $sddd"; //แบ่งเขต
// $strSQL = "SELECT *  FROM in__br  where  status_doc ='Approve' and close_br = '1' "; // ไม่แบ่งเขต
$strSQL = "SELECT *  FROM in__br  where  status_doc ='Approve'  "; // ไม่จำเป็นต้องเช็คครบ
...
// echo $strSQL;
// SELECT * FROM in__br where status_doc ='Approve' order by id DESC LIMIT 0 , 20
?>
...
$strSQL_count = "SELECT *,(count - return_product) as return_product_s FROM in__subbr where `ref_idd_br` = '".$objResult["ref_id_br"]."' HAVING return_product_s > 0 ";
$objQuery_count = mysqli_query($conn,$strSQL_count);
$objResult_count = mysqli_fetch_array($objQuery_count);

// $strSQL21 = "SELECT * FROM in__subbr WHERE clear_ckk = '0' and ref_idd_br = '".$objResult["ref_id_br"]."'";
...
// $save="Update  in__br set  close_br = '1' where ref_id_br = '".$objResult["ref_id_br"]."'";
// $qsave=mysqli_query($conn,$save);
	
// }	
if($objResult_count['return_product_s'] > 0){
?>
...
<td>
<a href=javascript:if(confirm('!!!ต้องการคืนสินค้าใช่หรือไม่')==true){window.location='rister_clearbrpn_st_breq.php?ref_id_br=<?php echo $objResult["ref_id_br"];?>';}><img src="img/sticker.png" width="23" height="23" border="0" /></a>	
</td>
