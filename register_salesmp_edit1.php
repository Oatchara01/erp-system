...
smp_date = '".$smp_date."',address_name ='".$address_name."',customer_name ='".$customer_name."',comment_sale = '".$comment_sale."',delivery_type = '".$delivery_type."',delivery_date='".$delivery_date."',date_send_key='".$date_send_key."',brnp_ckk='".$brnp_ckk."',brnp_no='".$brnp_no."',up_img1='".$up_img1."',up_img2='".$up_img2."',up_img3='".$up_img3."',customer_tel='".$customer_tel."'  where ref_idsmp = '".$ref_idsmp."'";
...
$sql3 = "SELECT sum(sale_count) as count3   FROM   (hos__spr LEFT JOIN hos__subspr ON hos__spr.ref_id=hos__subspr.ref_idd)   where  product_id = '".$product_id_new."' and clear_br = '1' and clear_ivno ='".$br_no_new."' and status_doc ='Approve'";
$qry3 = mysqli_query($conn,$sql3) or die(mysqli_error());
$rs3 = mysqli_fetch_array($qry3);
		
$sql13 = "SELECT sum(count) as count3   FROM   (hos__so LEFT JOIN hos__subso ON hos__so.ref_id=hos__subso.ref_idd)   where  product_id = '".$product_id_new."' and clear_br = '1' and clear_ivno ='".$br_no_new."' and status_doc ='Approve'";
...
$strSQL1 = "Update  hos__subsmp set  reff_idsmp ='".$ref_idsmp."' ,product_id = '".$product_id_new."',product_code = '".$product_id_new."',sale_count ='".$sale_count_new."',sale_countref ='".$sale_count_new."',unit_price = '".$product_price_new."',sum_amount = '".$sum_amount_new."',waranty = '".$waranty_new."',sale_remark = '".$sale_remarkk_new."',clear_br='".$clear_br_new."',br_no='".$br_no_new."',sn='".$sn_new."'   where subsmp_id = '".$id_new."'";
...
$strSQL1 = "insert into hos__subsmp
(reff_idsmp,product_id,product_code,sale_count,sale_countref,unit_price,sum_amount,sale_remark,clear_br,br_no)
values ('".$ref_idsmp."','".$id_product9."','".$id_product9."','".$unit9."','".$unit9."','0.00','0.00','".$sale_remark6."','".$clear_br6."','".$br_no7."')";
$objQuery1 = mysqli_query($conn,$strSQL1);	
