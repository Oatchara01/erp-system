...
$objResult = mysqli_fetch_assoc($objQuery);
	...
	<form action='rister_clearbrpn_adm1.php' method="post" name="frmMain" enctype="multipart/form-data" onSubmit="JavaScript:return fncSubmit();" >
...
<?php if ($objResult['company']=='1'){
		?>
<input type="radio" checked='checked' name="type_doc" value = "3">&nbsp;ใบสั่งขาย ALL
<input type="radio" name="type_doc"  value="4" >&nbsp;ใบสั่งขาย NBM
<?php }else{ ?>

	<input type="radio"  name="type_doc" value = "3">&nbsp;ใบสั่งขาย ALL
...
<input type='text' name = "bill_id" value="<?php echo $objResult["customer_id"]; ?>"  id = "bill_id" class="button4" placeholder="Search ชื่อลูกค้า..."  style="width:30%;" OnChange="JavaScript:doCallAjax1('bill_id','bill_name','bill_address','bill_tel','tax_id');"/> 
...
<input type='text' name = "bill_name" value="<?php echo $objResult["customer"]; ?>"  id = "bill_name" style="width:30%;" class="button4" readonly>
				</p>
			
					ที่อยู่ที่ใช้ในการออกบิล : &nbsp;
					
					<textarea  name = "bill_address"  id = "bill_address" style="width:30%;" rows="2" class="button4" readonly><?php echo $objResult["address"]; ?></textarea>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div id="pd" class="w3-container city1" >
	...
	<?php include ('product_rister.php') ;

 include ('product_clearadm.php');
