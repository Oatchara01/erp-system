...
<form action="register_supsmp_edit1.php" method="post" name="frmMain" enctype="multipart/form-data">
...
<a href="sample_rejected1.php?ref_idsmp=<?php echo $_GET["ref_idsmp"]; ?>" target="_blank" class="w3-button w3-red w3-right"><font color="black">ยกเลิกเอกสาร</font></a>&nbsp;&nbsp;
<?php }
	if($ffirst['send_stock']=='0' or $ffirst['send_dm']=='0'){
	?>
