...
$des_productunit = $_POST["des_productunit"];	
...
$date = explode('-' , $_POST["promis_date"] );	
$year = $date[0];
$mont = $date[1];
...
$sql1 = "SELECT doc_no FROM tb_product_checklist where ref_id='".$ref_id."'";
$qry1 = mysqli_query($conn,$sql1) or die(mysqli_error());
$rs1 = mysqli_fetch_assoc($qry1);
	
$strSQL292="insert into   tb_register_data (IV_number,date_inv,company,customer_name,employee_name,ref_id) values ('".$promis_no."','".$start_promis."','ออลล์เวล ไลฟ์ บจก.','".$bill_name."','".$add_by."','".$ref_id."')";
$objQuery292 = mysqli_query($code,$strSQL292);		

	
$strSQL293="insert into   tb_register_data (IV_number,date_inv,company,customer_name,employee_name,ref_id) values ('".$rs1["doc_no"]."','".$start_promis."','ออลล์เวล ไลฟ์ บจก.','".$bill_name."','".$add_by."','".$ref_id."')";
$objQuery293 = mysqli_query($code,$strSQL293);			
	
	
$save3="UPDATE hos__rental SET send_acc='2' where ref_id='".$ref_id."' ";
...
$strSQL = "Update   hos__subrental set count='".$sale_count_new."',price='".$product_price_new."',amount='".$sum_amount_new."',remark_sale='".$sale_remarkk_new."',sn_number='".$sn_number_new."'  Where id_sub = '$id_new' ";
...
(ref_idd,product_id,product_code,count,sn_number,price,amount,remark_sale)
values ('".$ref_id."','".$product_id6."','".$product_id6."','".$sale_count6."','".$sn_number6."','".$product_price6."','".$sum_amount6."','".$sale_remarkk6."')";
...
(ref_idd,product_id,product_code,count,sn_number,price,amount,remark_sale)
values ('".$ref_id."','".$product_id7."','".$product_id7."','".$sale_count7."','".$sn_number7."','".$product_price7."','".$sum_amount7."','".$sale_remarkk7."')";
...
(ref_idd,product_id,product_code,count,sn_number,price,amount,remark_sale)
values ('".$ref_id."','".$product_id8."','".$product_id8."','".$sale_count8."','".$sn_number8."','".$product_price8."','".$sum_amount8."','".$sale_remarkk8."')";
...
(ref_idd,product_id,product_code,count,sn_number,price,amount,remark_sale)
values ('".$ref_id."','".$product_id9."','".$product_id9."','".$sale_count9."','".$sn_number9."','".$product_price9."','".$sum_amount9."','".$sale_remarkk9."')";
...
(ref_idd,product_id,product_code,count,sn_number,price,amount,remark_sale)
values ('".$ref_id."','".$product_id10."','".$product_id10."','".$sale_count10."','".$sn_number10."','".$product_price10."','".$sum_amount10."','".$sale_remarkk10."')";
...
echo "alert('บันทึกข้อมูลของท่านเรียบร้อยแล้ว');window.location='register_adminrental_edit.php?ref_id=$ref_id';";
echo "</script>";
  } else {
   echo "Cannot";
  }
