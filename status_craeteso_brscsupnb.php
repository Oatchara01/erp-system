...
<div class="w3-panel w3-light-grey"><h3>Status ใบยืมฝากขายค้างเคลียร์ (NBM)</h3></div>
...
<input type="submit" class="w3-button w3-teal" value="Search"></div>
 ...
 <center>
		  <input type="button" name ="Submit" value="เปิดใบสั่งขาย" class = "w3-button w3-purple" onClick="this.form.action='register_suphos_brscany.php'; submit()">
		</center><br>
<?php	
...
$strSQL = "SELECT ref_id,iv_no,iv_date,customer,sale_code,status_doc,sale,date_save  FROM hos__consig where  close_br ='0' and status_doc ='Approve' and company='2' $sddd";	
