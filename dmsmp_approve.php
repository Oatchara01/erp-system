...
<div class="w3-white w3-container">
 ...
 <input type="button" name ="Submit" value="Rejected" class = "w3-button w3-red w3-right" onClick="this.form.action='dm_rejected.php'; submit()">

 <input type="button" name ="Submit" value="Approve" class = "w3-button w3-green w3-right" onClick="this.form.action='dm_approve.php'; submit()">
...
<div class="w3-bar w3-margin-bottom">
			Comment ผู้บริหาร :&nbsp;
			<textarea name="comment_dm" id="comment_dm" class="w3-input" style="width:90%;"  required><?php echo $ffirst['comment_dm']; ?></textarea>
</div>
...
<div class="w3-bar w3-margin-bottom">
			Comment Sale :&nbsp;
			<textarea name="comment_sale" id="comment_sale" class="w3-input" style="width:90%;"  ><?php echo $ffirst['comment_sale']; ?></textarea>
</div>
...
<td style="width:5%;">
<input type='text' name = "clear_br[]<?php echo $objResult1["subsmp_id"]; ?>"  id = "clear_br[]<?php echo $objResult1["subsmp_id"]; ?>" value="<?php echo $objResult1["clear_br"];?>" class="w3-input"  style="color:black;text-align:center" />
	<input type='text' name = "br_no[]<?php echo $objResult1["subsmp_id"]; ?>"  id = "br_no[]<?php echo $objResult1["subsmp_id"]; ?>" value="<?php echo $objResult1["br_no"];?>" class="w3-input"  style="color:black;text-align:center" />
</td >
...
<input type="button" name ="Submit" value="บันทึกข้อมูล" class = "w3-button w3-green" onClick="this.form.action='dmsmp_approve1.php'; submit()">
	</center><br>
	</div>
	</form>
</div>
