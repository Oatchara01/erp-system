...
<div  class="w3-white w3-container">
	...
	<form action="register_allwellchange1.php" method="post" name="frmMain" enctype="multipart/form-data" 
...
if(document.frmMain.province_name.value == ""){
	...
	<div class="w3-half 1">
		...
		<div class="w3-bar w3-margin-bottom">
		ชื่อพนักงาน:
	<?php if ($_SESSION['name']=='วันทนีย์') { ?> 
	<input type="text" name="sale_code" id="sale_code" value="(SOL99)" class="w3-input" style="width:90%;"  readonly>		
			<?php }else{ ?>
...
<input name="slip5"  type="file">
		...
		<div class="w3-bar w3-margin-bottom w3-half">
			...
			<div class="w3-panel"><input type="radio"  name="objective" value="1" id="objective" required> แลกเปลี่ยนสินค้าตามใบงานบริการเลขที่
...
make_autocom("customer_id","customer_id");
        </script> */?>
