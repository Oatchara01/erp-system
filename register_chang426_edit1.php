...
$slip1 = $_POST["img_upsn_1"];	
}
	
	
$save="Update  hos__smp set
smp_date = '".$smp_date."',address_name ='".$address_name."',customer_name ='".$customer_name."',comment_sale = '".$comment_sale."',sup_name = '".$sup_name."',sale_code = '".$sale_code."',comment_sup='".$comment_sup."',delivery_date='".$delivery_date."',date_send_key='".$date_send_key."',brnp_no='".$brnp_no."',brnp_ckk='".$brnp_ckk."',img_upsn='".$slip1."',crm_ref='".$crm_ref."',crm_ckk='".$crm_ckk."',delivery_type='".$delivery_type."',order_no='".$order_no."',ref_idnew='".$ref_idnew."'  where ref_idsmp = '".$ref_idsmp."'";
 ...
 foreach($id as $key =>$value)
	{
		...
		$sn_old_new = $sn_old[$key];
	    $clear_br_new = $clear_br[$key];
	    $br_no_new = $br_no[$key];
	    $sn_new = $sn[$key];
	    $sn_out_new = $sn_out[$key];
...
$sql11 = "SELECT ref_id   FROM   so__main   where  doc_no = '".$br_no_new."' and approve_complete = 'Approve'";
$qry11 = mysqli_query($conn,$sql11) or die(mysqli_error());
$rs11 = mysqli_fetch_assoc($qry11);

	
$sql22 = "SELECT sum(sale_count) as sale_count   FROM   so__submain   where  ref_idd = '".$rs11['ref_id']."' and product_id = '".$product_id_new."'";
...
$save6="Update  so__submain set  clear_ckk = '1'    where ref_idd = '".$rs11['ref_id']."' and product_id = '".$product_id_new."'";
$qsave6=mysqli_query($conn,$save6);	
...
$strSQL1 = "Update  hos__subsmp set  reff_idsmp ='".$ref_idsmp."' ,product_id = '".$product_id_new."',product_code = '".$product_id_new."',sale_count ='".$sale_count_new."',sale_countref ='".$sale_count_new."',unit_price = '".$product_price_new."',sum_amount = '".$sum_amount_new."',sale_remark ='".$sale_remark_new."',clear_br = '".$clear_br_new."',br_no ='".$br_no_new."',sn='".$sn_new."',sn_old='".$sn_old_new."',sn_out='".$sn_out_new."'   where subsmp_id = '".$id_new."'";
