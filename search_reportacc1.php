...
<form name="frmSearch" method="GET" action="report_acc1.php">
<div class ="w3-white">
...
if($_GET["payment"] == $objResuut5["credit_id"])
{
$sel = "selected";
}
else
...
?>
<option   value="<?php echo $objResuut5['credit_id']; ?>"<?php echo $sel;?>> <?php echo $objResuut5['credit_name']; ?></option>
<?php } ?>
</select>
</div>
