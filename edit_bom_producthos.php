...
<div class="w3-panel w3-light-gray"><h4>EDIT : PRODUCT BOM HOSPITAL</h4></div>

<?php
		$strSQL = "SELECT *  FROM tb_product_bomhos WHERE bom_id = '".$_GET["bom_id"]."' ";
...
รหัสสินค้า
<input name="bom_code" value="<?php echo $objResult["bom_code"]; ?>" class="w3-input" >


</div><div class="w3-container w3-third">
ชื่อสินค้า
<input name="bom_name" value="<?php echo $objResult["bom_name"]; ?>" class="w3-input" >
</div><div class="w3-container w3-third">
หน่วย
<input name="unit_name" value="<?php echo $objResult["unit_name"]; ?>" class="w3-input" >
</div>


<div class="w3-container w3-third">
<?php
		$strSQL1 = "SELECT *  FROM tb_product WHERE Product_ID = '".$objResult["product_id1"]."' ";
...
ID สินค้า 1
<input name="id_product1" value="<?php echo $objResult["product_id1"]; ?>" class="w3-input" placeholder="Search ชื่อสินค้า...">
...
<div class="w3-container w3-third">
<?php
		$strSQL2 = "SELECT *  FROM tb_product WHERE Product_ID = '".$objResult["product_id2"]."' ";
...
<input name="id_product2" value="<?php echo $objResult["product_id2"]; ?>" class="w3-input" placeholder="Search ชื่อสินค้า...">
...
<div class="w3-container w3-third">
<?php
		$strSQL3 = "SELECT *  FROM tb_product WHERE Product_ID = '".$objResult["product_id3"]."' ";
	...
	?>
ID สินค้า 3
<input name="id_product3" value="<?php echo $objResult["product_id3"]; ?>" class="w3-input" placeholder="Search ชื่อสินค้า...">
...
<input type = 'hidden' name="bom_id" value="<?php echo $objResult["bom_id"]; ?>" class="w3-input" >
</div>
	
<div class="w3-container w3-third">
<?php
		$strSQL4 = "SELECT *  FROM tb_product WHERE Product_ID = '".$objResult["product_id4"]."' ";
	...
	?>
ID สินค้า 4
<input name="id_product4" class="w3-input" value="<?php echo $objResult["product_id4"]; ?>" placeholder="Search ชื่อสินค้า...">
...
<br>
<center>
		  <input type="button" name ="Submit" value="บันทึก" class = "button button4" onClick="this.form.action='edit_bom_producthos1.php'; submit()">
</center>
