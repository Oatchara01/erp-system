...
$strSQL = "SELECT order_id,cs_remark FROM so__main WHERE sale_channel ='12' and order_refer_code='' and register_date>='2026-05-01' and register_date <='2026-05-30'  and  cs_remark NOT LIKE '%Instant%' and pre_ckk='0' and doc_no !='' and cancel_ckk='0'";
...
//รอเปิด
/*$strSQL = "SELECT order_id, ref_id FROM so__main WHERE sale_channel='12' AND ref_id >='633138' AND ref_id <='633138' "; 
$objQuery = mysqli_query($conn, $strSQL) or die("Error Query [$strSQL]");
...
$strSQL = "SELECT order_id FROM so__main WHERE sale_channel='12'  AND ref_id >='633138' AND ref_id <='633138' ";
