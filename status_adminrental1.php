...
<div class="w3-panel w3-light-gray"><h4>Status ใบสั่งเช่า ค้างเลขที่สัญญา</h4></div>
...
$strSQL = "SELECT *  FROM hos__rental  where send_admin='1' ";	
...
<div class="w3-container">
	<table border="1" width="100%" class="w3-table">
		<thead class="w3-gray">
			...
			<th width="8%">วันที่สัญญา</th>
			<th width="8%">วันที่ครบสัญญา</th>
...
?>
		<tbody>
			<tr>
				...
				<td><a href="promis_from.php?ref_id=<?php echo $objResult["ref_id"];?>" target="_blank" class="w3-center"><?php echo $objResult["promis_no"];?></a>	</td>
				<td><?php if ($objResult["promis_date"]=="0000-00-00") { echo "-"; }else{ echo DateThai($objResult["promis_date"]);	} ?> </td>
				<td><?php echo DateThai($objResult13["date_runiv"]);	?></td>
				<td><div align="left">
					<?php
	...
	echo $objResult1["sol_name"];  ?><br> <?php }  ?>
				...
				<?php }
					...
					<td ></td>
				<?php } ?>
<td><a href="register_adminrental_edit.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a></td>
<td><a href="from_rental.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a></td>
