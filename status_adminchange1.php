...
<form name="frmSearch" method="GET" action="<?php echo $_SERVER['SCRIPT_NAME'];?>">
	<div class="w3-white">
<div class="w3-panel w3-light-gray"><h4>รายการใบแลกเปลี่ยน รอใส่เลขที่เอกสาร</h4></div>		
...
$strSQL = "SELECT *  FROM hos__change  where send_admin='1' and status_doc ='Approve' and iv_no=''";
...
<?php if($objResult["close_mount"]=='0'){ ?>
				<a href="register_adminchange_edit.php?ref_id=<?php echo $objResult["ref_id"];?>&start_date=<?php echo $_GET["start_date"];  ?>&end_date=<?php echo $_GET["end_date"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
			<?php } ?>	
				...
				<a href="report_changhos1.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a>
				<?php } ?>	
...
<a href="report_changehosptl.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a>
				<?php }else if ($objResult["company"]=='2'){?>
<a href="report_changehosnbm.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a>
