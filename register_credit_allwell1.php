...
(ref_credit,date_credit,customer_name,customer_tel,address_name,return_des,send_return_name,date_send_return,sale_name,sale_date,add_by,add_date,ttype_doc,iv_no_ref,sale_code,status_doc,type_return,bank_name,account_name,account_no,book_bank,bill_id,sale_chan)

values

('".$ref_credit."','".$date_credit."','".$customer_name."','".$customer_tel."','".$address_name."','".$return_des."','".$send_return_name."','".$date_send_return."','".$sale_name."','".$sale_date."','".$add_by."','".$add_date."','".$ttype_doc."','".$iv_no_ref."','".$sale_code."','".$status_doc."','".$type_return."','".$bank_name."','".$account_name."','".$account_no."','".$_FILES['book_bank']['name']."','".$bill_id."','".$sale_chan."')";
