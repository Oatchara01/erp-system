...
<div class="w3-white w3-container">
	<div class="w3-container w3-bar w3-light-gray w3-margin-bottom">
				...
				<div class="w3-half">
					<a href="dmallwell_approve.php?ref_id=<?php echo $objResult["ref_id"];?>" class="w3-button w3-green w3-center"><font color="330066">Approve</font></a>
					<a href="dmallwell_rejected.php?ref_id=<?php echo $objResult["ref_id"];?>" class="w3-button w3-red w3-center"><font color="330066">Rejected</font></a>
...
<a href="report_loanptl.php?ref_id=<?php echo $objResult["ref_id"];?>" target="_blank" class="w3-button w3-right w3-grey"><font color="Blue">ใบยืม AWL</font></a>&nbsp;&nbsp;
...
<a  href="report_loannbm.php?ref_id=<?php echo $objResult["ref_id"];?>" target="_blank" class="w3-button w3-right w3-grey"><font color="DeepPink"> ใบยืม NBM</font></a>&nbsp;
...
<a href="report_saleptl1.php?ref_id=<?php echo $objResult["ref_id"];?>" target="_blank" class="w3-button w3-right w3-grey"><font color="Blue">ใบสั่งขาย AWL</font></a><br />
...
<a href="report_salenbm1.php?ref_id=<?php echo $objResult["ref_id"];?>" target="_blank" class="w3-button w3-right w3-grey"><font color="DeepPink">ใบสั่งขาย NBM</font></a>
<?php
}
?>
...
<input type='hidden' name = "product_id[]" value="<?php echo $objResult1["product_id"];?>" id = "product_id[]"    size='16' readonly/>
 <input type='text' name = "product_code" value="<?php echo $objResult1["sol_code"];?>" id = "product_code"  class="w3-input"    size='16' readonly/>  


</div></td>

<td> <input type='text' name = "product_name"  value="<?php echo $objResult1["sol_name"];?>" id = "product_name"  class="w3-input" readonly></textarea></td>

<td><input type='text' name = "unit_name" value="<?php echo $objResult1["unit_name"];?>" id = "unit_name"  class="w3-input"    size='9' readonly/></td>

<td><input type='text' name = "sale_count" value="<?php echo $objResult1["sale_count"];?>" id = "sale_count"  class="w3-input" style="color:black;text-align:center"   size='7' /></td>

<td><input type='text' name = "product_price" value="<?php $price_per_unit= $objResult1["price_per_unit"]; echo number_format( $price_per_unit,2)."";?>" id = "product_price"  class="w3-input"  style="color:black;text-align:right"   /></td>

<td><input type='text' name = "discount_unit" value="<?php $discount_unit= $objResult1["discount_unit"]; echo number_format( $discount_unit,2)."";?>" id = "discount_unit"  class="w3-input"  style="color:black;text-align:right"   /></td>


<td><input type='text' name = "sum_amount" value="<?php  $sum_amount=$objResult1["sum_amount"]; echo number_format( $sum_amount,2)."";?>" id = "sum_amount"  class="w3-input" style="color:black;text-align:right"    readonly/></td>


<td><input type='text' name = "warranty" value="<?php echo $objResult1["warranty"];?>" id = "warranty"  class="w3-input"   /></td>

<td><input type='text' name = "cal[]" value="<?php echo $objResult1["cal"];?>" id = "cal"  class="w3-input"   /></td>

<td><input type='text' name = "pm" value="<?php echo $objResult1["pm"];?>" id = "pm"  class="w3-input"   /></td>



<td><input type='text' name = "sale_remarkk"  id = "sale_remarkk" value="<?php echo $objResult1["sale_remark"];?>" class="w3-input"    size='13' /></td>
...
<input name="customer_typename" type='text' class="w3-input"  id="customer_typename" value="<?php echo $fetch1["customer_typename"]; ?>" size="20"  />
	   ...
	   <input name="company_name" type='text' class="w3-input"  id="company_name" value="<?php echo $fetch1["company_name"]; ?>" size="20"  />


</div><div class="w3-container w3-third">
       ประเภทงาน :
	   <input name="department_name" type='text' class="w3-input"  id="department_name" value="<?php echo $fetch1["department_name"]; ?>" size="20"  />
...
<div class="w3-container w3-third">
สินค้า/เอกสาร :  
<textarea name="product"  class="w3-input" id="product" cols="54" rows="1"><?php echo $fetch1["product"]; ?></textarea>
