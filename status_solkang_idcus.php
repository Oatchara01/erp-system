...
<div class="w3-container w3-bar w3-light-gray w3-margin-bottom"><h4>Status ค้าง ID ลูกค้า </h4></div>
...
?>
 ...
 <div class="w3-panel">    <strong>พบทั้งหมด</strong>
	...
	if($Prev_Page)
	{
		echo " <a href='$_SERVER[SCRIPT_NAME]?Page=$Prev_Page&Keyword=$Keyword&start_date=$start_date&end_date=$end_date&Keyword1=$Keyword1'><font color='black'><< Back</font></a> ";
	}

	for($i=1; $i<=$Num_Pages; $i++){
		if($i != $Page)
		{
			echo "[ <a href='$_SERVER[SCRIPT_NAME]?Page=$i&Keyword=$Keyword&start_date=$start_date&end_date=$end_date&Keyword1=$Keyword1'><font color='black'>$i</font></a> ]";
	...
	if($Page!=$Num_Pages)
	{
		echo " <a href ='$_SERVER[SCRIPT_NAME]?Page=$Next_Page&Keyword=$Keyword&start_date=$start_date&end_date=$end_date&Keyword1=$Keyword1'><font color='black'>Next>></font></a> ";
	}
