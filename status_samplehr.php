...
?>
 ...
 echo $objResult["ref_no"];
	...
	<td><div align="left"><?php echo $objResult["ref_no"];?></p><?php echo $objResult["ref_no1"];?></div></td>
				...
				<td>
						<a href=javascript:if(confirm('!!!ต้องการเพิ่มเอกสารใบเบิกสินค้าใช่หรือไม่')==true){window.location='register_supsmp_createnew.php?ref_idsmp=<?php echo $objResult["ref_idsmp"];?>';}><img src="img/sticker.png" width="23" height="23" border="0" /></a>
