...
$nextId = $yearMonth.$maxId1;
	...
	<form action='register_posave1.php' method="post" name="frmMain" enctype="multipart/form-data" onSubmit="JavaScript:return fncSubmit();" >
...
<div class="w3-white">
		<div class="w3-container w3-padding-large"><!-- main div -->
			<div class="w3-panel w3-light-gray"><h4>Register PO Sale</h4></div>
...
?>
		...
		วันที่ : <input type="date" name = "date_po" id="date_po" style="width:90%;"  value="<?php echo $today; ?>" class = "w3-input"> 	
		รหัสลูกค้า  : 

<input type='text' name = "bill_id"  id = "bill_id" class="w3-input" placeholder="Search ชื่อลูกค้า..."  style="width:90%;" OnChange="JavaScript:doCallAjax1('bill_id','bill_name');"/> 
...
?>
		...
		<div class="w3-half 1">
		เลขที่ PO  : <input type='text' name = "po_no"  id = "po_no" style="width:90%;" class="w3-input" required>
ชื่อที่ต้องการออกบิล :
				
<input type='text' name = "bill_name"  id = "bill_name" style="width:90%;" class="w3-input" >
			
			หมายเหตุ
<textarea name="remark" id="remark" class="w3-input" rows="2" style="width:90%"></textarea>
...
แนบไฟล์ </p>
<input name="img_po1"  type="file">
</p>
<input name="img_po2"  type="file">
</p>
<input name="img_po3"  type="file">
</p>
<input name="img_po4"  type="file">
</p>
<input name="img_po5"  type="file">
</p>
