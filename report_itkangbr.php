...
$strSQL1 = "SELECT distinct product_code FROM (so__submain LEFT JOIN tb_product ON so__submain.product_ID=tb_product.product_id)  WHERE  type_br='1' and clear_ckk = '0' and ckk_st ='1' and status_sol='Approve'";
...
$strSQL19 = "SELECT ref_id  FROM (st__main LEFT JOIN st__sbmain ON st__main.ref_id=st__sbmain.ref_idd) WHERE product_id = '".$objResult1["product_code"]."' and sale_code = '".$sale_code."'  and type_doc = '3' and ref_idsale ='".$objResult3["ref_idd"]."'";
...
$save="Update  st__sbmain set ckk_rpbr='1' where product_id = '".$objResult1['product_code']."' and ref_idd ='".$objResult19["ref_id"]."'";
...
$strSQL19 = "SELECT ref_id  FROM (st__main LEFT JOIN st__sbmain ON st__main.ref_id=st__sbmain.ref_idd) WHERE product_id = '".$objResult2['product_id']."'   and type_doc = '3' and ref_idsale ='".$objResult1["ref_id_br"]."'";
$strSQL19 .=" order  by stock_date ASC";
$objQuery19 = mysqli_query($new,$strSQL19) or die ("Error Query [".$strSQL19."]");
while($objResult19 = mysqli_fetch_array($objQuery19))
{

$save="Update  st__sbmain set ckk_rpbr='1' where product_id = '".$objResult2['product_id']."' and ref_idd ='".$objResult19["ref_id"]."'";
$qsave=mysqli_query($new,$save);		
...
<?php	
$strSQL9 = "SELECT ref_id,ref_idsale,stock_date,product_id,count_send,iv_no,customer_name,st__sbmain.stock_remark  FROM (st__main LEFT JOIN st__sbmain ON st__main.ref_id=st__sbmain.ref_idd) WHERE  sale_code = '".$sale_code."'  and type_doc = '3' and ckk_rpbr='0'";
$strSQL9 .=" order  by stock_date ASC";
$objQuery9 = mysqli_query($new,$strSQL9) or die ("Error Query [".$strSQL9."]");
...
<tr >
<td width="8%" align="center"  ><div class="style32">วันที่</div></td>
<td width="8%" align="center" ><div class="style32">เลขที่อ้างอิง</div></td>	
<td width="8%" align="center" ><div class="style32">เลขที่ใบยืม</div></td>
...
<td align="center" ><div class="style33"><?php echo $objResult9["ref_idsale"]; ?></div></td>	
...
$strSQL19 = "SELECT ref_id  FROM (st__main LEFT JOIN st__sbmain ON st__main.ref_id=st__sbmain.ref_idd) WHERE product_id = '".$objResult2['product_id']."'  and type_doc = '25' and ref_idsale ='".$objResult1["ref_id"]."'";
$strSQL19 .=" order  by stock_date ASC";
$objQuery19 = mysqli_query($new,$strSQL19) or die ("Error Query [".$strSQL19."]");
while($objResult19 = mysqli_fetch_array($objQuery19))
{
...
$sql4 = "SELECT sum(count) as count4   FROM  (hos__receive LEFT JOIN hos__subreceive ON hos__receive.ref_id=hos__subreceive.ref_idd)  where  product_id = '".$objResult2['product_id']."' and  iv_no = '".$objResult1["iv_no"]."'";
$qry4 = mysqli_query($conn,$sql4) or die(mysqli_error());
$rs4 = mysqli_fetch_array($qry4);
