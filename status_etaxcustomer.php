...
<div class="w3-panel w3-light-gray"><h4>ข้อมูลลูกค้าขอใบกำกับภาษี</h4></div>
...
$strSQL = "SELECT *  FROM tb_customer_etax  where 1 ";	
...
$save="UPDATE tb_customer_etax SET address_name='".$address_name."',customer_name='".$customer_name."'  where ref_id ='".$objResult["ref_id"]."' ";
$qsave=mysqli_query($conn,$save);	
	
	
$sql = "SELECT doc_no  FROM so__main where order_id = '".$objResult["order_id"]."'";
...
?>
		<tbody>
			<tr>
				...
				<?php }else if($objResult["import_order"]=='3'){	?>
						<td bgcolor="#FF3030" >ยกเลิกออเดอร์</td>
