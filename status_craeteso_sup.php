...
$strSQL = "SELECT ref_id_br,iv_no,iv_date,customer,sale_code,status_doc,sale,date_br FROM hos__br  where  close_br ='0' and status_doc ='Approve' and company='1' $sddd";	
