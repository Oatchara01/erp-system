...
<div class="w3-white">
		<div class="w3-container w3-padding-large"><!-- main div -->
			<div class="w3-panel w3-light-gray"><h4>Status ใบยืมค้างเคลียร์โชว์รูม</h4></div>
...
$strSQL = "SELECT *  FROM so__main  where allwell_ckk = '1' and close_br = '0' and allwell_br ='1'  and approve_complete = 'Approve'";
...
?>
 ...
 echo DateThai($objResult["register_date"]);
				...
				<td><div align="left">
					<?php
						$strSQL1 = "SELECT * FROM (so__submain LEFT JOIN tb_product ON so__submain.product_ID=tb_product.product_id) WHERE ref_idd = '".$objResult["ref_id"]."' and clear_ckk ='0' ";
						//echo $strSQL1;
						//exit();
...
<a href=javascript:if(confirm('!!!ต้องการเคลียร์ใบยืมนี้ใช่หรือไม่')==true){window.location='register_clearst_allwell.php?ref_id=<?php echo $objResult["ref_id"];?>';}><img src="img/sticker.png" width="23" height="23" border="0" /></a>		
</td>
