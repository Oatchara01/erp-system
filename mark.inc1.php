...
$black = imagecolorallocate($image_p, 253, 241, 160);//กำหนดสี
$font = 'PSLxKittithada_Bold.ttf';//กำหนดชื่อฟอนต์
$font_size = 36; //กำหนดขนาดฟอนต์
imagettftext($image_p, $font_size, 0, 280, 267, $black, $font, $WaterMarkText);
	imagettftext($image_p, $font_size, 0, 610, 267, $black, $font, $WaterMarkText1);
	imagettftext($image_p, $font_size, 0, 440, 359, $black, $font, $WaterMarkText2);
