...
<input type='text' name = "product_code1"  id = "product_code1" class="w3-input" placeholder="Search ชื่อสินค้าอังกฤษ..."  size="10" OnChange="JavaScript:doCallAjax('product_code1','product_id1','product_name1','unit_name1','product_price1');"/> 
<input type='hidden' name = "h_product_code1"  id = "h_product_code1"  class="button4" readonly>

<input type='text' name = "product_c1"  id = "product_c1" class="w3-input" placeholder="Search ชื่อสินค้าไทย..."  size="10" OnChange="JavaScript:doCallAjax('product_c1','product_id1','product_name1','unit_name1','product_price1');"/> 
...
<tr>
<td style="width:10%;">
<input type='text' name = "product_codet2"  id = "product_codet2" class="w3-input" placeholder="Search รหัส..."  size="10" OnChange="JavaScript:doCallAjax('product_codet2','product_id2','product_name2','unit_name2','product_price2');"/> 
<input type='hidden' name = "h_product_codet2"  id = "h_product_codet2"  class="button4" readonly>

<input type='text' name = "product_code2"  id = "product_code2" class="w3-input" placeholder="Search ชื่อสินค้าอังกฤษ..."  size="10" OnChange="JavaScript:doCallAjax('product_code2','product_id2','product_name2','unit_name2','product_price2');"/> 
<input type='hidden' name = "h_product_code2"  id = "h_product_code2"  class="button4" readonly>
	
<input type='text' name = "product_c2"  id = "product_c2" class="w3-input" placeholder="Search ชื่อสินค้าไทย..."  size="10" OnChange="JavaScript:doCallAjax('product_c2','product_id2','product_name2','unit_name2','product_price2');"/> 
...
<td style="width:5%;">
<input type='text' name = "count_stock2" id = "count_stock2"  class="w3-input" style="color:black;text-align:center"  />
</td>
...
<td style="width:15%;">
<textarea name = "sn2"  id = "sn2"  class="w3-input" ></textarea>
</td>	
...
<input type='text' name = "product_code3"  id = "product_code3" class="w3-input" placeholder="Search ชื่อสินค้าอังกฤษ..."  size="10" OnChange="JavaScript:doCallAjax('product_code3','product_id3','product_name3','unit_name3','product_price3');"/> 
<input type='hidden' name = "h_product_code3"  id = "h_product_code3"  class="button4" readonly>
	
<input type='text' name = "product_c3"  id = "product_c3" class="w3-input" placeholder="Search ชื่อสินค้าไทย..."  size="10" OnChange="JavaScript:doCallAjax('product_c3','product_id3','product_name3','unit_name3','product_price3');"/> 
...
<input type='text' name = "product_code4"  id = "product_code4" class="w3-input" placeholder="Search ชื่อสินค้าอังกฤษ..."  size="10" OnChange="JavaScript:doCallAjax('product_code4','product_id4','product_name4','unit_name4','product_price4');"/> 
<input type='hidden' name = "h_product_code4"  id = "h_product_code4"  class="button4" readonly>
	
<input type='text' name = "product_c4"  id = "product_c4" class="w3-input" placeholder="Search ชื่อสินค้าไทย..."  size="10" OnChange="JavaScript:doCallAjax('product_c4','product_id4','product_name4','unit_name4','product_price4');"/> 
...
<input type='text' name = "product_code5"  id = "product_code5" class="w3-input" placeholder="Search ชื่อสินค้าอังกฤษ..."  size="10" OnChange="JavaScript:doCallAjax('product_code5','product_id5','product_name5','unit_name5','product_price5');"/> 
<input type='hidden' name = "h_product_code5"  id = "h_product_code5"  class="button4" readonly>
	
<input type='text' name = "product_c5"  id = "product_c5" class="w3-input" placeholder="Search ชื่อสินค้าไทย..."  size="10" OnChange="JavaScript:doCallAjax('product_c5','product_id5','product_name5','unit_name5','product_price5');"/> 
...
<td style="width:5%;"><a onclick="document.getElementById('product_code5').value = '';
...
<input type='text' name = "product_code6"  id = "product_code6" class="w3-input" placeholder="Search ชื่อสินค้าอังกฤษ..."  size="10" OnChange="JavaScript:doCallAjax('product_code6','product_id6','product_name6','unit_name6','product_price6');"/> 
<input type='hidden' name = "h_product_code6"  id = "h_product_code6"  class="button4" readonly>
	
<input type='text' name = "product_c6"  id = "product_c6" class="w3-input" placeholder="Search ชื่อสินค้าไทย..."  size="10" OnChange="JavaScript:doCallAjax('product_c6','product_id6','product_name6','unit_name6','product_price6');"/> 
...
<td style="width:5%;"><a onclick="document.getElementById('product_code6').value = '';
...
function make_autocom(autoObj,showObj){
	...
	new Autocomplete(mkAutoObj, function() {
		...
		if ( this.value.length < 1 && this.isNotClick ) 
			return ;	
		return "data_product_hosnb.php?product_code_search=" +encodeURIComponent(this.value);
    });	
}	
...
function make_autocom(autoObj,showObj){
	...
	new Autocomplete(mkAutoObj, function() {
		...
		if ( this.value.length < 1 && this.isNotClick ) 
			return ;	
		return "data_product_hosinb.php?product_code_search=" +encodeURIComponent(this.value);
    });	
}	
