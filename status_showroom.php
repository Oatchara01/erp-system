...
<div class="w3-panel w3-light-grey"><h3>รายการแบบสอบถามลูกค้า Showroom</h3></div>
...
<div class="w3-bar w3-quarter">
สินค้า
<select name="product_code" id="product_code"  class="w3-input" style="width:90%;" >
<option class="w3-bar" value="">**โปรดเลือกสินค้า**</option>
<?php
$strSQL5 = "SELECT * FROM tb_prowaranty where ckk_sh='1' ORDER BY id ASC";
$objQuery5 = mysqli_query($conn,$strSQL5);
while($objResuut5 = mysqli_fetch_array($objQuery5))
{
if($_GET["product_code"] == $objResuut5["id"])
{
$sel = "selected";
}
else
...
?>
<option value="<?php echo $objResuut5["id"];?>" <?php echo $sel;?>><?php echo $objResuut5["product_name"];?></option>
<?php
}
?>
...
$strSQL = "SELECT *  FROM tb_research_showroom  where 1 ";
...
if($product_code !=""){ 
	$strSQL .= ' AND product_code  LIKE "%'.$product_code.'%"'; 
...
$strSQL1 = "SELECT * FROM tb_prowaranty WHERE id = '".$objResult["product_code"]."' ";
...
?>
		<tbody>
			<tr>
				...
				<td><?php echo DateThai($objResult["date_research"]); ?></td>
				<td><?php echo $objResult["customer_name"];?></td>
				<td><?php echo $objResult1["product_name"];?></td>
				
				<td>

				<a href="research_showroom_edit.php?ref_id=<?php echo $objResult["ref_id"];?>&start_date=<?php echo $_GET["start_date"];  ?>&end_date=<?php echo $_GET["end_date"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
