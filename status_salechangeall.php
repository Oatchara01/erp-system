...
<div class="w3-panel w3-light-grey"><h3>รายการแบบสอบถามทั้งหมด</h3></div>
...
$strSQL = "SELECT *  FROM hos__so  where sale_code = '".$sale_code."' and close_reseach ='1' and reseach_kk='1'";
...
?> <br>
	...
	<td>
<?php if($objResult["job_no"]!="" and $objResult["status_doc"]=='Approve'){ 
		
$strSQL5 = "SELECT date_research FROM tb_research WHERE running_id = '".$objResult["job_no"]."' ";
