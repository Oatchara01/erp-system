...
<a href="report_brcshos_n.php?ref_id=<?php echo $rs["ref_id"];?>" target="_blank" class="w3-button w3-grey w3-right"><font color="red">ใบฝากขายต่อเนือง</font></a>	
...
<form action="register_adminbrcshos_edit1.php" method="post" name="frmMain" enctype="multipart/form-data" onSubmit="JavaScript:return fncSubmit();" >
...
<span>ชื่อผู้แทน</span> <input type="text" name="sale" id="sale" value = "<?php echo $rs["sale"]; ?>" class="w3-input" style="width:90%;"></p>
...
<?php if($rs["status_doc"]=='ยกเลิก'){ ?>
	...
	<div class="w3-panel">
		<textarea name="remark_cancel" id="remark_cancel" class="w3-input" style="width:90%;" rows="2"><?php echo $rs["remark_cancel"]; ?></textarea>
		</div>
