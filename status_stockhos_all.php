...
$strSQL = "SELECT *  FROM hos__so  where  status_doc ='Approve' and send_erpst ='0' and stock !=''";
...
?>
 ...
 echo DateThai($objResult["date_so"]);
			...
			<td  >
<a href="register_hossend_edit.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
