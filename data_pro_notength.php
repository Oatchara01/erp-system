...
$sql = "select * from $table_db  where engineer_ckk='1' and demo_ckk='0' and type_company = 'AWL' and locate('$product_code_search', $find_field) > 0 order by locate('$product_code_search', $find_field), $find_field limit $pagesize";
