...
<a href="credit_cmapprove.php?ref_credit=<?php echo $rs["ref_credit"];?>&date_credit=<?php echo $rs["date_credit"]; ?>" class="w3-button w3-green "><font color="330066">Approve</font></a>

<a href="credit_cmrejected.php?ref_credit=<?php echo $rs["ref_credit"];?>" class="w3-button w3-red "><font color="330066">Rejected</font></a><?php


							
$strSQL = "SELECT *  FROM hos__rental WHERE ref_ai = '".$ref_idww."' ";						
...
$ref_iv = substr($rs["ref_id"],0,2);	
	
if($ref_iv=='SO'){ 
?>		
<a href="register_adminhos_edit.php?ref_id=<?php echo $ref_idww;?>" class="w3-button w3-right w3-grey "  target="_blank"><font color="330066">ข้อมูลใบสั่งขาย</font></a>
<?php }else{ ?>
<a href="register_admin_edit.php?ref_id=<?php echo $ref_idww;?>" class="w3-button w3-right w3-grey " target="_blank"><font color="330066">ข้อมูลใบสั่งขาย</font></a>							
<?php } ?>							
