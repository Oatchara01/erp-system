...
$sql2 = "SELECT * FROM tb_product_med where code_lazada='".$objArr[4]."'";
...
$address1 = "$objArr[14] $objArr[15] $str_arr1[0]; $str_arr[0]  $objArr[18]";
$address2 = "$str_arr1[0];";
...
values
('".$customer_name."','6','".$address1."','".$address2."','".$str_arr[0]."','".$postcode."','".$tel."','".$billing_name."','".$billing_address."','".$str_arr2[0]."','".$str_arr3[0]."','".$billing_postcode."','".$billing_tel."','".$tax_id."','".$delivery_name."','".$delivery_place."','".$address2."','".$str_arr[0]."','".$postcode."','".$tel."','".$delivery_contact."','".$employee_name."')";
...
$qsave=mysqli_query($conn,$save);
 ...
 $strSQL = "INSERT INTO so__main (ref_id,register_date,register_time,delivery_name,address1,province,postcode,billing_address,billing_name,billing_tel,tel,order_id,customer_name,order_name,delivery_contact,delivery_place,add_date,add_by,order_refer_code,sale_channel,select_type_doc,doc_release_date,status_doc,delivery,payment,employee_name,address2,delivery_date,approve_complete,send_stock,bill_vat,tax_id,send_supadm,status_vat,bill_id,doc_no) VALUES ('".$main_id."','".$register_date."','".$register_time."','".$delivery_name."','".$address1."','".$str_arr[0]."','".$postcode."','".$billing_address."','".$billing_name."','".$billing_tel."','".$tel."','".$order_id."','".$customer_name."','".$order_name."','".$delivery_contact."','".$delivery_place."','".$add_date."','".$add_by."','".$order_refer_code."','".$sale_channel."','2','".$doc_release_date."','".$select_type_doc."','".$delivery."','".$payment."','".$employee_name."','".$address2."','".$delivery_date."','".$approve_complete."','1','".$bill_vat."','".$tax_id."','".$send_supadm."','".$status_vat."','".$bill_id."','".$doc_no."')";
