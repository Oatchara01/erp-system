...
$sql21 = "SELECT ref_id FROM so__main where order_id='".$objArr[2]."'";
//echo $sql21."<br>";
...
$price_per_unit = $objArr[11];	
$sum_amount = 	$objArr[11]*$unit1;
...
values ('".$fetch21["ref_id"]."','".$unit1."','".$unit1."','".$price_per_unit."','".$objArr[11]."','".$sum_amount."','0.00','".$id_product1."','".$id_product1."','".$waranty1."','Approve')";
...
$customer_name = $objArr[4];
$delivery_name = $objArr[4];
$tax_id = "";	

$sale_remark = $objArr[5];
$order_name = $objArr[21];
$delivery_contact = "$objArr[4] / $objArr[30]";
$address1 = "$objArr[22] $objArr[23] $objArr[24]";
$province = trim($objArr[24]);
$delivery_place = "$objArr[22] $objArr[23] $objArr[24] $objArr[25]";


$postcode =	$objArr[25];
	
$billing_address = "$objArr[26] $objArr[27] $objArr[28] $objArr[29]";
$billing_name =	$objArr[21];
$billing_tel =	$objArr[30];
$billing_postcode =	$objArr[29];
$billing_add = $objArr[26];
$billing_aum = $objArr[27];
$billing_pro = trim($objArr[28]);
...
/*if($sku=='SUP-KOW-CFKNEL' or $sku =='SUP-KOW-CFKNEM' or $sku =='SUP-KOW-CFKNES'){
...
/*if($sku=='OLWHGK' or $sku=='BLWHGK' or $sku=='GBWHGK' or $sku=='OSWHGK' or $sku=='BSWHGK' or $sku=='wheel-chair' or $sku =='178946' or $sku=='178947'){

$strSQL19 = "insert into so__submain
(ref_idd,sale_count,sale_countref,price_per_unit,price_per_unitref,sum_amount,discount_unit,product_id,product_code,warranty,status_sol,sale_remark)
values ('".$main_id."','1','1','0.00','0.00','0.00','0.00','4853','4853','','Approve','แถมกระบอกน้ำ ALLWELL เก็บอุณหภูมิ สีม่วง 1 ขิ้น เมื่อซื้อวีลแชร์')";
$objQuery19 = mysqli_query($conn,$strSQL19);
