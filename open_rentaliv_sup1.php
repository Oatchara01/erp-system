...
$ref_ren = $_POST["ref_ren"];
$promis_ref = $_POST["promis_no"];
$type = $_POST["type"];
...
(ref_id,type_doc,bill_name,bill_address,bill_tel,full_bill,date_so,suggest,payment,sale_comment,po_no,delivery_contract,book_clear,book_no,brn_clear,brn_no,brnp_clear,brnp_no,sn_ckk,sn_no,install_place,with_pr,type_type,type_detail,delivery_type,delivery_date,delivery_time,delivery_address,delivery_contact,delivery_tel,sale_date,sale,sale_code,pr_no,add_date,add_by,status_doc,approve,approve_code,approve_date,payment_des,slip1,slip2,slip3,slip4,slip5,date_send_key,have_order,send_sup,iv_no,tax_id,approve_time,bill_id,cm_no,pre_name,que_ckk,ref_ren,promis_ref)
values
('".$ref_id."','".$type_doc."','".$bill_name."','".$bill_address."','".$bill_tel."','".$full_bill."','".$date_so."','".$suggest."','".$payment."','".$sale_comment."','".$po_no."','".$delivery_contract."','".$book_clear."','".$book_no."','".$brn_clear."','".$brn_no."','".$brnp_clear."','".$brnp_no."','".$sn_ckk."','".$sn_no."','".$install_place."','".$with_pr."','".$type_type."','".$type_detail."','".$delivery_type."','".$delivery_date."','".$delivery_time."','".$delivery_address."','".$delivery_contact."','".$delivery_tel."','".$sale_date."','".$sale."','".$sale_code."','".$pr_no."','".$add_date."','".$add_by."','Approve','".$approve."','".$sup_code."','".$sale_date."','".$payment_des."','".$_FILES['slip1']['name']."','".$_FILES['slip2']['name']."','".$_FILES['slip3']['name']."','".$_FILES['slip4']['name']."','".$_FILES['slip5']['name']."','".$date_send_key."','".$have_order."','1','".$iv_no."','".$tax_id."','".$approve_time."','".$bill_id."','".$cm_no."','".$pre_name."','".$que_ckk."','".$ref_ren."','".$promis_ref."')";

$qsave=mysqli_query($conn,$save);

$strSQL55 = "SELECT date_runiv  FROM hos__rental_runiv  where ref_idren = '".$ref_ren."' and ckk_open='0'";	
$qry55 = mysqli_query($conn,$strSQL55) or die(mysqli_error());
$Num_Rows55 = mysqli_num_rows($qry55);	
...
if(($Num_Rows55%2) == 0){
//เลขคู่
$date_pm = date('Y-m-d',strtotime($rs55["date_runiv"] . "+7 day"));	
...
$strSQL13 = "SELECT product_sn  FROM tb_service_check  where remark_check = '".$ref_id."' and product_sn='".$objResult2["product_sn"]."'";	
$qry13 = mysqli_query($service,$strSQL13) or die(mysqli_error());
$Num_Rows13 = mysqli_num_rows($qry13);	

$j = $Num_Rows13+1;	
	
$save2="insert into tb_service_check (product_sn,service_check_terms,service_check_date,service_check_type,add_by,add_date,remark_check) values ('".$objResult2["product_sn"]."','".$j."','".$date_pm."','PM','".$add_by."','".$add_date."','".$ref_id."') ";	
$qsave2=mysqli_query($service,$save2);
	
$product_sn = $objResult2["product_sn"];
...
$sMessage = "มีการลง PM สินค้าเช่า
			หมายเลขเครื่อง  : $product_sn
			PM วันที่ : $date_pm
			ลูกค้า : $bill_name
			เลขที่สัญญา : $promis_ref
			รบกวนทำการตรวจสอบข้อมูล เพื่อประสานงานกับลูกค้า
			ตามลิงค์ด้านล่างได้เลยคะ
			https://service-engineer.allwellcenter.com			
";
$chOne = curl_init();
...
$strSQL13 = "SELECT product_sn  FROM tb_service_check  where remark_check = '".$ref_id."' and product_sn='".$objResult2["product_sn"]."'";	
$qry13 = mysqli_query($servicenb,$strSQL13) or die(mysqli_error());
$Num_Rows13 = mysqli_num_rows($qry13);	
...
$sMessage = "มีการลง PM สินค้าเช่า
			...
			รบกวนทำการตรวจสอบข้อมูล เพื่อประสานงานกับลูกค้า
			ตามลิงค์ด้านล่างได้เลยคะ
			https://service-engineernb.allwellcenter.com			
";
$chOne = curl_init();
curl_setopt( $chOne, CURLOPT_URL, "https://notify-api.line.me/api/notify");
curl_setopt( $chOne, CURLOPT_SSL_VERIFYHOST, 0);
...
$date_runiv = date('Y-m-d',strtotime($rs55["date_runiv"] . "+1 months"));	
	
$strSQL65 = "Update   hos__rental_runiv set ref_idiv='".$ref_id."',date_opiv='".$add_date."',add_by='".$add_by."',ckk_open='1'  Where ref_idren= '".$ref_ren."' and ckk_open='0'";
$objQuery65 = mysqli_query($conn,$strSQL65);	
	
	
$save1 = "insert into hos__rental_runiv (ref_idren,date_runiv,sale_area) values ('".$ref_ren."','".$date_runiv."','".$sale_code."')";
...
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,code_bom,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit1."','".$unit1."','".$product_price1."','".$product_price1."','".$sum_amount1."','".$sale_remarkk1."','".$discount_unit1."','".$warranty1."','".$cal1."','".$pm1."','".$product_idb1."','".$product_idb1."','".$product_code1."','1','".$product_code1."','".$have_order."','".$clear_br1."','".$clear_ivno1."')";
...
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit2."','".$unit2."','0.00','0.00','0.00','".$sale_remarkk1."','0.00','0','0','0','".$product_idb2."','".$product_idb2."','1','".$product_code1."','".$have_order."','".$clear_br1."','".$clear_ivno1."')";
...
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit3."','".$unit3."','0.00','0.00','0.00','".$sale_remarkk1."','0.00','0','0','0','".$product_idb3."','".$product_idb3."','1','".$product_code1."','".$have_order."','".$clear_br1."','".$clear_ivno1."')";
...
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit4."','".$unit4."','0.00','0.00','0.00','".$sale_remarkk1."','0.00','0','0','0','".$product_idb4."','".$product_idb4."','1','".$product_code1."','".$have_order."','".$clear_br1."','".$clear_ivno1."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit5."','".$unit5."','0.00','0.00','0.00','".$sale_remarkk1."','0.00','0','0','0','".$product_idb5."','".$product_idb5."','1','".$product_code1."','".$have_order."','".$clear_br1."','".$clear_ivno1."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit6."','".$unit6."','0.00','0.00','0.00','".$sale_remarkk1."','0.00','0','0','0','".$product_idb6."','".$product_idb6."','1','".$product_code1."','".$have_order."','".$clear_br1."','".$clear_ivno1."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit7."','".$unit7."','0.00','0.00','0.00','".$sale_remarkk1."','0.00','0','0','0','".$product_idb7."','".$product_idb7."','1','".$product_code1."','".$have_order."','".$clear_br1."','".$clear_ivno1."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit8."','".$unit8."','0.00','0.00','0.00','".$sale_remarkk1."','0.00','0','0','0','".$product_idb8."','".$product_idb8."','1','".$product_code1."','".$have_order."','".$clear_br1."','".$clear_ivno1."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit9."','".$unit9."','0.00','0.00','0.00','".$sale_remarkk1."','0.00','0','0','0','".$product_idb9."','".$product_idb9."','1','".$product_code1."','".$have_order."','".$clear_br1."','".$clear_ivno1."')";
$objQuery102 = mysqli_query($conn,$strSQL102);
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit10."','".$unit10."','0.00','0.00','0.00','".$sale_remarkk1."','0.00','0','0','0','".$product_idb10."','".$product_idb10."','1','".$product_code1."','".$have_order."','".$clear_br1."','".$clear_ivno1."')";
...
values ('".$ref_id."','".$sale_count1."','".$sale_count1."','".$product_price1."','".$product_price1."','".$sum_amount1."','".$sale_remarkk1."','".$discount_unit1."','".$warranty1."','".$cal1."','".$pm1."','".$product_id1."','".$product_id1."','".$have_order."','".$clear_br1."','".$clear_ivno1."')";
...
$strSQL104 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,code_bom,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit1."','".$unit1."','".$product_price2."','".$product_price2."','".$sum_amount2."','".$sale_remarkk2."','".$discount_unit2."','".$warranty2."','".$cal2."','".$pm2."','".$product_idb1."','".$product_idb1."','".$product_code2."','1','".$product_code2."','".$have_order."','".$clear_br2."','".$clear_ivno2."')";
...
$strSQL100 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit2."','".$unit2."','0.00','0.00','0.00','".$sale_remarkk2."','0.00','0','0','0','".$product_idb2."','".$product_idb2."','1','".$product_code2."','".$have_order."','".$clear_br2."','".$clear_ivno2."')";
$objQuery100 = mysqli_query($conn,$strSQL100);
...
$strSQL101 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit3."','".$unit3."','0.00','0.00','0.00','".$sale_remarkk2."','0.00','0','0','0','".$product_idb3."','".$product_idb3."','1','".$product_code2."','".$have_order."','".$clear_br2."','".$clear_ivno2."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit4."','".$unit4."','0.00','0.00','0.00','".$sale_remarkk2."','0.00','0','0','0','".$product_idb4."','".$product_idb4."','1','".$product_code2."','".$have_order."','".$clear_br2."','".$clear_ivno2."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit5."','".$unit5."','0.00','0.00','0.00','".$sale_remarkk2."','0.00','0','0','0','".$product_idb5."','".$product_idb5."','1','".$product_code2."','".$have_order."','".$clear_br2."','".$clear_ivno2."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit6."','".$unit6."','0.00','0.00','0.00','".$sale_remarkk2."','0.00','0','0','0','".$product_idb6."','".$product_idb6."','1','".$product_code2."','".$have_order."','".$clear_br2."','".$clear_ivno2."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit7."','".$unit7."','0.00','0.00','0.00','".$sale_remarkk2."','0.00','0','0','0','".$product_idb7."','".$product_idb7."','1','".$product_code2."','".$have_order."','".$clear_br2."','".$clear_ivno2."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit8."','".$unit8."','0.00','0.00','0.00','".$sale_remarkk2."','0.00','0','0','0','".$product_idb8."','".$product_idb8."','1','".$product_code2."','".$have_order."','".$clear_br2."','".$clear_ivno2."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit9."','".$unit9."','0.00','0.00','0.00','".$sale_remarkk2."','0.00','0','0','0','".$product_idb9."','".$product_idb9."','1','".$product_code2."','".$have_order."','".$clear_br2."','".$clear_ivno2."')";
$objQuery102 = mysqli_query($conn,$strSQL102);
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit10."','".$unit10."','0.00','0.00','0.00','".$sale_remarkk2."','0.00','0','0','0','".$product_idb10."','".$product_idb10."','1','".$product_code2."','".$have_order."','".$clear_br2."','".$clear_ivno2."')";
...
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$sale_count2."','".$sale_count2."','".$product_price2."','".$product_price2."','".$sum_amount2."','".$sale_remarkk2."','".$discount_unit2."','".$warranty2."','".$cal2."','".$pm2."','".$product_id2."','".$product_id2."','".$have_order."','".$clear_br2."','".$clear_ivno2."')";
...
$strSQL104 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,code_bom,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit1."','".$unit1."','".$product_price3."','".$product_price3."','".$sum_amount3."','".$sale_remarkk3."','".$discount_unit3."','".$warranty3."','".$cal3."','".$pm3."','".$product_idb1."','".$product_idb1."','".$product_code3."','1','".$product_code3."','".$have_order."','".$clear_br3."','".$clear_ivno3."')";
...
$strSQL100 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit2."','".$unit2."','0.00','0.00','0.00','".$sale_remarkk3."','0.00','0','0','0','".$product_idb2."','".$product_idb2."','1','".$product_code3."','".$have_order."','".$clear_br3."','".$clear_ivno3."')";
$objQuery100 = mysqli_query($conn,$strSQL100);
...
$strSQL101 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit3."','".$unit3."','0.00','0.00','0.00','".$sale_remarkk3."','0.00','0','0','0','".$product_idb3."','".$product_idb3."','1','".$product_code3."','".$have_order."','".$clear_br3."','".$clear_ivno3."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit4."','".$unit4."','0.00','0.00','0.00','".$sale_remarkk3."','0.00','0','0','0','".$product_idb4."','".$product_idb4."','1','".$product_code3."','".$have_order."','".$clear_br3."','".$clear_ivno3."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit5."','".$unit5."','0.00','0.00','0.00','".$sale_remarkk3."','0.00','0','0','0','".$product_idb5."','".$product_idb5."','1','".$product_code3."','".$have_order."','".$clear_br3."','".$clear_ivno3."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit6."','".$unit6."','0.00','0.00','0.00','".$sale_remarkk3."','0.00','0','0','0','".$product_idb6."','".$product_idb6."','1','".$product_code3."','".$have_order."','".$clear_br3."','".$clear_ivno3."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit7."','".$unit7."','0.00','0.00','0.00','".$sale_remarkk3."','0.00','0','0','0','".$product_idb7."','".$product_idb7."','1','".$product_code3."','".$have_order."','".$clear_br3."','".$clear_ivno3."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit8."','".$unit8."','0.00','0.00','0.00','".$sale_remarkk3."','0.00','0','0','0','".$product_idb8."','".$product_idb8."','1','".$product_code3."','".$have_order."','".$clear_br3."','".$clear_ivno3."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit9."','".$unit9."','0.00','0.00','0.00','".$sale_remarkk3."','0.00','0','0','0','".$product_idb9."','".$product_idb9."','1','".$product_code3."','".$have_order."','".$clear_br3."','".$clear_ivno3."')";
$objQuery102 = mysqli_query($conn,$strSQL102);
...
values ('".$ref_id."','".$unit10."','".$unit10."','0.00','0.00','0.00','".$sale_remarkk3."','0.00','0','0','0','".$product_idb10."','".$product_idb10."','1','".$product_code3."','".$have_order."','".$clear_br3."','".$clear_ivno3."')";
...
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$sale_count3."','".$sale_count3."','".$product_price3."','".$product_price3."','".$sum_amount3."','".$sale_remarkk3."','".$discount_unit3."','".$warranty3."','".$cal3."','".$pm3."','".$product_id3."','".$product_id3."','".$have_order."','".$clear_br3."','".$clear_ivno3."')";
...
$strSQL104 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,code_bom,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit1."','".$unit1."','".$product_price4."','".$product_price4."','".$sum_amount4."','".$sale_remarkk4."','".$discount_unit4."','".$warranty4."','".$cal4."','".$pm4."','".$product_idb1."','".$product_idb1."','".$product_code4."','1','".$product_code4."','".$have_order."','".$clear_br4."','".$clear_ivno4."')";
...
$strSQL100 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit2."','".$unit2."','0.00','0.00','0.00','".$sale_remarkk4."','0.00','0','0','0','".$product_idb2."','".$product_idb2."','1','".$product_code4."','".$have_order."','".$clear_br4."','".$clear_ivno4."')";
$objQuery100 = mysqli_query($conn,$strSQL100);
...
$strSQL101 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit3."','".$unit3."','0.00','0.00','0.00','".$sale_remarkk4."','0.00','0','0','0','".$product_idb3."','".$product_idb3."','1','".$product_code4."','".$have_order."','".$clear_br4."','".$clear_ivno4."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit4."','".$unit4."','0.00','0.00','0.00','".$sale_remarkk4."','0.00','0','0','0','".$product_idb4."','".$product_idb4."','1','".$product_code4."','".$have_order."','".$clear_br4."','".$clear_ivno4."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit5."','".$unit5."','0.00','0.00','0.00','".$sale_remarkk4."','0.00','0','0','0','".$product_idb5."','".$product_idb5."','1','".$product_code4."','".$have_order."','".$clear_br4."','".$clear_ivno4."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit6."','".$unit6."','0.00','0.00','0.00','".$sale_remarkk4."','0.00','0','0','0','".$product_idb6."','".$product_idb6."','1','".$product_code4."','".$have_order."','".$clear_br4."','".$clear_ivno4."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit7."','".$unit7."','0.00','0.00','0.00','".$sale_remarkk4."','0.00','0','0','0','".$product_idb7."','".$product_idb7."','1','".$product_code4."','".$have_order."','".$clear_br4."','".$clear_ivno4."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit8."','".$unit8."','0.00','0.00','0.00','".$sale_remarkk4."','0.00','0','0','0','".$product_idb8."','".$product_idb8."','1','".$product_code4."','".$have_order."','".$clear_br4."','".$clear_ivno4."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit9."','".$unit9."','0.00','0.00','0.00','".$sale_remarkk4."','0.00','0','0','0','".$product_idb9."','".$product_idb9."','1','".$product_code4."','".$have_order."','".$clear_br4."','".$clear_ivno4."')";
$objQuery102 = mysqli_query($conn,$strSQL102);
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit10."','".$unit10."','0.00','0.00','0.00','".$sale_remarkk4."','0.00','0','0','0','".$product_idb10."','".$product_idb10."','1','".$product_code4."','".$have_order."','".$clear_br4."','".$clear_ivno4."')";
...
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$sale_count4."','".$sale_count4."','".$product_price4."','".$product_price4."','".$sum_amount4."','".$sale_remarkk4."','".$discount_unit4."','".$warranty4."','".$cal4."','".$pm4."','".$product_id4."','".$product_id4."','".$have_order."','".$clear_br4."','".$clear_ivno4."')";
...
$strSQL104 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,code_bom,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit1."','".$unit1."','".$product_price5."','".$product_price5."','".$sum_amount5."','".$sale_remarkk5."','".$discount_unit5."','".$warranty5."','".$cal5."','".$pm5."','".$product_idb1."','".$product_idb1."','".$product_code5."','1','".$product_code5."','".$have_order."','".$clear_br5."','".$clear_ivno5."')";
...
$strSQL100 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit2."','".$unit2."','0.00','0.00','0.00','".$sale_remarkk5."','0.00','0','0','0','".$product_idb2."','".$product_idb2."','1','".$product_code5."','".$have_order."','".$clear_br5."','".$clear_ivno5."')";
$objQuery100 = mysqli_query($conn,$strSQL100);
...
$strSQL101 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit3."','".$unit3."','0.00','0.00','0.00','".$sale_remarkk5."','0.00','0','0','0','".$product_idb3."','".$product_idb3."','1','".$product_code5."','".$have_order."','".$clear_br5."','".$clear_ivno5."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit4."','".$unit4."','0.00','0.00','0.00','".$sale_remarkk5."','0.00','0','0','0','".$product_idb4."','".$product_idb4."','1','".$product_code5."','".$have_order."','".$clear_br5."','".$clear_ivno5."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit5."','".$unit5."','0.00','0.00','0.00','".$sale_remarkk5."','0.00','0','0','0','".$product_idb5."','".$product_idb5."','1','".$product_code5."','".$have_order."','".$clear_br5."','".$clear_ivno5."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit6."','".$unit6."','0.00','0.00','0.00','".$sale_remarkk5."','0.00','0','0','0','".$product_idb6."','".$product_idb6."','1','".$product_code5."','".$have_order."','".$clear_br5."','".$clear_ivno5."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit7."','".$unit7."','0.00','0.00','0.00','".$sale_remarkk5."','0.00','0','0','0','".$product_idb7."','".$product_idb7."','1','".$product_code5."','".$have_order."','".$clear_br5."','".$clear_ivno5."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit8."','".$unit8."','0.00','0.00','0.00','".$sale_remarkk5."','0.00','0','0','0','".$product_idb8."','".$product_idb8."','1','".$product_code5."','".$have_order."','".$clear_br5."','".$clear_ivno5."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit9."','".$unit9."','0.00','0.00','0.00','".$sale_remarkk5."','0.00','0','0','0','".$product_idb9."','".$product_idb9."','1','".$product_code5."','".$have_order."','".$clear_br5."','".$clear_ivno5."')";
$objQuery102 = mysqli_query($conn,$strSQL102);
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit10."','".$unit10."','0.00','0.00','0.00','".$sale_remarkk5."','0.00','0','0','0','".$product_idb10."','".$product_idb10."','1','".$product_code5."','".$have_order."','".$clear_br5."','".$clear_ivno5."')";
...
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$sale_count5."','".$sale_count5."','".$product_price5."','".$product_price5."','".$sum_amount5."','".$sale_remarkk5."','".$discount_unit5."','".$warranty5."','".$cal5."','".$pm5."','".$product_id5."','".$product_id5."','".$have_order."','".$clear_br5."','".$clear_ivno5."')";
...
$strSQL104 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,code_bom,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit1."','".$unit1."','".$product_price6."','".$product_price6."','".$sum_amount6."','".$sale_remarkk6."','".$discount_unit6."','".$warranty6."','".$cal6."','".$pm6."','".$product_idb1."','".$product_idb1."','".$product_code6."','1','".$product_code6."','".$have_order."','".$clear_br6."','".$clear_ivno6."')";
...
$strSQL100 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit2."','".$unit2."','0.00','0.00','0.00','".$sale_remarkk6."','0.00','0','0','0','".$product_idb2."','".$product_idb2."','1','".$product_code6."','".$have_order."','".$clear_br6."','".$clear_ivno6."')";
$objQuery100 = mysqli_query($conn,$strSQL100);
...
$strSQL101 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit3."','".$unit3."','0.00','0.00','0.00','".$sale_remarkk6."','0.00','0','0','0','".$product_idb3."','".$product_idb3."','1','".$product_code6."','".$have_order."','".$clear_br6."','".$clear_ivno6."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit4."','".$unit4."','0.00','0.00','0.00','".$sale_remarkk6."','0.00','0','0','0','".$product_idb4."','".$product_idb4."','1','".$product_code6."','".$have_order."','".$clear_br6."','".$clear_ivno6."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit5."','".$unit5."','0.00','0.00','0.00','".$sale_remarkk6."','0.00','0','0','0','".$product_idb5."','".$product_idb5."','1','".$product_code6."','".$have_order."','".$clear_br6."','".$clear_ivno6."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit6."','".$unit6."','0.00','0.00','0.00','".$sale_remarkk6."','0.00','0','0','0','".$product_idb6."','".$product_idb6."','1','".$product_code6."','".$have_order."','".$clear_br6."','".$clear_ivno6."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit7."','".$unit7."','0.00','0.00','0.00','".$sale_remarkk6."','0.00','0','0','0','".$product_idb7."','".$product_idb7."','1','".$product_code6."','".$have_order."','".$clear_br6."','".$clear_ivno6."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit8."','".$unit8."','0.00','0.00','0.00','".$sale_remarkk6."','0.00','0','0','0','".$product_idb8."','".$product_idb8."','1','".$product_code6."','".$have_order."','".$clear_br6."','".$clear_ivno6."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit9."','".$unit9."','0.00','0.00','0.00','".$sale_remarkk6."','0.00','0','0','0','".$product_idb9."','".$product_idb9."','1','".$product_code6."','".$have_order."','".$clear_br6."','".$clear_ivno6."')";
$objQuery102 = mysqli_query($conn,$strSQL102);
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit10."','".$unit10."','0.00','0.00','0.00','".$sale_remarkk6."','0.00','0','0','0','".$product_idb10."','".$product_idb10."','1','".$product_code6."','".$have_order."','".$clear_br6."','".$clear_ivno6."')";
...
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$sale_count6."','".$sale_count6."','".$product_price6."','".$product_price6."','".$sum_amount6."','".$sale_remarkk6."','".$discount_unit6."','".$warranty6."','".$cal6."','".$pm6."','".$product_id6."','".$product_id6."','".$have_order."','".$clear_br6."','".$clear_ivno6."')";
...
$strSQL104 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,code_bom,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit1."','".$unit1."','".$product_price7."','".$product_price7."','".$sum_amount7."','".$sale_remarkk7."','".$discount_unit7."','".$warranty7."','".$cal7."','".$pm7."','".$product_idb1."','".$product_idb1."','".$product_code7."','1','".$product_code7."','".$have_order."','".$clear_br7."','".$clear_ivno7."')";
...
$strSQL100 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit2."','".$unit2."','0.00','0.00','0.00','".$sale_remarkk7."','0.00','0','0','0','".$product_idb2."','".$product_idb2."','1','".$product_code7."','".$have_order."','".$clear_br7."','".$clear_ivno7."')";
$objQuery100 = mysqli_query($conn,$strSQL100);
...
$strSQL101 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit3."','".$unit3."','0.00','0.00','0.00','".$sale_remarkk7."','0.00','0','0','0','".$product_idb3."','".$product_idb3."','1','".$product_code7."','".$have_order."','".$clear_br7."','".$clear_ivno7."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit4."','".$unit4."','0.00','0.00','0.00','".$sale_remarkk7."','0.00','0','0','0','".$product_idb4."','".$product_idb4."','1','".$product_code7."','".$have_order."','".$clear_br7."','".$clear_ivno7."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit5."','".$unit5."','0.00','0.00','0.00','".$sale_remarkk7."','0.00','0','0','0','".$product_idb5."','".$product_idb5."','1','".$product_code7."','".$have_order."','".$clear_br7."','".$clear_ivno7."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit6."','".$unit6."','0.00','0.00','0.00','".$sale_remarkk7."','0.00','0','0','0','".$product_idb6."','".$product_idb6."','1','".$product_code7."','".$have_order."','".$clear_br7."','".$clear_ivno7."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit7."','".$unit7."','0.00','0.00','0.00','".$sale_remarkk7."','0.00','0','0','0','".$product_idb7."','".$product_idb7."','1','".$product_code7."','".$have_order."','".$clear_br7."','".$clear_ivno7."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit8."','".$unit8."','0.00','0.00','0.00','".$sale_remarkk7."','0.00','0','0','0','".$product_idb8."','".$product_idb8."','1','".$product_code7."','".$have_order."','".$clear_br7."','".$clear_ivno7."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit9."','".$unit9."','0.00','0.00','0.00','".$sale_remarkk7."','0.00','0','0','0','".$product_idb9."','".$product_idb9."','1','".$product_code7."','".$have_order."','".$clear_br7."','".$clear_ivno7."')";
$objQuery102 = mysqli_query($conn,$strSQL102);
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit10."','".$unit10."','0.00','0.00','0.00','".$sale_remarkk7."','0.00','0','0','0','".$product_idb10."','".$product_idb10."','1','".$product_code7."','".$have_order."','".$clear_br7."','".$clear_ivno7."')";
...
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$sale_count7."','".$sale_count7."','".$product_price7."','".$product_price7."','".$sum_amount7."','".$sale_remarkk7."','".$discount_unit7."','".$warranty7."','".$cal7."','".$pm7."','".$product_id7."','".$product_id7."','".$have_order."','".$clear_br7."','".$clear_ivno7."')";
...
$strSQL104 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,code_bom,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit1."','".$unit1."','".$product_price8."','".$product_price8."','".$sum_amount8."','".$sale_remarkk8."','".$discount_unit8."','".$warranty8."','".$cal8."','".$pm8."','".$product_idb1."','".$product_idb1."','".$product_code8."','1','".$product_code8."','".$have_order."','".$clear_br8."','".$clear_ivno8."')";
...
$strSQL100 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit2."','".$unit2."','0.00','0.00','0.00','".$sale_remarkk8."','0.00','0','0','0','".$product_idb2."','".$product_idb2."','1','".$product_code8."','".$have_order."','".$clear_br8."','".$clear_ivno8."')";
$objQuery100 = mysqli_query($conn,$strSQL100);
...
$strSQL101 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit3."','".$unit3."','0.00','0.00','0.00','".$sale_remarkk8."','0.00','0','0','0','".$product_idb3."','".$product_idb3."','1','".$product_code8."','".$have_order."','".$clear_br8."','".$clear_ivno8."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit4."','".$unit4."','0.00','0.00','0.00','".$sale_remarkk8."','0.00','0','0','0','".$product_idb4."','".$product_idb4."','1','".$product_code8."','".$have_order."','".$clear_br8."','".$clear_ivno8."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit5."','".$unit5."','0.00','0.00','0.00','".$sale_remarkk8."','0.00','0','0','0','".$product_idb5."','".$product_idb5."','1','".$product_code8."','".$have_order."','".$clear_br8."','".$clear_ivno8."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit6."','".$unit6."','0.00','0.00','0.00','".$sale_remarkk8."','0.00','0','0','0','".$product_idb6."','".$product_idb6."','1','".$product_code8."','".$have_order."','".$clear_br8."','".$clear_ivno8."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit7."','".$unit7."','0.00','0.00','0.00','".$sale_remarkk8."','0.00','0','0','0','".$product_idb7."','".$product_idb7."','1','".$product_code8."','".$have_order."','".$clear_br8."','".$clear_ivno8."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit8."','".$unit8."','0.00','0.00','0.00','".$sale_remarkk8."','0.00','0','0','0','".$product_idb8."','".$product_idb8."','1','".$product_code8."','".$have_order."','".$clear_br8."','".$clear_ivno8."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit9."','".$unit9."','0.00','0.00','0.00','".$sale_remarkk8."','0.00','0','0','0','".$product_idb9."','".$product_idb9."','1','".$product_code8."','".$have_order."','".$clear_br8."','".$clear_ivno8."')";
$objQuery102 = mysqli_query($conn,$strSQL102);
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit10."','".$unit10."','0.00','0.00','0.00','".$sale_remarkk8."','0.00','0','0','0','".$product_idb10."','".$product_idb10."','1','".$product_code8."','".$have_order."','".$clear_br8."','".$clear_ivno8."')";
...
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$sale_count8."','".$sale_count8."','".$product_price8."','".$product_price8."','".$sum_amount8."','".$sale_remarkk8."','".$discount_unit8."','".$warranty8."','".$cal8."','".$pm8."','".$product_id8."','".$product_id8."','".$have_order."','".$clear_br8."','".$clear_ivno8."')";
...
$strSQL104 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,code_bom,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit1."','".$unit1."','".$product_price9."','".$product_price9."','".$sum_amount9."','".$sale_remarkk9."','".$discount_unit9."','".$warranty9."','".$cal9."','".$pm9."','".$product_idb1."','".$product_idb1."','".$product_code9."','1','".$product_code9."','".$have_order."','".$clear_br9."','".$clear_ivno9."')";
...
$strSQL100 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit2."','".$unit2."','0.00','0.00','0.00','".$sale_remarkk9."','0.00','0','0','0','".$product_idb2."','".$product_idb2."','1','".$product_code9."','".$have_order."','".$clear_br9."','".$clear_ivno9."')";
$objQuery100 = mysqli_query($conn,$strSQL100);
...
$strSQL101 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit3."','".$unit3."','0.00','0.00','0.00','".$sale_remarkk9."','0.00','0','0','0','".$product_idb3."','".$product_idb3."','1','".$product_code9."','".$have_order."','".$clear_br9."','".$clear_ivno9."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit4."','".$unit4."','0.00','0.00','0.00','".$sale_remarkk9."','0.00','0','0','0','".$product_idb4."','".$product_idb4."','1','".$product_code9."','".$have_order."','".$clear_br9."','".$clear_ivno9."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit5."','".$unit5."','0.00','0.00','0.00','".$sale_remarkk9."','0.00','0','0','0','".$product_idb5."','".$product_idb5."','1','".$product_code9."','".$have_order."','".$clear_br9."','".$clear_ivno9."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit6."','".$unit6."','0.00','0.00','0.00','".$sale_remarkk9."','0.00','0','0','0','".$product_idb6."','".$product_idb6."','1','".$product_code9."','".$have_order."','".$clear_br9."','".$clear_ivno9."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit7."','".$unit7."','0.00','0.00','0.00','".$sale_remarkk9."','0.00','0','0','0','".$product_idb7."','".$product_idb7."','1','".$product_code9."','".$have_order."','".$clear_br9."','".$clear_ivno9."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit8."','".$unit8."','0.00','0.00','0.00','".$sale_remarkk9."','0.00','0','0','0','".$product_idb8."','".$product_idb8."','1','".$product_code9."','".$have_order."','".$clear_br9."','".$clear_ivno9."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit9."','".$unit9."','0.00','0.00','0.00','".$sale_remarkk9."','0.00','0','0','0','".$product_idb9."','".$product_idb9."','1','".$product_code9."','".$have_order."','".$clear_br9."','".$clear_ivno9."')";
$objQuery102 = mysqli_query($conn,$strSQL102);
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit10."','".$unit10."','0.00','0.00','0.00','".$sale_remarkk9."','0.00','0','0','0','".$product_idb10."','".$product_idb10."','1','".$product_code10."','".$have_order."','".$clear_br9."','".$clear_ivno9."')";
...
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$sale_count9."','".$sale_count9."','".$product_price9."','".$product_price9."','".$sum_amount9."','".$sale_remarkk9."','".$discount_unit9."','".$warranty9."','".$cal9."','".$pm9."','".$product_id9."','".$product_id9."','".$have_order."','".$clear_br9."','".$clear_ivno9."')";
...
$strSQL104 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,code_bom,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit1."','".$unit1."','".$product_price10."','".$product_price10."','".$sum_amount10."','".$sale_remarkk10."','".$discount_unit10."','".$warranty10."','".$cal10."','".$pm10."','".$product_idb1."','".$product_idb1."','".$product_code10."','1','".$product_code10."','".$have_order."','".$clear_br10."','".$clear_ivno10."')";
...
$strSQL100 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit2."','".$unit2."','0.00','0.00','0.00','".$sale_remarkk10."','0.00','0','0','0','".$product_idb2."','".$product_idb2."','1','".$product_code10."','".$have_order."','".$clear_br10."','".$clear_ivno10."')";
$objQuery100 = mysqli_query($conn,$strSQL100);
...
$strSQL101 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit3."','".$unit3."','0.00','0.00','0.00','".$sale_remarkk10."','0.00','0','0','0','".$product_idb3."','".$product_idb3."','1','".$product_code10."','".$have_order."','".$clear_br10."','".$clear_ivno10."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit4."','".$unit4."','0.00','0.00','0.00','".$sale_remarkk10."','0.00','0','0','0','".$product_idb4."','".$product_idb4."','1','".$product_code10."','".$have_order."','".$clear_br10."','".$clear_ivno10."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit5."','".$unit5."','0.00','0.00','0.00','".$sale_remarkk10."','0.00','0','0','0','".$product_idb5."','".$product_idb5."','1','".$product_code10."','".$have_order."','".$clear_br10."','".$clear_ivno10."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit6."','".$unit6."','0.00','0.00','0.00','".$sale_remarkk10."','0.00','0','0','0','".$product_idb6."','".$product_idb6."','1','".$product_code10."','".$have_order."','".$clear_br10."','".$clear_ivno10."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit7."','".$unit7."','0.00','0.00','0.00','".$sale_remarkk10."','0.00','0','0','0','".$product_idb7."','".$product_idb7."','1','".$product_code10."','".$have_order."','".$clear_br10."','".$clear_ivno10."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit8."','".$unit8."','0.00','0.00','0.00','".$sale_remarkk10."','0.00','0','0','0','".$product_idb8."','".$product_idb8."','1','".$product_code10."','".$have_order."','".$clear_br10."','".$clear_ivno10."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit9."','".$unit9."','0.00','0.00','0.00','".$sale_remarkk10."','0.00','0','0','0','".$product_idb9."','".$product_idb9."','1','".$product_code10."','".$have_order."','".$clear_br10."','".$clear_ivno10."')";
$objQuery102 = mysqli_query($conn,$strSQL102);
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit10."','".$unit10."','0.00','0.00','0.00','".$sale_remarkk10."','0.00','0','0','0','".$product_idb10."','".$product_idb10."','1','".$product_code10."','".$have_order."','".$clear_br10."','".$clear_ivno10."')";
...
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$sale_count10."','".$sale_count10."','".$product_price10."','".$product_price10."','".$sum_amount10."','".$sale_remarkk10."','".$discount_unit10."','".$warranty10."','".$cal10."','".$pm10."','".$product_id10."','".$product_id10."','".$have_order."','".$clear_br10."','".$clear_ivno10."')";
...
$strSQL104 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,code_bom,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit1."','".$unit1."','".$product_price11."','".$product_price11."','".$sum_amount11."','".$sale_remarkk11."','".$discount_unit11."','".$warranty11."','".$cal11."','".$pm11."','".$product_idb1."','".$product_idb1."','".$product_code11."','1','".$product_code11."','".$have_order."','".$clear_br11."','".$clear_ivno11."')";
...
$strSQL100 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit2."','".$unit2."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb2."','".$product_idb2."','1','".$product_code11."','".$have_order."','".$clear_br11."','".$clear_ivno11."')";
$objQuery100 = mysqli_query($conn,$strSQL100);
...
$strSQL101 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit3."','".$unit3."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb3."','".$product_idb3."','1','".$product_code11."','".$have_order."','".$clear_br11."','".$clear_ivno11."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit4."','".$unit4."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb4."','".$product_idb4."','1','".$product_code11."','".$have_order."','".$clear_br11."','".$clear_ivno11."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit5."','".$unit5."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb5."','".$product_idb5."','1','".$product_code11."','".$have_order."','".$clear_br11."','".$clear_ivno11."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit6."','".$unit6."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb6."','".$product_idb6."','1','".$product_code11."','".$have_order."','".$clear_br11."','".$clear_ivno11."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit7."','".$unit7."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb7."','".$product_idb7."','1','".$product_code11."','".$have_order."','".$clear_br11."','".$clear_ivno11."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit8."','".$unit8."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb8."','".$product_idb8."','1','".$product_code11."','".$have_order."','".$clear_br11."','".$clear_ivno11."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit9."','".$unit9."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb9."','".$product_idb9."','1','".$product_code11."','".$have_order."','".$clear_br11."','".$clear_ivno11."')";
$objQuery102 = mysqli_query($conn,$strSQL102);
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit10."','".$unit10."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb10."','".$product_idb10."','1','".$product_code11."','".$have_order."','".$clear_br11."','".$clear_ivno11."')";
...
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$sale_count11."','".$sale_count11."','".$product_price11."','".$product_price11."','".$sum_amount11."','".$sale_remarkk11."','".$discount_unit11."','".$warranty11."','".$cal11."','".$pm11."','".$product_id11."','".$product_id11."','".$have_order."','".$clear_br11."','".$clear_ivno11."')";
...
$strSQL104 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,code_bom,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit1."','".$unit1."','".$product_price12."','".$product_price12."','".$sum_amount12."','".$sale_remarkk12."','".$discount_unit12."','".$warranty12."','".$cal12."','".$pm12."','".$product_idb1."','".$product_idb1."','".$product_code12."','1','".$product_code12."','".$have_order."','".$clear_br12."','".$clear_ivno12."')";
...
$strSQL100 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit2."','".$unit2."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb2."','".$product_idb2."','1','".$product_code12."','".$have_order."','".$clear_br12."','".$clear_ivno12."')";
$objQuery100 = mysqli_query($conn,$strSQL100);
...
$strSQL101 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit3."','".$unit3."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb3."','".$product_idb3."','1','".$product_code12."','".$have_order."','".$clear_br12."','".$clear_ivno12."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit4."','".$unit4."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb4."','".$product_idb4."','1','".$product_code12."','".$have_order."','".$clear_br12."','".$clear_ivno12."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit5."','".$unit5."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb5."','".$product_idb5."','1','".$product_code12."','".$have_order."','".$clear_br12."','".$clear_ivno12."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit6."','".$unit6."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb6."','".$product_idb6."','1','".$product_code12."','".$have_order."','".$clear_br12."','".$clear_ivno12."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit7."','".$unit7."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb7."','".$product_idb7."','1','".$product_code12."','".$have_order."','".$clear_br12."','".$clear_ivno12."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit8."','".$unit8."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb8."','".$product_idb8."','1','".$product_code12."','".$have_order."','".$clear_br12."','".$clear_ivno12."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit9."','".$unit9."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb9."','".$product_idb9."','1','".$product_code12."','".$have_order."','".$clear_br12."','".$clear_ivno12."')";
$objQuery102 = mysqli_query($conn,$strSQL102);
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit10."','".$unit10."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb10."','".$product_idb10."','1','".$product_code12."','".$have_order."','".$clear_br12."','".$clear_ivno12."')";
...
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$sale_count12."','".$sale_count12."','".$product_price12."','".$product_price12."','".$sum_amount12."','".$sale_remarkk12."','".$discount_unit12."','".$warranty12."','".$cal12."','".$pm12."','".$product_id12."','".$product_id12."','".$have_order."','".$clear_br12."','".$clear_ivno12."')";
...
$strSQL104 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,code_bom,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit1."','".$unit1."','".$product_price13."','".$product_price13."','".$sum_amount13."','".$sale_remarkk13."','".$discount_unit13."','".$warranty13."','".$cal13."','".$pm13."','".$product_idb1."','".$product_idb1."','".$product_code13."','1','".$product_code13."','".$have_order."','".$clear_br13."','".$clear_ivno13."')";
...
$strSQL100 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit2."','".$unit2."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb2."','".$product_idb2."','1','".$product_code13."','".$have_order."','".$clear_br13."','".$clear_ivno13."')";
$objQuery100 = mysqli_query($conn,$strSQL100);
...
$strSQL101 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit3."','".$unit3."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb3."','".$product_idb3."','1','".$product_code13."','".$have_order."','".$clear_br13."','".$clear_ivno13."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit4."','".$unit4."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb4."','".$product_idb4."','1','".$product_code13."','".$have_order."','".$clear_br13."','".$clear_ivno13."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit5."','".$unit5."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb5."','".$product_idb5."','1','".$product_code13."','".$have_order."','".$clear_br13."','".$clear_ivno13."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit6."','".$unit6."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb6."','".$product_idb6."','1','".$product_code13."','".$have_order."','".$clear_br13."','".$clear_ivno13."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit7."','".$unit7."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb7."','".$product_idb7."','1','".$product_code13."','".$have_order."','".$clear_br13."','".$clear_ivno13."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit8."','".$unit8."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb8."','".$product_idb8."','1','".$product_code13."','".$have_order."','".$clear_br13."','".$clear_ivno13."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit9."','".$unit9."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb9."','".$product_idb9."','1','".$product_code13."','".$have_order."','".$clear_br13."','".$clear_ivno13."')";
$objQuery102 = mysqli_query($conn,$strSQL102);
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit10."','".$unit10."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb10."','".$product_idb10."','1','".$product_code13."','".$have_order."','".$clear_br13."','".$clear_ivno13."')";
...
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$sale_count13."','".$sale_count13."','".$product_price13."','".$product_price13."','".$sum_amount13."','".$sale_remarkk13."','".$discount_unit13."','".$warranty13."','".$cal13."','".$pm13."','".$product_id13."','".$product_id13."','".$have_order."','".$clear_br13."','".$clear_ivno13."')";
...
$strSQL104 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,code_bom,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit1."','".$unit1."','".$product_price14."','".$product_price14."','".$sum_amount14."','".$sale_remarkk14."','".$discount_unit14."','".$warranty14."','".$cal14."','".$pm14."','".$product_idb1."','".$product_idb1."','".$product_code14."','1','".$product_code14."','".$have_order."','".$clear_br14."','".$clear_ivno14."')";
...
$strSQL100 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit2."','".$unit2."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb2."','".$product_idb2."','1','".$product_code14."','".$have_order."','".$clear_br14."','".$clear_ivno14."')";
$objQuery100 = mysqli_query($conn,$strSQL100);
...
$strSQL101 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit3."','".$unit3."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb3."','".$product_idb3."','1','".$product_code14."','".$have_order."','".$clear_br14."','".$clear_ivno14."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit4."','".$unit4."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb4."','".$product_idb4."','1','".$product_code14."','".$have_order."','".$clear_br14."','".$clear_ivno14."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit5."','".$unit5."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb5."','".$product_idb5."','1','".$product_code14."','".$have_order."','".$clear_br14."','".$clear_ivno14."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit6."','".$unit6."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb6."','".$product_idb6."','1','".$product_code14."','".$have_order."','".$clear_br14."','".$clear_ivno14."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit7."','".$unit7."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb7."','".$product_idb7."','1','".$product_code14."','".$have_order."','".$clear_br14."','".$clear_ivno14."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit8."','".$unit8."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb8."','".$product_idb8."','1','".$product_code14."','".$have_order."','".$clear_br14."','".$clear_ivno14."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit9."','".$unit9."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb9."','".$product_idb9."','1','".$product_code14."','".$have_order."','".$clear_br14."','".$clear_ivno14."')";
$objQuery102 = mysqli_query($conn,$strSQL102);
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit10."','".$unit10."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb10."','".$product_idb10."','1','".$product_code14."','".$have_order."','".$clear_br14."','".$clear_ivno14."')";
...
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$sale_count14."','".$sale_count14."','".$product_price14."','".$product_price14."','".$sum_amount14."','".$sale_remarkk14."','".$discount_unit14."','".$warranty14."','".$cal14."','".$pm14."','".$product_id14."','".$product_id14."','".$have_order."','".$clear_br14."','".$clear_ivno14."')";
...
$strSQL104 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,code_bom,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit1."','".$unit1."','".$product_price15."','".$product_price15."','".$sum_amount15."','".$sale_remarkk15."','".$discount_unit15."','".$warranty15."','".$cal15."','".$pm15."','".$product_idb1."','".$product_idb1."','".$product_code15."','1','".$product_code15."','".$have_order."','".$clear_br15."','".$clear_ivno15."')";
...
$strSQL100 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit2."','".$unit2."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb2."','".$product_idb2."','1','".$product_code15."','".$have_order."','".$clear_br15."','".$clear_ivno15."')";
$objQuery100 = mysqli_query($conn,$strSQL100);
...
$strSQL101 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit3."','".$unit3."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb3."','".$product_idb3."','1','".$product_code15."','".$have_order."','".$clear_br15."','".$clear_ivno15."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit4."','".$unit4."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb4."','".$product_idb4."','1','".$product_code15."','".$have_order."','".$clear_br15."','".$clear_ivno15."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit5."','".$unit5."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb5."','".$product_idb5."','1','".$product_code15."','".$have_order."','".$clear_br15."','".$clear_ivno15."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit6."','".$unit6."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb6."','".$product_idb6."','1','".$product_code15."','".$have_order."','".$clear_br15."','".$clear_ivno15."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit7."','".$unit7."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb7."','".$product_idb7."','1','".$product_code15."','".$have_order."','".$clear_br15."','".$clear_ivno15."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit8."','".$unit8."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb8."','".$product_idb8."','1','".$product_code15."','".$have_order."','".$clear_br15."','".$clear_ivno15."')";
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit9."','".$unit9."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb9."','".$product_idb9."','1','".$product_code15."','".$have_order."','".$clear_br15."','".$clear_ivno15."')";
$objQuery102 = mysqli_query($conn,$strSQL102);
...
$strSQL102 = "insert into hos__subso
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,bom_ckk,code_bomsame,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$unit10."','".$unit10."','0.00','0.00','0.00','','0.00','0','0','0','".$product_idb10."','".$product_idb10."','1','".$product_code15."','".$have_order."','".$clear_br15."','".$clear_ivno15."')";
...
(ref_idd,count,countref,price,price_ref,amount,sale_remark,discount,warranty,cal,pm,product_id,product_code,ckk_order,clear_br,clear_ivno)
values ('".$ref_id."','".$sale_count15."','".$sale_count15."','".$product_price15."','".$product_price15."','".$sum_amount15."','".$sale_remarkk15."','".$discount_unit15."','".$warranty15."','".$cal15."','".$pm15."','".$product_id15."','".$product_id15."','".$have_order."','".$clear_br15."','".$clear_ivno15."')";
