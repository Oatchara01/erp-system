...
<div class="w3-container w3-bar w3-light-gray w3-margin-bottom"><h4>รายงานใบยืมค้างเคลียร์ ตามเขตการขาย (ตามรหัสสินค้า)</h4></div>
...
if($sale_code =='SOL0' or $sale_code =='SOL1' or $sale_code =='SOL2' or $sale_code =='SOL3' or $sale_code =='SOL4' or $sale_code =='SOL5' or $sale_code =='SOL91' or $sale_code =='SOL92' or $sale_code =='SOL93' or $sale_code =='SOL94'){ 
...
<div align="right"  class="style33"><?php echo number_format($objResult9["count"],0).""; ?> <?php echo $objResult2["unit_name"]; ?></div>
<?php if($count9!=$count2){ ?>	</font> <?php } ?>		
</td>
...
$strSQL = "SELECT DISTINCT(product_id) from (hos__br  LEFT JOIN hos__subbr ON hos__br.ref_id_br=hos__subbr.ref_idd_br) WHERE clear_ckk = '0' and close_br ='0' and status_doc ='Approve' and sale_code ='".$sale_code."'  and iv_date !='0000-00-00' ORDER BY product_id ASC";
...
$strSQL4 = "SELECT sol_name,access_code,unit_name FROM tb_product WHERE product_ID = '".$objResult["product_id"]."' ";
$objQuery4 = mysqli_query($conn,$strSQL4);
$objResult4 = mysqli_fetch_array($objQuery4);

//
$strSQL1 = "SELECT customer,ref_id_br,iv_no,iv_date,product_id,count,sale_remark,hos__subbr.id FROM (hos__br  LEFT JOIN hos__subbr ON hos__br.ref_id_br=hos__subbr.ref_idd_br) WHERE clear_ckk = '0' and close_br ='0' and status_doc ='Approve' and sale_code ='".$sale_code."' and product_id ='".$objResult["product_id"]."' and iv_date !='0000-00-00' ORDER BY product_id ASC";
$objQuery1 = mysqli_query($conn,$strSQL1) or die ("Error Query [".$strSQL1."]");
$Num_Rows1 = mysqli_num_rows($objQuery1);
...
</p><div class="style15"><?php echo $objResult4["access_code"]; ?> <?php echo $objResult4["sol_name"]; ?></div></p>

<table  border= "1" width="100%" class='w3-table'>
<tr >
<td width="8%" align="center"  ><div class="style32">วันที่</div></td>
<td width="8%" align="center" ><div class="style32">เลขที่ใบยืม</div></td>
<td width="15%" align="center" ><div class="style32">ชื่อลูกค้า</div></td>
...
$strSQL9 = "SELECT SUM(count_send) AS count  FROM (st__main LEFT JOIN st__sbmain ON st__main.ref_id=st__sbmain.ref_idd) WHERE product_id = '".$objResult1['product_id']."' and sale_code = '".$sale_code."'  and type_doc = '3' and ref_idsale ='".$objResult1["ref_id_br"]."'";
$strSQL9 .=" order  by stock_date ASC";
$objQuery9 = mysqli_query($new,$strSQL9) or die ("Error Query [".$strSQL9."]");
$objResult9 = mysqli_fetch_array($objQuery9);	
...
$sql3 = "SELECT sum(sale_count) as count3   FROM   hos__subspr   where  product_id = '".$objResult1['product_id']."' and clear_br = '1' and clear_ivno ='".$objResult1["iv_no"]."' and status_spr='Approve'";
$qry3 = mysqli_query($conn,$sql3) or die(mysqli_error());
$rs3 = mysqli_fetch_array($qry3);
		
$sql13 = "SELECT sum(count) as count3   FROM   hos__subso   where  product_id = '".$objResult1['product_id']."' and clear_br = '1' and clear_ivno ='".$objResult1["iv_no"]."' and status_so='Approve'";
...
$sql4 = "SELECT sum(count) as count4   FROM  (hos__receive  LEFT JOIN hos__subreceive ON hos__receive.ref_id=hos__subreceive.ref_idd)  where iv_no = '".$objResult1["iv_no"]."' and product_id = '".$objResult1['product_id']."'";
$qry4 = mysqli_query($conn,$sql4) or die(mysqli_error());
$rs4 = mysqli_fetch_array($qry4);

$sql12 = "SELECT sum(sale_count) as count3   FROM   hos__subsmp   where  product_id = '".$objResult1['product_id']."' and clear_br = '1' and br_no ='".$objResult1["iv_no"]."' and status_smp='Approve'";
...
$save3="Update  hos__subbr set clear_ckk = '1' where id='".$objResult1["id"]."' and ref_idd_br ='".$objResult1["ref_id_br"]."'";
...
<td ><div align="left"  class="style33"><?php echo $objResult1["customer"]; ?></div></td>
<td><?php if($count9!=$count2){ ?>	<font color='red'> <?php } ?>
...
//
$strSQL1 = "SELECT hos__subconsig.id,product_id,count,sale_remark,ref_id,iv_no,iv_date FROM (hos__consig  LEFT JOIN hos__subconsig ON hos__consig.ref_id=hos__subconsig.ref_idd) WHERE clear_ckk = '0' and close_br ='0' and status_doc ='Approve' and sale_code ='".$sale_code."' and customer_id ='".$objResult["customer_id"]."' and iv_date !='0000-00-00'  ORDER BY product_id ASC";
$objQuery1 = mysqli_query($conn,$strSQL1) or die ("Error Query [".$strSQL1."]");
$Num_Rows1 = mysqli_num_rows($objQuery1);
...
$strSQL9 = "SELECT SUM(count_send) AS count  FROM (st__main LEFT JOIN st__sbmain ON st__main.ref_id=st__sbmain.ref_idd) WHERE product_id = '".$objResult1['product_id']."' and sale_code = '".$sale_code."'  and type_doc = '25' and ref_idsale ='".$objResult1["ref_id"]."'";
$strSQL9 .=" order  by stock_date ASC";
$objQuery9 = mysqli_query($new,$strSQL9) or die ("Error Query [".$strSQL9."]");
$objResult9 = mysqli_fetch_array($objQuery9);	
...
$save3="Update  hos__subconsig set clear_ckk = '1' where id='".$objResult1["id"]."' and ref_idd ='".$objResult1["ref_id"]."'";
$qsave3=mysqli_query($conn,$save3);	
