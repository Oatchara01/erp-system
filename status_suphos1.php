...
$strSQL = "SELECT *  FROM hos__so  where adm_ckk='1'";
...
?>
 ...
 echo DateThai($objResult["date_so"]);
				...
				<td><div align="left">
					<?php
						$strSQL2 = "SELECT * FROM (hos__subso LEFT JOIN tb_product ON hos__subso.product_ID=tb_product.product_id) WHERE ref_idd = '".$objResult["ref_id"]."' ";
						//echo $strSQL1;
						//exit();
