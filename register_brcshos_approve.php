...
<a href="approve_brcshos_cm.php?ref_id=<?php echo $rs["ref_id"];?>&sale_code=<?php echo $_SESSION["code"]; ?>" target="_blank" class="w3-button w3-green w3-center"><font color="black">Approve</font></a>&nbsp;&nbsp;
	
<?php }else{ ?>
<a href="approve_brcshos.php?ref_id=<?php echo $rs["ref_id"];?>&sale_code=<?php echo $_SESSION["code"]; ?>" target="_blank" class="w3-button w3-green w3-center"><font color="black">Approve</font></a>&nbsp;&nbsp;
	
<?php } ?>	

<a href="rejected_brcshos.php?ref_id=<?php echo $rs["ref_id"];?>&sale_code=<?php echo $_SESSION["code"]; ?>" target="_blank" class="w3-button w3-red w3-center"><font color="black">Rejected</font></a>&nbsp;&nbsp;
...
<form action="register_brcshos_approve1.php" method="post" name="frmMain" enctype="multipart/form-data" onSubmit="JavaScript:return fncSubmit();" >
...
function make_autocom(autoObj,showObj){
	...
	new Autocomplete(mkAutoObj, function() {
		...
		if ( this.value.length < 1 && this.isNotClick ) 
			return ;	
		return "data_bill_name2.php?customer_search=" +encodeURIComponent(this.value);
    });	
}	
