...
<div class="w3-panel w3-light-gray"><h4>ADD : กลุ่มลูกค้า</h4></div>

<div class=" w3-container w3-half">

ชื่อกลุ่มลูกค้า
<input name="mode_name" id="mode_name" class="w3-input" >

</div>
<br>
<center>
		  <input type="button" name ="Submit" value="บันทึก" class = "button button4" onClick="this.form.action='add_modecus1.php'; submit()">
</center>
...
$strSQL = "SELECT * FROM tb_mode_customer   where 1";

if($Keyword !=""){ //แสดงว่ามีค่า end_date ส่งมา หรือมีการค้นหา ก็ใหเต่อ String query
	$strSQL .= ' AND mode_name  LIKE "%'.$Keyword.'%"'; 
...
$strSQL .=" order  by id_mode DESC   LIMIT $Page_Start , $Per_Page";
$objQuery  = mysqli_query($conn,$strSQL);
?>
<div class="w3-container">
	<table border="1" width="100%" class="w3-table">
		<thead class="w3-gray">
			<th width="5%">ID กลุ่มลูกค้า</th>
			<th width="20%">ชื่อกลุ่มลูกค้า</th>
			<th width="5%">แก้ไข</th>
	</thead>
<?php
$i = 1;
...
?>
		<tbody>
			<tr>
				<td><?php echo $objResult["id_mode"];?></td>
				<td><?php echo $objResult["mode_name"];?></td>
				<td><a href="edit_modecus.php?id_mode=<?php echo $objResult["id_mode"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a></td>
