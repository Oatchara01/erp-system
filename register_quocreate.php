...
$strSQL = "SELECT *  FROM qou__main WHERE ref_id = '".$_GET['id']."' ";
$objQuery = mysqli_query($conn,$strSQL) or die(mysqli_error());
$objResult = mysqli_fetch_array($objQuery);


$strSQL1 = "SELECT * FROM (qou__sbmain LEFT JOIN tb_product ON qou__sbmain.product_ID=tb_product.product_id) WHERE ref_idd = '".$_GET["id"]."' ";
...
$Num_Rows1 = mysqli_num_rows($objQuery1);
	...
	<form action='register_quocreate1.php' method="post" name="frmMain" enctype="multipart/form-data">
		<div class="w3-white">
...
<option value="">**Please Select Item**</option>
<?php
$strSQL5 = "select * from tb_bank where close_ckk='0' and company !='4' order by number ASC";
...
<td style="width:8%;">
	<input type='text' name = "sn[]<?php echo $objResult1["id"];?>" value="<?php echo $objResult1["sn_number"];?>" id = "sn[]<?php echo $objResult1["id"];?>"  class="w3-input"  placeholder="หมายเลขเครื่อง"  />
</td>
	
<td style="width:8%;"><input type='text' name = "clear_br[]<?php echo $objResult1["id"];?>" value="<?php echo $objResult1["clear_br"];?>" id = "clear_br[]<?php echo $objResult1["id"];?>"  class="w3-input"  />
