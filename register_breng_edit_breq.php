...
<a href="sendmail_approvebr_breq.php?ref_id_br=<?php echo $rs["ref_id_br"];?>&sale_code=<?php echo $_SESSION["code"]; ?>" target="_blank" class="w3-button w3-grey w3-right"><font color="red">ส่งยืมให้ Sup อนุมัติ</font></a>&nbsp;&nbsp;
<?php } ?>


<a href="report_loanhosptl1_breq.php?ref_id_br=<?php echo $rs["ref_id_br"];?>" target="_blank" class="w3-button w3-grey w3-right"><font color="Purple">แบบฟอร์มใบยืมใบยืม</font></a><br />
	...
	<form action="register_breng_edit1_breq.php" method="post" name="frmMain" enctype="multipart/form-data">
	<div class="w3-bar">
...
<input name="sn_num" id="sn_num" value = "<?php echo $rs["sn"]; ?>" class="w3-input" >
เลขที่ CM 
...
$save="Update   in__br set research_demo='1'   where ref_id_br ='".$ref_id_br."'";
...
<td style="width:2%;">
	...
	<a href="producthos_brdelete_breq.php?ref_id_br=<?php echo $rs["ref_id_br"];?>&id=<?php echo $objResult1["id"];?>&code=<?php echo $_SESSION["type_login"]; ?>"><img src="img/false.png" width="16" height="16" border="0" /></a>
	<?php } } ?>
	</td>
