...
$strSQL25="Update  so__main set approve_complete='Rejected',dm_name='".$add_by."',dm_date = '".$add_date."'  where ref_id='".$ref_id."'";
$objQuery25 = mysqli_query($conn,$strSQL25);


$strSQL27="Update  so__submain set status_sol='Rejected'  where ref_idd = '".$ref_id."'";
