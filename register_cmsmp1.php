...
(ref_idsmp,smp_date,address_name,customer_name,comment_sale,status_sup,sale_date,sale_name,sale_code,add_by,add_date,send_sup,sup_name,sup_date,comment_sup,delivery_type,type_company,send_admin,send_stock,send_dm,dm_name,dm_date,dm_create)
values
('".$ref_idsmp."','".$smp_date."','".$address_name."','".$customer_name."','".$comment_sale."','Approve','".$sale_date."','".$sale_name."','SM1','".$add_by."','".$add_date."','".$send_sup."','".$sup_name."','".$sup_date."','".$comment_sup."','".$delivery_type."','".$type_company."','1','1','1','".$name."','".$sale_date."','1')";
...
$save="insert into hos__smp
(ref_idsmp,smp_date,address_name,customer_name,comment_sale,status_sup,sale_date,sale_name,sale_code,add_by,add_date,send_sup,sup_name,sup_date,comment_sup,delivery_type,type_company,send_admin,send_stock,send_dm,dm_name,dm_date)
values
('".$ref_idsmp."','".$smp_date."','".$address_name."','".$customer_name."','".$comment_sale."','Approve','".$sale_date."','".$sale_name."','".$sale_code."','".$add_by."','".$add_date."','".$send_sup."','".$sup_name."','".$sup_date."','".$comment_sup."','".$delivery_type."','".$type_company."','1','1','1','".$name."','".$sale_date."')";
...
values ('".$ref_idsmp."','".$product_id1."','".$product_id1."','".$sale_count1."','".$product_price1."','".$sum_amount1."')";
...
(reff_idsmp,product_id,product_code,sale_count,unit_price,sum_amount)
values ('".$ref_idsmp."','".$product_id2."','".$product_id2."','".$sale_count2."','".$product_price2."','".$sum_amount2."')";
...
(reff_idsmp,product_id,product_code,sale_count,unit_price,sum_amount)
values ('".$ref_idsmp."','".$product_id3."','".$product_id3."','".$sale_count3."','".$product_price3."','".$sum_amount3."')";
...
(reff_idsmp,product_id,product_code,sale_count,unit_price,sum_amount)
values ('".$ref_idsmp."','".$product_id4."','".$product_id4."','".$sale_count4."','".$product_price4."','".$sum_amount4."')";
...
(reff_idsmp,product_id,product_code,sale_count,unit_price,sum_amount)
values ('".$ref_idsmp."','".$product_id5."','".$product_id5."','".$sale_count5."','".$product_price5."','".$sum_amount5."')";
