...
<div class="w3-container w3-padding-large"><!-- main div -->
			<div class="w3-panel w3-light-gray"><h4>รายการรับเรื่องจากลูกค้าของช่าง (ปิดงาน)</h4>
			</div>
	<div class="w3-half">
...
$strSQL = "SELECT *  FROM tb_register_eng  where send_eng='1' and summary_adm='1'";
...
<td><?php echo $objResult["ref_id"];?></td>
				...
				<td><div align="left"><?php echo $objResult["remark_adm"];?>
										<br>
<font color='green'><?php if($objResult["date_calcus"]!='0000-00-00'){ echo "วันที่ติดต่อลูกค้า : "; echo Datethai($objResult["date_calcus"]);	 echo " "; echo $objResult["time_calcus"]; } ?></font>
				...
				<td><a href="register_engveiw.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/create.png" width="23" height="23" border="0" /></a></td>
			</tr>
			<?php $i++; } ?>
		</tbody>
	</table>
