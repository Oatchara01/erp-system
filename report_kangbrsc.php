...
<body>
<center><font size="5">รายการใบยืมฝากขายคงค้าง เขตการขาย <?php echo $sale_code; ?> </font></center>
<?php
...
//
$strSQL1 = "SELECT ref_id,iv_no,iv_date FROM hos__consig WHERE close_br ='0' and status_doc ='Approve' and sale_code ='".$sale_code."' and customer_id ='".$objResult["customer_id"]."' ";
