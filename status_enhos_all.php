...
<div class="w3-panel w3-light-gray"><h4>Status ใบสั่งขาย (ทั้งหมด)</h4></div>
...
$strSQL = "SELECT *  FROM hos__so  where  status_doc !='Rejected'    and stock !='' ";
...
?>
 ...
 echo DateThai($objResult["date_so"]);
				...
				<td><div align="left">
					<?php
						$strSQL1 = "SELECT sol_name,sn,sale_remark FROM (hos__subso LEFT JOIN tb_product ON hos__subso.product_ID=tb_product.product_id) WHERE ref_idd = '".$objResult["ref_id"]."' ";
						//echo $strSQL1;
						//exit();
