...
$sql12 = "SELECT * FROM hos__smp  where  ref_idsmp = '".$_GET['ref_id']."'";
...
<input type="radio" name="type_company"  value="2" >&nbsp;NBM
		...
		<div class="w3-bar w3-margin-bottom">
			...
			<div class="w3-bar w3-margin-bottom">
ที่อยุ่ :<textarea name="address_name" id="address_name" class="w3-input" style="width:90%;"  required><?php echo $rs12["address_name"]; ?></textarea>
</div>
...
<div class="w3-bar w3-margin-bottom">
	...
	<input type="hidden" name="ref_idsale" id="ref_idsale" class="w3-input" style="width:90%;"  value="<?php echo $rs12["ref_idsmp"]; ?>" >
</div>
<div class="w3-bar w3-margin-bottom">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 เบอร์โทรลูกค้า :
<input name="customer_tel"  class="button4" type='text'  value="<?php echo $rs12["customer_tel"]; ?>" id="customer_tel" >
</p>
ชื่อพนักงาน :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<textarea  class="button4" name="address_name1"  style="width:50%" ><?php echo $rs12["address_name"]; ?></textarea>            
</p>

  สถานที่ติดตั้งเครื่อง :</p>
<textarea   class="button4" name="address_send" style="width:50%" rows="2"><?php echo $rs12["address_name"]; ?></textarea>
</p>
