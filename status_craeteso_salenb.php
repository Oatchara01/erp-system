...
<div class="w3-panel w3-light-grey"><h3>Status ใบยืมค้างเคลียร์ (NBM)</h3></div>
...
$strSQL = "SELECT ref_id_br,iv_no,iv_date,customer,sale_code,status_doc,sale,date_br  FROM hos__br  where sale_code LIKE '%EN%' and close_br = '0' and status_doc = 'Approve' and company='2'";
}else{
$strSQL = "SELECT ref_id_br,iv_no,iv_date,customer,sale_code,status_doc,sale,date_br FROM hos__br  where  close_br ='0' and status_doc ='Approve' and sale_code ='".$sale_code."' and company='2'";	
}
