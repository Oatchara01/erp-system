...
$sql = "select * from $table_db  where type_company='NBM' and  sale_ckk='1' and demo_ckk='0' and locate('$product_code_search', $find_field) > 0 order by locate('$product_code_search', $find_field), $find_field limit $pagesize";
