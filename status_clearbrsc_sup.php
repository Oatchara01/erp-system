...
<div class="w3-panel w3-light-grey"><h3>รายการใบยืมฝากขายค้างเคลียร์</h3></div>
...
//and send_sup = '1' 
$strSQL = "SELECT *  FROM hos__consig  where  status_doc ='Approve' and close_br = '0' $sddd";
...
<td>	
<a href=javascript:if(confirm('!!!ต้องการเคลียร์ใบยืมนี้ใช่หรือไม่')==true){window.location='rister_clearbrsc_sup.php?ref_id=<?php echo $objResult["ref_id"];?>';}><img src="img/sticker.png" width="23" height="23" border="0" /></a>	
</td>
