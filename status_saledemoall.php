...
<div class="w3-container w3-padding-large">
	<div class="w3-panel w3-light-grey"><h3>แบบสอบถามสินค้าสาธิต ทำแล้ว (ทั้งหมด)</h3></div>
...
$strSQL = "SELECT *  FROM hos__br  where sale_code = '".$sale_code."' and research_demo ='2' ";	
...
$Num_Rows2 = mysqli_num_rows($objQuery2);
 ...
 if($Num_Rows2 > 0){
 ?>
			<td>	<a href="viewreserch_demo.php?ref_id_br=<?php echo $objResult["ref_id_br"];?>"><img src="img/create.png" width="23" height="23" border="0" /></a>
					<?php }else{ ?>
					<td bgcolor="#FF0000">ไม่ได้ทำแบบสอบถาม
					<?php } ?>							
				</td>
