...
$strSQL = "SELECT *  FROM hos__rental_runiv  where sale_area LIKE '%EN%' and ckk_open='0' and close_ckk='0'";
}else{
$strSQL = "SELECT *  FROM hos__rental_runiv  where sale_area = '".$sale_code."' and ckk_open='0' and close_ckk='0'";	
}
...
<div class="w3-container">
	<table border="1" width="100%" class="w3-table">
		<thead class="w3-gray">
			...
			<th width="8%">วันที่กำหนดการชำระเงิน</th>
...
<?php echo DateThai($objResult["date_runiv"]);?></td>
				<td><a href="register_salerental_edit.php?ref_id=<?php echo $rs["ref_id"];?>"  target="_blank"><?php echo $rs["iv_no"];?></a></td>
...
<td>
<a href="contact_salerental.php?ref_id=<?php echo $rs["ref_id"];?>"  target="_blank"><img src="img/create.png" width="23" height="23" border="0" /></a>
...
<td><a href="open_rentaliv.php?ref_id=<?php echo $rs["ref_id"];?>"><img src="img/create.png" width="23" height="23" border="0" /></a></td>
                <td><a href="close_rental.php?ref_id=<?php echo $rs["ref_id"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a></td>
