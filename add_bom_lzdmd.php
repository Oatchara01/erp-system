...
<div class="w3-panel w3-light-gray"><h4>ADD : PRODUCT LAZADA MEDSHOP</h4></div>
...
<br>
<center>
		  <input type="button" name ="Submit" value="บันทึก" class = "button button4" onClick="this.form.action='add_bom_lzdmd1.php'; submit()">
</center>
...
$strSQL = "SELECT *  FROM tb_product_med  where 1";
...
?>
		<tbody>
			<tr>
				...
				<td><a href="edit_bom_lzdmd.php?lzd_id=<?php echo $objResult["lzd_id"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a></td>
