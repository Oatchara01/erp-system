...
<input type='text' name = "product_c10"  id = "product_c10" class="button4" placeholder="Search ชื่อสินค้า..."  size="10" OnChange="JavaScript:doCallAjax('product_c10','product_id10','product_name10','unit_name10','product_price10');"/> 
