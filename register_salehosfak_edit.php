...
$Num_Rows1 = mysqli_num_rows($objQuery1);
	...
	<form action='register_salehosfak_edit1.php' method="post" name="frmMain" enctype="multipart/form-data"
...
<!--a href="send_faksalead.php?ref_id=<?php echo $rs["ref_id"];?>&sale_code=<?php echo $_SESSION["code"]; ?>" target="_blank" class="w3-button w3-grey w3-right"><font color="red">ส่งออกจากใบฝาก</font></a-->

<a href="sendmail_approveso.php?ref_id=<?php echo $rs["ref_id"];?>&sale_code=<?php echo $_SESSION["code"]; ?>&have_product=<?php echo "2"; ?>" target="_blank" class="w3-button w3-yellow w3-right"><font color="red">ส่งใบสั่งขายให้ Sup อนุมัติ</font></a>&nbsp;&nbsp;
...
<input type='text' name ="product_code[<?php echo $objResult3["id"];?>]" value="<?php echo $objResult3["bom_code"];?>" id ="product_code[<?php echo $objResult3["id"];?>]"  size="5"  class="button4" /></td>
...
<input type='text' name = "warranty[<?php echo $objResult3["id"];?>]" value="<?php echo $objResult3["warranty"];?>" id = "warranty[<?php echo $objResult3["id"];?>]"  class="w3-input"  />
...
<textarea name = "sn[<?php echo $objResult3["id"];?>]"  id = "sn[<?php echo $objResult3["id"];?>]" class="w3-input" ><?php echo $objResult3["sn"];?></textarea>

</td>
	
<td style="width:10%;">
<textarea name = "sale_remarkk[<?php echo $objResult3["id"];?>]"  id = "sale_remarkk[<?php echo $objResult3["id"];?>]" class="w3-input" ><?php echo $objResult3["sale_remark"];?></textarea>
</td>
	
<td style="width:8%;">
	<?php if($objResult3["clear_br"]=='1'){ ?>
	<input type='checkbox' name = "clear_br[<?php echo $objResult3["id"];?>]" checked='checked' value="1" id = "clear_br[<?php echo $objResult3["id"];?>]" >
	<?php }else{ ?>
	<input type='checkbox' name = "clear_br[<?php echo $objResult3["id"];?>]" value="1" id = "clear_br[<?php echo $objResult3["id"];?>]" >
	<?php } ?>
	<input type='text' name = "clear_ivno[<?php echo $objResult3["id"];?>]" value="<?php echo $objResult3["clear_ivno"];?>" id = "clear_ivno[<?php echo $objResult3["id"];?>]" placeholder="เลขที่ใบยืม"  class="w3-input"  />
	</td>
	<td style="width:8%;">
	<?php if($objResult3["jong_ckk"]=='1'){ ?>
	<input type='checkbox' name = "jong_ckk[<?php echo $objResult3["id"];?>]" checked='checked' value="1" id = "jong_ckk[<?php echo $objResult3["id"];?>]" >
	<?php }else{ ?>
	<input type='checkbox' name = "jong_ckk[<?php echo $objResult3["id"];?>]" value="1" id = "jong_ckk[<?php echo $objResult3["id"];?>]" >
	<?php } ?>
	<input type='text' name = "jong_no[<?php echo $objResult3["id"];?>]" value="<?php echo $objResult3["jong_no"];?>" id = "jong_no[<?php echo $objResult3["id"];?>]" placeholder="เลขที่ใบจอง"  class="w3-input"  />
	</td>	
	<?php 	if ($rs["status_doc"] =='Request'){ ?>
