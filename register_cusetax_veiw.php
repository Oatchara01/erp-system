...
<body>
<form  action= "register_cusetax_edit1.php"  method="POST" name="frmMain" enctype="multipart/form-data" >
...
<input type="submit" name ="Submit" value="แก้ไขข้อมูล" class = "button99 button44" onclick="return confirm('โปรดตรวจสอบความถูกต้องของข้อมูล ก่อนส่งข้อมูล กรณีที่ข้อมูลไม่ถูกต้องจะไม่สามารถแก้ไขได้')" >  
	
<a href="register_cusetax_view1.php?ref_id=<?php echo $objResult["ref_id"];?>" class = "button button4"><font color="white">ยืนยัน</font></a>
</center>
<br>
