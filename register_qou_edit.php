...
<body>
	...
	<form action='register_qou_edit1.php' method="post" name="frmMain" enctype="multipart/form-data">
	<div class="w3-white">
...
<a href="sendsup_qou.php?ref_id=<?php echo $objResult["ref_id"];?>" class="w3-button w3-grey w3-right"><font color="FF0000">ส่งข้อมูลให้ Sup</font></a>
	<?php  }  ?>
...
<td style="width:15%;"><textarea name = "product_name[]<?php echo $objResult1["id"];?>" id = "product_name[]<?php echo $objResult1["id"];?>" style="color:black;text-align:left" class="w3-input" readonly><?php echo $objResult1["sol_name"];?></textarea></td>	
...
<td style="width:15%;"><textarea name = "remark_name[]<?php echo $objResult1["id"];?>" id = "remark_name[]<?php echo $objResult1["id"];?>" class="w3-input" size='9' ><?php echo $objResult1["remark_name"];?></textarea></td>	
