...
$sql2 = "SELECT * FROM tb_product_lzd where code_lazada='".$objArr[8]."'";
	//echo $sql2;
$query2 = mysqli_query($conn,$sql2) or die(mysqli_error());
$Num_Rows2 = mysqli_num_rows($query2);
$fetch2 = mysqli_fetch_array($query2);

/*if($objArr[12]=='jpd500d' or $objArr[12]=='JPD-500D' or $objArr[12]=='JPD500D'){	
$id_product1 = "4416";	
}else{}*/
...
$price_per_unit = ($objArr[19]/$unit1);	
$discount_unit = '0';
...
/*if($objArr[12]=='AW100TL' or $objArr[12]=='AW50TL'  or $objArr[12]=='AW50T' or $objArr[12]=='AW25T'){
...
values ('".$fetch21["ref_id"]."','".$unit1."','".$unit1."','".$price_per_unit."','".$price_per_unit."','".$sum_amount."','".$discount_unit."','".$id_product1."','".$id_product1."','".$waranty1."','Approve','".$objArr[21]."')";
...
$customer_name = $objArr[33];
$delivery_name = $objArr[33];
$tax_id = $objArr[50];		

	

$dd = $objArr[31]; //"0$yyy";	
$order_name = $objArr[33];
$delivery_contact = "$objArr[33] / $objArr[34]";
$address1 = $objArr[35];
$address2 = $objArr[38];
$province = $objArr[37];
$ampher = $objArr[38];

$delivery_place = "$objArr[35] $objArr[38] $objArr[37] $objArr[39]";
$tel = $objArr[34];
...
$billing_address = "$objArr[46] $objArr[47] $objArr[48] $objArr[49]";
$billing_name =	$objArr[42];
$billing_tel = $objArr[51];
$billing_postcode =	$objArr[49];
$billing_add = $objArr[46];
$billing_aum = $objArr[47];
$billing_pro = $objArr[48];

}else{

$billing_address = "$objArr[35] $objArr[38] $objArr[37] $objArr[39]";
$billing_name =	$objArr[33];
$billing_tel = $objArr[34];
$billing_postcode =	$objArr[39];	
$billing_add = $objArr[35];
$billing_aum = $objArr[38];
$billing_pro = $objArr[37];
...
(customer_name='".$customer_name."',type_customer='7',cus_address='".$address1."',cus_ampher='".$ampher."',cus_province='".$province."',cus_postcode='".$postcode."',cus_tel='".$tel."',bill_name='".$billing_name."',bill_address='".$billing_add."',bill_ampher='".$billing_aum."',billl_province='".$billing_pro."',bill_postcode='".$billing_postcode."',bill_tel='".$billing_tel."',tax_id='".$tax_id."',delivery_name='".$customer_name."',del_address='".$address1."',del_ampher='".$ampher."',del_province='".$province."',del_postcode='".$postcode."',del_tel='".$tel."',contact_name='".$delivery_contact."',email_cus='".$email."'  where cus_tel = '".$tel."'";
//echo $save9;
$qsave9=mysqli_query($conn,$save9);	
...
values
('".$customer_name."','7','".$address1."','".$ampher."','".$province."','".$postcode."','".$tel."','".$billing_name."','".$billing_add."','".$billing_aum."','".$billing_pro."','".$billing_postcode."','".$billing_tel."','".$tax_id."','".$customer_name."','".$address1."','".$ampher."','".$province."','".$postcode."','".$tel."','".$delivery_contact."','".$employee_name."','".$email."')";
//echo $save9;
$qsave9=mysqli_query($conn,$save9);
...
$strSQL1 = "insert into so__submain
(ref_idd,sale_count,sale_countref,price_per_unit,price_per_unitref,sum_amount,discount_unit,product_id,product_code,warranty,status_sol,code_dis)
values ('".$main_id."','".$unit1."','".$unit1."','".$price_per_unit."','".$price_per_unit."','".$sum_amount."','".$discount_unit."','".$id_product1."','".$id_product1."','".$waranty1."','Approve','".$objArr[21]."')";
...
if($objArr[28]!='0' OR $objArr[28]!='0.00'){
	
$strSQL74 = "insert into so__submain
(ref_idd,sale_count,sale_countref,price_per_unit,price_per_unitref,sum_amount,discount_unit,product_id,product_code,warranty,status_sol,sale_remark)
values ('".$main_id."','1','1','".$objArr[28]."','".$objArr[28]."','".$objArr[28]."','0.00','5204','5204','".$waranty9."','Approve','ค่าจัดส่ง SPX EXPRESS ปกติ')";
	$objQuery74 = mysqli_query($conn,$strSQL74);
...
$strSQL5 = "SELECT *  FROM so__main  WHERE  sale_channel = '33' and register_date = '" . $register_date . "' and ckk_item='0'";
...
values ('".$doc_no."','".$delivery_date."','".$com."','".$billing_name."','".$amount_1."','36','".$add_by."','".$ref_id."','1','Homepro','".$bill_id."','".$sale_channel."','สมบูรณ์','สมบูรณ์','1')";
...
$sql2 = "SELECT ref_id FROM so__main WHERE sale_channel = '33' and register_date = '" . $register_date . "' and ckk_item='0' ";
$result2 = mysqli_query($conn, $sql2);
$Num_Rows21 = mysqli_num_rows($result2);	
	 
$strSQL = "Update  so__main set ckk_item='1' Where sale_channel= '33' and register_date = '".$register_date."'";
