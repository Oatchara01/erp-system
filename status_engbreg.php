...
<div class="w3-container w3-bar w3-light-gray w3-margin-bottom"><h4>Status ใบขอเบิกอะไหล่จากสินค้าขาย (BREG)</h4></div>
...
<div class="w3-container">
	<table border="1" width="100%" class="w3-table">
		<thead class="w3-gray">
			...
			<td width="8%">อนุมัติโดย Sup</td >
			<td width="8%">อนุมัติโดยผู้บริหาร</td >
			<td width="2%">แก้ไข</td >
			<td width="2%">Print</td >
			</thead>
...
<td><div align="left">
	...
	echo $objResult1["sol_name"]; ?><br>
				...
				<?php } ?>
				<td ><div align="left"><?php echo $objResult["sup_name"]; ?> <br>  
				<?php if ($objResult["sup_date"]=="0000-00-00 00:00:00") { echo "-"; }else{ echo $objResult["sup_date"]; } ?></div></td>
