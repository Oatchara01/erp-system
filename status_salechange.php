...
<div class="w3-container w3-padding-large">
	<div class="w3-panel w3-light-grey"><h3>รายการใบแลกเปลี่ยนสินค้า</h3></div>
...
$strSQL = "SELECT *  FROM hos__change  where sale_code LIKE '%EN%' ";	
}else{
$strSQL = "SELECT *  FROM hos__change  where sale_code = '".$sale_code."' ";
}
...
?>
 ...
 echo DateThai($objResult["date_change"]);
				...
				<?php } ?>
				<td>
				<?php if($objResult["status_doc"] =="Rejected" or $objResult["status_doc"] =="Approve"){	}else{ ?> 
