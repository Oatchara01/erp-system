...
<input type='text' name = "br6"  id = "br6" size="7" class="w3-input" >
</td>	
...
<td style="width:10%;">
<textarea name = "sn7" id = "sn7"  class="w3-input"   ></textarea>
</td>	
<td style="width:5%;">
<input type='checkbox' name = "clear_br7"  id = "clear_br7"  class="w3-input" />
<input type='text' name = "br7"  id = "br7" size="7" class="w3-input" >
</td>	
...
<td style="width:10%;">
<textarea name = "sn8" id = "sn8"  class="w3-input"   ></textarea>
</td>	
<td style="width:5%;">
<input type='checkbox' name = "clear_br8"  id = "clear_br8"  class="w3-input" />
<input type='text' name = "br8"  id = "br8" size="7" class="w3-input" >
</td>	
...
<td style="width:10%;">
<textarea name = "sn9" id = "sn9"  class="w3-input"   ></textarea>
</td>	
<td style="width:5%;">
<input type='checkbox' name = "clear_br9"  id = "clear_br9"  class="w3-input" />
<input type='text' name = "br9"  id = "br9" size="7" class="w3-input" >
</td>		
...
<td style="width:10%;">
<textarea name = "sn10" id = "sn10"  class="w3-input"   ></textarea>
</td>	
<td style="width:5%;">
<input type='checkbox' name = "clear_br10"  id = "clear_br10"  class="w3-input" />
<input type='text' name = "br10"  id = "br10" size="7" class="w3-input" >
</td>	
