...
<div class="w3-panel w3-light-grey"><h3>แบบสอบถามสินค้าสาธิต (ทำแบบสอบถามแล้ว)</h3></div>
</form>
<?php	
...
$strSQL = "SELECT ref_id,select_type_doc,register_date,doc_no,doc_release_date,delivery_contact,approve_complete,cancel_ckk,order_refer_code,order_refer_code1,employee_name,sale_channel,bill_id,bill_vat,status_vat  FROM so__main  where research_demo = '2' ";
...
?>
 ...
 echo DateThai($objResult["register_date"]);
	...
	echo $objResult1["sum"]; 
				...
				<?php } ?>
	<td><a href="viewreserch_soldemo.php?ref_id_br=<?php echo $objResult["ref_id"];?>"><img src="img/create.png" width="23" height="23" border="0" /></a></td>
