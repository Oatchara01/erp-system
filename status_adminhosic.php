...
<style>
  ...
  /* คอลัมน์ทั่วไปไม่ให้ดันกว้าง */
  .nowrap-ellipsis{
    white-space:nowrap;
    text-overflow:ellipsis;
  }

  /* คอลัมน์ที่ต้อง “แสดงครบ” */
  .wrap-full{
    white-space:normal;
    overflow:visible;              /* สำคัญ: ให้แสดงครบ */
...
<div class="w3-container w3-bar w3-light-gray w3-margin-bottom"><h4>Status ใบสั่งขาย (ฝากขาย IC) ทั้งหมด</h4></div>
...
<table border="1" class="w3-table tbl-fixed">
...
$strSQL = "SELECT *  FROM hos__so  where  send_sup ='1' and ic_ckk='1'";
...
?>
 ...
 echo DateThai($objResult["date_so"]);
	...
	?><br />
				...
				<td  style="font-size: 10px;"><div align="left"><?php if($objResult["approve_date"]!='0000-00-00'){ echo Datethai($objResult["approve_date"]);  ?>   <?php echo $objResult["approve_time"]; } ?></div></td>
