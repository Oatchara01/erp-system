...
<div class="w3-panel w3-light-gray"><h4>Status ใบฝาก</h4></div>
...
$strSQL = "SELECT ref_id,select_type_doc,register_date,doc_no,doc_release_date,delivery_contact,approve_complete,cancel_ckk  FROM so__main  where allwell_ckk = '1' and have_order = '1' and have_product = '0' and cancel_ckk='0'";
...
?>
 ...
 echo DateThai($objResult["register_date"]);
	...
	?><br />
				...
				<?php } ?>
				<td>
				<a href="register_admin_edit.php?ref_id=<?php echo $objResult["ref_id"];?>&start_date=<?php echo $_GET["start_date"];  ?>&end_date=<?php echo $_GET["end_date"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
