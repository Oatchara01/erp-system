...
$sql_cus = "SELECT * FROM tb_customer where customer_id = '".$rs["bill_id"]."'";
$qry_cus = mysqli_query($conn,$sql_cus) or die(mysqli_error());
$rs_cus = mysqli_fetch_assoc($qry_cus);	
...
$nextId = $yearMonth.$maxId1;
	...
	<form action='register_creteso_breg1.php' method="post" name="frmMain" enctype="multipart/form-data"
...
<input type="radio" name="type_doc" checked='checked' value="4" >&nbsp;ใบสั่งขาย NBM
	...
	<input type="hidden" name="ref_breg" id="ref_breg" class="w3-input" value="<?php echo $rs["ref_id"]; ?>">
	</div>
...
คำนำหน้าชื่อ  : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type='text' name = "pre_name" value="<?php echo $rs_cus["preface_name"];?>"  id = "pre_name" style="width:30%;" class="button4" >				
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
ชื่อที่ต้องการออกบิล :&nbsp; <input type="text" value="<?php echo $rs_cus["bill_name"];?>" name="bill_name" id="bill_name" class="button4" style="width:30%;"  > </p>

ที่อยู่ที่ใช้ในการออกบิล : &nbsp; <textarea rows="2" name="bill_address" id ="bill_address" class="button4" style="width:30%" ><?php echo $rs_cus["bill_address"]; echo $rs_cus["bill_ampher"]; echo $rs_cus["billl_province"];  echo $rs_cus["bill_postcode"];?></textarea>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			
				เบอร์โทรศัพท์ :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="bill_tel" id="bill_tel" class="button4" value="<?php echo $rs_cus["bill_tel"];?>" style="width:30%;" ></p>

<input type="checkbox" name="full_bill" value="1"> &nbsp;บิล VAT


 &nbsp;&nbsp;
เลขประจำตัวผู้เสียภาษี :&nbsp;&nbsp;&nbsp;<input type="text" name="tax_id" id = 'tax_id' value = "<?php echo $rs_cus["tax_id"]; ?>" class="button4" style="width:22%;" >
...
<input type="hidden" name="product_id[<?php echo $objResult1["id"];?>]" class="w3-input w3-center" size="1%" value="<?php echo $objResult1['product_id1']; ?>">
...
<td style="width:5%;"><input type='text' name = "sale_count[<?php echo $objResult1["id"];?>]" value="<?php echo $count;?>" id = "sale_count[<?php echo $objResult1["id"];?>]"  class="w3-input" style="color:black;text-align:center"    /></td>
...
<td style="width:8%;">
	...
	<input type='text' name = "clear_ivno[<?php echo $objResult1["id"];?>]" value="<?php echo $rs["iv_no"];?>" id = "clear_ivno[<?php echo $objResult1["id"];?>]" placeholder="เลขที่ใบยืม"  class="w3-input"  />
	</td>
