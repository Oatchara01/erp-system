...
<body>
	<form action='edit_smpdel1.php' method="post" name="frmMain" enctype="multipart/form-data">
...
$strSQL1 = "SELECT ref_no,ref_no1,ker_bath,date_ker,smp_no,ref_idsmp FROM hos__smp WHERE ref_idsmp = '".$_GET["ref_idsmp"]."'";
$objQuery1 = mysqli_query($conn,$strSQL1);
$objResult1 = mysqli_fetch_array($objQuery1);

$strSQL2 = "SELECT address_1 FROM tb_register_data WHERE ref_id = '".$_GET["ref_idsmp"]."'";
//echo $strSQL2;			
...
เลขที่เอกสาร : &nbsp;
		<input type="text" name="iv_no"  id="iv_no" value="<?php echo $objResult1["smp_no"];?>" class="button4" style="width:20%;" > &nbsp;&nbsp;&nbsp;
		<input type="hidden" name="ref_idsmp"  id="ref_idsmp" value="<?php echo $objResult1["ref_idsmp"];?>" class="button4" style="width:20%;" >
...
<input type='text' name = "order_refer_code"  id = "order_refer_code" class="button4" value="<?php echo $objResult1["ref_no"];?>" style="width:20%;" />

 </p>
เลขที่พัสดุ2  :  &nbsp;&nbsp;
<input type='text' name = "order_refer_code1"  id = "order_refer_code1" class="button4" value="<?php echo $objResult1["ref_no1"];?>" style="width:20%;" />
