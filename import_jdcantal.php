...
$pre_name = "คุณ";
$product_price = $objArr[11]-$objArr[13];
$product_code = $objArr[9];
$count = $objArr[12];
$sum_amount = $product_price*$count;
...
$sql2 = "SELECT * FROM tb_product_lzd where code_lazada='".$objArr[10]."'";
//echo $sql2."<br>";
...
if($objArr[10]=='AW100TL' or $objArr[10]=='AW50TL'  or $objArr[10]=='AW50T' or $objArr[10]=='AW25T'){
...
values ('".$fetch21["ref_id"]."','".$unit1."','".$unit1."','".$product_price."','".$product_price."','".$sum_amount."','0.00','".$id_product1."','".$id_product1."','".$waranty1."','Approve')";
...
$strSQL1 = "insert into so__submain
(ref_idd,sale_count,sale_countref,price_per_unit,price_per_unitref,sum_amount,discount_unit,product_id,product_code,warranty,status_sol)
values ('".$main_id."','".$unit1."','".$unit1."','".$product_price."','".$product_price."','".$sum_amount."','0.00','".$id_product1."','".$id_product1."','".$waranty1."','Approve')";
...
$customer_name = $objArr[26];
$delivery_name = $objArr[26];

$order_name = $objArr[26];
$province = $objArr[31];
...
if($objArr[43] !=''){	
$ex_add =  "$objArr[43]  $objArr[42]";
$billing_address = "$objArr[43] $objArr[42]";
}else{
$ex_add =  "$objArr[27]  $objArr[32]";	
$billing_address = "$objArr[27] $objArr[32]";
}

$delivery_contact = "$objArr[26] / $objArr[33]";
$address1 = $objArr[27];
$delivery_place = $objArr[27];

$postcode =	$objArr[32];

$billing_name =	$objArr[38];
$billing_tel =	$objArr[33];
$tel =	$objArr[33];
$add_date = date('Y-m-d H:i:s');
$order_refer_code = $objArr[0];
$sale_channel = '23';
...
values
('".$customer_name."','7','".$address1."','".$ampher."','".$province."','".$postcode."','".$tel."','".$billing_name."','".$billing_address."','".$ampher."','".$province."','".$billing_postcode."','".$billing_tel."','".$tax_id."','".$delivery_name."','".$delivery_place."','".$ampher."','".$province."','".$postcode."','".$tel."','".$delivery_contact."','".$employee_name."')";
...
$maxId2 = substr("0000".$maxId1, -4);
$nextId = $maxId2;
$doc_no = $so.$so1.$year1.$mont.$nextId;

$save9="insert into tb_doc_nbm (doc_no,year_no,mount_no,run_no,iv_date) values ('".$doc_no."','".$year1."','".$mont."','".$nextId."','".$register_date."')";
$qsave9=mysqli_query($conn,$save9);
...
$qsave19=mysqli_query($conn,$save19);	
 ...
 $strSQL = "INSERT INTO so__main (ref_id,register_date,register_time,delivery_name,address1,province,postcode,billing_address,billing_name,billing_tel,tel,order_id,customer_name,order_name,delivery_contact,delivery_place,add_date,add_by,order_refer_code,sale_channel,select_type_doc,doc_release_date,status_doc,delivery_date,approve_complete,employee_name,job_id,delivery,payment,sale_remark,send_stock,bill_id,doc_no,pre_name,ex_add) VALUES ('".$main_id."','".$register_date."','".$register_time."','".$delivery_name."','".$address1."','".$province."','".$postcode."','".$billing_address."','".$billing_name."','".$billing_tel."','".$tel."','".$order_id."','".$customer_name."','".$order_name."','".$delivery_contact."','".$delivery_place."','".$add_date."','".$add_by."','".$order_refer_code."','".$sale_channel."','".$select_type_doc."','".$doc_release_date."','2','".$delivery_date."','".$approve_complete."','".$employee_name."','".$job_id."','".$delivery."','".$payment."','JD Central','1','".$bill_id."','".$doc_no."','".$pre_name."','".$ex_add."')";
      //echo $strSQL."<br>";
	   //exit();
...
fclose($objCSV);  
 ...
 if($objQuery){
$sql2 = "SELECT ref_id FROM so__main WHERE sale_channel = '23' and register_date = '" . $register_date . "' and register_time = '" . $register_time . "' and add_by ='" . $add_by . "' ";
