...
<td ><input type='checkbox' value='1' name = "clear_br2"  id = "clear_br2"  class="w3-input"  >
...
<td ><input type='checkbox' value='1' name = "clear_br3"  id = "clear_br3"  class="w3-input"   />
...
<td ><input type='checkbox' value='1' name = "clear_br4"  id = "clear_br4"  class="w3-input"   />
...
<td ><input type='checkbox' value='1' name = "clear_br5"  id = "clear_br5"  class="w3-input"   />
