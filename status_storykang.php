...
$strSQL = "SELECT *  FROM tb_register_story  where summary_adm = '0' ";
...
<?php if($objResult["remark_sale"] !='' and $objResult["summary_sale"] =='0'){ ?>
				<td bgcolor="#00FF00">
					<?php }else{ ?>
					<td>
					<?php } ?>
...
<?php if($objResult["summary_sale"]=='1'){ 
	...
	?>
				<a href="register_story_edit.php?id_story=<?php echo $objResult["id_story"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
...
<td>
<a href=javascript:if(confirm('!!!ต้องการเพิ่มเอกสารใหม่โดยCopyเอกสารเดิมใช่หรือไม่')==true){window.location='register_story_create.php?id_story=<?php echo $objResult["id_story"];?>';}><img src="img/sticker.png" width="23" height="23" border="0" /></a>
	
</td>

<td>
<?php if($objResult["summary_sale"]=='1'){ ?>
				<a href="register_storysum.php?id_story=<?php echo $objResult["id_story"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
				<?php } ?>
