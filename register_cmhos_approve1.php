...
$objQuery15 = mysqli_query($conn,$strSQL15) or die(mysqli_error());
 ...
 if($qsave){
   echo "<script language=\"JavaScript\">";
echo "alert('บันทึกข้อมูลของท่านเรียบร้อยแล้ว');window.location='register_cmhos_approve.php?ref_id=$ref_id';";
echo "</script>";
  } else {
   echo "Cannot";
  }
