...
$strSQL = "SELECT *  FROM hos__breg  where status_doc ='Request' and send_dm='1' ";
...
<td><div align="left">
	...
	echo $objResult1["sol_name"]; ?><br>
				...
				<td><a href="register_dmbreg_app.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/create.png" width="23" height="23" border="0" /></a></td>
