...
<div class="w3-panel w3-light-gray"><h4>Status โชว์รายการเคลียร์ยืม</h4></div>
...
$strSQL = "SELECT ref_id,select_type_doc,register_date,doc_no,doc_release_date,delivery_contact,approve_complete,clear_brnp_no,cancel_ckk  FROM so__main  where allwell_ckk = '1' and doc_no NOT LIKE '%BRNP%' and cancel_ckk='0' and approve_complete ='Approve'";

if($start_date !=""){ 
    $strSQL .= ' AND register_date >= "'.$start_date.'"'; 
}else{
    $strSQL .= ' AND register_date >= "2019-12-01"'; 
...
if($Keyword !=""){ //แสดงว่ามีค่า end_date ส่งมา หรือมีการค้นหา ก็ใหเต่อ String query
	...
	$strSQL .= ' or clear_brnp_no  LIKE "%'.$Keyword.'%"'; 
...
<div class="w3-container">
	<table border="1" width="100%" class="w3-table">
		<thead class="w3-gray">
			...
			<th width="10%">เลขที่เคลียร์ใบยืม</th> 
...
?>
 ...
 echo DateThai($objResult["register_date"]);
				...
				<td><?php echo $objResult["clear_brnp_no"];?></td>
				<td>
