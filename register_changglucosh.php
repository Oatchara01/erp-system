...
<div class="w3-white w3-container">
	...
	<form action="register_changglucos_save.php" method="post" name="frmMain" enctype="multipart/form-data" onSubmit="JavaScript:return fncSubmit();">
...
$sql12 = "SELECT * FROM hos__so  where  ref_id = '".$_GET['ref_id']."'";
$qry12 = mysqli_query($conn,$sql12) or die(mysqli_error());
$rs12 = mysqli_fetch_array($qry12);

$sql10 = "SELECT * FROM tb__glucos  where  id = '".$_GET['id']."'";
...
<input type="radio" name="type_company"  value="2" >&nbsp;NBM
		...
		<div class="w3-bar w3-margin-bottom">
			...
			<div class="w3-bar w3-margin-bottom">
ที่อยุ่ :<textarea name="address_name" id="address_name" class="w3-input" style="width:90%;"  required><?php echo $rs12["bill_address"]; ?></textarea>
</div>
...
if($_SESSION['code'] == $objResuut5["sale_code"])
{
$sel = "selected";
}
else
...
<div class="w3-bar w3-margin-bottom">
			ชื่อลูกค้า 
			<input type="text" name="customer_name" id="customer_name" class="w3-input" style="width:90%;"  value="<?php echo $rs12["bill_name"]; ?>" required>
...
<div class="w3-bar w3-margin-bottom">
			Comment Sale:&nbsp;
			<textarea name="comment_sale" id="comment_sale" class="w3-input" style="width:90%;"  required>เบิกเครื่องวัดระดับน้ำตาลในเลือด GLUCOALL-1B (เฉพาะเครื่อง) ทดแทนลูกค้าซื้อเครื่องวัดน้ำตาล GLUCOSURE</textarea>
</div>
<div class="w3-bar w3-margin-bottom">
			Comment Sup :&nbsp;
...
<input type='hidden' name = "product_id1"  id = "product_id1"  value="<?php echo "5499"; ?>" class="w3-input" />
...
ชื่อผู้ติดต่อ  :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input name="customer_name1"  class="button4" type='text'  value="<?php echo $rs12["bill_name"]; ?>" id="customer_name">

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 ผู้รับสินค้า :&nbsp;&nbsp;
<input name="customer_contact"  value="<?php echo $rs12["bill_name"]; ?>" class="button4" type='text' id="customer_contact">


&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 เบอร์โทรลูกค้า :
<input name="customer_tel"  class="button4" type='text'  value="<?php echo $rs12["bill_tel"]; ?>" id="customer_tel" >
</p>
ชื่อพนักงาน :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<textarea  class="button4" name="address_name1"  style="width:50%" ><?php echo $rs12["bill_address"]; ?></textarea>            
</p>

  สถานที่ติดตั้งเครื่อง :</p>
<textarea   class="button4" name="address_send" style="width:50%" rows="2"><?php echo $rs12["bill_address"]; ?></textarea>
</p>
