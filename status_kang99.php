...
<div class="w3-panel w3-light-gray"><h4>Status 99ค้าง IV</h4></div>
...
$strSQL = "SELECT ref_id,select_type_doc,register_date,doc_no,doc_release_date,delivery_contact,approve_complete,ckk_h,bill_vat,select_type_doc,status_vat,print_vat,print_doc,sale_channel,close_mount,billing_name,approve_date,approve_name  FROM so__main  where  (sale_channel = '3' or sale_channel = '45' or sale_channel = '46')  and ckk_h='0' and cancel_ckk='0' and approve_complete ='Approve' and doc_release_date='0000-00-00' and select_type_doc IN (3,4)";
/*and doc_no LIKE '%IV%' and status_doc = '1'*/
...
if($Keyword !=""){ //แสดงว่ามีค่า end_date ส่งมา หรือมีการค้นหา ก็ใหเต่อ String query and doc_release_date ='0000-00-00'
...
<?php
					if($objResult["approve_complete"]=='Rejected'){	?>
						<td bgcolor="#FF3030"><?php echo $objResult["approve_complete"];?>
	<?php if($objResult["approve_name"] !=''){ ?>
					<br>	<?php echo $objResult["approve_name"];?>	<br>
							<?php echo $objResult["approve_date"];?>
							<?php } ?>
	
	</td>
				<?php }
					else if ($objResult["approve_complete"]=='Approve'){ ?>
				<td bgcolor="#00FF00"><?php echo $objResult["approve_complete"];?>
	<?php if($objResult["approve_name"] !=''){ ?>
						<br><?php echo $objResult["approve_name"];?>	<br>
							<?php echo $objResult["approve_date"];?>
							<?php } ?>
				...
				<?php }
					...
					<td ><?php echo $objResult["approve_complete"];?>
	<?php if($objResult["approve_name"] !=''){ ?>
					<br>	<?php echo $objResult["approve_name"];?>	<br>
							<?php echo $objResult["approve_date"];?>
							<?php } ?>
...
$strSQL = "SELECT ref_id,select_type_doc,register_date,doc_no,doc_release_date,delivery_contact,approve_complete,ckk_h,bill_vat,select_type_doc,status_vat,print_vat,print_doc,sale_channel,close_mount,billing_name,approve_date,approve_name  FROM so__main  where allwell_ckk ='1' and sale_channel = '41' and status_doc = '1'  and cancel_ckk='0' and ckk_h='0' and approve_complete ='Approve'";
/*and doc_no LIKE '%IV%'*/
