...
<html>
 ...
 <tr> 
  ...
  <tr>
      ...
      <td align="right"><a href="report_ecomsum.php?sale_code=<?php echo "Ecom";?>&start_date=<?php echo $start_date;?>"  target="_blank" ><?php echo number_format($sum_ecom,2);?></a></td> 
...
$dataPoints = array( 
	...
	array("y" =>  $percen_solecom,"color" => "#330066", "label" => "Ecom" )
