...
$sql = "SELECT *   FROM hos__po where ref_id = '".$ref_id."'";
$qry = mysqli_query($conn,$sql) or die(mysqli_error());
$rs = mysqli_fetch_assoc($qry);


$strSQL1 = "SELECT * FROM  (hos__subpo LEFT JOIN tb_product ON hos__subpo.product_ID=tb_product.product_id) WHERE ref_idd = '".$ref_id."' ";
...
$Num_Rows1 = mysqli_num_rows($objQuery1);
	...
	<form action='register_poso_create1.php' method="post" name="frmMain" enctype="multipart/form-data"
...
?>
		...
		<input type="hidden" name="ref_po" class="w3-input" value="<?php echo $rs["ref_id"]; ?>" >
	</div>
...
<input type='text' name = "bill_id"  id = "bill_id" value = "<?php echo $rs["bill_id"]; ?>" class="button4" placeholder="Search ชื่อลูกค้า..."  style="width:30%;" OnChange="JavaScript:doCallAjax1('bill_id','bill_name','bill_address','bill_tel','tax_id','pre_name');"/> 
<input type='hidden' name = "h_bill_id"  id = "h_bill_id"  class="button4" readonly>
</p>

<?php

$sql2 = "SELECT *   FROM tb_customer where customer_id = '".$rs["bill_id"]."'";
...
คำนำหน้าชื่อ  : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type='text' name = "pre_name" value="<?php echo $rs2["preface_name"];?>"  id = "pre_name" style="width:30%;" class="button4" >				
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
ชื่อที่ต้องการออกบิล :&nbsp; <input type="text" value="<?php echo $rs2["bill_name"];?>" name="bill_name" id="bill_name" class="button4" style="width:30%;"  > </p>

ที่อยู่ที่ใช้ในการออกบิล : &nbsp; <textarea rows="2" name="bill_address" id ="bill_address" class="button4" style="width:30%" ><?php echo $rs2["bill_address"];  echo $rs2["bill_ampher"];  echo $rs2["billl_province"];  echo $rs2["bill_postcode"];  ?></textarea>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			
				เบอร์โทรศัพท์ :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="bill_tel" id="bill_tel" class="button4" value="<?php echo $rs2["bill_tel"];?>" style="width:30%;" ></p>

<input type="checkbox" name="full_bill" value="1"> &nbsp;บิล VAT


 &nbsp;&nbsp;
เลขประจำตัวผู้เสียภาษี :&nbsp;&nbsp;&nbsp;<input type="text" name="tax_id" id = 'tax_id' value = "<?php echo $rs2["tax_id"]; ?>" class="button4" style="width:22%;" >
...
<?php
$strSQL5 = "select * from tb_bank where close_ckk='0' and company !='4' order by number";
...
แนบไฟล์ </p>
<input type='hidden' name='slip_1' id='slip_1' value ="<?php echo $rs['img_po1']; ?>"  />
<input type='hidden' name='slip_2' id='slip_2' value ="<?php echo $rs['img_po2']; ?>"  />
<input type='hidden' name='slip_3' id='slip_3' value ="<?php echo $rs['img_po3']; ?>"  />
<input type='hidden' name='slip_4' id='slip_4' value ="<?php echo $rs['img_po4']; ?>"  />
<input type='hidden' name='slip_5' id='slip_5' value ="<?php echo $rs['img_po5']; ?>"  />

<input name="slip1"  type="file"><a href="upload/<?php echo $rs['img_po1']; ?>" target="_blank"><?php echo $rs['img_po1']; ?></a>
</p>
<input name="slip2"  type="file"><a href="upload/<?php echo $rs['img_po2']; ?>" target="_blank"><?php echo $rs['img_po2']; ?></a>
</p>
<input name="slip3"  type="file"><a href="upload/<?php echo $rs['img_po3']; ?>" target="_blank"><?php echo $rs['img_po3']; ?></a>
</p>
<input name="slip4"  type="file"><a href="upload/<?php echo $rs['img_po4']; ?>" target="_blank"><?php echo $rs['img_po4']; ?></a>
</p>
<input name="slip5"  type="file"><a href="upload/<?php echo $rs['img_po5']; ?>" target="_blank"><?php echo $rs['img_po5']; ?></a>
</p>
...
<td style="width:8%;"><input type='text' name = "clear_br[]<?php echo $objResult1["id"];?>"  id = "clear_br[]<?php echo $objResult1["id"];?>"  class="w3-input"   OnKeyPress="return chkNumber(this)"/>
	<input type='text' name = "clear_ivno[]<?php echo $objResult1["id"];?>"  id = "clear_ivno[]<?php echo $objResult1["id"];?>" placeholder="เลขที่ใบยืม"  class="w3-input"  />
	</td>
