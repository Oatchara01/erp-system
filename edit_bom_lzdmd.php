...
<?php
		$strSQL = "SELECT *  FROM tb_product_med WHERE lzd_id = '".$_GET["lzd_id"]."' ";
...
<br>
<center>
		  <input type="button" name ="Submit" value="บันทึก" class = "button button4" onClick="this.form.action='edit_bom_lzdmd1.php'; submit()">
</center>
