...
$save6="UPDATE tb_service_order SET ref_change='".$ref_id."' where service_order_id = '".$service_order_id."'";
$qsave6=mysqli_query($service,$save6);	
	
}else if($company=='2'){
	
$save6="UPDATE tb_service_order SET ref_change='".$ref_id."' where service_order_id = '".$service_order_id."'";
$qsave6=mysqli_query($servicenb,$save6);	
...
(ref_idd,count_stock,count_sale,price,amount,sale_remark,product_id,product_code,sn)
values ('".$ref_id."','".$count_stock1."','".$count_sale1."','".$product_price1."','".$sum_amount1."','".$sale_remarkk1."','".$product_id1."','".$product_id1."','".$sn1."')";
...
(ref_idd,count_stock,count_sale,price,amount,sale_remark,product_id,product_code,sn)
values ('".$ref_id."','".$count_stock2."','".$count_sale2."','".$product_price2."','".$sum_amount2."','".$sale_remarkk2."','".$product_id2."','".$product_id2."','".$sn2."')";
...
(ref_idd,count_stock,count_sale,price,amount,sale_remark,product_id,product_code,sn)
values ('".$ref_id."','".$count_stock3."','".$count_sale3."','".$product_price3."','".$sum_amount3."','".$sale_remarkk3."','".$product_id3."','".$product_id3."','".$sn3."')";
...
(ref_idd,count_stock,count_sale,price,amount,sale_remark,product_id,product_code,sn)
values ('".$ref_id."','".$count_stock4."','".$count_sale4."','".$product_price4."','".$sum_amount4."','".$sale_remarkk4."','".$product_id4."','".$product_id4."','".$sn4."')";
...
(ref_idd,count_stock,count_sale,price,amount,sale_remark,product_id,product_code,sn)
values ('".$ref_id."','".$count_stock5."','".$count_sale5."','".$product_price5."','".$sum_amount5."','".$sale_remarkk5."','".$product_id5."','".$product_id5."','".$sn5."')";
...
(ref_idd,count_stock,count_sale,price,amount,sale_remark,product_id,product_code,sn)
values ('".$ref_id."','".$count_stock6."','".$count_sale6."','".$product_price6."','".$sum_amount6."','".$sale_remarkk6."','".$product_id6."','".$product_id6."','".$sn6."')";
...
// อ้างอิงเลขที่เอกสารไปยังใบงานบริการช่าง
if($service_order_no != ''){
	$ensql = "UPDATE tb_service_order SET ev_no = '".$ref_id."' WHERE service_order_no = '".$service_order_no."' ";
	if($company == 1){
		$qensql = mysqli_query($service,$ensql);
	} else if($company == 2) {
		$qensql = mysqli_query($servicenb,$ensql);
	}
}
...
echo "alert('บันทึกข้อมูลของท่านเรียบร้อยแล้ว');window.location='register_saletran_edit.php?ref_id=$ref_id';";
echo "</script>";
  } else {
   echo "Cannot";
  }
