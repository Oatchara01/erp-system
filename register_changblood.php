...
<div class="w3-white w3-container">
	...
	<form action="register_changblood1.php" method="post" name="frmMain" enctype="multipart/form-data"  onSubmit="JavaScript:return fncSubmit();" >
...
$sql10 = "SELECT * FROM tb__gluboold  where  ref_id = '".$_GET['ref_id']."'";
...
<input type="radio" name="type_company"  value="2" >&nbsp;NBM
		...
		<div class="w3-bar w3-margin-bottom">
			...
			<div class="w3-bar w3-margin-bottom">
ที่อยุ่ :<textarea name="address_name" id="address_name" class="w3-input" style="width:90%;"  required><?php echo $rs10["address"]; ?> <?php echo $rs10["add_aumpher"]; ?> <?php echo $rs10["province"]; ?> <?php echo $rs10["postcode"]; ?></textarea>
</div>
...
<div class="w3-bar w3-margin-bottom">
			ชื่อลูกค้า 
			<input type="text" name="customer_name" id="customer_name" class="w3-input" style="width:90%;"  value="<?php echo $rs10["customer_name"]; ?>" required>
	<input type="hidden" name="ref_idsale" id="ref_idsale" class="w3-input" style="width:90%;"  value="<?php echo $rs10["ref_id"]; ?>" >
</div>
<div class="w3-bar w3-margin-bottom">
...
<div class="w3-bar w3-margin-bottom">
			Comment Sale:&nbsp;
			<textarea name="comment_sale" id="comment_sale" class="w3-input" style="width:90%;"  required>เบิกเครื่องวัดระดับน้ำตาลในเลือด GLUCOALL-1B (เฉพาะเครื่อง) แลกเปลี่ยนเครื่องวัดน้ำตาลยี่ห้ออื่นๆ</textarea>
</div>
<div class="w3-bar w3-margin-bottom">
			Comment Sup :&nbsp;
...
<td style="width:5%;">
<input type='text' name = "sale_count1" id = "sale_count1"  value='1' class="w3-input" style="color:black;text-align:center"  required>
</td>
<td style="width:8%;">
...
<td style="width:10%;">
<textarea name = "sn_old1" id = "sn_old1"  class="w3-input"   readonly><?php echo trim($rs10["sn_number"]); ?></textarea>
</td>	
<td style="width:8%;">
...
ชื่อผู้ติดต่อ  :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input name="customer_name1"  class="button4" type='text'  value="<?php echo $rs10["customer_name"]; ?>" id="customer_name">

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 ผู้รับสินค้า :&nbsp;&nbsp;
<input name="customer_contact"  value="<?php echo $rs10["customer_name"]; ?>" class="button4" type='text' id="customer_contact">


&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 เบอร์โทรลูกค้า :
<input name="customer_tel"  class="button4" type='text'  value="<?php echo $rs10["customer_tel"]; ?>" id="customer_tel" >
</p>
ชื่อพนักงาน :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<textarea  class="button4" name="address_name1"  style="width:50%" ><?php echo $rs10["address"]; ?> <?php echo $rs10["add_aumpher"]; ?> <?php echo $rs10["province"]; ?> <?php echo $rs10["postcode"]; ?></textarea>            
</p>

  สถานที่ติดตั้งเครื่อง :</p>
<textarea   class="button4" name="address_send" style="width:50%" rows="2"><?php echo $rs10["address"]; ?> <?php echo $rs10["add_aumpher"]; ?> <?php echo $rs10["province"]; ?> <?php echo $rs10["postcode"]; ?></textarea>
</p>
