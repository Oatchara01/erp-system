...
<br><br>
<center> 
    <h2><span class="style15">Upload รายการจาก  Homepro1 </span></h2>
...
<br>
  ...
  <form enctype="multipart/form-data" action="upload_homepro.php" method="POST">
  <center>
  <br>
  <br>
...
<?PHP
  if(!empty($_FILES['uploaded_file']))
  {
    ...
    if(move_uploaded_file($_FILES['uploaded_file']['tmp_name'], $path)) {
     echo '	 	 <center>
           <form action = "import_homepro.php" method ="post">
