...
<div class="w3-container w3-bar w3-light-gray w3-margin-bottom"><h4>Status (BR)</h4></div>
...
$strSQL = "SELECT *  FROM hos__br  where status_doc !='Rejected' ";
...
<?php if($objResult["send_admin"] =='1' ){	?> 
				<a href="report_loanhos.php?ref_id_br=<?php echo $objResult["ref_id_br"];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a><br>
				<a href="report_brnphos_awl.php?ref_id_br=<?php echo $objResult["ref_id_br"];?>"><img src="img/print_icon.jpg" width="23" height="23" border="0" /></a>	
