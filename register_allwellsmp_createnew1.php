...
(ref_idsmp,smp_date,address_name,customer_name,comment_sale,status_sup,sale_date,sale_name,sale_code,add_by,add_date,allwell_ckk,type_company,delivery_type,customer_tel,bill_id)
values
('".$ref_idsmp."','".$smp_date."','".$address_name."','".$customer_name."','".$comment_sale."','".$status_sup."','".$sale_date."','".$sale_name."','".$sale_code."','".$add_by."','".$add_date."','1','".$type_company."','".$delivery_type."','".$customer_tel."','".$bill_id."')";
