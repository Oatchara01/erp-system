...
$strSQL = "SELECT *  FROM hos__so  where  status_doc !='Rejected'  and have_order ='1'  and order_no !='' and have_product ='0'";
...
?>
 ...
 echo DateThai($objResult["date_so"]);
				...
				<td><div align="left">
					<?php
						$strSQL1 = "SELECT access_name,sale_remark FROM (hos__subso LEFT JOIN tb_product ON hos__subso.product_ID=tb_product.product_id) WHERE ref_idd = '".$objResult["ref_id"]."' ";
						//echo $strSQL1;
						//exit();
	...
	echo $objResult1["access_name"];  echo $objResult1["sale_remark"]; 
	...
	echo $objResult2["count"]; ?>&nbsp; <?php  echo $objResult2["unit_name"]; 
	...
	?><br />
				...
				<td><div align="right">
					<?php
						$strSQL3 = "SELECT price FROM hos__subso  WHERE ref_idd = '".$objResult["ref_id"]."' ";
						//echo $strSQL1;
						//exit();
	 ...
	 $price=$objResult3["price"]; echo number_format( $price,2)."";
	...
	?><br />
				...
				<a href="register_stockhos_jong.php?ref_id=<?php echo $objResult["ref_id"];?>&start_date=<?php echo $_GET["start_date"];  ?>&end_date=<?php echo $_GET["end_date"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
				<?php } ?>
