...
<div class="w3-white w3-container">
	...
	<div class="w3-half">
	<h3>Approve Borrow Order</h3>
	</div>

<div class="w3-half">

<a href="dmbrhos_approve.php?ref_id_br=<?php echo $rs["ref_id_br"];?>&que_ckk=<?php echo $rs["que_ckk"];?>&customer=<?php echo $rs["customer"];?>&approve_name=<?php echo $_SESSION['name']; ?>&sale_code=<?php echo $_SESSION['code']; ?>&adm_ckk=<?php echo $rs["adm_ckk"];?>" class="w3-button w3-green "><font color="330066">Approve</font></a>	

	
	
	
<a href="dmbrhos_rejected.php?ref_id_br=<?php echo $rs["ref_id_br"];?>&approve_name=<?php echo $_SESSION['name']; ?>&sale_code=<?php echo $_SESSION['code']; ?>" class="w3-button w3-red "><font color="330066">Rejected</font></a>
