...
values ('".$nextId."','".$product_id_new."','".$have_ckk_new."','".$des_sale_new."','".$sale_code_new."','".$customer_name_new."','".$count_new."','".$sn_number_new."','".$iv_no_new."','".$stock_date_new."','".$iv_date_new."','".$add_by."','".$add_date."','".$today_save."','".$status_doc."','".$employee_code."','2')";
