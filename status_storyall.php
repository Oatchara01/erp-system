...
<div class="w3-panel w3-light-gray"><h4>รายการรับเรื่องจากลูกค้า (ปิดงานแล้วทั้งหมด)</h4></div>
...
$strSQL = "SELECT *  FROM tb_register_story  where summary_adm = '1' ";
...
?>
 ...
 echo DateThai($objResult["date_story"]);
				...
				<td><?php echo DateThai($objResult["date_sumsale"]); ?>  <?php echo $objResult["time_sumsale"]; ?></td>
