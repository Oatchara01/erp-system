...
<div class="w3-half">
	...
	<form action="register_adminbrhos_createnew1.php" method="post" name="frmMain" enctype="multipart/form-data"  onSubmit="JavaScript:return fncSubmit();" >
...
?>
		...
		<div class="w3-bar w3-margin-bottom w3-half">
			...
			<div class="w3-panel"><input type="radio" onclick="javascript:object();" name="objective" value="6" id="object6" required> สินค้าฝากขาย (มีใบรับประกัน)</div>
			<div class="w3-panel">
...
<div class="w3-panel">
			เลขที่เอกสาร  : <input type="text" name="iv_no" id="iv_no" class="w3-input" value = "BRNP" style="width:90%;"  required>
</div>
...
<?php include ('detail_adminbrhos1.php')?>
