...
<form name="frmSearch" method="GET" action="report_express1.php">
...
<option  value="3">บริษัท ฟาร์ ทริลเลียน จำกัด</option>
<option  value="4">บริษัท โนเบิล เมด จำกัด</option>
2</select>
