...
?>
<form  method="post" name="frmMain" enctype="multipart/form-data" onkeypress="return event.keyCode!=13">
	<div class="w3-white">
...
<a href="register_closebr_allwell1.php?ref_id=<?php echo $objResult["ref_id"];?>" target="_blank" class="w3-button w3-grey w3-right"><font color="Blue">ปิดใบยืม</font></a>
