...
<br><br>
<center> 
    <h2><span class="style15">Upload รายการจาก  Amaze</span></h2>
...
<br>
  ...
  <form enctype="multipart/form-data" action="upload_amaze.php" method="POST">
  <center>
  <br>
  <br>
...

  {
    ...
    if(move_uploaded_file($_FILES['uploaded_file']['tmp_name'], $path)) {
     ...
     echo '	 	 <center>
           ...
           <form action = "import_amaze.php" method ="post">
