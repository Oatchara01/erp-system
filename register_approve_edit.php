...
?>
<form action="register_approve_edit1.php" method="post" name="frmMain" >
<div class="w3-container w3-padding-large"><!-- main div -->
<div class="w3-container w3-panel w3-light-gray"><h4>Data : Approve</h4></div>
...
<div class="w3-bar w3-light-grey w3-border">
  <a class="w3-bar-item w3-button" onclick="openCity('st')"><font color="#404040"><b>ผู้อนุมัติ</b></font></a>
...
ผู้อนุมัติ :
<select  name="approve_name" class="w3-select"  >
<option value="">**Please Select Item**</option>
<?php
$emp = "select * from tb_employee where status=1 order by employee_ID";
$sqlemp = mysqli_query($conn,$emp);
while ($fetchemp = mysqli_fetch_array($sqlemp,MYSQLI_ASSOC)) {
if($objResult["approve_name"] == $fetchemp["employee_ID"])
{
$sel = "selected";
}
else
...
<?php 
if ($objResult["approve_name"]=='1'){
	?>

<input type="checkbox" name="approve_complete" checked='checked' value="1">สมบูรณ์

<?php
	}else{
?>
<input type="checkbox" name="approve_complete" value="1">สมบูรณ์
