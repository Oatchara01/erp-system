...
$strSQL = "SELECT ref_id,select_type_doc,register_date,doc_no,doc_release_date,delivery_contact,approve_complete,ckk_h  FROM so__main   where  approve_complete = 'Approve' and bill_send ='1'";
...
<td><a href="register_stock_edit.php?ref_id=<?php echo $objResult["ref_id"];?>&start_date=<?php echo $start_date;  ?>&end_date=<?php echo $end_date;?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a></td>
</tr>
<?php
$i++;
}
