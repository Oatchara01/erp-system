...
<a href="sendsup_brcshos.php?ref_id=<?php echo $rs["ref_id"];?>&sale_code=<?php echo $_SESSION["code"]; ?>" target="_blank" class="w3-button w3-grey w3-right"><font color="red">ส่งให้หัวหน้าอนุมัติ</font></a>&nbsp;&nbsp;
...
<form action="register_brcshos_edit1.php" method="post" name="frmMain" enctype="multipart/form-data" onSubmit="JavaScript:return fncSubmit();" >
