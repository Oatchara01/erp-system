...
?>
<div class="w3-button"><input type="radio" name="select_type_doc" checked='checked' value="1" disabled>&nbsp;ใบยืมสินค้า PTL</div>
<?php
}else{
	?>
<div class="w3-button"><input type="radio" name="select_type_doc" value="1" disabled>&nbsp;ใบยืมสินค้า PTL</div>
		<?php
}
		if ($objResult["select_type_doc"]=='2'){
			?>
<div class="w3-button"><input type="radio" name="select_type_doc" checked='checked' value="2"  disabled>&nbsp;ใบยืมสินค้า NBM</div>
				<?php
		}else{
				?>
<div class="w3-button"><input type="radio" name="select_type_doc" value="2"  disabled>&nbsp;ใบยืมสินค้า NBM</div>
					<?php
					}
		if ($objResult["select_type_doc"]=='3'){
?>
<div class="w3-button"><input type="radio" name="select_type_doc" checked='checked' value="3"  disabled>&nbsp;ใบสั่งขาย PTL</div>
<?php
	}else{
	?>
<div class="w3-button"><input type="radio" name="select_type_doc" value="3"  disabled>&nbsp;ใบสั่งขาย PTL</div>
		<?php
}
			if ($objResult["select_type_doc"]=='4'){
			?>
<div class="w3-button"><input type="radio" name="select_type_doc" checked='checked' value="4"  disabled>&nbsp;ใบสั่งขาย NBM</div>
<?php
			}else{
				?>
<div class="w3-button"><input type="radio" name="select_type_doc" value="4" disabled>&nbsp;ใบสั่งขาย NBM</div>
					<?php
			}
						?>
...
<select name="sale_channel" id="sale_channel" class="w3-select" onchange="showUser(this.value)" disabled>
...
<input name="payment" type='text' class="w3-input" id="payment"  value="<?php echo $objResult["payment_name"]; ?><?php echo $objResult["bank_name"]; ?><?php echo $objResult["book_name"]; ?>" readonly> 
</div>
<div class="w3-padding-small"></div>
<div class="w3-bar">หมายเหตุ
<textarea name="sale_remark"  class="w3-input" id="sale_remark" rows="1" disabled><?php echo $objResult['sale_remark']; ?></textarea>
</div>
<div class="w3-padding-small"></div>
<div class="w3-bar">ชื่อพนักงาน
<input name="employee_name" type='text' class="w3-input" value ="<?php echo $objResult['employee_name']; ?>" id="employee_name" readonly> </div>
</div><!-- 1st half -->
...
<select name="transfer" class="w3-select" disabled>
...
?>
<input type="checkbox" name="account_approve" checked='checked' value="1" disabled>
<?php
}else{
	?>
<input type="checkbox" name="account_approve" value="1" disabled>
...
<select name="province" class="w3-select" disabled>
...
<div class="w3-bar">
ใบสั่งซื้อเลขที่
<input name="order_no" value="<?php echo $objResult['order_id']; ?>" class="w3-input" readonly>
</div>
<div class="w3-bar">
กำหนดส่งตามสัญญา
...
?>
<input name="with_pr" type="checkbox" checked='checked' value="1" disabled>
<?php
}else{
	?>
<input name="with_pr" type="checkbox" value="1" disabled>
<?php
}
			?>
แนบใบเสนอราคา<br />
...
<input type="radio" name="type_type" checked="checked" value="1" o disabled>พิมพ์ตามคอม
<br />
<input type="radio" name="type_type" value="2"  disabled>พิมพ์ตามใบสั่งซื้อ
<br />
<input type="radio" name="type_type" value="3"  disabled>พิมพ์ตามที่เขียน
<br />

<?php
}else if($objResult["type_type"]=='2'){
	?>
<input type="radio" name="type_type"  value="1" disabled>พิมพ์ตามคอม
<br />
<input type="radio" name="type_type" checked="checked" value="2" disabled>พิมพ์ตามใบสั่งซื้อ
<br />
<input type="radio" name="type_type" value="3" disabled>พิมพ์ตามที่เขียน
<br />
...
<input type="radio" name="type_type" value="2" disabled>พิมพ์ตามใบสั่งซื้อ
<br />
<input type="radio" name="type_type" checked="checked" value="3" disabled>พิมพ์ตามที่เขียน
<br />
...
เลขที่เอกสาร
<input name="doc_no" class="w3-input w3-sand" value="<?php echo $objResult['doc_no']; ?>"  type="text" readonly>
ชื่อที่ออกบิล
<input name="billing_name" class="w3-input w3-sand" value="<?php echo $objResult['billing_name']; ?>"  type="text" readonly>
รหัสอ้างอิงการส่ง
<input name="order_refer_code" class="w3-input w3-sand" value="<?php echo $objResult['order_refer_code']; ?>"  type="text" >
วันที่เบิกจ่ายสินค้า
	<?php if ($objResult['date_disburse'] =='0000-00-00'){ ?>
<input name="date_disburse" class="w3-input w3-sand" value="<?php echo $today; ?>"  type="date" >
	
	<?php }else{ ?>
	<input name="date_disburse" class="w3-input w3-sand" value="<?php echo $objResult['date_disburse']; ?>"  type="date" readonly>
	<?php } ?>
</div><!-- close more -->
</div><!-- right half -->
...
?>
<input type="checkbox" name="delivery_company" checked='checked' value="1" disabled>&nbsp;บริษัทจัดส่ง<br />
<?php
}else{
	?>
<input type="checkbox" name="delivery_company" value="1" disabled>&nbsp;บริษัทจัดส่ง<br />
<?php
}
if($objResult["big_car"]=='1'){
		?>
<input type="checkbox" name="big_car" checked='checked' value="1" disabled>&nbsp;ต้องการรถใหญ่<br />
<?php
}else{
			?>

<input type="checkbox" name="big_car" value="1" disabled>&nbsp;ต้องการรถใหญ่<br />
<?php
		}
if($objResult["call_before"]=='1'){
	?>

<input type="checkbox" name="call_before" checked='checked' value="1" disabled>&nbsp;โทรแจ้งลูกค้าก่อนไป<br />
<?php
}else{
	?>
<input type="checkbox" name="call_before" value="1" disabled>&nbsp;โทรแจ้งลูกค้าก่อนไป<br />

		<?php
}
		if($objResult["maps"]=='1'){
			?>
<input type="checkbox" name="maps" checked='checked' value="1" disabled>&nbsp;มีแผนที่ประกอบ<br />
<?php
		}else{
				?>
<input type="checkbox" name="maps" value="1" disabled>&nbsp;มีแผนที่ประกอบ<br />

<?php
}
if($objResult["assign_date_time"]=='1'){
						?>
<input type="checkbox" name="assign_date_time" checked='checked' value="1" disabled>&nbsp;นัดวันเวลาเรียบร้อยแล้ว<br />
<?php
}else{
							?>
<input type="checkbox" name="assign_date_time" value="1" disabled>&nbsp;นัดวันเวลาเรียบร้อยแล้ว<br />
<?php
						}
								?>
</div><!-- 1st 3rd -->
...
?>
<input type="checkbox" name="delivery_sale" checked='checked' value="1" disabled>&nbsp;Sale รับเอง
<?php
}else{
	?>
<input type="checkbox" name="delivery_sale" value="1" disabled>&nbsp;Sale รับเอง

<?php
}
if($objResult["delivery_engineer"]=='1'){
?>
<input type="checkbox" name="delivery_engineer" checked='checked' value="1" disabled>&nbsp;ช่างรับเอง

<?php
}else{
	?>
		<input type="checkbox" name="delivery_engineer" value="1" disabled>&nbsp;ช่างรับเอง
<?php
}
		
		if($objResult["delivery_customer"]=='1'){
?>
<input type="checkbox" name="delivery_customer" checked='checked' value="1" disabled>&nbsp;ลูกค้ารับเอง <br />

<?php
		}else{
	?>
		<input type="checkbox" name="delivery_customer" value="1" disabled>&nbsp;ลูกค้ารับเอง <br />
<?php
}
	?>
	</div>
...
?>
<input type="checkbox" name="returns" checked='checked' value="1" disabled>&nbsp;รับคืนสินค้า<br>
<?php
}else{
	?>
<input type="checkbox" name="returns" value="1" disabled>&nbsp;รับคืนสินค้า<br>
<?php
}
	?>
	</div>
...
<?php include ('data_product_stock.php') ?>

</div>
<center>
<?php if($_SESSION['code']=='ST'){ ?>
 <input type="button" name ="Submit" value="บันทึก" class = "button button4" onClick="this.form.action='register_stock_fak1.php'; submit()">
<?php } ?>
</center>
