...
$save14="UPDATE hos__breg SET ckk_iv ='1',ref_idso='".$ref_id."',open_so='".$add_by."',name_eng='".$add_by."' where ref_id = '".$ref_breg."'";
$qsave14=mysqli_query($conn,$save19);	
