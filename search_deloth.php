...
$strSQL5 = "DELETE FROM tb_delivery_report WHERE 1";
$objQuery5 = mysqli_query($conn,$strSQL5);


?>
<div class="w3-container w3-white">
<form name="frmSearch" method="GET" action="report_deloth.php">
<div class="w3-panel w3-light-gray"><h4>รายงานค่าขนส่งสินค้า</h4></div>
