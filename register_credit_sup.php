...
$nextId = $yearMonth.$maxId1;
	...
	<form action='register_credit_sup1.php' method="post" name="frmMain" enctype="multipart/form-data">
		<div class="w3-white" >
...
ค้นหาชื่อลูกค้า :&nbsp;&nbsp;
<input type="text" name="customer_id" id="customer_id" class="button4" style="width:30%;"  OnChange="JavaScript:doCallAjax1('customer_id','customer_name','address_name','customer_tel','mode_name');"  placeholder="Search ชื่อลูกค้า..." required>
