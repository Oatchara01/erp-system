...
<div class="w3-panel w3-light-gray"><h4>Status ใบยืม (ทั้งหมด)</h4></div>
...
$strSQL = "SELECT *  FROM hos__br  where  status_doc !='Rejected'   and iv_no !='' and iv_date !='0000-00-00' ";
...
?>
 ...
 echo DateThai($objResult["date_br"]);
	...
	?><br />
				...
				$strSQL2 = "SELECT sn FROM hos__subbr  WHERE ref_idd_br = '".$objResult["ref_id_br"]."' ";
						//echo $strSQL1;
						//exit();
	...
	<td  >
				...
				<a href="register_stockbrhos.php?ref_id_br=<?php echo $objResult["ref_id_br"];?>&start_date=<?php echo $_GET["start_date"];  ?>&end_date=<?php echo $_GET["end_date"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
				<?php } ?>
...
<?php if($_SESSION['code']=='ST'){ ?>
				...
				<td bgcolor="#00FF00">
					...
					<td>
					<?php } ?>
<?php if($objResult["send_admin"] =='1'){	if($objResult["company"] =='1' ){				
					?> 
					
				<a href="report_loanhosptl_st.php?ref_id_br=<?php echo $objResult["ref_id_br"];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a>
					<?php }else{ ?>
				<a href="report_loanhosnbm_st.php?ref_id_br=<?php echo $objResult["ref_id_br"];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a>	
				<?php } } ?>
				</td>
				<?php } ?>
