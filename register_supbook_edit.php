...
<div class="w3-white w3-container">
	...
	<?php if($ffirst["send_stock"]=='0'){ ?>
		<a href="send_jong_stapp.php?ref_id=<?php echo $_GET["ref_id"];?>&sale_code=<?php echo $_SESSION["code"]; ?>" target="_blank" class="w3-button w3-grey w3-right"><font color="red">ส่งใบจองดำเนินการ</font></a>&nbsp;&nbsp; 
<?php } ?>
<a href="report_jongpro.php?ref_id=<?php echo $_GET["ref_id"];?>" target="_blank" class="w3-button w3-yellow w3-right"><font color="black">Print Preview</font></a>&nbsp;&nbsp;
	</div>
	<form action="register_supbook_edit1.php" method="post" name="frmMain" enctype="multipart/form-data">
	<div class="w3-bar">
...
<input type="radio" name="type_jong" id="type_jong"   value="1" required>&nbsp;จองมีสัญญา
<input type="radio" name="type_jong" id="type_jong"   value="2" required>&nbsp;จองตามการประมาณการ
<input type="radio" name="type_jong" id="type_jong"   checked='checked' value="3" required>&nbsp;จองสินค้าสาธิต			
		<?php }else{ ?>
<input type="radio" name="type_jong" id="type_jong"   value="1" required>&nbsp;จองมีสัญญา
<input type="radio" name="type_jong" id="type_jong"   value="2" required>&nbsp;จองตามการประมาณการ
<input type="radio" name="type_jong" id="type_jong"   value="3" required>&nbsp;จองสินค้าสาธิต			
...
<div class="w3-bar w3-margin-bottom">
			...
			<div class="w3-bar w3-margin-bottom">
หมายเหตุ :&nbsp;		
			<textarea name="drescription" id="drescription" class="w3-input" style="width:90%;"  ><?php echo $ffirst['drescription']; ?></textarea></div>
				
			<div class="w3-bar w3-margin-bottom">
หมายเหตุ การแก้ไข :&nbsp;		
			<textarea name="remark_edit" id="remark_edit" class="w3-input" style="width:90%;"  required><?php echo $ffirst['remark_edit']; ?></textarea>				
			</div>
			<div class="w3-bar w3-margin-bottom">
				<?php if($ffirst['contact_ckk']=='1'){ ?>
			<input type='checkbox' name ='contact_ckk' checked='checked'  name ='contact_ckk' values='1'> นัดทำสัญญาแล้ว
				<?php }else{ ?>
			<input type='checkbox' name ='contact_ckk'   name ='contact_ckk' values='1'> นัดทำสัญญาแล้ว	
				<?php } ?>
...
<div class="w3-bar w3-margin-bottom">
	...
	<input type="hidden" name="send_stock" id="send_stock" value = "<?php echo $ffirst['send_stock']; ?>"   >
...
<td style="width:2%;"><a href="jong_delete.php?ref_id=<?php echo $ffirst["ref_id"];?>&id=<?php echo $objResult1["id"];?>&code=<?php echo $_SESSION["type_login"]; ?>"><img src="img/false.png" width="16" height="16" border="0" /></a></td>
</tr>
<?php } ?>
...
<?php
	 if ($ffirst['company']=='1'){ 
	include ('detail_salejong1.php');
	 }else  if ($ffirst['company']=='2'){ 
	include ('detail_salejongnb1.php');	 
	 }
		?>
