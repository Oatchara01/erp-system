...
<a href="send_cm.php?ref_id=<?php echo $objResult["ref_id"];?>&billing_name=<?php echo $objResult["billing_name"];?>" target="_blank" class="w3-button w3-grey w3-right"><font color="red">ส่งใบกำกับภาษีให้ผู้บริหารอนุมัติ</font></button></a>&nbsp;&nbsp;
				
	<a href="supp_approve.php?ref_id=<?php echo $objResult["ref_id"];?>&billing_name=<?php echo $objResult["billing_name"];?>" target="_blank" class="w3-button w3-grey w3-right"><font color="green">Approve</font></button></a>&nbsp;&nbsp;
...
<td><input type='text' name = "product_name[]<?php echo $objResult1["id"];?>"  value="<?php echo $objResult1["access_name"];?>" id = "product_name[]<?php echo $objResult1["id"];?>"  class="w3-input" readonly></td>	
