...
<?php	
$strSQL = "SELECT expire_total,problem_total,reorder_point,access_code,sol_name,order_no,unit_name,product_ID,ordered,order_count,grade_b  FROM tb_product  WHERE popular_2 ='1' ";
