...
<a href="send_changesup.php?ref_id=<?php echo $rs["ref_id"];?>&sale_code=<?php echo $_SESSION["code"]; ?>" target="_blank" class="w3-button w3-grey w3-right"><font color="red">ส่งใบแลกเปลี่ยนสินค้าให้ Sup อนุมัติ</font></a>&nbsp;&nbsp;
<?php } ?>
...
<a href="report_salechangeptl.php?ref_id=<?php echo $rs["ref_id"];?>" target="_blank" class="w3-button w3-grey w3-right"><font color="Blue">ใบแลกเปลี่ยน AWL</font></a><br />
<?php
...
?>
	...
	<form action="register_saletran_edit1.php" method="post" name="frmMain" enctype="multipart/form-data">
	<div class="w3-bar">
...
<td><a href="product_tran_del.php?ref_id=<?php echo $rs["ref_id"];?>&id=<?php echo $objResult1["id"];?>"><img src="img/false.png" width="16" height="16" border="0" /></a></td>
</tr>
