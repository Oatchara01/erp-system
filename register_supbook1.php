...
(ref_id,date_jong,company,customer,bq_no,drescription,date_receive,address_send,status_doc,sale_code,sale_name,add_date,add_by,date_approve,send_sup,approve_name,customer_id,iv_no,ref_receive,type_jong)
values
('".$ref_id."','".$date_jong."','".$company."','".$customer."','".$bq_no."','".$drescription."','".$date_receive."','".$address_send."','".$status_doc."','".$sale_code."','".$add_by."','".$add_date."','".$add_by."','".$date_approve."','".$send_sup."','".$add_by."','".$customer_id."','".$iv_no."','".$ref_receive."','".$type_jong."')";
