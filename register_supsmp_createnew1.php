...
(ref_idsmp,smp_date,address_name,customer_name,comment_sale,status_sup,sale_date,sale_name,sale_code,add_by,add_date,send_sup,sup_name,sup_date,comment_sup,type_company,delivery_type)
values
('".$ref_idsmp."','".$smp_date."','".$address_name."','".$customer_name."','".$comment_sale."','".$status_sup."','".$sale_date."','".$sale_name."','".$sale_code."','".$add_by."','".$add_date."','".$send_sup."','".$sup_name."','".$sup_date."','".$comment_sup."','".$type_company."','".$delivery_type."')";
