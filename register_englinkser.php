...
function doCallAjax1(bill_id,bill_name,bill_address,bill_tel,tax_id,pre_name,sale_comment) {
HttPRequest = false;
...
// $sql1 = "SELECT product_sn,service_order_no FROM tb_service_order where service_order_no = '".$_GET["wo_no"]."'";
// $qry1 = mysqli_query($service,$sql1) or die(mysqli_error());
// $rs1 = mysqli_fetch_assoc($qry1);

// $sql3 = "SELECT register_id,install_cus_title,install_cus_name,install_cus_address,install_cus_tel FROM tb_installation_data where product_sn = '".$rs1["product_sn"]."'";
...
if($rs3["register_id"]!=''){			
$strSQL1 = "SELECT * FROM tb_customer WHERE customer_id  = '".$rs3["register_id"]."' ";
$objQuery1 = mysqli_query($conn,$strSQL1) or die(mysqli_error());
$objResult1 = mysqli_fetch_array($objQuery1);
	
$customer_id = $objResult1["customer_id"];	
$preface_name = $objResult1["preface_name"];
$bill_name = $objResult1["bill_name"];
$bill_tel = $objResult1["bill_tel"];
$tax_id = $objResult1["tax_id"];	
$bill_add	=$objResult1["bill_address"]; 
$bill_ampher = $objResult1["bill_ampher"];   
$billl_province = $objResult1["billl_province"];   
$bill_postcode = $objResult1["bill_postcode"];
$bill_address = "$bill_add $bill_ampher $billl_province $bill_postcode";
}else{

$customer_id = '';	
$preface_name = $rs3["install_cus_title"];
$bill_name = $rs3["install_cus_name"];
$bill_tel = $rs3["install_cus_tel"];
$tax_id = '';	
$bill_address = $rs3["install_cus_address"]; 
...
<input type="checkbox" name="que_ckk" id="que_ckk" value="1" ><font color='red' > งานด่วน </font></p>
...
<input type='text' name = "bill_id"  value="<?php echo $customer_id; ?>" id = "bill_id" class="button4" placeholder="Search ชื่อลูกค้า..."  style="width:30%;" OnChange="JavaScript:doCallAjax1('bill_id','bill_name','bill_address','bill_tel','tax_id','pre_name','sale_comment');"/> 
<input type='hidden' name = "h_bill_id"  id = "h_bill_id"  class="button4" readonly></p>

คำนำหน้าชื่อ  : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type='text' name = "pre_name"   value="<?php echo $preface_name; ?>" id = "pre_name" style="width:30%;" class="button4" >
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ชื่อที่ต้องการออกบิล :&nbsp; 
				
<input type='text' name = "bill_name" value="<?php echo $bill_name; ?>" id = "bill_name" style="width:30%;" class="button4" >
				</p>
			
					ที่อยู่ที่ใช้ในการออกบิล : &nbsp;
					
					<textarea  name = "bill_address" id = "bill_address" style="width:30%;" rows="2" class="button4" readonly><?php echo $bill_address;   ?></textarea>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			
				เบอร์โทรศัพท์ :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
<input type='text' name = "bill_tel"  value="<?php echo $objResult1["bill_tel"]; ?>"  id = "bill_tel" style="width:30%;" class="button4" readonly></p>


<input type="checkbox" name="full_bill"  id="full_bill" value="1"> &nbsp;บิล VAT
 &nbsp;&nbsp;
เลขประจำตัวผู้เสียภาษี :&nbsp;&nbsp;&nbsp;<input type="text" name="tax_id"   value="<?php echo $tax_id; ?>" id = 'tax_id' class="button4" style="width:22%;" readonly>
</p>

<input type="checkbox" name="head_1"  id="head_1" value="1"> &nbsp;ต้องการเอกสารแนบบิล<br>
...
<?php
$strSQL5 = "select * from tb_bank where close_ckk='0' and company != '$ab_bank' order by number";
...
เลขที่ใบงานบริการ &nbsp;:
<input name="cm_no" id="cm_no" value="<?php echo $wo_no; ?>"  class="button4" style="width:30%" readonly></p>
