...
<body>
	<?php 
	$strSQL = "SELECT * FROM tb_doc_nbm   where id_doc = '".$_GET["ref_id"]."'";
	//echo $strSQL;
...
<center>
		  <input type="button" name ="Submit" value="บันทึก" class = "button button4" onClick="this.form.action='edit_docno1.php'; submit()">
</center>
