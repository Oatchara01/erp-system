...
?>
 ...
 echo DateThai($objResult["register_date"]);
	...
	?><br />
				...
				<a href="register_supqou_edit.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
				
				</td>
					<td>	
		<?php  
		if($objResult["status_doc"]=='Approve') {
		 ?>
