...
<a href="sendsale_edit.php?ref_id=<?php echo $objResult["ref_id"];?>" class="w3-button w3-grey w3-right"><font color="FF0000">ส่งข้อมูลกลับแก้ไข</font></a>
...
<a href="qou_rejecte.php?ref_id=<?php echo $objResult["ref_id"];?>" class="w3-button w3-grey w3-right"><font color="FF0000">Rejected</font></a>			
	<a href="qou_approve.php?ref_id=<?php echo $objResult["ref_id"];?>" class="w3-button w3-grey w3-right"><font color="00CC00">Approve</font></a>
...
<input type="text" name="cus_name"  class="w3-input" value="<?php echo $objResult["cus_name"] ?>" id="cus_name"  style="width:90%;">
	...
	<input name="iv_no" id="iv_no" class="w3-input" value="<?php echo $objResult["iv_no"] ?>"  type="text" style="width:90%;">
			...
			วันที่ในใบเสนอราคา :
	<input name="iv_date" id="iv_date" class="w3-input" value="<?php echo $objResult["iv_date"] ?>" type="date" style="width:90%;">
