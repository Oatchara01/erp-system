...
<div class="w3-container w3-bar w3-light-gray w3-margin-bottom"><h4>รายงานใบเบิกสินค้า SMP (E-Comerce)</h4></div>
...
$strSQL5 = "SELECT * FROM tb_team_adm where sale_code LIKE '%SOL9%' and sale_code NOT LIKE '%SOL99%' ORDER BY sale_code ASC";
...
$strSQL = "SELECT DISTINCT sale_code  FROM hos__smp  where status_sup='Approve' and sale_code LIKE '%SOL9%' and sale_code NOT LIKE '%SOL99%'";
...
$strSQL1 = "SELECT * FROM hos__smp  where sale_code='".$objResult["sale_code"]."' and  status_sup='Approve'";
