...
<body>
    <div class="w3-white" id="w3-container">
      ...
      <div id="box2_center">
		 ...
		 <a href=javascript:if(confirm('!!!ต้องการสร้างใบรับสินค้าบริษัทโนเบิลเมดใช่หรือไม่')==true){window.location='register_receivepronb.php';}><img src="img/nbm_select.png" width="250" height="120"></a>&nbsp&nbsp&nbsp</br></br></br></br>
