...
<center>
<h4>รายงานการสั่งซื้อ <?php echo $objResult3["salechannel_nameshort"]; ?></h4>
...
$strSQL = "SELECT DISTINCT ref_id FROM tb__buyecomercs1  where sale_chan='".$sale_channel."' and create_date='".$register_date."'";
...
$strSQL6 = "SELECT create_date,doc_date,doc_no,order_id,customer FROM tb__buyecomercs1 WHERE ref_id='".$objResult["ref_id"]."'";
...
<td><?php echo DateThai($objResult6["create_date"]);?></td>
...
<td><div align="right">
<?php
$strSQL4 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE sale_chan='".$sale_channel."' and create_date='".$register_date."'";
$objQuery4 = mysqli_query($conn,$strSQL4) or die ("Error Query [".$strSQL4."]");
$objResult4 = mysqli_fetch_array($objQuery4);
	echo number_format($objResult4["sum_amount"],2); ?>
