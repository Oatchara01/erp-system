...
<form action='register_suprental_edit1.php' method="post" name="frmMain" enctype="multipart/form-data" onSubmit="JavaScript:return fncSubmit();" >
...
<a href="sendrental_adminapp.php?ref_id=<?php echo $objResult["ref_id"];?>&rental_name=<?php echo $objResult["rental_name"]; ?>&iv_no=<?php echo $objResult["iv_no"]; ?>&type_doc=<?php echo $objResult["type_doc"]; ?>" class="w3-button w3-yellow w3-right"><font color="red">ส่งใบสั่งเช่าให้ Admin</font></a>&nbsp;&nbsp;
<?php } ?>
					
<?php if($objResult["ref_iv"]==''){ ?>			
<a href="open_rentaliv_sup.php?ref_id=<?php echo $objResult["ref_id"];?>&type=<?php echo 'IV'; ?>" class="w3-button w3-blue w3-right"><font color="black">เปิดใบค่าเช่าสินค้า</font></a>&nbsp;&nbsp;
	<?php } ?>	<?php if($objResult["ref_ai"]=='0'){ ?>
<a href="open_rentaliv_sup.php?ref_id=<?php echo $objResult["ref_id"];?>&type=<?php echo 'AI'; ?>" class="w3-button w3-grey w3-right"><font color="black">เปิดใบค่ามัดจำสินค้า</font></a>&nbsp;&nbsp;
	<?php } ?>					
...
<input type='hidden' name='bank_img' id='bank_img' value ="<?php echo $rs['bank_img']; ?>"  />	
...
<td style="width:8%;">
<input type='text' name = "warranty[]<?php echo $objResult1["id_sub"];?>" id = "warranty[]<?php echo $objResult1["id_sub"];?>" value="<?php echo $objResult1["warranty"]; ?>"  class="w3-input">
</td>
<td style="width:8%;">
