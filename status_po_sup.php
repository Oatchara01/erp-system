...
$strSQL = "SELECT *  FROM hos__po  where  send_sale = '1' and open_so = '0' and cancel_ckk='0' $sddd";
...
?>
	...
	?><br />
				...
				<td><div align="left">
					<?php
						$strSQL3 = "SELECT sol_name FROM (hos__subpo LEFT JOIN tb_product ON hos__subpo.product_ID=tb_product.product_id) WHERE ref_idd = '".$objResult["ref_id"]."' ";
						//echo $strSQL1;
						//exit();
...
<td  >
<a href="veiw_po.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/preview.jpg" width="23" height="23" border="0" /></a></td>				
<td  >
<a href="register_posup_create.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/create.png" width="23" height="23" border="0" /></a></td>
...
</div></div></div><div id="cr_bar"> <?php include "foot.php"; ?></div>		
