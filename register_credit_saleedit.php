...
$Num_Rows1 = mysqli_num_rows($objQuery1);
	...
	<form action='register_credit_saleedit1.php' method="post" name="frmMain" enctype="multipart/form-data">
	<div class="w3-white">
...
<a href="send_credit_approve.php?ref_credit=<?php echo $rs["ref_credit"];?>&sale_code=<?php echo $_SESSION["code"]; ?>" target="_blank" class="w3-button w3-grey w3-right"><font color="red">ส่งใบสั่งลดหนี้ให้ SUP อนุมัติ</font></button></a>&nbsp;&nbsp;
					<?php } ?>
				</div></div>
...
<input type="radio" name="company_type" id="company_type" value = '4'  class="button4" checked='checked' >&nbsp;&nbsp; NBM</p>
<?php } ?>
