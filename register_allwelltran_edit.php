...
<a href="send_changesup.php?ref_id=<?php echo $rs["ref_id"];?>&sale_code=<?php echo $_SESSION["code"]; ?>&allwell_ckk=<?php echo $rs["allwell_ckk"]; ?>" target="_blank" class="w3-button w3-grey w3-right"><font color="red">ส่งใบแลกเปลี่ยนสินค้าให้ Sup อนุมัติ</font></button></a>&nbsp;&nbsp;
<?php } ?>
...
<a href="report_salechangeptl.php?ref_id=<?php echo $rs["ref_id"];?>" target="_blank" class="w3-button w3-grey w3-right"><font color="Blue">ใบแลกเปลี่ยน AWL</font></button></a><br />
<?php
}else if ($rs["company"]=='2'){
?>
<a href="report_salechangenbm.php?ref_id=<?php echo $rs["ref_id"];?>" target="_blank" class="w3-button w3-grey w3-right"><font color="DeepPink">ใบแลกเปลี่ยน NBM</font></a>
<?php
}
?>
	...
	<form action="register_allwelltran_edit1.php" method="post" name="frmMain" enctype="multipart/form-data">
	<div class="w3-bar">
...
<?php } ?>
		...
		<span class="w3-light-grey w3-right"> เลขที่อ้างอิง : <?php echo $ref_id; ?></span>
		<input type="hidden" name="ref_id" class="w3-input" value="<?php echo $ref_id; ?>">
	</div>
...
<input name="sale_code" type='text' class="w3-input" value ="<?php echo $rs['sale_code']; ?>" id="sale_code" placeholder="Search พนักงาน..."> 
<input name="h_employee_name" type="hidden" id="h_employee_name" value="<?php echo $rs["sale_code"]; ?>" class="w3-input" /> 
</div>
...
<input name="sn" value = "<?php echo $rs["sn"]; ?>" style="width:90%;" class="w3-input" >
...
<?php }else{ ?>
				...
				<input type="radio"  name="objective" value="1"   required> แลกเปลี่ยนสินค้าตามใบงานบริการเลขที่
				<?php } ?>
...
<td><a href="product_tran_del.php?ref_id=<?php echo $objResult["ref_id"];?>&id=<?php echo $objResult1["id"];?>"><img src="img/false.png" width="16" height="16" border="0" /></a></td>
...
<?php	
if($rs["company"]=='1'){
		include ('detail_changehos1.php');
}else if($rs["company"]=='2'){
include ('detail_changehosnb1.php');	
}
		?>
</div>
...
<select name="company_name" class="button4" id="company_name">
...
// การใช้งาน
// make_autocom(" id ของ input ตัวที่ต้องการกำหนด "," id ของ input ตัวที่ต้องการรับค่า");
make_autocom("sale_code","h_employee_name");
        </script>
