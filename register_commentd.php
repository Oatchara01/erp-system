...
<center>
	...
	<form action="register_commentd1.php" name="frmAdd" method="post" onSubmit="JavaScript:return fncSubmit();">
...
<div class="w3-container w3-padding-large">
	...
	<input type='radio' name = "grade"  name='grade'  value="D" checked="checked" size='10' > D
