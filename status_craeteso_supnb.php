...
<input type="submit" class="w3-button w3-teal" value="Search"></div>
 ...
 <center>
		  <input type="button" name ="Submit" value="เปิดใบสั่งขาย" class = "w3-button w3-purple" onClick="this.form.action='register_suphos_any.php'; submit()">
		</center><br>
<?php	
...
$strSQL = "SELECT ref_id_br,iv_no,iv_date,customer,sale_code,status_doc,sale,date_br FROM hos__br  where  close_br ='0' and status_doc ='Approve' and company='2' $sddd";	
