...
<div class="w3-white w3-container">
	...
	<form action="register_supbook1.php" method="post" name="frmMain" enctype="multipart/form-data"  >
...
<div class="w3-bar w3-margin-bottom">
			วันที่ต้องการสินค้า :<input type="date" name="date_receive"  style="width:30%;" class="w3-input"  >
...
<div class="w3-bar w3-margin-bottom">
			ชื่อลูกค้า 
			<input type="text" name="customer" id="customer" class="w3-input" style="width:90%;"  >
</div>

<div class="w3-bar w3-margin-bottom">
	สถานที่ส่ง :<textarea name="address_send" id="address_send" class="w3-input" style="width:90%;"  ></textarea>
...
<?php
	if($_SESSION['department']=="วิศวกรรม"){ 
		include ('detail_engjongnb.php');
	}else{
	include ('detail_salejongnb.php');
	}	
