...
<div class="w3-container">
	<table border="1" width="100%" class="w3-table">
		<thead class="w3-gray">
			...
			<td width="2%">ยิงบาร์โค้ดสินค้า</td >
			<td width="2%">แก้ไข</td >
			<td width="2%">Print</td >
...
$strSQL = "SELECT *  FROM hos__so  where  status_doc !='Rejected'   and stock = ''  and send_sup = '1'";
...
while($objResult = mysqli_fetch_array($objQuery))
{
	...
	if($objResult["status_doc"]=='ยกเลิก'){
	}else{
?>
 ...
 echo DateThai($objResult["date_so"]);
				...
				<td><div align="left">
					<?php
						$strSQL1 = "SELECT access_name,sn,sale_remark FROM (hos__subso LEFT JOIN tb_product ON hos__subso.product_ID=tb_product.product_id) WHERE ref_idd = '".$objResult["ref_id"]."' ";
						//echo $strSQL1;
						//exit();
						...
						while($objResult1 = mysqli_fetch_array($objQuery1)) { ?>
							<?php	echo $objResult1["access_name"]; echo $objResult1["sale_remark"]; ?>
				...
				<a href="register_stockhos.php?ref_id=<?php echo $objResult["ref_id"];?>&start_date=<?php echo $_GET["start_date"];  ?>&end_date=<?php echo $_GET["end_date"];?>"><img src="img/create.png" width="23" height="23" border="0" /></a>
				
								
				</td>
				<td  >
				
<?php if($objResult["send_admin"] =='1' and $objResult["close_mount"] =='0' and $objResult["status_doc"]=='Approve'){	?> 
				<a href=javascript:if(confirm('!!!ต้องการแกไขข้อมูลรายการสินค้าใช่หรือไม่')==true){window.location='register_stockhos_edit.php?ref_id=<?php echo $objResult["ref_id"];?>&start_date=<?php echo $_GET["start_date"];  ?>&end_date=<?php echo $_GET["end_date"];?>';}><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
				<?php } ?>
...
<?php if($objResult["send_admin"] =='1' and $objResult["status_doc"]=='Approve'){	 ?>

<?php if ($objResult["type_doc"]=='3'){?>
<a href="report_salehosptl_st.php?ref_id=<?php echo $objResult["ref_id"];?>&stock=<?php echo $_SESSION['name'];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a>
				<?php }else if ($objResult["type_doc"]=='4'){?>
<a href="report_salehosnbm_st.php?ref_id=<?php echo $objResult["ref_id"];?>&stock=<?php echo $_SESSION['name'];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a>
...
?>
 ...
 echo DateThai($objResult["date_so"]);
			...
			<td ><?php echo $objResult["order_no"];?></td>
				...
				<td><div align="left">
					<?php
						$strSQL1 = "SELECT access_name,sn FROM (hos__subso LEFT JOIN tb_product ON hos__subso.product_ID=tb_product.product_id) WHERE ref_idd = '".$objResult["ref_id"]."' ";
						//echo $strSQL1;
						//exit();
						$objQuery1 = mysqli_query($conn,$strSQL1) or die ("Error Query [".$strSQL1."]");
						$Num_Rows1 = mysqli_num_rows($objQuery1);
