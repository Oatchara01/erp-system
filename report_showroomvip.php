...
<div class="w3-white w3-container">
	...
	<div class="w3-panel w3-light-gray"><h4>รายงานเปิดออเดอร์ HomeCare</h4></div>
...
<?php
$strSQL = "SELECT salechannel_ID,salechannel_nameshort,GP_sum FROM tb_salechannel where salechannel_ID IN ('3', '4', '41', '45', '46')";	
...
<td bgcolor = "#FFCC99" ><?php  if($objResult["GP_sum"]=='0.0000'){  echo number_format($objResult16["sum_amount"]/1.07,2); }else{ echo number_format(($objResult16["sum_amount"])/1.07,2); } ?></td>	
...
$strSQL1 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE  sale_chan IN ('3', '4', '41', '45', '46') and doc_date ='".$day_1."'";
$objQuery1 = mysqli_query($conn,$strSQL1) or die ("Error Query [".$strSQL1."]");
$objResult1 = mysqli_fetch_array($objQuery1);
	
$strSQL2 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE  sale_chan IN ('3', '4', '41', '45', '46') and doc_date ='".$day_2."'";
$objQuery2 = mysqli_query($conn,$strSQL2) or die ("Error Query [".$strSQL2."]");
$objResult2 = mysqli_fetch_array($objQuery2);
	
$strSQL3 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE  sale_chan IN ('3', '4', '41', '45', '46') and doc_date ='".$day_3."'";
$objQuery3 = mysqli_query($conn,$strSQL3) or die ("Error Query [".$strSQL3."]");
$objResult3 = mysqli_fetch_array($objQuery3);
	
$strSQL4 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE  sale_chan IN ('3', '4', '41', '45', '46') and doc_date ='".$day_4."'";
$objQuery4 = mysqli_query($conn,$strSQL4) or die ("Error Query [".$strSQL4."]");
$objResult4 = mysqli_fetch_array($objQuery4);
	
$strSQL5 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE  sale_chan IN ('3', '4', '41', '45', '46') and doc_date ='".$day_5."'";
$objQuery5 = mysqli_query($conn,$strSQL5) or die ("Error Query [".$strSQL5."]");
$objResult5 = mysqli_fetch_array($objQuery5);
	
$strSQL6 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE  sale_chan IN ('3', '4', '41', '45', '46') and doc_date ='".$day_6."'";
$objQuery6 = mysqli_query($conn,$strSQL6) or die ("Error Query [".$strSQL6."]");
$objResult6 = mysqli_fetch_array($objQuery6);
	
$strSQL7 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE  sale_chan IN ('3', '4', '41', '45', '46') and doc_date ='".$day_7."'";
$objQuery7 = mysqli_query($conn,$strSQL7) or die ("Error Query [".$strSQL7."]");
$objResult7 = mysqli_fetch_array($objQuery7);
	
$strSQL8 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE  sale_chan IN ('3', '4', '41', '45', '46') and doc_date ='".$day_8."'";
$objQuery8 = mysqli_query($conn,$strSQL8) or die ("Error Query [".$strSQL8."]");
$objResult8 = mysqli_fetch_array($objQuery8);
	
$strSQL9 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE  sale_chan IN ('3', '4', '41', '45', '46') and doc_date ='".$day_9."'";
$objQuery9 = mysqli_query($conn,$strSQL9) or die ("Error Query [".$strSQL9."]");
$objResult9 = mysqli_fetch_array($objQuery9);
	
$strSQL10 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE  sale_chan IN ('3', '4', '41', '45', '46') and doc_date ='".$day_10."'";
$objQuery10 = mysqli_query($conn,$strSQL10) or die ("Error Query [".$strSQL10."]");
$objResult10 = mysqli_fetch_array($objQuery10);
	
$strSQL11 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE  sale_chan IN ('3', '4', '41', '45', '46') and doc_date ='".$day_11."'";
$objQuery11 = mysqli_query($conn,$strSQL11) or die ("Error Query [".$strSQL11."]");
$objResult11 = mysqli_fetch_array($objQuery11);
	
$strSQL12 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE  sale_chan IN ('3', '4', '41', '45', '46') and doc_date ='".$day_12."'";
$objQuery12 = mysqli_query($conn,$strSQL12) or die ("Error Query [".$strSQL12."]");
$objResult12 = mysqli_fetch_array($objQuery12);
	
$strSQL13 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE  sale_chan IN ('3', '4', '41', '45', '46') and doc_date ='".$day_13."'";
$objQuery13 = mysqli_query($conn,$strSQL13) or die ("Error Query [".$strSQL13."]");
$objResult13 = mysqli_fetch_array($objQuery13);
	
$strSQL14 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE  sale_chan IN ('3', '4', '41', '45', '46') and doc_date ='".$day_14."'";
$objQuery14 = mysqli_query($conn,$strSQL14) or die ("Error Query [".$strSQL14."]");
$objResult14 = mysqli_fetch_array($objQuery14);
	
$strSQL15 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE  sale_chan IN ('3', '4', '41', '45', '46') and doc_date ='".$day_15."'";
$objQuery15 = mysqli_query($conn,$strSQL15) or die ("Error Query [".$strSQL15."]");
$objResult15 = mysqli_fetch_array($objQuery15);	

$strSQL16 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE  sale_chan IN ('3', '4', '41', '45', '46') and doc_date >='".$day_1."'  and doc_date <='".$day_31."'";
$objQuery16 = mysqli_query($conn,$strSQL16) or die ("Error Query [".$strSQL16."]");
$objResult16 = mysqli_fetch_array($objQuery16);		
...
<?php
$strSQL = "SELECT salechannel_ID,salechannel_nameshort FROM tb_salechannel where  salechannel_ID IN ('3', '4', '41', '45', '46')";	
$objQuery = mysqli_query($conn,$strSQL) or die ("Error Query [".$strSQL."]");
$Num_Rows = mysqli_num_rows($objQuery);		
while($objResult = mysqli_fetch_array($objQuery))
{
...
$strSQL1 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE sale_chan IN ('3', '4', '41', '45', '46')  and doc_date ='".$day_16."'";
$objQuery1 = mysqli_query($conn,$strSQL1) or die ("Error Query [".$strSQL1."]");
$objResult1 = mysqli_fetch_array($objQuery1);
	
$strSQL2 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE sale_chan IN ('3', '4', '41', '45', '46')  and doc_date ='".$day_17."'";
$objQuery2 = mysqli_query($conn,$strSQL2) or die ("Error Query [".$strSQL2."]");
$objResult2 = mysqli_fetch_array($objQuery2);
	
$strSQL3 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE sale_chan IN ('3', '4', '41', '45', '46')  and doc_date ='".$day_18."'";
$objQuery3 = mysqli_query($conn,$strSQL3) or die ("Error Query [".$strSQL3."]");
$objResult3 = mysqli_fetch_array($objQuery3);
	
$strSQL4 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE sale_chan IN ('3', '4', '41', '45', '46')  and doc_date ='".$day_19."'";
$objQuery4 = mysqli_query($conn,$strSQL4) or die ("Error Query [".$strSQL4."]");
$objResult4 = mysqli_fetch_array($objQuery4);
	
$strSQL5 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE sale_chan IN ('3', '4', '41', '45', '46')  and doc_date ='".$day_20."'";
$objQuery5 = mysqli_query($conn,$strSQL5) or die ("Error Query [".$strSQL5."]");
$objResult5 = mysqli_fetch_array($objQuery5);
	
$strSQL6 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE sale_chan IN ('3', '4', '41', '45', '46')  and doc_date ='".$day_21."'";
$objQuery6 = mysqli_query($conn,$strSQL6) or die ("Error Query [".$strSQL6."]");
$objResult6 = mysqli_fetch_array($objQuery6);
	
$strSQL7 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE sale_chan IN ('3', '4', '41', '45', '46')  and doc_date ='".$day_22."'";
$objQuery7 = mysqli_query($conn,$strSQL7) or die ("Error Query [".$strSQL7."]");
$objResult7 = mysqli_fetch_array($objQuery7);
	
$strSQL8 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE sale_chan IN ('3', '4', '41', '45', '46')  and doc_date ='".$day_23."'";
$objQuery8 = mysqli_query($conn,$strSQL8) or die ("Error Query [".$strSQL8."]");
$objResult8 = mysqli_fetch_array($objQuery8);
	
$strSQL9 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE sale_chan IN ('3', '4', '41', '45', '46')  and doc_date ='".$day_24."'";
$objQuery9 = mysqli_query($conn,$strSQL9) or die ("Error Query [".$strSQL9."]");
$objResult9 = mysqli_fetch_array($objQuery9);
	
$strSQL10 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE sale_chan IN ('3', '4', '41', '45', '46')  and doc_date ='".$day_25."'";
$objQuery10 = mysqli_query($conn,$strSQL10) or die ("Error Query [".$strSQL10."]");
$objResult10 = mysqli_fetch_array($objQuery10);
	
$strSQL11 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE sale_chan IN ('3', '4', '41', '45', '46')  and doc_date ='".$day_26."'";
$objQuery11 = mysqli_query($conn,$strSQL11) or die ("Error Query [".$strSQL11."]");
$objResult11 = mysqli_fetch_array($objQuery11);
	
$strSQL12 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE sale_chan IN ('3', '4', '41', '45', '46')  and doc_date ='".$day_27."'";
$objQuery12 = mysqli_query($conn,$strSQL12) or die ("Error Query [".$strSQL12."]");
$objResult12 = mysqli_fetch_array($objQuery12);
	
$strSQL13 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE sale_chan IN ('3', '4', '41', '45', '46')  and doc_date ='".$day_28."'";
$objQuery13 = mysqli_query($conn,$strSQL13) or die ("Error Query [".$strSQL13."]");
$objResult13 = mysqli_fetch_array($objQuery13);
	
$strSQL14 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE sale_chan IN ('3', '4', '41', '45', '46')  and doc_date ='".$day_29."'";
$objQuery14 = mysqli_query($conn,$strSQL14) or die ("Error Query [".$strSQL14."]");
$objResult14 = mysqli_fetch_array($objQuery14);
	
$strSQL15 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE sale_chan IN ('3', '4', '41', '45', '46')  and doc_date ='".$day_30."'";
$objQuery15 = mysqli_query($conn,$strSQL15) or die ("Error Query [".$strSQL15."]");
$objResult15 = mysqli_fetch_array($objQuery15);		
	
$strSQL16 = "SELECT SUM(amount) AS sum_amount FROM tb__buyecomercs1 WHERE sale_chan IN ('3', '4', '41', '45', '46')  and doc_date ='".$day_31."'";
$objQuery16 = mysqli_query($conn,$strSQL16) or die ("Error Query [".$strSQL16."]");
$objResult16 = mysqli_fetch_array($objQuery16);			
	?>
<tr>	
