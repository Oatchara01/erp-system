...
$save56="Update tb__gluboold SET chang_ckk='1',smp_ref='".$ref_idsmp."' where  ref_id ='".$ref_idsale."'";
...
(reff_idsmp,product_id,product_code,sale_count,sale_countref,unit_price,sum_amount,sale_remark,sn_out)
