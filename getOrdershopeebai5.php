...
$strSQL = "SELECT order_id,cs_remark FROM so__main WHERE sale_channel ='12'  and order_refer_code ='' and cs_remark LIKE '%ด่วน%' and cs_remark NOT LIKE '%Instant%' and doc_no!='' and pre_ckk='0'";
$objQuery = mysqli_query($conn, $strSQL) or die ("Error Query [".$strSQL."]");
...
$strSQL = "SELECT order_id,cs_remark FROM so__main WHERE sale_channel ='12'  and order_refer_code ='' and cs_remark LIKE '%ด่วน%' and cs_remark NOT LIKE '%Instant%' and doc_no!='' register_date > '2026-01-01' and pre_ckk='1'";
$objQuery = mysqli_query($conn, $strSQL) or die ("Error Query [".$strSQL."]");
