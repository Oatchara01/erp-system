...
<div class="w3-panel w3-light-gray"><h4>อนุมัติใบเสนอราคา</h4></div>
...
$strSQL = "SELECT *  FROM qou__main  where send_sup='1' and status_doc ='Request' ";
...
?>
 ...
 echo DateThai($objResult["register_date"]);
				...
				<td>
					<?php if ($objResult["iv_date"]=="0000-00-00" or $objResult["iv_date"]=="") {
						echo "-"; 
					} 
					else 
	...
	?><br />
				...
				<a href="register_appqou.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
