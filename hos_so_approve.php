...
<div class="w3-container">
	<div class="w3-panel w3-light-grey"><h3>View Sale Order</h3></div>
	<form action="register_sale_hos1.php" method="post" name="frmMain" enctype="multipart/form-data">
	<div class="w3-bar">
		<?php if($fv["company"]=="PTL") { ?>
			<input type="radio" name="company" value="PTL" checked readonly> <img src="img/ptl64.png">
			<input type="radio" name="company" value="NBM" readonly> <img src="img/nbm64.png">
		<?php } 
		else if($fv["company"]=="NBM") { ?>
			<input type="radio" name="company" value="PTL" readonly> <img src="img/ptl64.png">
			<input type="radio" name="company" value="NBM" checked readonly> <img src="img/nbm64.png">
		<?php } ?>
	</div>
	...
	<div class="w3-bar w3-margin-bottom"></div>
		<div class="w3-half"><!--ครึ่งแรก-->
			<div class="w3-bar 11">
				<div class="w3-half">
					วันที่ <input type="date" name="date" class="w3-input" style="width:90%;" value="<?php echo $fv["date"]; ?>" readonly>
				</div>
				<div class="w3-half 12">
					ชื่อผู้แนะนำ/ร.พ./แผนก <input type="text" name="suggest" class="w3-input" style="width:90%;" value="<?php echo $fv["suggest"]; ?>" readonly>
				</div>
			</div>
			<div class="w3-bar w3-padding-small"></div>
			<div class="w3-bar 31">
				ชื่อที่ต้องการออกบิล <input type="text" name="bill_name" class="w3-input" style="width:95%;" value="<?php echo $fv["bill_name"]; ?>" readonly>
			</div>
			<div class="w3-bar w3-padding-small"></div>
			<div class="w3-bar 32">
				ที่อยู่ที่ใช้ในการออกบิล <input type="text" name="bill_address" class="w3-input" style="width:95%" value="<?php echo $fv["bill_address"]; ?>" readonly>
			</div>
			<div class="w3-bar w3-padding-small"></div>
			<div class="w3-half 24">
				เบอร์โทรศัพท์ <input type="text" name="bill_tel" class="w3-input" style="width:90%;" value="<?php echo $fv["bill_tell"]; ?>" readonly>
			</div>
			<div class="w3-half 242">
				ชำระโดย <input type="text" name="payment" class="w3-input" style="width:90%;" value="<?php echo $fv["payment"]; ?>" readonly>
			</div>				
			
			<div class="w3-bar w3-padding-small"></div>
			
			<div class="w3-half 33">
				ใบสั่งซื้อเลขที่ <input type="text" name="po_no" class="w3-input" style="width:90%;" value="<?php echo $fv["po_no"]; ?>" readonly>
			</div>
			<div class="w3-half 34">
				กำหนดส่งตามสัญญา <input type="text" name="delivery_contract" class="w3-input" style="width:90%;" value="<?php echo $fv["delivery_contract"]; ?>" readonly>
			</div>
			<div class="w3-bar w3-padding-small"></div>
			<div class="w3-bar">
				สถานที่ติดตั้ง<input name="install_place" class="w3-input" style="width:95%;" value="<?php echo $fv["install_place"]; ?>" readonly>
			</div>
			<div class="w3-bar w3-padding-small"></div>
			<div class="w3-bar">
				Sale Comment<textarea name="sale_comment" rows="5" class="w3-input" style="width:95%;" readonly><?php echo $fv["sale_comment"]; ?></textarea>
			</div>
			<div class="w3-bar w3-margin-bottom"></div>
		</div><!-- จบครึ่งแรก -->
			...
			<div class="w3-padding-small"></div>
				<div class="w3-half 1 w3-container w3-padding-small"><!-- first right half-->
					<?php if($fv["book_clear"]==1) { ?>
						<div class="w3-bar"><input type="checkbox" name="book_clear" value="1" checked readonly> Clear ใบจองสินค้า เลขที่ <input type="text" name="book_no" class="w3-input" style="width:90%;" value="<?php echo $fv["book_no"]; ?>" readonly></div>
					<?php } else { ?>
						<div class="w3-bar"><input type="checkbox" name="book_clear" value="1" readonly> Clear ใบจองสินค้า เลขที่ <input type="text" name="book_no" class="w3-input" style="width:90%;" readonly></div>
					<?php } ?>
					<div class="w3-padding-small"></div>
					<?php if($fv["brn_clear"]==1) { ?>
						<div class="w3-bar"><input type="checkbox" name="brn_clear" value="1" checked readonly> Clear ใบยืมสินค้าติดเล่ม <input type="text" name="brn_no" class="w3-input" style="width:90%;" value="<?php echo $fv["brn_no"]; ?>" readonly></div>
					<?php } else { ?>
						<div class="w3-bar"><input type="checkbox" name="brn_clear" value="1" readonly> Clear ใบยืมสินค้าติดเล่มี่ <input type="text" name="brn_no" class="w3-input" style="width:90%;" readonly></div>
					<?php } ?>
					<div class="w3-padding-small"></div>
					<?php if($fv["brnp_clear"]==1) { ?>
						<div class="w3-bar"><input type="checkbox" name="brnp_clear" value="1" checked readonly> Clear ใบยืมฯ กระดาษต่อเนื่อง <input type="text" name="brnp_no" class="w3-input" style="width:90%;" value="<?php echo $fv["brnp_no"]; ?>" readonly></div>
					<?php } else { ?>
						<div class="w3-bar"><input type="checkbox" name="brnp_clear" value="1" readonly> Clear ใบยืมฯ กระดาษต่อเนื่อง <input type="text" name="brnp_no" class="w3-input" style="width:90%;" readonly></div>
					<?php } ?>					
					<div class="w3-padding-small"></div>
					<div class="w3-bar">Sale</div>
					<div class="w3-bar">
						<input type="text" name="sale" class="w3-input" style="width:90%;" value="<?php echo $fv["sale"]; ?>" readonly>
						<input type="date" name="sale_date" class="w3-input" style="width:90%;" value="<?php echo $fv["sale_date"]; ?>" readonly>
					</div>
					<div class="w3-padding-small"></div>
					<div class="w3-bar">
							Approve
							<?php if($fv["approve"]!="") { ?>
								<input type="text" name="approve" class="w3-input" style="width:90%;" value="<?php echo $fv["approve"]; ?>" readonly>
								<input type="date" name="approve_time" class="w3-input" style="width:90%;" value="<?php echo $fv["approve_date"]; ?>" readonly>
							<?php } else if($fv["approve"]=="") { ?>
								<input type="text" name="approve" class="w3-input w3-light-grey" style="width:90%;" readonly>
				...
				<div class="w3-half 2 w3-padding-small"><!--second right half-->
						<div class="w3-bar"><?php if($fv["with_pr"]==1) { ?>
								<input type="checkbox" name="with_pr" value="1" checked readonly> แนบใบเสนอราคา <?php }
							else { ?>
								<input type="checkbox" name="with_pr" value="1" readonly> แนบใบเสนอราคา <?php } ?>
						</div>
						<div class="w3-padding-small"></div>
						<div class="w3-bar"><?php if($fv["full_bill"]==1) { ?>
								<input type="checkbox" name="full_bill" value="1" checked readonly> ต้องการใบกำกับภาษี<?php }
							else { ?>
								<input type="checkbox" name="full_bill" value="1" readonly> ต้องการใบกำกับภาษี <?php } ?>
						</div>
						<div class="w3-padding-small"></div>
						<?php if($fv["type_type"]==1) { ?>
							<div class="w3-bar"><input type="radio" onclick="javascript:qtype();" name="type_type" value="1" id="type1" checked readonly> พิมพ์ตามคอม</div>
							<div class="w3-bar"><input type="radio" onclick="javascript:qtype();" name="type_type" value="2" id="type2" readonly> พิมพ์ตามใบสั่งซื้อ</div>
							<div class="w3-bar"><input type="radio" onclick="javascript:qtype();" name="type_type" value="3" id="type3" readonly> พิมพ์ตามที่เขียน
								<div id="detail" style="display:none">
									<textarea name="type_detail" class="w3-input" style="width:90%;" rows="5"></textarea>
								</div>
							</div>
						<?php } else if($fv["type_type"]==2) { ?>
							<div class="w3-bar"><input type="radio" onclick="javascript:qtype();" name="type_type" value="1" id="type1" readonly> พิมพ์ตามคอม</div>
							<div class="w3-bar"><input type="radio" onclick="javascript:qtype();" name="type_type" value="2" id="type2" checked readonly> พิมพ์ตามใบสั่งซื้อ</div>
							<div class="w3-bar"><input type="radio" onclick="javascript:qtype();" name="type_type" value="3" id="type3" readonly> พิมพ์ตามที่เขียน
								<div id="detail" style="display:none">
									<textarea name="type_detail" class="w3-input" style="width:90%;" rows="5"></textarea>
								</div>
						...
						<?php } else if($fv["type_type"]==3) { ?>
							<div class="w3-bar"><input type="radio" onclick="javascript:qtype();" name="type_type" value="1" id="type1" readonly> พิมพ์ตามคอม</div>
							<div class="w3-bar"><input type="radio" onclick="javascript:qtype();" name="type_type" value="2" id="type2" readonly> พิมพ์ตามใบสั่งซื้อ</div>
							<div class="w3-bar"><input type="radio" onclick="javascript:qtype();" name="type_type" value="3" id="type3" checked readonly> พิมพ์ตามที่เขียน
						...
						<div class="w3-bar"><a href="slip/<?php echo $fv["slip1"]; ?>" target="_blank"><?php echo $fv["slip1"]; ?></a></div>
						<div class="w3-bar"><a href="slip/<?php echo $fv["slip2"]; ?>" target="_blank"><?php echo $fv["slip2"]; ?></a></div>
						<div class="w3-bar"><a href="slip/<?php echo $fv["slip3"]; ?>" target="_blank"><?php echo $fv["slip3"]; ?></a></div>
						<div class="w3-bar"><a href="slip/<?php echo $fv["slip4"]; ?>" target="_blank"><?php echo $fv["slip4"]; ?></a></div>
						<div class="w3-bar"><a href="slip/<?php echo $fv["slip5"]; ?>" target="_blank"><?php echo $fv["slip5"]; ?></a></div>
		...
		<div class="w3-bar w3-margin-bottom"><!-- ท่อนล่าง -->
			...
			<div id="14" class="tab w3-padding-small">
				<div style="overflow-x:auto;">
					...
					<?php
						...
						<tr>
							<td></td>
							<td><?php echo $fpd["access_code"]; ?></td>
							<td><?php echo $fpd["access_name"]; ?></td>
							<td><?php echo $fpd["count"]; ?></td>
							<td><?php echo $fpd["unit"]; ?></td>
							<td><?php echo $fpd["price"]; ?></td>
							<td><?php echo $fpd["discount"]; ?></td>
							<td><?php echo $fpd["amount"]; ?></td>
							<td><?php echo $fpd["warranty"]; ?></td>
							<td><?php echo $fpd["cal"]; ?></td>
							<td><?php echo $fpd["pm"]; ?></td>
							<td><?php echo $fpd["sale_remark"]; ?></td>
						</tr>
						<?php } ?>
					<!-- body dynamic rows -->
			...
			<div id="3" class="tab w3-padding-small" style="display:none">
				<?php if($fv["delivery_type"]==1) { ?>
					<input type="radio" name="delivery_type" value="1" onclick="javascript:ckk_2();" id="object8" checked readonly>&nbsp;Sale รับเอง
					<input type="radio" name="delivery_type" value="2"  onclick="javascript:ckk_2();" id="object9" readonly>&nbsp;ช่างรับเอง<br />
					<input type="radio" name="delivery_type" value="3"  onclick="javascript:ckk_2();" id="object10" readonly>&nbsp;ลูกค้ารับเอง 
					<input type="radio" name="delivery_type" value="4"  onclick="javascript:ckk_2();" id="object11" readonly>&nbsp;บริษัทจัดส่ง <br />
				...
				<?php if($fv["delivery_type"]==2) { ?>
					<input type="radio" name="delivery_type" value="1" onclick="javascript:ckk_2();" id="object8" readonly>&nbsp;Sale รับเอง
					<input type="radio" name="delivery_type" value="2"  onclick="javascript:ckk_2();" id="object9" checked readonly>&nbsp;ช่างรับเอง<br />
					<input type="radio" name="delivery_type" value="3"  onclick="javascript:ckk_2();" id="object10" readonly>&nbsp;ลูกค้ารับเอง 
					<input type="radio" name="delivery_type" value="4"  onclick="javascript:ckk_2();" id="object11" readonly>&nbsp;บริษัทจัดส่ง <br />
				...
				<?php if($fv["delivery_type"]==3) { ?>
					<input type="radio" name="delivery_type" value="1" onclick="javascript:ckk_2();" id="object8" readonly>&nbsp;Sale รับเอง
					<input type="radio" name="delivery_type" value="2"  onclick="javascript:ckk_2();" id="object9" readonly>&nbsp;ช่างรับเอง<br />
					<input type="radio" name="delivery_type" value="3"  onclick="javascript:ckk_2();" id="object10" checked readonly>&nbsp;ลูกค้ารับเอง 
					<input type="radio" name="delivery_type" value="4"  onclick="javascript:ckk_2();" id="object11" readonly>&nbsp;บริษัทจัดส่ง <br />
				...
				<?php if($fv["delivery_type"]==4) { ?>
					...
					<input type="radio" name="delivery_type" value="2"  onclick="javascript:ckk_2();" id="object9" readonly>&nbsp;ช่างรับเอง<br />
					<input type="radio" name="delivery_type" value="3"  onclick="javascript:ckk_2();" id="object10" readonly>&nbsp;ลูกค้ารับเอง 
					<input type="radio" name="delivery_type" value="4"  onclick="javascript:ckk_2();" id="object11" checked readonly>&nbsp;บริษัทจัดส่ง <br />
				...
				<div id="dv2" style="display:none"><!-- dv2 -->
					<div class="w3-container w3-third"><!-- first third -->
						...
						<div class="w3-bar">
							ประเภทลูกค้า
							<select name="customer_typename" id="customer_typename" class="w3-select" readonly>
						...
						<div class="w3-bar">
							หน่วยงาน
							<select name="company_name" id="company_name" class="w3-select" readonly>
					...
					<div class="w3-container w3-third"><!-- second third -->
						...
						<div class="w3-bar">
							...
							<div id="have_map-2" style="display:block;">
								<div class="w3-bar"><a href="map/<?php echo $fcs["mapfile1"]; ?>"><?php echo $fcs["mapfile1"]; ?></a></div>
								<div class="w3-bar"><a href="map/<?php echo $fcs["mapfile2"]; ?>"><?php echo $fcs["mapfile2"]; ?></a></div>
								<div class="w3-bar"><a href="map/<?php echo $fcs["mapfile3"]; ?>"><?php echo $fcs["mapfile3"]; ?></a></div>
								<div class="w3-bar"><a href="map/<?php echo $fcs["mapfile4"]; ?>"><?php echo $fcs["mapfile4"]; ?></a></div>
								<div class="w3-bar"><a href="map/<?php echo $fcs["mapfile5"]; ?>"><?php echo $fcs["mapfile5"]; ?></a></div>
							</div>
						</fieldset>
					</div><!-- second third -->
		...
		<div class="w3-bar w3-center">
			<input type="submit" name="approve" class="w3-button w3-teal w3-border" value="Approve">   <input type="submit" name="reject" class="w3-button w3-red w3-border" value="Reject">
		</div>
	</form>
</div>
