...
<form name="frmSearch" method="GET" action="rport_kangclear.php">
<div class="w3-panel w3-light-gray"><h4>รายงานออร์เดอร์ค้างเคลียร์ยืม</h4></div>
<div class="w3-white">
...
<div class="w3-container w3-third">
  ...
  ประเภทเลขที่เอกสาร
<select name="sol" id="sol" style="width:90%" class="w3-input"   >
