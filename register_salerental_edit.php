...
<form action='register_salerental_edit1.php' method="post" name="frmMain" enctype="multipart/form-data" onSubmit="JavaScript:return fncSubmit();" >
...
<a href="sendrental_supapp.php?ref_id=<?php echo $objResult["ref_id"];?>&rental_name=<?php echo $objResult["rental_name"]; ?>" class="w3-button w3-yellow w3-right"><font color="red">ส่งใบสั่งเช่าให้ Sup อนุมัติ</font></a>&nbsp;&nbsp;
					
					
					<?php } ?>
					<?php if($objResult["ref_iv"]==''){ ?>			
<a href="open_rentaliv.php?ref_id=<?php echo $objResult["ref_id"];?>&type=<?php echo 'IV'; ?>" class="w3-button w3-blue w3-right"><font color="black">เปิดใบค่าเช่าสินค้า</font></a>&nbsp;&nbsp;
	<?php } ?>	<?php if($objResult["ref_ai"]=='0'){ ?>
<a href="open_rentaliv.php?ref_id=<?php echo $objResult["ref_id"];?>&type=<?php echo 'AI'; ?>" class="w3-button w3-grey w3-right"><font color="black">เปิดใบค่ามัดจำสินค้า</font></a>&nbsp;&nbsp;
	<?php } ?>
