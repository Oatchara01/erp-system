...
$sql7="insert into tb_warranty_eng (date_install,add_by,add_date,ckk_h) values ('".$strNewDate."','".$add_by."','".$add_date."','2') ";
...
<div class="w3-panel w3-light-gray"><h4>รายการติดตั้งสินค้า Hospital</h4></div>	
...
$strSQL51 = "SELECT DISTINCT date_disburse  FROM hos__so  WHERE iv_no!='' and status_doc = 'Approve'";
...
/*$strSQL53 = "SELECT date_install  FROM so__main  WHERE date_install='".$objResult51["date_disburse"]."' and ckk_h='2'";
$objQuery53 = mysqli_query($conn,$strSQL53) or die ("Error Query [".$strSQL53."]");
$objResult53 = mysqli_fetch_array($objQuery53)	
	
if($objResult53["date_install"]!=''){	
$sql7="insert into tb_warranty_eng (date_install,add_by,add_date,ckk_h) values ('".$objResult51["date_disburse"]."','".$add_by."','".$add_date."','2') ";
$objQuery7 = mysqli_query($conn,$sql7)or die(mysqli_error());	
...
$add_by = "$name $surname";
 ...
 $strSQL91 = "INSERT INTO tb_exportsn (channel,date_export,add_by,add_date) VALUES ('2','".$objResult51["date_disburse"]."','".$add_by."','".$add_date."')";
 $objQuery91 = mysqli_query($conn,$strSQL91)or die(mysqli_error());	
	
}		
	
	
$strSQL = "SELECT bill_id,bill_name,bill_address,bill_tel,ref_id,delivery_date,date_send_key,iv_no,have_order,have_product,stock_date,sale_comment  FROM hos__so  WHERE iv_no!='' and status_doc = 'Approve'";
...
$sale_remark1 = $objResult1["sale_remark"];
$sale_comment = $objResult["sale_comment"];
$sale_remark = "$sale_remark1 $sale_comment";
		
$strSQL2 = "SELECT sol_name,war_hos FROM tb_product WHERE product_ID = '".$product_id."'";
...
<td align="center" class="style30"><?php echo $objResult["bill_name"]; ?></td>
<td align="center" class="style30"><?php echo $objResult["bill_tel"]; ?></td>
<td align="center" class="style30"><?php echo $objResult["bill_address"]; ?></td>
...
<td align="center" class="style30"><?php echo $sale_remark; ?></td>
...
$strSQL9 = "UPDATE tb_installation_data SET install_cus_name ='".$customer_name."',install_cus_address='".$address."',install_cus_tel='".$tel."',install_date='".$register_date."',warranty_phase='".$warranty1."',out_insurance_date='".$datedate."',add_date_search='".$date_edit."',ref_id = '".$ref_id."',register_id ='".$bill_id."'  where product_sn='".$product_sn1."'";
...
$strSQL = "SELECT bill_id,bill_name,bill_address,bill_tel,ref_id,delivery_date,date_send_key,iv_no,have_order,have_product,stock_date,sale_comment  FROM hos__so  WHERE iv_no!='' and status_doc = 'Approve' and date_disburse='0000-00-00'";
