...
$sale_remark = "บริจาคน้ำท่วมเชียงราย"; 
...
values
('".$customer_name."','6','".$address1."','".$address2."','".$province."','".$postcode."','".$tel."','".$billing_name."','".$billing_add."','".$billing_aum."','".$billing_pro."','".$billing_postcode."','".$billing_tel."','".$tax_id."','".$delivery_name."','".$address1."','".$address2."','".$province."','".$postcode."','".$tel."','".$delivery_contact."','".$employee_name."','".$email_cus."')";
...
values ('".$main_id."','".$objArr[9]."','".$objArr[9]."','0.00','0.00','0.00','0.00','5016','5016','','Approve','บริจาคน้ำท่วมภาคใต้')";
$objQuery1 = mysqli_query($conn,$strSQL1);
...
$strSQL3 = "insert into so__submain
(ref_idd,sale_count,sale_countref,price_per_unit,price_per_unitref,sum_amount,discount_unit,product_id,product_code,warranty,status_sol)
values ('".$main_id."','1','1','0.00','0.00','0.00','0.00','5204','5204','','Approve')";
$objQuery3 = mysqli_query($conn,$strSQL3);
...
fclose($objCSV);  
 ...
 if($objQuery){
$sql2 = "SELECT ref_id FROM so__main WHERE sale_channel = '33' and register_date = '" . $register_date . "' and add_by ='" . $add_by . "' ";
