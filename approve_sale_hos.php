...
<div class="w3-container">
	<div class="w3-panel w3-light-grey"><h3>Approve Sale Order</h3></div>
		...
		<div class="w3-half"><!-- ครึ่งสอง -->
			...
			<div class="w3-bar">
				...
				<div class="w3-half">
					...
					<input type="text" name="approve_name" class="w3-input w3-center" style="width:90%;" value="<?php $approves=$fadmin['approve']; $approven=mysqli_query($conn,"select * from tb_user where em_id='$approves'"); $fapproven = mysqli_fetch_array($approven); echo $fapproven['name']; echo $fapproven['surname']; ?>">
