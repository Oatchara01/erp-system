...
ช่องทางการขาย</p>
<select name="sale_channel" id="sale_channel" class="w3-select" style="width:30%;" >
...
<br>
<center>
		  <input type="button" name ="Submit" value="บันทึก" class = "button button4" onClick="this.form.action='add_solptl1.php'; submit()">
</center>
...
$strSQL = "SELECT * FROM  (tb_solptl LEFT JOIN tb_salechannel ON tb_solptl.sale_channel=tb_salechannel.salechannel_ID)  where 1";
...
$strSQL .=" order  by sol_ptl DESC   LIMIT $Page_Start , $Per_Page";
$objQuery  = mysqli_query($conn,$strSQL);
?>
<div class="w3-container">
	<table border="1" width="100%" class="w3-table">
		<thead class="w3-gray">
			<th width="5%">ID เลขที่เอกสาร</th>
...
?>
		<tbody>
			<tr>
				<td><?php echo $objResult["sol_ptl"];?></td>
				<td><?php echo datethai($objResult["date_sol"]);?></td>
