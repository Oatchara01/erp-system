...
<?php 
if($_SESSION['name']=='สมบัติ'){
}else{
?>
<a href="sample_sendstock.php?ref_idsmp=<?php echo $_GET["ref_idsmp"]; ?>" target="_blank" class="w3-button w3-green w3-right"><font color="black">ส่งใบเบิกให้ Stock</font></a>&nbsp;&nbsp;

<a href="sample_senddm.php?ref_idsmp=<?php echo $_GET["ref_idsmp"]; ?>" target="_blank" class="w3-button w3-blue w3-right"><font color="black">ส่งให้พี่โจ้ Approve</font></a>&nbsp;&nbsp;

<?php }  ?>

	</div>
		<form action="register_cmsmp_edit1.php" method="post" name="frmMain" enctype="multipart/form-data">
<div class="w3-bar">
...
<div class="w3-bar w3-margin-bottom">
			Comment Sup :&nbsp;
			<textarea name="comment_sup" id="comment_sup" class="w3-input" style="width:90%;"  required><?php echo $ffirst['comment_sup']; ?></textarea>
</div>
</div>
