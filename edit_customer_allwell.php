...
<body>
<form   method="post" action="edit_customer_allwell1.php" name="frmMain" enctype="multipart/form-data"  onSubmit="JavaScript:return fncSubmit();" >
...
หมายเหตุ
<textarea name="remark_cus"  class="w3-input" ><?php echo $objResult["remark_cus"]; ?></textarea>
...
<div class="w3-container w3-third">
<input type="checkbox" name="ckk_chnge" id="ckk_chnge"  value = "1"  >	 แก้ไขข้อมูลออกบิล ใส่เหตุผล <br>
	<input name="remark_edit" id = "remark_edit" style="width:100%" >
</div>
<div class="w3-container w3-third">
 ชื่อที่ใช้ออกบิล
