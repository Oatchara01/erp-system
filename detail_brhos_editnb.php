...
<tr>
<td style="width:10%;">
<input type='text' name = "product_codet9"  id = "product_codet9" class="button4" placeholder="Search รหัส..."  size="10" OnChange="JavaScript:doCallAjax('product_codet9','product_id9','product_name9','unit_name9','product_price9','warranty9');"/> 
<input type='hidden' name = "h_product_codet9"  id = "h_product_codet9"  class="button4" readonly>

<input type='text' name = "product_code9"  id = "product_code9" class="button4" placeholder="Search ชื่อสินค้า..."  size="10" OnChange="JavaScript:doCallAjax('product_code9','product_id9','product_name9','unit_name9','product_price9','warranty9');"/> 
<input type='hidden' name = "h_product_code9"  id = "h_product_code9"  class="button4" readonly>
	
<input type='text' name = "product_c9"  id = "product_c9" class="button4" placeholder="Search ชื่อสินค้า..."  size="10" OnChange="JavaScript:doCallAjax('product_c9','product_id9','product_name9','unit_name9','product_price9','warranty9');"/> 
...
<td  style="width:12%;">
<textarea  name = "product_name9"  id = "product_name9"  rows="2" class="button4" readonly></textarea>
</td>
<td style="width:5%;">
...
<td style="width:10%;">
<input type='text' name = "product_price9"  id = "product_price9"  class="button4" size="10" style="color:black;text-align:right" />
</td >


<td style="width:10%;"><input type='text' name = "sum_amount9"  id = "sum_amount9"  class="button4" size="10" style="color:black;text-align:right" value="" jAutoCalc= '{sale_count9} * {product_price9}'readonly/>
</td>
<td style="width:10%;">
<textarea name = "sn9"  id = "sn9"  class="w3-input" ></textarea>
</td>		
<td style="width:5%;">
<input type='text' name = "warranty9"  id = "warranty9"  class="w3-input" />
</td>		
<td style="width:5%;">
<input type='text' name = "br_period9" id = "br_period9" placeholder="จำนวนวัน" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}" class="button4" style="color:black;text-align:center" size="10"  />
</td>
<td style="width:20%;">
...
<tr>
<td style="width:10%;">
<input type='text' name = "product_codet10"  id = "product_codet10" class="button4" placeholder="Search รหัส..."  size="10" OnChange="JavaScript:doCallAjax('product_codet10','product_id10','product_name10','unit_name10','product_price10','warranty10');"/> 
<input type='hidden' name = "h_product_codet10"  id = "h_product_codet10"  class="button4" readonly>

<input type='text' name = "product_code10"  id = "product_code10" class="button4" placeholder="Search ชื่อสินค้า..."  size="10" OnChange="JavaScript:doCallAjax('product_code10','product_id10','product_name10','unit_name10','product_price10','warranty10');"/> 
<input type='hidden' name = "h_product_code10"  id = "h_product_code10"  class="button4" readonly>
	
<input type='text' name = "product_c10"  id = "product_c10" class="button4" placeholder="Search ชื่อสินค้า..."  size="10" OnChange="JavaScript:doCallAjax('product_c10','product_id10','product_name10','unit_name10','product_price10','warranty10');"/> 
...
<td  style="width:12%;">
<textarea  name = "product_name10"  id = "product_name10"  rows="2" class="button4" readonly></textarea>
</td>
<td style="width:5%;">
...
<td style="width:10%;">
<input type='text' name = "product_price10"  id = "product_price10"  class="button4" size="10" style="color:black;text-align:right" />
</td >


<td style="width:10%;"><input type='text' name = "sum_amount10"  id = "sum_amount10"  class="button4" size="10" style="color:black;text-align:right" value="" jAutoCalc= '{sale_count10} * {product_price10}'readonly/>
</td>
<td style="width:10%;">
<textarea name = "sn10"  id = "sn10"  class="w3-input" ></textarea>
</td>		
<td style="width:5%;">
<input type='text' name = "warranty10"  id = "warranty10"  class="w3-input" />
</td>		
<td style="width:5%;">
<input type='text' name = "br_period10" id = "br_period10" placeholder="จำนวนวัน" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}" class="button4" style="color:black;text-align:center" size="10"  />
</td>
<td style="width:20%;">
...
function make_autocom(autoObj,showObj){
	...
	new Autocomplete(mkAutoObj, function() {
		...
		if ( this.value.length < 1 && this.isNotClick ) 
			return ;	
		return "data_product_hosthnb.php?product_code_search=" +encodeURIComponent(this.value);
    });	
}	
