...
$nextId = $yearMonth.$maxId1;
	...
	<form action='register_credit_saleallwell1.php' method="post" name="frmMain" enctype="multipart/form-data">
		<div class="w3-white">
...
เลขที่ IV :&nbsp;&nbsp;
<input type="text" name="iv_no_ref" id="iv_no_ref" value ="<?php echo $rs["doc_no"]; if($rs["iv_no"]!=''){ echo '/'; echo $rs["iv_no"]; }?>" class="button4" style="width:30%;"  > 
...
<input type="hidden" name="sale_code" id="sale_code" value = "<?php echo $rs['employee_name']; ?>" class="button4" style="width:12%;"  required> &nbsp;&nbsp;
...
$sql3 = "SELECT sum(count) as count3   FROM  (tb_credit_note LEFT JOIN tb_subcredit ON tb_credit_note.ref_credit=tb_subcredit.ref_creditt) where iv_no_ref = '".$rs["doc_no"]."' and product_id = '".$product_id."' and status_doc ='Approve'";
...
<td style="width:5%;"><input type='text' name = "unit_name[]<?php echo $objResult1["id"];?>" value="<?php echo $objResult11["unit_name"];?>" id = "unit_name[]<?php echo $objResult1["id"];?>"  class="w3-input"    readonly/></td>
