...
<div class="w3-panel w3-light-gray"><h4>ใบสั่งขาย (ฝากขาย)  ค้าง (IC)</h4></div>
...
$strSQL = "SELECT *  FROM hos__so  where status_doc !='Rejected' and send_sup ='1' and iv_date ='0000-00-00' and have_order = '0' and ic_ckk='1'";
...
?>
 ...
 echo DateThai($objResult["date_so"]);
	...
	?><br />
				...
				<td ><div align="left"><?php if($objResult["approve_date"]!='0000-00-00'){ echo Datethai($objResult["approve_date"]); ?>   <?php echo $objResult["approve_time"]; } ?></div></td>
