...
<div class="w3-panel w3-light-gray"><h4>รายการใบเสนอราคา</h4></div>
...
<div class="w3-container">
	<table border="1" width="100%" class="w3-table">
		<thead class="w3-gray">
			...
			<th width="5%">สถานะ</th>
			<th width="2%">ปิดการขาย</th>
			<th width="5%">แก้ไข</th>
			<th width="2%">Print</th>
			<th width="2%">Copy Doc</th>
			<th width="2%">สร้างใบสั่งขาย</th>
...
<td><div align="left">
<?php
$strSQL1 = "SELECT sol_name FROM (qou__sbmain LEFT JOIN tb_product ON qou__sbmain.product_ID=tb_product.product_id) WHERE ref_idd = '".$objResult["ref_id"]."' ";
...
<td><div align="left"><?php echo $objResult["cus_name"];?></div></td>
<?php
...
<?php } ?>
				...
				<?php
					if($objResult["ref_so"]==''){	?>
						<td bgcolor="#FF3030"><?php echo "รอเปิดใบสั่งขาย";?></td>
								<?php }
					else if ($objResult["ref_so"] !=''){ ?>
				<td bgcolor="#00FF00"><a href="register_allwell_edit.php?ref_id=<?php echo $objResult["ref_so"];?>">เปิดใบสั่งขายแล้ว</a></td>
				
				<?php } ?>
				<td>	
				
				<a href="register_qou_edit.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
				
				</td>
					<td>	
		<?php  		//if($objResult["status_doc"]=='Approve') {		 ?>
<a href="formnb_qou.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a>
...
<a href="register_qou_create.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/receipt_product.png" width="23" height="23" border="0" /></a>
				
				</td>			
				<td>
					<?php  		if($objResult["status_doc"]=='Approve') {  ?>
					<a href="register_quocreate.php?id=<?php echo $objResult["ref_id"];?>"><img src="img/create.png" width="23" height="23" border="0" /></a>
					<?php } ?>
					</td>
