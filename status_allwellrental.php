...
$strSQL = "SELECT *  FROM hos__rental  where ckk_allwell='1' ";	
...
<div class="w3-container">
	<table border="1" width="100%" class="w3-table">
		<thead class="w3-gray">
			...
			<th width="5%">สถานะ</th>
			<th width="5%">สถานะเช่า</th>
			<th width="5%">แก้ไข</th>
			<th width="5%">เปิดใบสั่งขาย</th>
			<th width="5%">เปิดรับเงินประกัน</th>
			<th width="5%">Print</th>
	</thead>
<?php
$i = 1;
...
$strSQL13 ="SELECT date_runiv FROM hos__rental_runiv WHERE ref_idren = '".$objResult['ref_id']."' and ref_idiv='' order by id_ren DESC";
...
?>
	...
	echo $objResult1["sol_name"];  ?><br> <?php }  ?>
				...
				<?php }
					...
					<td ></td>
				<?php } ?>
<td><a href="register_allwellrental_edit.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a></td>
				
					<td>
				<?php if($objResult["ref_iv"]!=''){	?>
				<a href="register_allwell_edit.php?ref_id=<?php echo $objResult["ref_iv"];?>"  target="_blank"><?php echo $objResult["ref_iv"];?></a>
				<?php }else{  ?>
					<a href="register_allwellso_rental.php?ref_id=<?php echo $objResult["ref_id"];?>&type_ivren=<?php echo "IV"; ?>"  target="_blank"><img src="img/create.png" width="23" height="23" border="0" /></a>
				<?php } ?>
				</td>
				<td>
					<?php if($objResult["ref_ai"]!=''){	?>
				<a href="register_allwell_edit.php?ref_id=<?php echo $objResult["ref_ai"];?>"  target="_blank"><?php echo $objResult["ref_ai"];?></a>
				<?php }else{  ?>
<a href="register_allwellai_rental.php?ref_id=<?php echo $objResult["ref_id"];?>&type_ivren=<?php echo "AI"; ?>"  target="_blank"><img src="img/create.png" width="23" height="23" border="0" /></a>
				<?php } ?></td>
<td>
