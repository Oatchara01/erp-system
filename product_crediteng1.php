...
<tr>
<td  style="width:10%;">
<input type='text' name = "product_codet6"  id = "product_codet6" class="button4" placeholder="Search รหัส" size="9"  OnChange="JavaScript:doCallAjax('product_codet6','product_id6','product_name6','unit_name6','product_price6','discount_unit6');"/> 
<input type='hidden' name = "h_product_codet6"  id = "h_product_codet6"  class="w3-input" readonly></p>

<input type='text' name = "product_code6"  id = "product_code6" size="9" class="button4" placeholder="Search ชื่อสินค้า..." OnChange="JavaScript:doCallAjax('product_code6','product_id6','product_name6','unit_name6','product_price6','discount_unit6');"/> 
...
<input type='text' name = "product_codet7"  id = "product_codet7" class="button4" placeholder="Search รหัส" size="9"  OnChange="JavaScript:doCallAjax('product_codet7','product_id7','product_name7','unit_name7','product_price7','discount_unit7');"/> 
<input type='hidden' name = "h_product_codet7"  id = "h_product_codet7"  class="w3-input" readonly></p>

<input type='text' name = "product_code7"  id = "product_code7" class="button4" placeholder="Search ชื่อสินค้า..." size="9" OnChange="JavaScript:doCallAjax('product_code7','product_id7','product_name7','unit_name7','product_price7','discount_unit7');"/> 
...
<input type='text' name = "product_codet8"  id = "product_codet8" class="button4" placeholder="Search รหัส" size="9"  OnChange="JavaScript:doCallAjax('product_codet8','product_id8','product_name8','unit_name8','product_price8','discount_unit8');"/> 
<input type='hidden' name = "h_product_codet8"  id = "h_product_codet8"  class="w3-input" readonly></p>

<input type='text' name = "product_code8"  id = "product_code8" class="button4" placeholder="Search ชื่อสินค้า..."  size="9" OnChange="JavaScript:doCallAjax('product_code8','product_id8','product_name8','unit_name8','product_price8','discount_unit8');"/> 
...
<input type='text' name = "product_codet9"  id = "product_codet9" class="button4" placeholder="Search รหัส" size="9"  OnChange="JavaScript:doCallAjax('product_codet9','product_id9','product_name9','unit_name9','product_price9','discount_unit9');"/> 
<input type='hidden' name = "h_product_codet9"  id = "h_product_codet9"  class="w3-input" readonly></p>

<input type='text' name = "product_code9"  id = "product_code9" class="button4" placeholder="Search ชื่อสินค้า..."  size="9" OnChange="JavaScript:doCallAjax('product_code9','product_id9','product_name9','unit_name9','product_price9','discount_unit9');"/> 
...
<input type='text' name = "product_codet10"  id = "product_codet10" class="button4" placeholder="Search รหัส" size="9"  OnChange="JavaScript:doCallAjax('product_codet10','product_id10','product_name10','unit_name10','product_price10','discount_unit10');"/> 
<input type='hidden' name = "h_product_codet10"  id = "h_product_codet10"  class="w3-input" readonly></p>

<input type='text' name = "product_code10"  id = "product_code10" class="button4" placeholder="Search ชื่อสินค้า..."  size="9" OnChange="JavaScript:doCallAjax('product_code10','product_id10','product_name10','unit_name10','product_price10','discount_unit10');"/> 
