...
$strSQL = "SELECT SUM(sum_awl) As sum_awl,SUM(sum_nbm) As sum_nbm  FROM tb_sumall WHERE  sale_cose LIKE '%SOL%' and sale_cose !='SOL99' and sale_cose !='SOL1' and sale_cose !='SOL2' and sale_cose !='SOL3' and sale_cose !='SOL4' and sale_cose !='SOL5' and sale_cose !='SOL6' and month_sum = '".$start_date."'";
...
$target99 = $objResult1['target'];

$percen_sol99 = ($sumary_sol99/$target99)*100;
...
$strSQL = "SELECT SUM(sum_awl) As sum_awl,SUM(sum_nbm) As sum_nbm   FROM tb_sumall WHERE  sale_cose LIKE '%SOL%' and sale_cose !='SOL99' and sale_cose !='SOL1' and sale_cose !='SOL2' and sale_cose !='SOL3' and sale_cose !='SOL4' and sale_cose !='SOL5' and sale_cose !='SOL6' and month_sum >= '".$ytd_1."' and month_sum <= '".$start_date."'";
$objQuery = mysqli_query($conn,$strSQL) or die ("Error Query [".$strSQL."]");
$objResult = mysqli_fetch_array($objQuery);
...
$strSQL1 = "SELECT SUM(target) AS target FROM tb_target WHERE ckk_type ='6'  and month_no >= '".$ytd_1."' and month_no <= '".$start_date."'";
$objQuery1 = mysqli_query($conn,$strSQL1) or die ("Error Query [".$strSQL1."]");
$objResult1 = mysqli_fetch_array($objQuery1);
...
<center>
<h3 align="center">รายงานยอดขายแบบกราฟ E-Commerce</h3>
...
<table width="90%" border="1" cellpadding="0"  cellspacing="0" align="center">
 ...
 <tr> 
	...
	<tr>
		...
		<td align="right"><b><?php echo number_format($target99,2);?></b></td>
  ...
  <tr>
	  <td align="center"><b>Achieve (ยอดขาย)</b></td>
	   <td align="right"><b><?php echo number_format($sumary_sol99,2);?></b></td>
 ...
 <tr>
	 ...
	 <td align="right"><h4><b><font color='#FF4500'><?php echo number_format($percen_sol99,2);?> % </font></b></h4></td>	
...
<html>
 ...
 <tr> 
   ...
   <tr>
      ...
      <td align="right"><?php echo number_format($sumary_sol99,2);?></td> 
	  <td align="right"><?php echo number_format($target99,2);?></td>
	 <td align="right"><?php echo number_format($percen_sol99,2);?> %</td>
    </tr>
