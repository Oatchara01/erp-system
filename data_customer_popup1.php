...
while ($row = mysqli_fetch_array( $result )) {
	...
	$display_name = preg_replace("/(" . $product_code_search . ")/iu", "<b>$1</b>", $customer_name);
	echo "<li onselect=\"this.setText('$customer_name').setValue('$customer_name');\">$display_name</li>";
}
?>