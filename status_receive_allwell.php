...
<div class="w3-panel w3-light-gray"><h4>Status ใบรับคืนสินค้า</h4></div>
...
if($_SESSION['name']=='สวรรยา'){
$add_by = "and add_by='สวรรยา ภิบาลบุตร'";	
}else{
$add_by = "";	
}

$strSQL = "SELECT *  FROM hos__receive  where  allwell_ckk = '1' $add_by";
...
<a href="rister_clearbrpn_stedit.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
				...
				<td>
<a href="report_receive.php?ref_id=<?php echo $objResult["ref_id"];?>"><img src="img/print_icon-2.png" width="23" height="23" border="0" /></a>
