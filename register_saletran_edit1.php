...
$strSQL = "Update   hos__subchange set count_sale='$count_sale_new',count_stock='$count_stock_new',price='$product_price_new',amount='$sum_amount_new',sale_remark='$sale_remarkk_new',product_id='$product_id_new',product_code ='$product_id_new',sn='".$sn_new."'   Where id= '$id_new' ";
