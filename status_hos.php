	...
	<table id="myTable" class="w3-table w3-striped w3-bordered" border=1>
		...
		<tbody>
			<?php
				...
				$sol = "select * from hos__so where sale_code='".$_SESSION["emid"]."'";
...
<div class="w3-bar w3-margin-top">
  <a href="status_hos.php?page=1" class="w3-button w3-light-grey">&laquo;</a>
  <?php for($i=1;$i<=$total_page;$i++){ ?>
  <a href="status_hos.php?page=<?php echo $i; ?>" class="w3-button w3-light-grey"><?php echo $i; ?></a>
  <?php } ?>
  <a href="status_hos.php?page=<?php echo $total_page;?>" class="w3-button w3-light-grey" aria-label="Next">
