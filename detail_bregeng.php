...
<td style="width:20%;">
<textarea name = "remark_eng1"  id = "remark_eng1"  class="w3-input" ></textarea>
</td>

<td  style="width:5%;"><a onclick="
document.getElementById('product_code1').value = '';
...
document.getElementById('remark_eng1').value  = '';
...
<td style="width:20%;">
<textarea name = "remark_eng2"  id = "remark_eng2"  class="w3-input" ></textarea>
</td>
...
<td style="width:20%;">
<textarea name = "remark_eng3"  id = "remark_eng3"  class="w3-input" ></textarea>
</td>


<td><a onclick="
document.getElementById('product_code3').value = '';
...
document.getElementById('remark_eng3').value  = '';
"><img src="img/false.png" width="16" height="16" border="16" /></a></td>
...
<td style="width:20%;">
<textarea name = "remark_eng4"  id = "remark_eng4"  class="w3-input" ></textarea>
</td>

<td><a onclick="
document.getElementById('product_code4').value = '';
...
document.getElementById('remark_eng4').value  = '';
"><img src="img/false.png" width="16" height="16" border="16" /></a></td>
...
<td style="width:20%;">
<textarea name = "remark_eng5"  id = "remark_eng5"  class="w3-input" ></textarea>
</td>

<td><a onclick="
document.getElementById('product_code5').value = '';
...
document.getElementById('remark_eng5').value  = '';
"><img src="img/false.png" width="16" height="16" border="16" /></a></td>
...
<td style="width:20%;">
<textarea name = "remark_eng6"  id = "remark_eng6"  class="w3-input" ></textarea>
</td>

<td style="width:5%;"><a onclick="
document.getElementById('product_code6').value = '';
...
document.getElementById('remark_eng6').value  = '';
"><img src="img/false.png" width="16" height="16" border="16" /></a></td>
...
<td style="width:20%;">
<textarea name = "remark_eng7"  id = "remark_eng7"  class="w3-input" ></textarea>
</td>

<td><a onclick="
document.getElementById('product_code7').value = '';
...
document.getElementById('remark_eng7').value  = '';
"><img src="img/false.png" width="16" height="16" border="16" /></a></td>
...
<input type='hidden' name = "h_product_c8"  id = "h_product_code8"  class="w3-input" readonly>	
...
<td style="width:20%;">
<textarea name = "remark_eng8"  id = "remark_eng8"  class="w3-input" ></textarea>
</td>


<td><a onclick="
document.getElementById('product_code8').value = '';
...
document.getElementById('remark_eng8').value  = '';
"><img src="img/false.png" width="16" height="16" border="16" /></a></td>
...
<td style="width:20%;">
<textarea name = "remark_eng9"  id = "remark_eng9"  class="w3-input" ></textarea>
</td>

<td><a onclick="
document.getElementById('product_code9').value = '';
...
document.getElementById('remark_eng9').value  = '';
"><img src="img/false.png" width="16" height="16" border="16" /></a></td>
...
<tr>
<td style="width:10%;">
<input type='text' name = "product_codet10"  id = "product_codet10" class="w3-input" placeholder="Search รหัสสินค้า..."  OnChange="JavaScript:doCallAjax('product_codet10','product_id10','product_name10','unit_name10','product_price10');"/> 
...
<td style="width:20%;">
<textarea name = "remark_eng10"  id = "remark_eng10"  class="w3-input" ></textarea>
</td>

<td><a onclick="
document.getElementById('product_code10').value = '';
...
document.getElementById('remark_eng10').value  = '';
"><img src="img/false.png" width="16" height="16" border="16" /></a></td>
