...
<div class="w3-half">
<a href="bregsup_app.php?ref_id=<?php echo $rs["ref_id"];?>&add_by=<?php echo $rs["add_by"]; ?>&iv_no=<?php echo $rs["iv_no"]; ?>&customer_name=<?php echo $rs["customer_name"]; ?>"  class="w3-button w3-green w3-center"><font color="black">Approve</font></a>
<a href="bregsup_reject.php?ref_id=<?php echo $rs["ref_id"];?>"  class="w3-button w3-red w3-center"><font color="black">Rejected</font></a>&nbsp;&nbsp;
