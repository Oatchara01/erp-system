...
<input type='text' name = "product_codet1"  id = "product_codet1" class="button4" placeholder="Search รหัส"  size="7" OnChange="JavaScript:doCallAjax('product_codet1','product_id1','product_name1','unit_name1','product_price1','discount_unit1');"/> 
<input type='hidden' name = "h_product_codet1"  id = "h_product_codet1"  class="button4" readonly>


<input type='text' name = "product_code1"  id = "product_code1" class="button4" placeholder="Search ชื่อ"  size="7" OnChange="JavaScript:doCallAjax('product_code1','product_id1','product_name1','unit_name1','product_price1','discount_unit1');"/> 
...
<td style="width:8%;">
<input type='text' name = "product_price1"  id = "product_price1"  class="button4" size="7" style="color:black;text-align:right" />
</td >

<td style="width:8%;"><input type='text' name = "discount_unit1" size="5" id = "discount_unit1" class="button4"  style="color:black;text-align:right" /></td>


<td style="width:8%;"><input type='text' name = "sum_amount1"  id = "sum_amount1"  class="button4" size="7" style="color:black;text-align:right" value="" jAutoCalc= '{sale_count1} * {product_price1} - {discount_unit1} * {sale_count1}'readonly/>
</td>
...
<input type='text' name = "product_codet2"  id = "product_codet2" class="button4" placeholder="Search รหัส" size="7"  OnChange="JavaScript:doCallAjax('product_codet2','product_id2','product_name2','unit_name2','product_price2','discount_unit2');"/> 
<input type='hidden' name = "h_product_codet2"  id = "h_product_codet2"  class="w3-input" readonly>

<input type='text' name = "product_code2"  id = "product_code2" class="button4" placeholder="Search ชื่อสินค้า..." size="7" OnChange="JavaScript:doCallAjax('product_code2','product_id2','product_name2','unit_name2','product_price2','discount_unit2');"/> 
...
<td style="width:15%;">
<textarea name = "product_name2"  id = "product_name2"  class="button4" rows="2" readonly></textarea>
</td>
<td style="width:5%;">
...
<td style="width:8%;">
<input type='text' name = "product_price2"  id = "product_price2" size="7" class="button4"  style="color:black;text-align:right" />
</td style="width:8%;">
<td><input type='text' name = "discount_unit2"  id = "discount_unit2" size="5" class="button4"  style="color:black;text-align:right" /></td>

<td style="width:8%;"><input type='text' name = "sum_amount2"  id = "sum_amount2" size="7" class="button4" style="color:black;text-align:right" value="" jAutoCalc= '{sale_count2} * {product_price2} - {discount_unit2} * {sale_count2}'readonly/>
</td>
...
<input type='text' name = "product_codet3"  id = "product_codet3" class="button4" placeholder="Search รหัส" size="7"  OnChange="JavaScript:doCallAjax('product_codet3','product_id3','product_name3','unit_name3','product_price3','discount_unit3');"/> 
<input type='hidden' name = "h_product_codet3"  id = "h_product_codet3"  class="w3-input" readonly>

<input type='text' name = "product_code3"  id = "product_code3" class="button4" placeholder="Search ชื่อสินค้า..."  size="7" OnChange="JavaScript:doCallAjax('product_code3','product_id3','product_name3','unit_name3','product_price3','discount_unit3');"/> 
...
<td>
<textarea name = "product_name3"  id = "product_name3"  class="button4" readonly></textarea>
</td>
<td>
...
<td>
<input type='text' name = "product_price3"  id = "product_price3" size="7" class="button4"  style="color:black;text-align:right" />
</td>
<td><input type='text' name = "discount_unit3"  id = "discount_unit3" size="5" class="button4"  style="color:black;text-align:right" /></td>

<td><input type='text' name = "sum_amount3"  id = "sum_amount3" size="7" class="button4" style="color:black;text-align:right" value="" jAutoCalc= '{sale_count3} * {product_price3} - {discount_unit3} * {sale_count3}'readonly/>
</td>
...
<input type='text' name = "product_codet4"  id = "product_codet4" class="button4" placeholder="Search รหัส" size="7"  OnChange="JavaScript:doCallAjax('product_codet4','product_id4','product_name4','unit_name4','product_price4','discount_unit4');"/> 
<input type='hidden' name = "h_product_codet4"  id = "h_product_codet4"  class="w3-input" readonly>

<input type='text' name = "product_code4"  id = "product_code4" class="button4" placeholder="Search ชื่อสินค้า..."  size="7" OnChange="JavaScript:doCallAjax('product_code4','product_id4','product_name4','unit_name4','product_price4','discount_unit4');"/> 
...
<td>
<textarea  name = "product_name4"  id = "product_name4"  class="button4" readonly></textarea>
</td>
<td>
...
<td>
<input type='text' name = "product_price4"  id = "product_price4" size="7" class="button4"  style="color:black;text-align:right" />
</td>
<td><input type='text' name = "discount_unit4"  id = "discount_unit4" class="button4" size="5" style="color:black;text-align:right" /></td>

<td><input type='text' name = "sum_amount4"  id = "sum_amount4" size="7" class="button4" style="color:black;text-align:right" value="" jAutoCalc= '{sale_count4} * {product_price4} - {discount_unit4} * {sale_count4}'readonly/>
</td>
...
<input type='text' name = "product_codet5"  id = "product_codet5" class="button4" placeholder="Search รหัส" size="7"  OnChange="JavaScript:doCallAjax('product_codet5','product_id5','product_name5','unit_name5','product_price5','discount_unit5');"/> 
<input type='hidden' name = "h_product_codet5"  id = "h_product_codet5"  class="w3-input" readonly>

<input type='text' name = "product_code5"  id = "product_code5" class="button4" placeholder="Search ชื่อสินค้า..."  size="7" OnChange="JavaScript:doCallAjax('product_code5','product_id5','product_name5','unit_name5','product_price5','discount_unit5');"/> 
...
<td>
<textarea  name = "product_name5"  id = "product_name5"  class="button4" readonly></textarea>
</td>
<td>
...
<td>
<input type='text' name = "product_price5"  id = "product_price5"  class="button4" size="7" style="color:black;text-align:right" />
</td>

<td><input type='text' name = "discount_unit5"  id = "discount_unit5" class="button4" size="5" style="color:black;text-align:right" /></td>


<th><input type='text' name = "sum_amount5"  id = "sum_amount5" size="7" class="button4" style="color:black;text-align:right" value="" jAutoCalc= '{sale_count5} * {product_price5} - {discount_unit5} * {sale_count5}'readonly/>
</td>
