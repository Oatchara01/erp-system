...
<div class="w3-container">
	...
	<div class="w3-half">
	<h3>Edit Change Product</h3>
	</div>

<div class="w3-half">
		
<a href="report_changehos.php?ref_id=<?php echo $rs["ref_id"];?>" target="_blank" class="w3-button w3-grey w3-right"><font color="Blue">Print ใบยืม</font></button></a><br />
	...
	<?php if ($rs["company"]=='1'){ ?>
		...
		<input type="radio" name="company" value="1"  required> PTL
	...
	<div class="w3-half 1">
		...
		<div class="w3-bar w3-margin-bottom">
			<span>รายกการแก้ไข</span> <textarea name="des_stock"  id="des_stock" class="w3-input" style="width:90%;" rows="2"><?php echo $rs["des_stock"]; ?></textarea>
		</div>
...
?>
		...
		<div class="w3-bar w3-margin-bottom w3-half">
			...
			<input type="radio"  name="objective" value="4" id="object4" checked="checked" required> แลกเปลี่ยนสินค้าตามใบงานบริการเลขที่
...
<?php } ?>
			<input type="text" name="objective_des"  value = "<?php echo $rs["objective_des"]; ?>" class="w3-input" placeholder="ใส่เลขที่ใบงานบริการ" style="width:90%;">	
			</div>
...
<div class="w3-panel">
 ...
 <?php /*&nbsp;&nbsp;&nbsp;<input type="checkbox" name="ckk_1" id="ckk_1" onClick="ck_1();" value="1"/>ใบปะหน้ากล่อง<br/>
...
$sql1 = "SELECT * FROM (hos__subchange LEFT JOIN tb_product ON hos__subchange.product_ID=tb_product.product_id) WHERE ref_idd = '".$_GET["ref_id"]."' ";
$query1 = mysqli_query($conn,$sql1) or die ("Error Query [".$sql1."]");


$i = 1;
while($objResult1 = mysqli_fetch_array($query1))
{
?>
<tr>
<td style="width:15%;">
...
<td style="width:5%;"><a href="delete_productstch.php?ref_id=<?php echo $rs["ref_id"];?>&id=<?php echo $objResult1["id"];?>"><img src="img/false.png" width="16" height="16" border="0" /></a></td>
...
<?php include "product_changestedit.php"; ?>
...
รายละเอียดเพิ่มเติม :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	...
	<div class="w3-bar w3-center">
		...
		<input type="button" name ="Submit" value="บันทึก" class = "button button4" onClick="this.form.action='register_stockchangehos_edit1.php'; submit()" >
<?php } ?>
