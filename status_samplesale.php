...
<div class="w3-panel w3-light-grey"><h3>รายการเบิกสินค้าเพื่อสนับสนุนการขาย</h3></div>
...
$strSQL = "SELECT *  FROM hos__smp  where sale_code LIKE '%EN%' ";
}else{
$strSQL = "SELECT *  FROM hos__smp  where sale_code = '".$sale_code."' ";	
}
				...
				<td><div align="left">
					<?php
						...
						while($objResult1 = mysqli_fetch_array($objQuery1)) { ?>
							<?php 	echo $objResult1["sol_name"]; ?> <?php 	echo $objResult1["sale_remark"]; ?><br />
						<?php } ?>
				</div></td>
				<td><div align="left"><?php echo $objResult["customer_name"];?></div></td>
				<td><div align="left"><?php echo $objResult["ref_no"];?><br><?php echo $objResult["ref_no1"];?></div></td>
