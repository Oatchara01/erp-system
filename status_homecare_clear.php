...
$strSQL = "SELECT *  FROM hos__jongproduct  where sale_code LIKE '%SOL%' and close_jong = '0' and cancel_ckk = '0' and status_doc='Approve'";
...
echo DateThai($objResult["date_receive"]);
	...
	?><br />
			...
			<td><div align="left"><?php echo $objResult["sale_code"];?> <?php echo '-'; ?> <?php echo $objResult["sale_name"];?></div></td>
				...
				<?php } ?>
				<td>
				<a href="register_homecare_edit.php?ref_id=<?php echo $objResult["ref_id"];?>&start_date=<?php echo $_GET["start_date"];  ?>&end_date=<?php echo $_GET["end_date"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
											
				</td>
					<td>
						<a href=javascript:if(confirm('!!!ต้องการเปิดเอกสารใบสั่งขายใช่หรือไม่')==true){window.location='register_homecare_create.php?ref_id=<?php echo $objResult["ref_id"];?>';}><img src="img/sticker.png" width="23" height="23" border="0" /></a>
									
					</td>
				
<td>
						<a href=javascript:if(confirm('!!!ต้องการยกเลิกใบจองใช่หรือไม่')==true){window.location='cancel_hcjong.php?ref_id=<?php echo $objResult["ref_id"];?>';}><img src="img/sticker.png" width="23" height="23" border="0" /></a>
