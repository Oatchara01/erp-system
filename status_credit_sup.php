...
$strSQL = "SELECT *  FROM tb_credit_note  where $sddd ";
...
<tr>
 ...
 echo DateThai($objResult["date_credit"]);
	...
	?><br />
				...
				<a href="register_credit_supedit.php?ref_credit=<?php echo $objResult["ref_credit"];?>&start_date=<?php echo $_GET["start_date"];  ?>&end_date=<?php echo $_GET["end_date"];?>"><img src="img/edit-icon.png" width="23" height="23" border="0" /></a>
			...
			<a href="register_credit_supcreatenew.php?ref_credit=<?php echo $objResult["ref_credit"];?>&start_date=<?php echo $_GET["start_date"];  ?>&end_date=<?php echo $_GET["end_date"];?>"><img src="img/sticker.png" width="23" height="23" border="0" /></a>
