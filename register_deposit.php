 		...
 		<div class="w3-half">
			<div class="w3-half">
				<div class="w3-bar w3-margin-bottom">
					...
					<input name="bill_date" type='date' id="bill_date" class="w3-input" style="width:90%;" value="<?php echo date('Y-m-d'); ?>" readonly />
										<span>เลขที่</span>
					<input name="iv_no" type='text' id="iv_no" class="w3-input" style="width:90%;"   />
			...
			<div class="w3-third 1">
				<div class="w3-bar w3-margin-bottom">
				<span>แผนก</span>
				<input name="department" type="text" id="department" style="width:90%;" class="w3-input" />
			</div>
			</div>
			<div class="w3-third 1">
				<div class="w3-bar w3-margin-bottom">
		  ...
		  <div class="w3-third">
			...
			<div class="w3-bar">
				...
				<div class="w3-third 3">
					...
					<input name="payment_date" type="date" id="payment_date" style="width:90%;" class="w3-input" />
				</div>
			</div>
		</div>
