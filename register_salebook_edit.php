...
<div class="w3-white w3-container">
	...
	<a href="send_jong_approve.php?ref_id=<?php echo $_GET["ref_id"];?>" target="_blank" class="w3-button w3-gley w3-right"><font color="black">ส่งใบจองให้ Sup</font></a>&nbsp;&nbsp;
<?php } ?>
<a href="report_jongpro.php?ref_id=<?php echo $_GET["ref_id"];?>" target="_blank" class="w3-button w3-yellow w3-right"><font color="black">Print Preview</font></a>&nbsp;&nbsp;
	...
	<form action="register_salebook_edit1.php" method="post" name="frmMain" enctype="multipart/form-data">
	<div class="w3-bar">
...
<?php
	...
	if($_SESSION['department']=="วิศวกรรม"){ 
				if($ffirst["company"]=='1'){
	include ('detail_engjong1.php');
		}else if($ffirst["company"]=='2'){
		include ('detail_engjongnb1.php');		
		}
	}else{
		if($ffirst["company"]=='1'){
